                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-pricing" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-pricing">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-pricing">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="pricing-column.html">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Pricing column</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="pricing-grid.html">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-files-landscapes-alt"></span>Pages</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="pricing" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item active" href="pricing-column.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Pricing column</div>
                      </a></li>
                    <li><a class="dropdown-item" href="pricing-grid.html">
        ...
        <div class="row g-7 g-lg-11 mb-7">
          <div class="col-12 col-sm-6 col-xxl-3">
            <div class="d-flex flex-column justify-content-between h-100">
              <div><img class="mb-4 d-dark-none" src="../../assets/img/spot-illustrations/13.png" alt="" width="120" height="96"><img class="mb-4 d-light-none" src="../../assets/img/spot-illustrations/dark_13.png" alt="" width="120" height="96">
                <div class="mb-sm-5">
          ...
          <div class="col-12 col-sm-6 col-xxl-3">
            <div class="d-flex flex-column justify-content-between h-100">
              <div><img class="mb-4 d-dark-none" src="../../assets/img/spot-illustrations/14.png" alt="" width="120" height="96"><img class="mb-4 d-light-none" src="../../assets/img/spot-illustrations/dark_14.png" alt="" width="120" height="96">
                <div class="mb-sm-5">
          ...
          <div class="col-12 col-sm-6 col-xxl-3">
            <div class="d-flex flex-column justify-content-between h-100">
              <div><img class="mb-4 d-dark-none" src="../../assets/img/spot-illustrations/15.png" alt="" width="120" height="96"><img class="mb-4 d-light-none" src="../../assets/img/spot-illustrations/dark_15.png" alt="" width="120" height="96">
                <div class="mb-sm-5">
          ...
          <div class="col-12 col-sm-6 col-xxl-3">
            <div class="d-flex flex-column justify-content-between h-100">
              <div><img class="mb-4 d-dark-none" src="../../assets/img/spot-illustrations/16.png" alt="" width="120" height="96"><img class="mb-4 d-light-none" src="../../assets/img/spot-illustrations/dark_16.png" alt="" width="120" height="96">
                <div class="mb-sm-5">
