                    ...
                    <div class="col-12 col-xl-10 col-xxl-8">
                        <div class="row justify-content-center g-5">
                            <div class="col-12 col-lg-6 text-center order-lg-1"><img
                                    class="img-fluid w-lg-100 d-light-none"
                                    src="{{ asset('assets/img/spot-illustrations/500-illustration.png') }}"
                                    alt="" width="400"><img class="img-fluid w-md-50 w-lg-100 d-dark-none"
                                    src="{{ asset('assets/img/spot-illustrations/dark_500-illustration.png') }}"
                                    alt="" width="540"></div>
