          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-faq" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-faq">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-faq">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('faq/faq-accordion') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Faq accordion</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('faq/faq-tab') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link active label-1" href="{{ url('timeline') }}" role="button" data-bs-toggle="" aria-expanded="false">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-files-landscapes-alt"></span>Pages</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="faq" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ url('faq/faq-accordion') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Faq accordion</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('faq/faq-tab') }}">
                ...
                <li><a class="dropdown-item active" href="{{ url('timeline') }}">
      ...
      <div class="content">
        ...
        <div class="row gx-xl-8 gx-xxl-11">
          <div class="col-xl-5 p-xxl-7">
            <div class="ms-xxl-3 d-none d-xl-block position-sticky" style="top: 30%"><img class="d-dark-none img-fluid" src="{{ asset('assets/img/spot-illustrations/timeline.png') }}" alt=""><img class="d-light-none img-fluid" src="{{ asset('assets/img/spot-illustrations/timeline-dark.png') }}" alt=""></div>
          </div>
          <div class="col-xl-7 scrollbar">
            <div>
              <h4 class="py-3 border-y mb-5 ms-8">Today</h4>
                    ...
                    <div class="col">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex mb-2">
                          <h6 class="lh-sm mb-0 me-2 text-body-secondary timeline-item-title">Assigned to serve as the <br class='d-sm-none'> project's director</h6>
                        </div>
                      ...
                      <p class="fs-9 text-body-secondary w-sm-60 mb-5">Utilizing best practices to better leverage our assets, we must engage in black sky leadership thinking, not the usual band-aid solution.</p>
                    </div>
                  </div>
                </div>
                <div class="timeline-item">
                  <div class="row g-3">
                    ...
                    <div class="col">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex mb-2">
                          <h6 class="lh-sm mb-0 me-2 text-body-secondary timeline-item-title">Quary about purchased <br class="d-sm-none"> soccer socks</h6>
                        </div>
                      ...
                      <p class="fs-9 text-body-secondary w-sm-60 mb-5">I’ve come across your posts and found some favorable deals on your page. I’ve added a load of products to the cart and I don’t know the payment options you avail. Also, can you enlighten me about any discount.</p>
                    </div>
                  </div>
                </div>
                <div class="timeline-item">
                  <div class="row g-3">
                    ...
                    <div class="col">
                      <div class="d-flex justify-content-between">
                        <div class="d-flex mb-2">
                          <h6 class="lh-sm mb-0 me-2 text-body-secondary timeline-item-title">Onboarding Meeting</h6>
                        </div>
              ...
              <h4 class="py-3 border-y mb-5 ms-8">15 October, 2022</h4>
              <div class="timeline-basic mb-9">
                <div class="timeline-item">
                  <div class="row g-3">
                    <div class="col-auto">
              ...
              <h4 class="py-3 border-y mb-5 ms-8">20 October, 2022</h4>
              <div class="timeline-basic mb-9">
                <div class="timeline-item">
                  <div class="row g-3">
                    <div class="col-auto">
