          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <hr class="navbar-vertical-line"><!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{ url('starter') }}" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-faq" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-faq">
                    <div class="d-flex align-items-center">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-faq">
                      <li class="collapsed-nav-item-title d-none">Faq</li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('faq-accordion') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Faq accordion</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link active" href="{{ url('faq-tab') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-landing" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-landing">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-landing">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('landing/default') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Default</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('landing/alternate') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-pricing" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-pricing">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-pricing">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('pricing/pricing-column') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Pricing column</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('pricing/pricing-grid') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{ url('notifications') }}" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{ url('members') }}" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{ url('timeline') }}" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-errors" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-errors">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-errors">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('errors/404') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">404</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('errors/403') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">403</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('errors/500') }}">
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-simple" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-simple">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent" data-bs-parent="#authentication" id="nv-simple">
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/simple/sign-in') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sign in</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/simple/sign-up') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sign up</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/simple/sign-out') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sign out</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/simple/forgot-password') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Forgot password</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/simple/reset-password') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Reset password</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/simple/lock-screen') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Lock screen</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/simple/2FA') }}">
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-split" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-split">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent" data-bs-parent="#authentication" id="nv-split">
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/split/sign-in') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sign in</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/split/sign-up') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sign up</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/split/sign-out') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sign out</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/split/forgot-password') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Forgot password</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/split/reset-password') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Reset password</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/split/lock-screen') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Lock screen</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/split/2FA') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">2FA</span></div>
                              </a><!-- more inner pages-->
                            </li>
                          </ul>
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-Card" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-Card">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent" data-bs-parent="#authentication" id="nv-Card">
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/card/sign-in') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sign in</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/card/sign-up') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sign up</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/card/sign-out') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sign out</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/card/forgot-password') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Forgot password</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/card/reset-password') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Reset password</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/card/lock-screen') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Lock screen</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('authentication/card/2FA') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">2FA</span></div>
                              </a><!-- more inner pages-->
                            </li>
                          </ul>
              ...
              <div class="dropdown-menu dropdown-menu-end notification-dropdown-menu py-0 shadow border navbar-dropdown-caret" id="navbarDropdownNotfication" aria-labelledby="navbarDropdownNotfication">
                <div class="card position-relative border-0">
                  ...
                  <div class="card-footer p-0 border-top border-translucent border-0">
                    <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a class="fw-bolder" href="{{ url('notifications') }}">Notification history</a></div>
                  </div>
                </div>
              </div>
            </li>
        ...
        <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center" id="navbarTopCollapse">
          <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-files-landscapes-alt"></span>Pages</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                <li><a class="dropdown-item" href="{{ url('starter') }}">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="faq" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ url('faq-accordion') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Faq accordion</div>
                      </a></li>
                    <li><a class="dropdown-item active" href="{{ url('faq-tab') }}">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="landing" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ url('landing/default') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Default</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('landing/alternate') }}">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="pricing" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ url('pricing/pricing-column') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Pricing column</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('pricing/pricing-grid') }}">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="errors" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ url('errors/404') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>404</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('errors/403') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>403</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('errors/500') }}">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="authentication" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="simple" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ url('authentication/simple/sign-in') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign in</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/simple/sign-up') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign up</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/simple/sign-out') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign out</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/simple/forgot-password') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Forgot password</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/simple/reset-password') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Reset password</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/simple/lock-screen') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Lock screen</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/simple/2FA') }}">
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="split" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ url('authentication/split/sign-in') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign in</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/split/sign-up') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign up</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/split/sign-out') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign out</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/split/forgot-password') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Forgot password</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/split/reset-password') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Reset password</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/split/lock-screen') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Lock screen</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/split/2FA') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>2FA</div>
                          </a></li>
                      </ul>
                    </li>
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="Card" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ url('authentication/card/sign-in') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign in</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/card/sign-up') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign up</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/card/sign-out') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign out</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/card/forgot-password') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Forgot password</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/card/reset-password') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Reset password</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/card/lock-screen') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Lock screen</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('authentication/card/2FA') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>2FA</div>
                          </a></li>
                      </ul>
                    </li>
      ...
      <div class="content">
        <div class="mb-9">
          <div class="mx-n4 mx-lg-n6 mt-n5 position-relative mb-md-9" style="height:208px">
            <div class="bg-holder bg-card d-dark-none" style="background-image:url({{ asset('assets/img/bg/bg-40.png') }});background-size:cover;"></div>
            <!--/.bg-holder-->
            <div class="bg-holder bg-card d-light-none" style="background-image:url({{ asset('assets/img/bg/bg-dark-40.png') }});background-size:cover;"></div>
            <!--/.bg-holder-->
            ...
            <div class="col-md-6 col-xl-5 col-xxl-4">
              <div class="faq-sidebar offcanvas offcanvas-start bg-body z-5 w-100" id="faq-offcanvas" data-bs-backdrop="false" data-vertical-category-offcanvas="data-vertical-category-offcanvas">
                <ul class="faq-category-tab nav nav-tabs mb-10 mb-md-5 pb-3 pt-2 w-100 w-sm-75 w-md-100 mx-auto">
                  <li class="nav-item"><button class="nav-link fw-semibold me-3 fs-8" id="popular" type="button" data-bs-toggle="tab" data-category-filter="popular">Popular Categories</button></li>
                  <li class="nav-item"><button class="nav-link fw-semibold fs-8 active" id="all" type="button" data-bs-toggle="tab" data-category-filter="all">All Categories</button></li>
                </ul>
                <div class="faq-subcategory-tab nav nav-tabs w-sm-75 w-md-100 mx-auto mb-4" id="faq-subcategory-tab" style="width: 90%">
                  <div class="nav-item w-100 popular mb-3" role="presentation"><button class="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8 active" id="tab-sale-101" data-bs-toggle="tab" data-bs-target="#sale-101" type="button" role="tab" aria-selected="false" data-vertical-category-tab="data-vertical-category-tab"><span class="category-icon text-body-secondary fs-6 fa-solid fa-chart-pie"></span><span class="d-block fs-6 fw-bolder lh-1 text-body mt-3 mb-2">Sales</span><span class="d-block text-body fw-normal mb-0 fs-9">Answer the most frequently asked questions about your products &amp; services here.</span></button></div>
                  <div class="nav-item w-100  mb-3" role="presentation"><button class="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-delivery-101" data-bs-toggle="tab" data-bs-target="#delivery-101" type="button" role="tab" aria-selected="false" data-vertical-category-tab="data-vertical-category-tab"><span class="category-icon text-body-secondary fs-6 fa-solid fa-truck-fast"></span><span class="d-block fs-6 fw-bolder lh-1 text-body mt-3 mb-2">Delivery</span><span class="d-block text-body fw-normal mb-0 fs-9">Answer each &amp; every question about your product and service delivery, maintain customers.</span></button></div>
                  <div class="nav-item w-100  mb-3" role="presentation"><button class="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-notification-101" data-bs-toggle="tab" data-bs-target="#notification-101" type="button" role="tab" aria-selected="false" data-vertical-category-tab="data-vertical-category-tab"><span class="category-icon text-body-secondary fs-6 fa-solid fa-bell"></span><span class="d-block fs-6 fw-bolder lh-1 text-body mt-3 mb-2">Notification</span><span class="d-block text-body fw-normal mb-0 fs-9">Check and get all the necessary notices on the same page and board. Learn the FAQs here.</span></button></div>
                  <div class="nav-item w-100  mb-3" role="presentation"><button class="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-order-101" data-bs-toggle="tab" data-bs-target="#order-101" type="button" role="tab" aria-selected="false" data-vertical-category-tab="data-vertical-category-tab"><span class="category-icon text-body-secondary fs-6 fa-solid fa-file-invoice-dollar"></span><span class="d-block fs-6 fw-bolder lh-1 text-body mt-3 mb-2">Order</span><span class="d-block text-body fw-normal mb-0 fs-9">Check and have all your product order FAQs answered here. </span></button></div>
                  <div class="nav-item w-100  mb-3" role="presentation"><button class="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-networking-101" data-bs-toggle="tab" data-bs-target="#networking-101" type="button" role="tab" aria-selected="false" data-vertical-category-tab="data-vertical-category-tab"><span class="category-icon text-body-secondary fs-6 fa-solid fa-circle-nodes"></span><span class="d-block fs-6 fw-bolder lh-1 text-body mt-3 mb-2">Networking</span><span class="d-block text-body fw-normal mb-0 fs-9">See and answer all the queries to help your clients and customers and build strong networking between your team and your clientele</span></button></div>
                  <div class="nav-item w-100 popular mb-3" role="presentation"><button class="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-customize-101" data-bs-toggle="tab" data-bs-target="#customize-101" type="button" role="tab" aria-selected="false" data-vertical-category-tab="data-vertical-category-tab"><span class="category-icon text-body-secondary fs-6 fa-solid fa-sliders"></span><span class="d-block fs-6 fw-bolder lh-1 text-body mt-3 mb-2">Customize</span><span class="d-block text-body fw-normal mb-0 fs-9">Answer customization related questions here for simple and easy assistance.</span></button></div>
                  <div class="nav-item w-100  mb-3" role="presentation"><button class="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-marketing-101" data-bs-toggle="tab" data-bs-target="#marketing-101" type="button" role="tab" aria-selected="false" data-vertical-category-tab="data-vertical-category-tab"><span class="category-icon text-body-secondary fs-6 fa-solid fa-bullhorn"></span><span class="d-block fs-6 fw-bolder lh-1 text-body mt-3 mb-2">Marketing</span><span class="d-block text-body fw-normal mb-0 fs-9">Get all the marketing related questions answered here.</span></button></div>
                  <div class="nav-item w-100  mb-3" role="presentation"><button class="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-our-vision-101" data-bs-toggle="tab" data-bs-target="#our-vision-101" type="button" role="tab" aria-selected="false" data-vertical-category-tab="data-vertical-category-tab"><span class="category-icon text-body-secondary fs-6 fa-solid fa-peace"></span><span class="d-block fs-6 fw-bolder lh-1 text-body mt-3 mb-2">Our Vision</span><span class="d-block text-body fw-normal mb-0 fs-9">We provide web development solution in an economically efficient way. Learn further from these FAQs here</span></button></div>
                  <div class="nav-item w-100  mb-0" role="presentation"><button class="category nav-link btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8" id="tab-scheduling-101" data-bs-toggle="tab" data-bs-target="#scheduling-101" type="button" role="tab" aria-selected="false" data-vertical-category-tab="data-vertical-category-tab"><span class="category-icon text-body-secondary fs-6 fa-solid fa-calendar-xmark"></span><span class="d-block fs-6 fw-bolder lh-1 text-body mt-3 mb-2">Scheduling</span><span class="d-block text-body fw-normal mb-0 fs-9">See everything related to our scheduling from these FAQs below:</span></button></div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-xl-7 col-xxl-8 mt-md-11">
              <div class="faq-subcategory-content tab-content">
                <div class="empty-header d-none d-md-block"></div><button class="btn btn-link d-md-none my-6 fs-8 ps-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#faq-offcanvas"> <span class="fa-solid fa-chevron-left fs-9 me-2" data-fa-transform="up-2"></span>Categories</button>
                <div class="tab-pane fade active show" id="sale-101">
                  <ul class="list-inline mb-0">
                    <li class="d-flex gap-2 mb-6"><span class="fa-solid fa-star fs-8 text-primary"></span>
                      <div>
                        ...
                        <p class="mb-0 text-body-tertiary">You can mail us at <a href="mailto:info@phoenix.template">info@phoenix.template</a> or go to our services page to directly choose and pay to buy the services we provide.</p>
                      </div>
                    </li>
                    <li class="d-flex gap-2 mb-6"><span class="fa-solid fa-star fs-8 text-primary"></span>
                      <div>
                        <h4 class="mb-3 text-body-highlight">How much do your service cost?</h4>
                        <p class="mb-0 text-body-tertiary">Our services can be availed at a minimum cost. Please visit <a href="mailto:info.phoenix-tw.com">info.phoenix-tw.com</a> to get insights into the better purchase plans.</p>
                      </div>
                    </li>
                    <li class="d-flex gap-2 mb-6"><span class="fa-solid fa-star fs-8 text-primary"></span>
                      <div>
                  ...
                  <ul class="faq-list list-inline">
                    <li class="d-flex mt-6"><span class="fa-solid fa-circle"></span>
                      <div>
                        <h4 class="mb-3 text-body-highlight">Do you offer any free trial?</h4>
                        <p class="mb-0 text-body-tertiary">No, we don’t avail of any pre-booking or free trial option. You can contact at <a href="mailto:support.phoenix.themewagon">support.phoenix.themewagon</a> for further info.</p>
                      </div>
                    </li>
                    <li class="d-flex mt-6"><span class="fa-solid fa-circle"></span>
                      <div>
                        <h4 class="mb-3 text-body-highlight">Is it compatible with all available browsers?</h4>
                        <p class="mb-0 text-body-tertiary">Yes, it is a cross-browser compatible product.</p>
                      </div>
                    </li>
                    <li class="d-flex mt-6"><span class="fa-solid fa-circle"></span>
                      <div>
                        <h4 class="mb-3 text-body-highlight">What level of customer service do you provide?</h4>
                        <p class="mb-0 text-body-tertiary">Our customer service is available 24/7 for your concerns. You can communicate through live chat, email, or phone for any queries at support.phoenix.themewagon.</p>
                      </div>
                    </li>
                    <li class="d-flex mt-6"><span class="fa-solid fa-circle"></span>
                      <div>
                        <h4 class="mb-3 text-body-highlight">Is my data privacy secure with your product?</h4>
                        <p class="mb-0 text-body-tertiary">Yes. We constantly update and cross-check security audits and assessments to ensure the highest security standards.</p>
                      </div>
                    </li>
                    <li class="d-flex mt-6"><span class="fa-solid fa-circle"></span>
                      <div>
                        <h4 class="mb-3 text-body-highlight">Do you provide any refund?</h4>
                        <p class="mb-0 text-body-tertiary">Yes, we offer refunds to our customers under our terms and policies. Contact <a href="mailto:info@phoenix.template">info@phoenix.template</a> for more information.</p>
                      </div>
                    </li>
                    <li class="d-flex mt-6"><span class="fa-solid fa-circle"></span>
                      <div>
                        <h4 class="mb-3 text-body-highlight">Do I need to complete the full payment at a time, or is any installment or discount available?</h4>
                        <p class="mb-0 text-body-tertiary">Contact <a href="mailto:info@phoenix.template">info@phoenix.template</a> for more information.</p>
                      </div>
                    </li>
                  </ul>
                </div>
