    ...
    <main class="main" id="top">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <hr class="navbar-vertical-line"><!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link active label-1" href="{{ url('starter') }}" role="button" data-bs-toggle="" aria-expanded="false">
        ...
        <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center" id="navbarTopCollapse">
          <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-files-landscapes-alt"></span>Pages</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                <li><a class="dropdown-item active" href="{{ url('starter') }}">
      ...
      <div class="content">
        <div class="d-flex flex-center content-min-h">
          <div class="text-center py-9"><img class="img-fluid mb-7 d-dark-none" src="{{ asset('assets/img/spot-illustrations/2.png') }}" width="470" alt=""><img class="img-fluid mb-7 d-light-none" src="{{ asset('assets/img/spot-illustrations/dark_2.png') }}" width="470" alt="">
            <h1 class="text-body-secondary fw-normal mb-5">Create Something Beautiful.</h1><a class="btn btn-lg btn-primary" href="{{ url('documentation/getting-started') }}">Getting Started</a>
          </div>
        </div>
