        ...
        <div class="row flex-center min-vh-100 py-5">
          <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3"><a class="d-flex flex-center text-decoration-none mb-4" href="{{ url("/") }}">
            ...
            <div class="row flex-between-center mb-7">
              ...
              <div class="col-auto"><a class="fs-9 fw-semibold" href="{{ url('pages/authentication/simple/forgot-password') }}">Forgot Password?</a></div>
            </div><button class="btn btn-primary w-100 mb-3">Sign In</button>
            <div class="text-center"><a class="fs-9 fw-bold" href="{{ url('pages/authentication/simple/sign-up') }}">Create an account</a></div>
          </div>
        </div>
      </div>
@endsection
