                  ...
                  <div class="col mx-auto">
                    <div class="auth-form-box">
                      ...
                      <div class="row flex-between-center mb-7">
                        ...
                        <div class="col-auto"><a class="fs-9 fw-semibold" href="{{ url('pages/authentication/card/forgot-password') }}">Forgot Password?</a></div>
                      </div><button class="btn btn-primary w-100 mb-3">Sign In</button>
                      <div class="text-center"><a class="fs-9 fw-bold" href="{{ url('pages/authentication/card/sign-up') }}">Create an account</a></div>
                    </div>
                  </div>
                </div>
              </div>
