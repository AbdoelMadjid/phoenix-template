        ...
        <div class="col-lg-6">
          <div class="row flex-center h-100 g-0 px-4 px-sm-0">
            <div class="col col-sm-6 col-lg-7 col-xl-6"><a class="d-flex flex-center text-decoration-none mb-4" href="{{ url('dashboard') }}">
              ...
              </div><button class="btn btn-phoenix-secondary w-100 mb-3"><span class="fab fa-google text-danger me-2 fs-9"></span>Sign in with google</button>
              ...
              <div class="row flex-between-center mb-7">
                ...
                <div class="col-auto"><a class="fs-9 fw-semibold" href="{{ url('simple/forgot-password') }}">Forgot Password?</a></div>
              </div><button class="btn btn-primary w-100 mb-3">Sign In</button>
              <div class="text-center"><a class="fs-9 fw-bold" href="{{ url('sign-up') }}">Create an account</a></div>
            </div>
          </div>
        </div>
      </div>
