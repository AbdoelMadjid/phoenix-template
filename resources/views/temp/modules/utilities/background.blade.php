...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Convey meaning through color with a handful of color utility classes. Includes
        ...
        href="https://getbootstrap.com/docs/5.3/utilities/background/" target="_blank">Background on Bootstrap<span
                ...
                <div class="mb-9">
                    <div class="card shadow-none border my-5" data-component-card="data-component-card" id="doc-bg-color">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                            ...
                                            href="#solid-colors-code" role="button" aria-controls="solid-colors-code"
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="solid-colors-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;row g-0&quot;&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-5" data-component-card="data-component-card" id="doc-bg-body">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#body-colors-code" role="button" aria-controls="body-colors-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="body-colors-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;row g-0&quot;&gt;
  &lt;div class=&quot;col-6 col-sm-4 col-lg-3&quot;&gt;
...
&lt;/div&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy">
                                <div class="row g-0">
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-body" style="height: 180px"><code
                                                class="text-body">.bg-body</code></div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-body-highlight" style="height: 180px"><code
                                                class="text-body">.bg-body-highlight</code></div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-body-secondary" style="height: 180px"><code
                                                class="text-body">.bg-body-secondary</code></div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-body-tertiary" style="height: 180px"><code
                                                class="text-body">.bg-body-tertiary</code></div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-body-quaternary" style="height: 180px"><code
                                                class="text-body">.bg-body-quaternary</code></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card shadow-none border my-5" data-component-card="data-component-card"
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#subtle-colors-code" role="button" aria-controls="subtle-colors-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="subtle-colors-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;row g-0&quot;&gt;
  &lt;div class=&quot;col-6 col-sm-4 col-lg-3&quot;&gt;
...
&lt;/div&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy">
                                <div class="row g-0">
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-primary-subtle" style="height: 180px"><code
                                                class="text-primary-emphasis">.text-primary-emphasis</code><br><code
                                                class="text-primary-emphasis">.bg-primary-subtle</code></div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-secondary-subtle" style="height: 180px"><code
                                                class="text-secondary-emphasis">.text-secondary-emphasis</code><br><code
                                                class="text-secondary-emphasis">.bg-secondary-subtle</code></div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-success-subtle" style="height: 180px"><code
                                                class="text-success-emphasis">.text-success-emphasis</code><br><code
                                                class="text-success-emphasis">.bg-success-subtle</code></div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-info-subtle" style="height: 180px"><code
                                                class="text-info-emphasis">.text-info-emphasis</code><br><code
                                                class="text-info-emphasis">.bg-info-subtle</code></div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-warning-subtle" style="height: 180px"><code
                                                class="text-warning-emphasis">.text-warning-emphasis</code><br><code
                                                class="text-warning-emphasis">.bg-warning-subtle</code></div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 bg-danger-subtle" style="height: 180px"><code
                                                class="text-danger-emphasis">.text-danger-emphasis</code><br><code
                    ...
                    <div class="card shadow-none border my-5" data-component-card="data-component-card"
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#gradients-code" role="button" aria-controls="gradients-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="gradients-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;row g-0&quot;&gt;
  &lt;div class=&quot;col-6 col-sm-4 col-lg-3&quot;&gt;
...
&lt;/div&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy">
                                <div class="row g-0">
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 d-flex flex-center bg-primary bg-gradient false"
                                            style="height: 180px">
                                            <pre class="text-center"><code class="text-white">.bg-gradient</code><br><code class="text-white">.bg-primary  </code><br></pre>
                                        </div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 d-flex flex-center bg-secondary bg-gradient false"
                                            style="height: 180px">
                                            <pre class="text-center"><code class="text-white">.bg-gradient</code><br><code class="text-white">.bg-secondary  </code><br></pre>
                                        </div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 d-flex flex-center bg-success bg-gradient false"
                                            style="height: 180px">
                                            <pre class="text-center"><code class="text-white">.bg-gradient</code><br><code class="text-white">.bg-success  </code><br></pre>
                                        </div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 d-flex flex-center bg-info bg-gradient false"
                                            style="height: 180px">
                                            <pre class="text-center"><code class="text-white">.bg-gradient</code><br><code class="text-white">.bg-info  </code><br></pre>
                                        </div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 d-flex flex-center bg-warning bg-gradient false"
                                            style="height: 180px">
                                            <pre class="text-center"><code class="text-white">.bg-gradient</code><br><code class="text-white">.bg-warning  </code><br></pre>
                                        </div>
                                    </div>
                                    <div class="col-6 col-sm-4 col-lg-3">
                                        <div class="p-3 d-flex flex-center bg-danger bg-gradient false"
                                            style="height: 180px">
                                            <pre class="text-center"><code class="text-white">.bg-gradient</code><br><code class="text-white">.bg-danger  </code><br></pre>
                                        </div>
                                    </div>
                    ...
                    <div class="card shadow-none border my-5" data-component-card="data-component-card"
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#grays-code" role="button" aria-controls="grays-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="grays-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;row g-0&quot;&gt;
  &lt;div class=&quot;col-6 col-sm-4 col-lg-3&quot;&gt;
