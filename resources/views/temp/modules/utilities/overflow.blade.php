...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Use these shorthand utilities for quickly configuring how content overflows an
        element.</p><a class="btn btn-link p-0" href="https://getbootstrap.com/docs/5.3/utilities/overflow/"
        target="_blank">Overflow on Bootstrap<span class="ms-1" data-feather="chevron-right"></span></a>
    <div class="mt-4">
        <div class="row g-4">
            <div class="col-12 col-xl-10 order-1 order-xl-0">
                <div class="mb-9">
                    <div class="card shadow-none border my-5 overflow-docs overflow-hidden"
                        data-component-card="data-component-card" style="min-height: 250px;">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    <h4 class="text-body mb-0" data-anchor="data-anchor">Example</h4>
                                    <p class="mb-0 mt-2 text-body-secondary">Adjust the overflow property on the fly with
                                        four default values and classes. These classes are not responsive by default.</p>
                                </div>
...
&lt;/div&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy">
                                <div class="d-flex">
                                    <div class="overflow-auto">This is an example of using <code>.overflow-auto </code>on an
                                        element with set width and height dimensions. By design, this content will
                                        vertically scroll.</div>
                                    <div class="overflow-hidden">This is an example of using <code>.overflow-auto </code>on
                                        an element with set width and height dimensions. By design, this content will
                                        vertically scroll.</div>
                                    <div class="overflow-visible">This is an example of using <code>.overflow-visible
                                        </code>on an element with set width and height dimensions. By design, this content
                                        will vertically scroll.</div>
                                    <div class="overflow-scroll">This is an example of using <code>.overflow-scroll
                                        </code>on an element with set width and height dimensions. By design, this content
                                        will vertically scroll.</div>
                                </div>
                            </div>
