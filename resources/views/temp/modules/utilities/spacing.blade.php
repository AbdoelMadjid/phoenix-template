...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Bootstrap includes a wide range of shorthand responsive margin, padding, and gap
        utility classes to modify an element’s appearance.</p><a class="btn btn-link p-0"
        href="https://getbootstrap.com/docs/5.3/utilities/spacing/" target="_blank">Spacing on Bootstrap<span class="ms-1"
            ...
            <div class="col-12 col-xl-10 order-1 order-xl-0">
                <div class="mb-9">
                    <div class="card border my-5">
                        ...
                        <div class="card-body">
                            <p>Assign responsive-friendly margin or padding values to an element or a subset of its sides
                                ...
                                .25rem to 3rem.</p>
                            <p class="mb-0">Using the CSS Grid layout module? Consider using the <a
                                    href="https://getbootstrap.com/docs/5.1/utilities/spacing/#gap">gap utility</a></p>
                        </div>
                    </div>
                    <div class="card border my-5">
                        <div class="card-header border-bottom">
                        ...
                        <div class="card-body">
                            <p> Spacing utilities that apply to all breakpoints, from <code>xs </code>to <code>xxl</code>,
                                ...
                                breakpoints, however, do include a breakpoint abbreviation.</p>
                            <p>The classes are named using the format <code>{property}{sides}-{size}</code> for
                                ...
                                <code>sm</code>,<code>md</code>,<code>lg</code>,<code>xl</code> and <code>xxl</code>.</p>
                            ...
                            <ul>
                                ...
                                <li><code>s</code> - for classes that set <code>margin-left</code> or
                                    <code>padding-left</code></li>
                                <li><code>e</code> - for classes that set <code>margin-right</code> or
                            ...
                            <p class="mb-0">Where<em>size</em> is one of:
                    ...
                    <div class="card border my-5">
                        ...
                        <div class="card-body p-0">
                            <pre><code class="language-css">.mt-0 {
...
padding: $spacer !important;
                    ...
                    <div class="card shadow-none border my-5" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">Additionally, Bootstrap also includes an
                                        <code>.mx-auto</code> class for horizontally centering fixed-width block level
                                        content—that is, content that has <code>display: block</code> and <code>a
                                            width</code> set—by setting the horizontal margins to <code>auto</code>.</p>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                            ...
                                            href="#horizontal-centering-code" role="button"
                                            aria-controls="horizontal-centering-code" aria-expanded="false"> <span
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="horizontal-centering-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;mx-auto bg-body-highlight&quot; style=&quot;width: 200px;&quot;&gt;Centered element&lt;/div&gt;</code></pre>
                            </div>
                    ...
                    <div class="card border my-5">
                        <div class="card-header border-bottom">
                            ...
                            <p class="text-body-tertiary mb-0">In CSS, <code>margin </code>properties can utilize negative
                                values (<code>padding </code>cannot). These negative margins are <strong>disabled
                                </strong>by default, but can be enabled in Sass by setting <code>$enable-negative-margins:
                                    true</code>.
                        ...
                        <div class="card-body p-0">
                            <pre><code class="language-css">.mt-n1 {
margin-top: -0.25rem !important;
                    ...
                    <div class="card shadow-none border my-5" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">When using <code>display: grid</code>, you can
                                        make use of <code>gap</code> utilities on the parent grid container. This can save
                                        on having to add margin utilities to individual grid items (children of a
                                        <code>display: grid</code> container). Gap utilities are responsive by default, and
                                        are generated via our utilities API, based on the <code>$spacers</code> Sass map.
                                    </p>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#gap-code" role="button" aria-controls="gap-code" aria-expanded="false">
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="gap-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-grid gap-3&quot;&gt;
                    ...
                    <ul class="nav nav-vertical flex-column doc-nav" data-doc-nav="data-doc-nav">
                        <li class="nav-item"> <a class="nav-link" href="#margin-and-padding">Margin and padding</a>
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="#horizontal-centering">Horizontal
                                        centering</a></li>
                            </ul>
                        </li>
