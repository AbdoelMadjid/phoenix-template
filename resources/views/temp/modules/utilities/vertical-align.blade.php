...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Easily change the vertical alignment of inline, inline-block, inline-table, and
        table cell elements.</p><a class="btn btn-link p-0" href="https://getbootstrap.com/docs/5.3/utilities/vertical-align/"
        target="_blank">Vertical align on Bootstrap<span class="ms-1" data-feather="chevron-right"></span></a>
    <div class="mt-4">
        <div class="row g-4">
                    ...
                    <div class="card shadow-none border mb-4" data-component-card="data-component-card">
                            ...
                            <div class="row g-3 justify-content-between align-items-center">
                                <div class="col-12 col-md">
                                    ...
                                    <div class="mt-2 text-body-secondary">
                                        <p class="mb-0 pt-1 mt-2">Change the alignment of elements with the
                                            vertical-alignment utilities. Please note that vertical-align only affects
                                            ...
                                            <br>Multiple links and tap targets are not recommended with stretched links.
                                            However, some <code>position </code>and <code>z-index </code>styles can help
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="example-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;span class=&quot;align-baseline&quot;&gt;baseline&lt;/span&gt;
...
&lt;span class=&quot;align-text-bottom&quot;&gt;text-bottom&lt;/span&gt;</code></pre>
                    ...
                    <div class="card shadow-none border mb-4" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-center">
                                <div class="col-12 col-md">
                                    <h4 class="text-body mb-0" data-anchor="data-anchor">Vertical Alignment With Table Cells
                                    </h4>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#vertical-alignment-with-table-cells-code" role="button"
                                            aria-controls="vertical-alignment-with-table-cells-code" aria-expanded="false">
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="vertical-alignment-with-table-cells-code">
            ...
            <div class="col-12 col-xl-2">
                <div class="position-sticky mt-xl-4" style="top: 80px;">
                    ...
                    <ul class="nav nav-vertical flex-column doc-nav" data-doc-nav="data-doc-nav">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="#vertical-alignment-with-table-cells">Vertical
                                Alignment With Table Cells example</a></li>
                    </ul>
                </div>
            </div>
        </div>
