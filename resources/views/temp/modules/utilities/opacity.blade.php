...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Control the opacity of elements.</p><a class="btn btn-link p-0"
        href="https://getbootstrap.com/docs/5.3/utilities/opacity/" target="_blank">Opacity on Bootstrap<span class="ms-1"
                    ...
                    <div class="card shadow-none border my-5 opacity-docs" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">The opacity property sets the opacity level for
                                        an element. The opacity level describes the transparency level, where 1 is not
                                        transparent at all, .5 is 50% visible, and 0 is completely transparent. <br>Set the
                                        opacity of an element using .opacity-{value} utilities.</p>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="example-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;opacity-100 text-white&quot;&gt;100%&lt;/div&gt;
