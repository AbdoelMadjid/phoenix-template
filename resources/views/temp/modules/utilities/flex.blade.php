  ...
  <body>
    ...
    <main class="main" id="top">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-forms" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-forms">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-forms">
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-advance" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-advance">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent" data-bs-parent="#forms" id="nv-advance">
                            <li class="nav-item"><a class="nav-link" href="{{ url('forms/advance/advance-select') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Advance select</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('forms/advance/date-picker') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Date picker</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('forms/advance/editor') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Editor</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('forms/advance/file-uploader') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">File uploader</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('forms/advance/range') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Range</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('forms/advance/rating') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Rating</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('forms/advance/emoji-button') }}">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('forms/validation') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Validation</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('forms/wizard') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-icons" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-icons">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-icons">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('icons/feather') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Feather</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('icons/font-awesome') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Font awesome</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('icons/unicons') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-tables" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-tables">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-tables">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('tables/basic-tables') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Basic tables</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('tables/advance-tables') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Advance tables</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('tables/bulk-select') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-components" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-components">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-components">
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-carousel" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-carousel">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent" data-bs-parent="#components" id="nv-carousel">
                            <li class="nav-item"><a class="nav-link" href="{{ url('components/carousel/bootstrap') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Bootstrap</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('components/carousel/swiper') }}">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('components/collapse') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Collapse</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('components/dropdown') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Dropdown</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('components/dhtmlx-gantt') }}">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('components/list-group') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">List group</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('components/modal') }}">
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-navs-_and_-Tabs" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-navs-_and_-Tabs">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent" data-bs-parent="#components" id="nv-navs-_and_-Tabs">
                            <li class="nav-item"><a class="nav-link" href="{{ url('components/navs-and-tabs/navs') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Navs</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('components/navs-and-tabs/navbar') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Navbar</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('components/navs-and-tabs/tabs') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-utilities" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-utilities">
                    <div class="d-flex align-items-center">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-utilities">
                      <li class="collapsed-nav-item-title d-none">Utilities</li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('background') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Background</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('borders') }}">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('vertical-align') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Vertical align</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('visibility') }}">
                  ...
                  <div class="px-3 pt-4 pb-3 img-dropdown">
                    <div class="row gx-4 gy-5">
                      <div class="col-12 col-sm-6 col-md-4">
                        ...
                        </div><a class="dropdown-link" href="{{ url('forms/basic/form-control') }}">Form control</a><a class="dropdown-link" href="{{ url('forms/basic/input-group') }}">Input group</a><a class="dropdown-link" href="{{ url('forms/basic/select') }}">Select</a><a class="dropdown-link" href="{{ url('forms/basic/checks') }}">Checks</a><a class="dropdown-link" href="{{ url('forms/basic/range') }}">Range</a><a class="dropdown-link" href="{{ url('forms/basic/floating-labels') }}">Floating labels</a><a class="dropdown-link" href="{{ url('forms/basic/layout') }}">Layout</a><a class="dropdown-link" href="{{ url('forms/advance/advance-select') }}">Advance select</a><a class="dropdown-link" href="{{ url('forms/advance/date-picker') }}">Date picker</a><a class="dropdown-link" href="{{ url('forms/advance/editor') }}">Editor</a><a class="dropdown-link" href="{{ url('forms/advance/file-uploader') }}">File uploader</a><a class="dropdown-link" href="{{ url('forms/advance/range') }}">Range</a><a class="dropdown-link" href="{{ url('forms/advance/rating') }}">Rating</a><a class="dropdown-link" href="{{ url('forms/advance/emoji-button') }}">Emoji button</a><a class="dropdown-link" href="{{ url('forms/validation') }}">Validation</a><a class="dropdown-link" href="{{ url('forms/wizard') }}">Wizard</a>
                        ...
                        </div><a class="dropdown-link" href="{{ url('icons/feather') }}">Feather</a><a class="dropdown-link" href="{{ url('icons/font-awesome') }}">Font awesome</a><a class="dropdown-link" href="{{ url('icons/unicons') }}">Unicons</a>
                        ...
                        </div><a class="dropdown-link" href="{{ url('echarts/line-charts') }}">Line charts</a><a class="dropdown-link" href="{{ url('echarts/bar-charts') }}">Bar charts</a><a class="dropdown-link" href="{{ url('echarts/candlestick-charts') }}">Candlestick charts</a><a class="dropdown-link" href="{{ url('echarts/geo-map') }}">Geo map</a><a class="dropdown-link" href="{{ url('echarts/scatter-charts') }}">Scatter charts</a><a class="dropdown-link" href="{{ url('echarts/pie-charts') }}">Pie charts</a><a class="dropdown-link" href="{{ url('echarts/gauge-chart') }}">Gauge chart</a><a class="dropdown-link" href="{{ url('echarts/radar-charts') }}">Radar charts</a><a class="dropdown-link" href="{{ url('echarts/heatmap-charts') }}">Heatmap charts</a><a class="dropdown-link" href="{{ url('echarts/how-to-use') }}">How to use</a>
                      </div>
                      <div class="col-12 col-sm-6 col-md-4">
                        ...
                        </div><a class="dropdown-link" href="{{ url('components/accordion') }}">Accordion</a><a class="dropdown-link" href="{{ url('components/avatar') }}">Avatar</a><a class="dropdown-link" href="{{ url('components/alerts') }}">Alerts</a><a class="dropdown-link" href="{{ url('components/badge') }}">Badge</a><a class="dropdown-link" href="{{ url('components/breadcrumb') }}">Breadcrumb</a><a class="dropdown-link" href="{{ url('components/button') }}">Buttons</a><a class="dropdown-link" href="{{ url('components/calendar') }}">Calendar</a><a class="dropdown-link" href="{{ url('components/card') }}">Card</a><a class="dropdown-link" href="{{ url('components/carousel/bootstrap') }}">Bootstrap</a><a class="dropdown-link" href="{{ url('components/carousel/swiper') }}">Swiper</a><a class="dropdown-link" href="{{ url('components/collapse') }}">Collapse</a><a class="dropdown-link" href="{{ url('components/dropdown') }}">Dropdown</a><a class="dropdown-link" href="{{ url('components/dhtmlx-gantt') }}">Dhtmlx gantt</a><a class="dropdown-link" href="{{ url('components/list-group') }}">List group</a><a class="dropdown-link" href="{{ url('components/modal') }}">Modals</a><a class="dropdown-link" href="{{ url('components/navs-and-tabs/navs') }}">Navs</a><a class="dropdown-link" href="{{ url('components/navs-and-tabs/navbar') }}">Navbar</a><a class="dropdown-link" href="{{ url('components/navs-and-tabs/tabs') }}">Tabs</a><a class="dropdown-link" href="{{ url('components/offcanvas') }}">Offcanvas</a><a class="dropdown-link" href="{{ url('components/progress-bar') }}">Progress bar</a><a class="dropdown-link" href="{{ url('components/placeholder') }}">Placeholder</a><a class="dropdown-link" href="{{ url('components/pagination') }}">Pagination</a><a class="dropdown-link" href="{{ url('components/popovers') }}">Popovers</a><a class="dropdown-link" href="{{ url('components/scrollspy') }}">Scrollspy</a><a class="dropdown-link" href="{{ url('components/sortable') }}">Sortable</a><a class="dropdown-link" href="{{ url('components/spinners') }}">Spinners</a><a class="dropdown-link" href="{{ url('components/toast') }}">Toast</a><a class="dropdown-link" href="{{ url('components/tooltips') }}">Tooltips</a><a class="dropdown-link" href="{{ url('components/typed-text') }}">Typed text</a><a class="dropdown-link" href="{{ url('components/chat-widget') }}">Chat widget</a>
                      </div>
                      <div class="col-12 col-sm-6 col-md-4">
                        ...
                        </div><a class="dropdown-link" href="{{ url('tables/basic-tables') }}">Basic tables</a><a class="dropdown-link" href="{{ url('tables/advance-tables') }}">Advance tables</a><a class="dropdown-link" href="{{ url('tables/bulk-select') }}">Bulk Select</a>
                        ...
                        </div><a class="dropdown-link" href="{{ url('background') }}">Background</a><a class="dropdown-link" href="{{ url('borders') }}">Borders</a><a class="dropdown-link" href="{{ url('colors') }}">Colors</a><a class="dropdown-link" href="{{ url('display') }}">Display</a><a class="dropdown-link active" href="{{ url('flex') }}">Flex</a><a class="dropdown-link" href="{{ url('stacks') }}">Stacks</a><a class="dropdown-link" href="{{ url('float') }}">Float</a><a class="dropdown-link" href="{{ url('grid') }}">Grid</a><a class="dropdown-link" href="{{ url('interactions') }}">Interactions</a><a class="dropdown-link" href="{{ url('opacity') }}">Opacity</a><a class="dropdown-link" href="{{ url('overflow') }}">Overflow</a><a class="dropdown-link" href="{{ url('position') }}">Position</a><a class="dropdown-link" href="{{ url('shadows') }}">Shadows</a><a class="dropdown-link" href="{{ url('sizing') }}">Sizing</a><a class="dropdown-link" href="{{ url('spacing') }}">Spacing</a><a class="dropdown-link" href="{{ url('typography') }}">Typography</a><a class="dropdown-link" href="{{ url('vertical-align') }}">Vertical align</a><a class="dropdown-link" href="{{ url('visibility') }}">Visibility</a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="content">
        ...
        <p class="text-body-tertiary lead mb-2">Quickly manage the layout, alignment, and sizing of grid columns, navigation, components, and more with a full suite of responsive flexbox utilities. For more complex implementations, custom CSS may be necessary.</p><a class="btn btn-link p-0" href="https://getbootstrap.com/docs/5.3/utilities/flex/" target="_blank">Flex on Bootstrap<span class="ms-1" data-feather="chevron-right"></span></a>
        <div class="mt-4">
          <div class="row g-4">
                  ...
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      <div class="col-12 col-md">
                        ...
                        <p class="mb-0 mt-2 text-body-secondary">Apply <code> display </code> utilities to create a flexbox container and transform direct children elements into flex items. Flex containers and items are able to be modified further with additional flex properties.</p>
                      </div>
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#flex-behaviors-code" role="button" aria-controls="flex-behaviors-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="flex-behaviors-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex p-2 bg-body-secondary mb-2&quot;&gt;Flexbox container!&lt;/div&gt;
                  ...
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      <div class="col-12 col-md">
                        ...
                        <p class="mb-0 mt-2 text-body-secondary">Use <code> .flex-row </code> to set a horizontal direction (the browser default), or .flex-row-reverse to start the horizontal direction from the opposite side.</p>
                      </div>
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#direction-row-code" role="button" aria-controls="direction-row-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="direction-row-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex bg-body-secondary mb-3 flex-row&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#direction-column-code" role="button" aria-controls="direction-column-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="direction-column-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex bg-body-secondary mb-3 flex-column&quot;&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item 1&lt;/div&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item 2&lt;/div&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item 3&lt;/div&gt;
&lt;/div&gt;
                  ...
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      <div class="col-12 col-md">
                        ...
                        <p class="mb-0 mt-2 text-body-secondary">justify-content<code>justify-content </code>utilities on flexbox containers to change the alignment of flex items on the main axis (the x-axis to start, y-axis if <code>flex-direction: column </code>). Choose from start (browser default), <code>end </code>,<code>center </code>,<code>between </code>, or<code>around.</code></p>
                      </div>
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#justify-content-code" role="button" aria-controls="justify-content-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="justify-content-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex justify-content-start bg-body-secondary mb-2&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#align-items-code" role="button" aria-controls="align-items-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="align-items-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex align-items-start bg-body-secondary mb-2&quot; style=&quot;height: 5rem;&quot;&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
&lt;/div&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#align-self-code" role="button" aria-controls="align-self-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="align-self-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex bg-body-secondary mb-2&quot; style=&quot;height: 5rem;&quot;&gt;
                  ...
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      <div class="col-12 col-md">
                        ...
                        <p class="mb-0 mt-2 text-body-secondary">Use the <code>.flex-fill </code>class on a series of sibling elements to force them into widths equal to their content (or equal widths if their content does not surpass their border-boxes) while taking up all available horizontal space.</p>
                      </div>
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#fill-code" role="button" aria-controls="fill-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="fill-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex bg-body-secondary&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#flex-grow-code" role="button" aria-controls="flex-grow-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="flex-grow-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex bg-body-secondary&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#flex-shrink-code" role="button" aria-controls="flex-shrink-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="flex-shrink-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex bg-body-secondary&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#auto-margins-code" role="button" aria-controls="auto-margins-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="auto-margins-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex bg-body-secondary mb-2&quot;&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
&lt;/div&gt;
                  ...
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      <div class="col-12 col-md">
                        ...
                        <p class="mb-0 mt-2 text-body-secondary">Vertically move one flex item to the top or bottom of a container by mixing
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#with-align-items-code" role="button" aria-controls="with-align-items-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="with-align-items-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex flex-column bg-body-secondary mb-3 align-items-start&quot; style=&quot;height: 200px;&quot;&gt;
                  ...
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      <div class="col-12 col-md">
                        ...
                        <p class="mb-0 mt-2 text-body-secondary">Change how flex items wrap in a flex container. Choose from no wrapping at all (the browser default) with <code>.flex-nowrap </code>, wrapping with<code>.flex-wrap </code>, or reverse wrapping with<code>.flex-wrap-reverse </code>.</p>
                      </div>
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#wrap-code" role="button" aria-controls="wrap-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="wrap-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex flex-nowrap mb-3 bg-body-secondary border py-3&quot; style=&quot;width: 8rem&quot;&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
                  ...
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      <div class="col-12 col-md">
                        ...
                        <p class="mb-0 mt-2 text-body-secondary">Change the <em>visual</em>order of specific flex items with a handful of <code>order </code>utilities. We only provide options for making an item first or last, as well as a reset to use the DOM order. As <code>order </code>takes any integer value (e.g., <code>5 </code>), add custom CSS for any additional values needed.</p>
                      </div>
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#order-code" role="button" aria-controls="order-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="order-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex flex-nowrap bg-body-secondary&quot;&gt;
                  ...
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-end">
                      <div class="col-12 col-md">
                        ...
                        <p class="mb-0 mt-2 text-body-secondary">Use <code>align-content </code>utilities on flexbox containers to align flex items<em>together</em>on the cross axis. Choose from <code>start (browser default) </code>,<code>end </code>,<code>center </code>,<code>between </code>,<code>around </code>, or <code>stretch. To demonstrate these utilities, we’ve enforced </code><code>flex-wrap: wrap </code>and increased the number of flex items.</p>
                      </div>
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#aligh-content-code" role="button" aria-controls="aligh-content-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="aligh-content-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex flex-wrap bg-body-secondary mb-3 align-content-start&quot; style=&quot;height: 300px;&quot;&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
  &lt;div class=&quot;p-2 bg-body-secondary border&quot;&gt;Flex item&lt;/div&gt;
