...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Easily make an element as wide or as tall with our width and height utilities.
    </p><a class="btn btn-link p-0" href="https://getbootstrap.com/docs/5.3/utilities/sizing/" target="_blank">Sizing on
                ...
                <div class="mb-9">
                    <div class="card shadow-none border my-5" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                            ...
                                            href="#width-relative-to-parent-code" role="button"
                                            aria-controls="width-relative-to-parent-code" aria-expanded="false"> <span
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="width-relative-to-parent-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;bg-body-highlight p-2 border-dashed mb-3 w-100&quot;&gt;&lt;code&gt;.w-100&lt;/code&gt;&lt;/div&gt;
...
&lt;div class=&quot;bg-body-highlight p-2 border-dashed mb-3 w-auto&quot;&gt;&lt;code&gt;.w-auto&lt;/code&gt;&lt;/div&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-5" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#height-relative-to-parent-code" role="button"
                                            aria-controls="height-relative-to-parent-code" aria-expanded="false"> <span
                                                class="me-2" data-feather="code"></span>View code</a><a
                                            class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                                data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="height-relative-to-parent-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;vh-50 py-3&quot;&gt;
  &lt;div class=&quot;row h-100&quot;&gt;
    &lt;div class=&quot;col&quot;&gt;
...
&lt;/div&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy">
                                <div class="vh-50 py-3">
                                    <div class="row h-100">
                                        <div class="col">
                                            <div class="bg-body-highlight p-2 border-dashed mb-3 h-100"><code>.h-100</code>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="bg-body-highlight p-2 border-dashed mb-3 h-75"><code>.h-75</code>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="bg-body-highlight p-2 border-dashed mb-3 h-50"><code>.h-50</code>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="bg-body-highlight p-2 border-dashed mb-3 h-25"><code>.h-25</code>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="bg-body-highlight p-2 border-dashed mb-3 h-auto">
                                                <code>.h-auto</code></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card shadow-none border my-5" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-center">
                                <div class="col-12 col-md">
                                    <h4 class="text-body mb-0" data-anchor="data-anchor">Special classes (relative to
                                        viewport)</h4>
                                </div>
                            </div>
                        </div>
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="special-classes-relative-to-viewport-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;pre class=&quot;rounded-3&quot;&gt;&lt;code class=&quot;lang-css&quot;&gt;.mw-100 { max-width: 100%; }
            ...
            <div class="col-12 col-xl-2">
                <div class="position-sticky mt-xl-4" style="top: 80px;">
                    ...
                    <ul class="nav nav-vertical flex-column doc-nav" data-doc-nav="data-doc-nav">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="#special-classes-relative-to-viewport">Special
                                classes</a></li>
                    </ul>
                </div>
            </div>
