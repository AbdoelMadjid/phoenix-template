...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Use loading placeholders for your components or pages to indicate something may
        still be loading.</p><a class="btn btn-link p-0" href="https://getbootstrap.com/docs/5.3/components/placeholders/"
                    ...
                    <div class="card shadow-none border my-6" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">In the example below, we take a typical card
                                        component and recreate it with placeholders applied to create a “loading card”. Size
                                        and proportions are the same between the two.</p>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="examples-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex justify-content-center&quot;&gt;
...
&lt;/div&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy">
                                <div class="d-flex justify-content-center">
                                    <div class="card overflow-hidden" style="max-width: 20rem;">
                                        <div class="card-img-top jhj">
                                            <img class="img-fluid" src="{{ asset('assets/img/generic/1.jpg') }}"
                                                alt="Card image cap">
                                        </div>
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                    ...
                                    <div class="card overflow-hidden ms-3" style="width: 20rem;" aria-hidden="true">
                                        <div class="card-img-top" style="width: 320px;height: 180px"><span
                                                class="placeholder w-100 h-100"></span></div>
                                        <div class="card-body">
                                            <h5 class="card-title placeholder-glow"><span class="placeholder col-6"></span>
                                            </h5>
                                            <p class="card-text placeholder-glow">
                                                <span class="placeholder col-7"></span>
                                                <span class="placeholder col-4"></span>
                                            ...
                                            <a class="btn btn-primary disabled placeholder col-6" href="#"
                                                tabindex="-1"></a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card shadow-none border my-6" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">You can change the <code>width</code> through
                                        grid column classes, width utilities, or inline styles.</p>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#width-code" role="button" aria-controls="width-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="width-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;span class=&quot;placeholder bg-quaternary col-6&quot;&gt;&lt;/span&gt;
...
&lt;span class=&quot;placeholder bg-quaternary&quot; style=&quot;width: 25%;&quot;&gt;&lt;/span&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-6" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">By default, the <code>placeholder</code> uses
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#color-code" role="button" aria-controls="color-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="color-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;span class=&quot;placeholder col-12 bg-primary&quot;&gt;&lt;/span&gt;
                    ...
                    <div class="card shadow-none border my-6" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">The size of <code>.placeholder</code>s are
                                        based on the typographic style of the parent element. Customize them with sizing
                                        modifiers: <code>.placeholder-lg</code>, <code>.placeholder-sm</code>, or
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="sizing-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;span class=&quot;placeholder bg-quaternary col-12 placeholder-lg&quot;&gt;&lt;/span&gt;
...
&lt;span class=&quot;placeholder bg-quaternary col-12 placeholder-xs&quot;&gt;&lt;/span&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy"><span
                                    class="placeholder bg-quaternary col-12 placeholder-lg"></span>
                                <span class="placeholder bg-quaternary col-12"></span>
                                <span class="placeholder bg-quaternary col-12 placeholder-sm"></span>
                    ...
                    <div class="card shadow-none border my-6" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">Animate placeholders with
                                        <code>.placeholder-glow</code> or <code>.placeholder-wave</code> to better convey
                                        the perception of something being <em>actively</em> loaded.</p>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#animation-code" role="button" aria-controls="animation-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="animation-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;p class=&quot;placeholder-glow&quot;&gt;&lt;span class=&quot;placeholder col-12&quot;&gt;&lt;/span&gt;&lt;/p&gt;
