...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Use Bootstrap’s custom button styles for actions in forms, dialogs, and more with
        support for multiple sizes, states, and more.</p><a class="btn btn-link p-0"
        href="https://getbootstrap.com/docs/5.3/components/buttons/" target="_blank">Buttons on Bootstrap<span class="ms-1"
                ...
                <div class="mb-9">
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                            ...
                                            href="#phoenix-buttons-code" role="button" aria-controls="phoenix-buttons-code"
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="phoenix-buttons-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-phoenix-primary me-1 mb-1&quot; type=&quot;button&quot;&gt;Primary&lt;/button&gt;
...
&lt;button class=&quot;btn btn-phoenix-info me-1 mb-1&quot; type=&quot;button&quot;&gt;Info&lt;/button&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy"><button class="btn btn-phoenix-primary me-1 mb-1"
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#solid-buttons-code" role="button" aria-controls="solid-buttons-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="solid-buttons-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-primary me-1 mb-1&quot; type=&quot;button&quot;&gt;Primary&lt;/button&gt;
...
&lt;button class=&quot;btn btn-link me-1 mb-1&quot; type=&quot;button&quot;&gt;Link&lt;/button&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy"><button class="btn btn-primary me-1 mb-1"
                                    type="button">Primary</button>
                                <button class="btn btn-secondary me-1 mb-1" type="button">Secondary</button>
                                <button class="btn btn-success me-1 mb-1" type="button">Success</button>
                                <button class="btn btn-danger me-1 mb-1" type="button">Danger</button>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#subtle-buttons-code" role="button"
                                            aria-controls="subtle-buttons-code" aria-expanded="false"> <span
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="subtle-buttons-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-subtle-primary me-1 mb-1&quot; type=&quot;button&quot;&gt;Primary&lt;/button&gt;
...
&lt;button class=&quot;btn btn-subtle-info me-1 mb-1&quot; type=&quot;button&quot;&gt;Info&lt;/button&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy"><button class="btn btn-subtle-primary me-1 mb-1"
                                    type="button">Primary</button>
                                <button class="btn btn-subtle-secondary me-1 mb-1" type="button">Secondary</button>
                                <button class="btn btn-subtle-success me-1 mb-1" type="button">Success</button>
                                <button class="btn btn-subtle-danger me-1 mb-1" type="button">Danger</button>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">In need of a button, but not the hefty
                                        background colors they bring? Replace the default modifier classes with the
                                        <code>.btn-outline-*</code> ones to remove all background images and colors on any
                                        button.</p>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#outline-buttons-code" role="button"
                                            aria-controls="outline-buttons-code" aria-expanded="false"> <span
                                                class="me-2" data-feather="code"></span>View code</a><a
                                            class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                                data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="outline-buttons-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-outline-primary me-1 mb-1&quot; type=&quot;button&quot;&gt;Primary&lt;/button&gt;
...
&lt;button class=&quot;btn btn-outline-info me-1 mb-1&quot; type=&quot;button&quot;&gt;Info&lt;/button&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy"><button class="btn btn-outline-primary me-1 mb-1"
                                    type="button">Primary</button>
                                <button class="btn btn-outline-secondary me-1 mb-1" type="button">Secondary</button>
                                <button class="btn btn-outline-success me-1 mb-1" type="button">Success</button>
                                <button class="btn btn-outline-danger me-1 mb-1" type="button">Danger</button>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">Provide an option to dismiss or close a
                                        component with <code>.btn-close</code>. Default styling is limited, but highly
                                        customizable. Modify the Sass variables to replace the default
                                        <code>background-image</code>. <strong>Be sure to include text for screen
                                            readers</strong>, as we’ve done with <code>aria-label</code>.</p>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#close-buttons-code" role="button" aria-controls="close-buttons-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="close-buttons-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn-close&quot; type=&quot;button&quot; aria-label=&quot;Close&quot;&gt;&lt;/button&gt;
&lt;button class=&quot;btn-close&quot; type=&quot;button&quot; disabled=&quot;&quot; aria-label=&quot;Close&quot;&gt;&lt;/button&gt;</code></pre>
                            </div>
                            <div class="p-4 code-to-copy"><button class="btn-close" type="button"
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">Add <code>data-bs-theme="dark"</code> to the
                                        <code>.btn-close</code> class, or to its parent element to invert the close button.
                                        This uses <code>filter</code> property to invert the <code>background-image</code>
                                        without overriding its value..</p>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#close-buttons-white-variant-code" role="button"
                                            aria-controls="close-buttons-white-variant-code" aria-expanded="false"> <span
                                                class="me-2" data-feather="code"></span>View code</a><a
                                            class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                                data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="close-buttons-white-variant-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;bg-body-highlight rounded-1 p-3&quot; data-bs-theme=&quot;dark&quot;&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    ...
                                    <p class="mb-0 mt-2 text-body-secondary">Fancy larger or smaller buttons? Add
                                        <code>.btn-lg</code> or <code>.btn-sm</code> for additional sizes.</p>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#button-sizes-code" role="button" aria-controls="button-sizes-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="button-sizes-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-primary btn-sm me-1 mb-1&quot; type=&quot;button&quot;&gt;Request Payout&lt;/button&gt;
...
&lt;button class=&quot;btn btn-primary btn-lg me-1 mb-1&quot; type=&quot;button&quot;&gt;Request Payout&lt;/button&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy"><button class="btn btn-primary btn-sm me-1 mb-1"
                                    type="button">Request Payout</button>
                                <button class="btn btn-primary me-1 mb-1" type="button">Request Payout</button>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#button-capsule-code" role="button"
                                            aria-controls="button-capsule-code" aria-expanded="false"> <span
                                                class="me-2" data-feather="code"></span>View code</a><a
                                            class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                                data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="button-capsule-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-phoenix-secondary rounded-pill me-1 mb-1&quot; type=&quot;button&quot;&gt;Example
...
&lt;button class=&quot;btn btn-lg btn-phoenix-secondary rounded-pill me-1 mb-1&quot; type=&quot;button&quot;&gt;Capsule Large&lt;/button&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy"><button class="btn btn-phoenix-secondary rounded-pill me-1 mb-1"
                                    type="button">Example
                                </button>
                                <button class="btn btn-phoenix-secondary rounded-pill me-1 mb-1" type="button">
                                    <span class="fas fa-align-left me-2" data-fa-transform="shrink-3"></span>Icon
                                    Left</button>
                                <button class="btn btn-phoenix-secondary rounded-pill me-1 mb-1" type="button">
                                    Icon Right <span class="fas fa-align-right ms-2" data-fa-transform="shrink-3"></span>
                                </button>
                                ...
                                <hr>
                                <button class="btn btn-sm btn-phoenix-secondary rounded-pill me-1 mb-1"
                                    type="button">Capsule Small</button>
                                <button class="btn btn-phoenix-secondary rounded-pill me-1 mb-1" type="button">Capsule
                                    Regular</button>
                                <button class="btn btn-lg btn-phoenix-secondary rounded-pill me-1 mb-1"
                                    type="button">Capsule Large</button>
                            </div>
                        </div>
                    </div>
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#button-group-code" role="button" aria-controls="button-group-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="button-group-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group&quot; role=&quot;group&quot; aria-label=&quot;Basic example&quot;&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#button-toolbar-code" role="button"
                                            aria-controls="button-toolbar-code" aria-expanded="false"> <span
                                                class="me-2" data-feather="code"></span>View code</a><a
                                            class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                                data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="button-toolbar-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-toolbar&quot; role=&quot;toolbar&quot; aria-label=&quot;Toolbar with button groups&quot;&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-center">
                                <div class="col-12 col-md">
                                    <h4 class="text-body mb-0" data-anchor="data-anchor">Button toolbar with input group
                                    </h4>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#button-toolbar-with-input-group-code" role="button"
                                            aria-controls="button-toolbar-with-input-group-code" aria-expanded="false">
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="button-toolbar-with-input-group-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-toolbar mb-3&quot; role=&quot;toolbar&quot; aria-label=&quot;Toolbar with button groups&quot;&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#button-group-sizing-code" role="button"
                                            aria-controls="button-group-sizing-code" aria-expanded="false"> <span
                                                class="me-2" data-feather="code"></span>View code</a><a
                                            class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                                data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="button-group-sizing-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group btn-group-lg me-2&quot; role=&quot;group&quot; aria-label=&quot;...&quot;&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Left&lt;/button&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Middle&lt;/button&gt;
  &lt;button class=&quot;btn btn-secondary&quot; type=&quot;button&quot;&gt;Right&lt;/button&gt;
&lt;/div&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                        <div class="card-header p-4 border-bottom bg-body">
                            <div class="row g-3 justify-content-between align-items-center">
                                <div class="col-12 col-md">
                                    <h4 class="text-body mb-0" data-anchor="data-anchor">Button group vertical variation
                                    </h4>
                                </div>
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#button-group-vertical-variation-code" role="button"
                                            aria-controls="button-group-vertical-variation-code" aria-expanded="false">
                                            <span class="me-2" data-feather="code"></span>View code</a><a
                                            class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                                data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="button-group-vertical-variation-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group-vertical&quot; role=&quot;group&quot; aria-label=&quot;Vertical button group&quot;&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#disabled-state-code" role="button"
                                            aria-controls="disabled-state-code" aria-expanded="false"> <span
                                                class="me-2" data-feather="code"></span>View code</a><a
                                            class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                                data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="disabled-state-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-lg btn-primary&quot; type=&quot;button&quot; disabled=&quot;disabled&quot;&gt;Primary button&lt;/button&gt;
&lt;button class=&quot;btn btn-secondary btn-lg ms-2&quot; type=&quot;button&quot; disabled=&quot;disabled&quot;&gt;Button&lt;/button&gt;</code></pre>
                            </div>
                            <div class="p-4 code-to-copy"><button class="btn btn-lg btn-primary" type="button"
                                    disabled="disabled">Primary button</button>
                                <button class="btn btn-secondary btn-lg ms-2" type="button"
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#block-buttons-code" role="button" aria-controls="block-buttons-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="block-buttons-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-grid gap-2&quot;&gt;
            ...
            <div class="col-12 col-xl-2">
                <div class="position-sticky mt-xl-4" style="top: 80px;">
                    ...
                    <ul class="nav nav-vertical flex-column doc-nav" data-doc-nav="data-doc-nav">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="#close-buttons-white-variant">Close buttons white
                                variant</a></li>
                        ...
                        <li class="nav-item"> <a class="nav-link" href="#button-toolbar-with-input-group">Button toolbar
                                with input group</a></li>
                        <li class="nav-item"> <a class="nav-link" href="#button-group-sizing">Button group sizing</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" href="#button-group-vertical-variation">Button group
                                vertical variation</a></li>
