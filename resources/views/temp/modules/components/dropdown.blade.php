  ...
  <body>
    ...
    <main class="main" id="top">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-components" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-components">
                    <div class="d-flex align-items-center">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-components">
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-carousel" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-carousel">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent" data-bs-parent="#components" id="nv-carousel">
                            <li class="nav-item"><a class="nav-link" href="{{ url('carousel/bootstrap') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Bootstrap</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('carousel/swiper') }}">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('collapse') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Collapse</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link active" href="{{ url('dropdown') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Dropdown</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('dhtmlx-gantt') }}">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('list-group') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">List group</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('modal') }}">
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-navs-_and_-Tabs" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-navs-_and_-Tabs">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent" data-bs-parent="#components" id="nv-navs-_and_-Tabs">
                            <li class="nav-item"><a class="nav-link" href="{{ url('navs-and-tabs/navs') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Navs</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('navs-and-tabs/navbar') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Navbar</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('navs-and-tabs/tabs') }}">
                  ...
                  <div class="px-3 pt-4 pb-3 img-dropdown">
                    <div class="row gx-4 gy-5">
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        ...
                        </div><a class="dropdown-link" href="{{ url('accordion') }}">Accordion</a><a class="dropdown-link" href="{{ url('avatar') }}">Avatar</a><a class="dropdown-link" href="{{ url('alerts') }}">Alerts</a><a class="dropdown-link" href="{{ url('badge') }}">Badge</a><a class="dropdown-link" href="{{ url('breadcrumb') }}">Breadcrumb</a><a class="dropdown-link" href="{{ url('button') }}">Buttons</a><a class="dropdown-link" href="{{ url('calendar') }}">Calendar</a><a class="dropdown-link" href="{{ url('card') }}">Card</a><a class="dropdown-link" href="{{ url('carousel/bootstrap') }}">Bootstrap</a><a class="dropdown-link" href="{{ url('carousel/swiper') }}">Swiper</a><a class="dropdown-link" href="{{ url('collapse') }}">Collapse</a><a class="dropdown-link active" href="{{ url('dropdown') }}">Dropdown</a><a class="dropdown-link" href="{{ url('dhtmlx-gantt') }}">Dhtmlx gantt</a><a class="dropdown-link" href="{{ url('list-group') }}">List group</a><a class="dropdown-link" href="{{ url('modal') }}">Modals</a><a class="dropdown-link" href="{{ url('navs-and-tabs/navs') }}">Navs</a><a class="dropdown-link" href="{{ url('navs-and-tabs/navbar') }}">Navbar</a><a class="dropdown-link" href="{{ url('navs-and-tabs/tabs') }}">Tabs</a><a class="dropdown-link" href="{{ url('offcanvas') }}">Offcanvas</a><a class="dropdown-link" href="{{ url('progress-bar') }}">Progress bar</a><a class="dropdown-link" href="{{ url('placeholder') }}">Placeholder</a><a class="dropdown-link" href="{{ url('pagination') }}">Pagination</a><a class="dropdown-link" href="{{ url('popovers') }}">Popovers</a><a class="dropdown-link" href="{{ url('scrollspy') }}">Scrollspy</a><a class="dropdown-link" href="{{ url('sortable') }}">Sortable</a><a class="dropdown-link" href="{{ url('spinners') }}">Spinners</a><a class="dropdown-link" href="{{ url('toast') }}">Toast</a><a class="dropdown-link" href="{{ url('tooltips') }}">Tooltips</a><a class="dropdown-link" href="{{ url('typed-text') }}">Typed text</a><a class="dropdown-link" href="{{ url('chat-widget') }}">Chat widget</a>
                      </div>
                      <div class="col-12 col-sm-6 col-md-4">
                        ...
                        </div><a class="dropdown-link" href="{{ url('utilities/background') }}">Background</a><a class="dropdown-link" href="{{ url('utilities/borders') }}">Borders</a><a class="dropdown-link" href="{{ url('utilities/colors') }}">Colors</a><a class="dropdown-link" href="{{ url('utilities/display') }}">Display</a><a class="dropdown-link" href="{{ url('utilities/flex') }}">Flex</a><a class="dropdown-link" href="{{ url('utilities/stacks') }}">Stacks</a><a class="dropdown-link" href="{{ url('utilities/float') }}">Float</a><a class="dropdown-link" href="{{ url('utilities/grid') }}">Grid</a><a class="dropdown-link" href="{{ url('utilities/interactions') }}">Interactions</a><a class="dropdown-link" href="{{ url('utilities/opacity') }}">Opacity</a><a class="dropdown-link" href="{{ url('utilities/overflow') }}">Overflow</a><a class="dropdown-link" href="{{ url('utilities/position') }}">Position</a><a class="dropdown-link" href="{{ url('utilities/shadows') }}">Shadows</a><a class="dropdown-link" href="{{ url('utilities/sizing') }}">Sizing</a><a class="dropdown-link" href="{{ url('utilities/spacing') }}">Spacing</a><a class="dropdown-link" href="{{ url('utilities/typography') }}">Typography</a><a class="dropdown-link" href="{{ url('utilities/vertical-align') }}">Vertical align</a><a class="dropdown-link" href="{{ url('utilities/visibility') }}">Visibility</a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="content">
        ...
        <p class="text-body-tertiary lead mb-2">Toggle contextual overlays for displaying lists of links and more with the Bootstrap dropdown plugin.</p><a class="btn btn-link p-0" href="https://getbootstrap.com/docs/5.3/components/dropdowns/" target="_blank">Dropdowns on Bootstrap<span class="ms-1" data-feather="chevron-right"></span></a>
        <div class="mt-4">
          <div class="row g-4">
            <div class="col-12 col-xl-10 order-1 order-xl-0">
              <div class="mb-9">
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  ...
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="example-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;dropdown d-inline-block&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#dropdown-link-code" role="button" aria-controls="dropdown-link-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="dropdown-link-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;dropdown&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#button-variant-code" role="button" aria-controls="button-variant-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="button-variant-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group me-1&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#button-split-code" role="button" aria-controls="button-split-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="button-split-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group mb-1 me-1&quot;&gt;
...
&lt;/div&gt;</code></pre>
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  ...
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="sizing-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group mb-1 mb-md-0 me-1&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#directions-code" role="button" aria-controls="directions-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="directions-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;!-- Default dropup button--&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#menu-items-code" role="button" aria-controls="menu-items-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="menu-items-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;dropdown&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#active-link-code" role="button" aria-controls="active-link-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="active-link-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-primary dropdown-toggle&quot; id=&quot;activeLinkExample&quot; type=&quot;button&quot; data-bs-toggle=&quot;dropdown&quot; aria-haspopup=&quot;true&quot; aria-expanded=&quot;false&quot;&gt;Dropdown&lt;/button&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="p-4 code-to-copy"><button class="btn btn-primary dropdown-toggle" id="activeLinkExample" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                      <div class="dropdown-menu" aria-labelledby="activeLinkExample">
                        <a class="dropdown-item" href="#">Regular link</a>
                        <a class="dropdown-item active" href="#">Active link</a>
                        <a class="dropdown-item" href="#">Another link</a>
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#disabled-link-code" role="button" aria-controls="disabled-link-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="disabled-link-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-primary dropdown-toggle&quot; id=&quot;disabledLinkExample&quot; type=&quot;button&quot; data-bs-toggle=&quot;dropdown&quot; aria-haspopup=&quot;true&quot; aria-expanded=&quot;false&quot;&gt;Dropdown&lt;/button&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="p-4 code-to-copy"><button class="btn btn-primary dropdown-toggle" id="disabledLinkExample" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                      <div class="dropdown-menu" aria-labelledby="disabledLinkExample">
                        <a class="dropdown-item" href="#">Regular link</a>
                        <a class="dropdown-item disabled" href="#">Disabled link</a>
                        <a class="dropdown-item" href="#">Another link</a>
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#alignment-code" role="button" aria-controls="alignment-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="alignment-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;btn-group&quot;&gt;
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                      ...
                      <div class="col col-md-auto">
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span class="fas fa-copy me-1"></span>Copy Code</button><a class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse" href="#headers-code" role="button" aria-controls="headers-code" aria-expanded="false"> <span class="me-2" data-feather="code"></span>View code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2" data-feather="eye"></span>Hide code</a></nav>
                      </div>
                    </div>
                  </div>
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="headers-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-primary dropdown-toggle&quot; id=&quot;headerExample&quot; type=&quot;button&quot; data-bs-toggle=&quot;dropdown&quot; aria-haspopup=&quot;true&quot; aria-expanded=&quot;false&quot;&gt;Dropdown&lt;/button&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="p-4 code-to-copy"><button class="btn btn-primary dropdown-toggle" id="headerExample" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                      <div class="dropdown-menu" aria-labelledby="headerExample">
                        <h6 class="dropdown-header">Dropdown Header</h6>
                        <a class="dropdown-item" href="#">Regular link</a>
                        <a class="dropdown-item" href="#">Another action link</a>
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                  ...
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="dividers-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;button class=&quot;btn btn-primary dropdown-toggle&quot; id=&quot;dividerExample&quot; type=&quot;button&quot; data-bs-toggle=&quot;dropdown&quot; aria-haspopup=&quot;true&quot; aria-expanded=&quot;false&quot;&gt;Dropdown&lt;/button&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="p-4 code-to-copy"><button class="btn btn-primary dropdown-toggle" id="dividerExample" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
                      <div class="dropdown-menu" aria-labelledby="dividerExample">
                        <a class="dropdown-item" href="#">Action</a>
                        <a class="dropdown-item" href="#">Another action</a>
                        <a class="dropdown-item" href="#">Something else here</a>
