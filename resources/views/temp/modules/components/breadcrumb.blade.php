...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Indicate the current page’s location within a navigational hierarchy that
        automatically adds separators via CSS.</p><a class="btn btn-link p-0"
        href="https://getbootstrap.com/docs/5.3/components/breadcrumb/" target="_blank">Breadcrumb on Bootstrap<span
                ...
                <div class="mb-9">
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                            ...
                                            href="#breadcrumb-example-code" role="button"
                                            aria-controls="breadcrumb-example-code" aria-expanded="false"> <span
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="breadcrumb-example-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;nav aria-label=&quot;breadcrumb&quot;&gt;
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="dividers-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;nav style=&quot;--phoenix-breadcrumb-divider: '&amp;gt;&amp;gt;';&quot; aria-label=&quot;breadcrumb&quot;&gt;
  &lt;ol class=&quot;breadcrumb mb-0&quot;&gt;
