                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-components" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-components">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-components">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="calendar.html">
          ...
          <div class="card-header p-4 border-bottom bg-body">
            <div class="row g-3 justify-content-between align-items-end">
              <div class="col-12 col-md">
                ...
                <p class="mb-0 mt-2 text-body-secondary">Basic example of FullCalendar with default options in Phoenix. You can also pass the extra options using <code>data-calendar </code> attribute.<a href="../../apps/calendar.html" target="_blank">See advanced implementation of fullCalendar </a></p>
              </div>
