  ...
  <body>
    ...
    <main class="main" id="top">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-components" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-components">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-components">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="{{ url('pagination') }}">
      ...
      <div class="content">
        ...
        <p class="text-body-tertiary lead mb-2">Documentation and examples for showing pagination to indicate a series of related content exists across multiple pages.</p><a class="btn btn-link p-0" href="https://getbootstrap.com/docs/5.3/components/pagination/" target="_blank">Pagination on Bootstrap<span class="ms-1" data-feather="chevron-right"></span></a>
        <div class="mt-4">
          <div class="row g-4">
            <div class="col-12 col-xl-10 order-1 order-xl-0">
              <div class="mb-9">
                <div class="card shadow-none border my-6" data-component-card="data-component-card">
                  ...
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="example-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;nav aria-label=&quot;Page navigation example&quot;&gt;
...
&lt;/nav&gt;</code></pre>
                ...
                <div class="card shadow-none border my-6" data-component-card="data-component-card">
                    ...
                    <div class="row g-3 justify-content-between align-items-center">
                      <div class="col-12 col-md">
                        ...
                        <div class="mt-2 text-body-secondary">
                          <p>Change the alignment of pagination components with <a href="{{ url('modules/utilities/flex') }}">flexbox utilities</a>.</p>
                        </div>
                      </div>
                      <div class="col col-md-auto">
                  ...
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="alignment-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;!-- Center--&gt;
&lt;nav aria-label=&quot;Page navigation example&quot;&gt;
