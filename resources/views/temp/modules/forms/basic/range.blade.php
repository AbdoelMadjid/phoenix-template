...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Use our custom range inputs for consistent cross-browser styling and built-in
        customization.</p><a class="btn btn-link p-0" href="https://getbootstrap.com/docs/5.3/forms/range/"
        target="_blank">Range on Bootstrap<span class="ms-1" data-feather="chevron-right"></span></a>
    <div class="mt-4">
        <div class="row g-4">
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="overview-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;label class=&quot;form-label&quot; for=&quot;customRange1&quot;&gt;Example range&lt;/label&gt;
&lt;input class=&quot;form-range&quot; id=&quot;customRange1&quot; type=&quot;range&quot; /&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#min-and-max-code" role="button" aria-controls="min-and-max-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="min-and-max-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;label class=&quot;form-label&quot; for=&quot;customRange2&quot;&gt;Example range&lt;/label&gt;
&lt;input class=&quot;form-range&quot; id=&quot;customRange2&quot; type=&quot;range&quot; min=&quot;0&quot; max=&quot;5&quot; /&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#steps-code" role="button" aria-controls="steps-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="steps-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;label class=&quot;form-label&quot; for=&quot;customRange3&quot;&gt;Example range&lt;/label&gt;
&lt;input class=&quot;form-range&quot; id=&quot;customRange3&quot; type=&quot;range&quot; min=&quot;0&quot; max=&quot;5&quot; step=&quot;0.5&quot; /&gt;</code></pre>
                            </div>
                            <div class="p-4 code-to-copy"><label class="form-label" for="customRange3">Example
                                    range</label>
                                <input class="form-range" id="customRange3" type="range" min="0"
                                    max="5" step="0.5">
                            </div>
                        </div>
                    </div>
