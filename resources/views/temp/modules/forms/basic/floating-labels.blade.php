...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Create beautifully simple form labels that float over your input fields.</p><a
        class="btn btn-link p-0" href="https://getbootstrap.com/docs/5.3/forms/floating-labels/" target="_blank">Floating
        labels on Bootstrap<span class="ms-1" data-feather="chevron-right"></span></a>
    <div class="mt-4">
        <div class="row g-4">
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="example-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;form-floating mb-3&quot;&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#icon-example-code" role="button" aria-controls="icon-example-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="icon-example-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;form-icon-container&quot;&gt;
...
&lt;/div&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy">
                                <div class="form-icon-container">
                                    <div class="form-floating mb-3"><input class="form-control form-icon-input"
                                            id="floatingInputIconExample" type="email"
                                            placeholder="name@example.com"><label class="form-icon-label"
                                            for="floatingInputIconExample">Email address</label></div>
                                    <span class="fa-solid fa-envelope text-body fs-9 form-icon"></span>
                                </div>
                            </div>
                        </div>
...
&lt;/div&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy">
                                <div class="form-floating mb-3">
                                    <input class="form-control is-valid" id="floatingInputValid" type="email"
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#textareas-code" role="button" aria-controls="textareas-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="textareas-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;form-floating&quot;&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="card shadow-none border my-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#selects-code" role="button" aria-controls="selects-code"
                                            aria-expanded="false"> <span class="me-2" data-feather="code"></span>View
                                            code</a><a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span
                                                class="me-2" data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="selects-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;form-floating&quot;&gt;
