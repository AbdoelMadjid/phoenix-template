...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Phoenix uses <b>Choices.js</b> for advance select. Choices.js is a lightweight,
        configurable select box/text input plugin. Similar to Select2 and Selectize but without the jQuery dependency</p><a
        class="btn btn-link p-0" href="https://github.com/Choices-js/Choices" target="_blank">Documentation for Choices<span
                ...
                <div class="mb-9">
                    <div class="card shadow-none border mb-4 mt-6" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                            ...
                                            href="#multiple-select-example-code" role="button"
                                            aria-controls="multiple-select-example-code" aria-expanded="false"> <span
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="multiple-select-example-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;label for=&quot;organizerMultiple&quot;&gt;Multiple&lt;/label&gt;&lt;select class=&quot;form-select&quot; id=&quot;organizerMultiple&quot; data-choices=&quot;data-choices&quot; multiple=&quot;multiple&quot; data-options='{&quot;removeItemButton&quot;:true,&quot;placeholder&quot;:true}'&gt;
...
&lt;/select&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy"><label for="organizerMultiple">Multiple</label><select
                                    class="form-select" id="organizerMultiple" data-choices="data-choices"
                    ...
                    <div class="card shadow-none border mb-4" data-component-card="data-component-card">
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#single-select-example-code" role="button"
                                            aria-controls="single-select-example-code" aria-expanded="false"> <span
                                                class="me-2" data-feather="code"></span>View code</a><a
                                            class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                                data-feather="eye"></span>Hide code</a></nav>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="collapse code-collapse" id="single-select-example-code">
                                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;label for=&quot;organizerSingle&quot;&gt;Single&lt;/label&gt;&lt;select class=&quot;form-select&quot; id=&quot;organizerSingle&quot; data-choices=&quot;data-choices&quot; data-options='{&quot;removeItemButton&quot;:true,&quot;placeholder&quot;:true}'&gt;
  &lt;option value=&quot;&quot;&gt;Select organizer...&lt;/option&gt;
  &lt;option&gt;Massachusetts Institute of Technology&lt;/option&gt;
  &lt;option&gt;University of Chicago&lt;/option&gt;
  &lt;option&gt;GSAS Open Labs At Harvard&lt;/option&gt;
...
&lt;/select&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy"><label for="organizerSingle">Single</label><select
                                    class="form-select" id="organizerSingle" data-choices="data-choices"
                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <button class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                                class="fas fa-copy me-1"></span>Copy Code</button><a
                                            class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                            href="#floating-label-example-code" role="button"
                                            aria-controls="floating-label-example-code" aria-expanded="false"> <span
                                                class="me-2" data-feather="code"></span>View code</a><a
                                            class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                                data-feather="eye"></span>Hide code</a></nav>
                                </div>
  ...
  &lt;/select&gt;&lt;/div&gt;</code></pre>
                            ...
                            <div class="p-4 code-to-copy">
                                <div class="form-floating form-floating-advance-select mb-3"><label
                                        for="floaTingLabelSingleSelect">Single</label><select class="form-select"
                                ...
                                <div class="form-floating form-floating-advance-select"><label
                                        for="floaTingLabelMultipleSelect">Multiple</label><select class="form-select"
                                        id="floaTingLabelMultipleSelect" data-choices="data-choices" multiple="multiple"
                                        data-options='{"removeItemButton":true,"placeholder":true}'>
                                        <option selected="selected">Massachusetts Institute of Technology</option>
                                        <option>University of Chicago</option>
                                        <option>GSAS Open Labs At Harvard</option>
                ...
                <div class="card shadow-none border mb-3" data-component-card="data-component-card">
                            ...
                            <div class="col col-md-auto">
                                <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist"><button
                                        class="btn btn-link px-2 text-body copy-code-btn" type="button"><span
                                            class="fas fa-copy me-1"></span>Copy Code</button><a
                                        class="btn btn-sm btn-phoenix-primary code-btn ms-2" data-bs-toggle="collapse"
                                        href="#validation-example-code" role="button"
                                        aria-controls="validation-example-code" aria-expanded="false"> <span
                                            class="me-2" data-feather="code"></span>View code</a><a
                                        class="btn btn-sm btn-phoenix-primary preview-btn ms-2"><span class="me-2"
                                            data-feather="eye"></span>Hide code</a></nav>
                            </div>
                    ...
                    <div class="card-body p-0">
                        <div class="collapse code-collapse" id="validation-example-code">
...
&lt;/form&gt;</code></pre>
                        ...
                        <div class="p-4 code-to-copy">
                            <form class="needs-validation" novalidate="novalidate">
                                <div class="mb-3"><label for="organizerMultiple2">Multiple</label><select
                                        class="form-select" id="organizerMultiple2" data-choices="data-choices"
                                        multiple="multiple" size="1" name="organizerMultiple" required="required"
                                        data-options='{"removeItemButton":true,"placeholder":true}'>
                                        <option value="">Select organizer...</option>
                                        <option>Massachusetts Institute of Technology</option>
                                        <option>University of Chicago</option>
                                ...
                                <div class="mb-3"><label for="organizerSingle2">Single</label><select
                                        class="form-select" id="organizerSingle2" data-choices="data-choices"
                                        size="1" required="required" name="organizerSingle"
                                        data-options='{"removeItemButton":true,"placeholder":true}'>
                                        <option value="">Select organizer...</option>
                                        <option>Massachusetts Institute of Technology</option>
                                        <option>University of Chicago</option>
                ...
                <div class="card shadow-none border my-4" data-component-card="data-component-card">
                    ...
                    <div class="card-body p-0">
                        <div class="collapse code-collapse" id="stylesheet-code">
                            <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;pre&gt;&lt;code class=&quot;language-html&quot;&gt;&amp;lt;link href=&amp;quot;vendors/choices/choices.min.css&amp;quot; rel=&amp;quot;stylesheet&amp;quot; /&amp;gt;&lt;/code&gt;&lt;/pre&gt;</code></pre>
                        </div>
                        <div class="p-4 code-to-copy">
                ...
                <div class="card shadow-none border my-4" data-component-card="data-component-card">
                    ...
                    <div class="card-body p-0">
                        <div class="collapse code-collapse" id="javascript-code">
                            <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;pre&gt;&lt;code class=&quot;language-html&quot;&gt;&amp;lt;script src=&amp;quot;vendors/choices/choices.min.js&amp;quot;&amp;gt;&amp;lt;/script&amp;gt;&lt;/code&gt;&lt;/pre&gt;</code></pre>
                        </div>
                        <div class="p-4 code-to-copy">
            ...
            <div class="col-12 col-xl-2">
                <div class="position-sticky mt-xl-4" style="top: 80px;">
                    ...
                    <ul class="nav nav-vertical flex-column doc-nav" data-doc-nav="data-doc-nav">
                        <li class="nav-item"> <a class="nav-link" href="#multiple-select-example">Multiple Select
                                Example</a></li>
                        <li class="nav-item"> <a class="nav-link" href="#single-select-example">Single Select Example</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" href="#floating-label-example">Floating label
                                Example</a></li>
