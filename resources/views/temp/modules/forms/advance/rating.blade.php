                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-advance" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-advance">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#forms" id="nv-advance">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="rating.html">
