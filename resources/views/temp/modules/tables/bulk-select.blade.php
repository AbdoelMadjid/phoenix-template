  ...
  <body>
    ...
    <main class="main" id="top">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-tables" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-tables">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-tables">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('advance-tables') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Advance tables</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link active" href="{{ url('bulk-select') }}">
                  ...
                  <div class="px-3 pt-4 pb-3 img-dropdown">
                    <div class="row gx-4 gy-5">
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        ...
                        </div><a class="dropdown-link" href="{{ url('basic-tables') }}">Basic tables</a><a class="dropdown-link" href="{{ url('advance-tables') }}">Advance tables</a><a class="dropdown-link active" href="{{ url('bulk-select') }}">Bulk Select</a>
      ...
      <div class="content">
        ...
        <p class="text-body-tertiary lead mb-2">Bulk select allows users to check multiple checkboxes at once and toggles a UI for bulk actions to be performed for the selected items.</p>
        <div class="mt-4">
          <div class="row g-4">
            <div class="col-12 col-xl-10 order-1 order-xl-0">
              <div class="mb-9">
                <div class="card shadow-none border my-4" data-component-card="data-component-card">
                  ...
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="docs-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;h5&gt;Bulk select consist of this following parts: &lt;/h5&gt;
&lt;ul&gt;
...
&lt;/ul&gt;</code></pre>
                ...
                <div class="card shadow-none border mb-3" data-component-card="data-component-card">
                  ...
                  <div class="card-body p-0">
                    <div class="collapse code-collapse" id="example-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;div class=&quot;d-flex align-items-center justify-content-end my-3&quot;&gt;
