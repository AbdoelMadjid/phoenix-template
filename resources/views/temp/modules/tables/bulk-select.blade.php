                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-tables" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-tables">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-tables">
                      ...
                      <li class="nav-item"><a class="nav-link" href="advance-tables.html">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Advance tables</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link active" href="bulk-select.html">
                  ...
                  <div class="px-3 pt-4 pb-3 img-dropdown">
                    <div class="row gx-4 gy-5">
                      ...
                      <div class="col-12 col-sm-6 col-md-4">
                        ...
                        </div><a class="dropdown-link" href="basic-tables.html">Basic tables</a><a class="dropdown-link" href="advance-tables.html">Advance tables</a><a class="dropdown-link active" href="bulk-select.html">Bulk Select</a>
