  ...
  <body>
    ...
    <main class="main" id="top">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-icons" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-icons">
                    <div class="d-flex align-items-center">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-icons">
                      <li class="collapsed-nav-item-title d-none">Icons</li>
                      <li class="nav-item"><a class="nav-link active" href="{{ url('feather') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Feather</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('font-awesome') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Font awesome</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('unicons') }}">
                  ...
                  <div class="px-3 pt-4 pb-3 img-dropdown">
                    <div class="row gx-4 gy-5">
                      <div class="col-12 col-sm-6 col-md-4">
                        ...
                        </div><a class="dropdown-link active" href="{{ url('feather') }}">Feather</a><a class="dropdown-link" href="{{ url('font-awesome') }}">Font awesome</a><a class="dropdown-link" href="{{ url('unicons') }}">Unicons</a>
      ...
      <div class="content">
        ...
        <p class="text-body-tertiary lead mb-2">Simply beautiful open source icons</p><a class="btn btn-link p-0" href="https://feathericons.com/" target="_blank">Feather Icons Documentation<span class="ms-1" data-feather="chevron-right"></span></a>
        <div class="mb-9">
          <div class="card shadow-none border my-5" data-component-card="data-component-card">
            ...
            <div class="card-body p-0">
              <div class="collapse code-collapse" id="example-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;span class=&quot;text-danger&quot; data-feather=&quot;bell&quot; style=&quot;height: 70px; width: 70px;&quot;&gt;&lt;/span&gt;</code></pre>
              </div>
              <div class="p-4 code-to-copy"><span class="text-danger" data-feather="bell" style="height: 70px; width: 70px;"></span></div>
            </div>
          </div>
