...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <body>
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-home">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="travel-agency.html">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Travel agency</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="stock.html">
          ...
          <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-chart-pie"></span>Home</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li><a class="dropdown-item" href="stock.html">
        ...
        <div class="row gx-3">
          ...
          <div class="col-xxl-5">
            <div class="row g-3">
                    ...
                    <div class="table-responsive scrollbar mt-3">
                      <table class="table fs-10 mb-0">
                        ...
                        <tbody class="list" id="table-country-wise-visitors">
                          <tr>
                            <td class="py-2 white-space-nowrap ps-0 country"><a class="d-flex align-items-center text-primary py-md-1 py-xxl-0" href="#!"><img src="../assets/img/country/india-2.png" alt="" width="40">
                          ...
                          <tr>
                            <td class="py-2 white-space-nowrap ps-0 country"><a class="d-flex align-items-center text-primary py-md-1 py-xxl-0" href="#!"><img src="../assets/img/country/china-2.png" alt="" width="40">
              ...
              <div class="col-12">
                <div class="card mb-3">
                  <div class="bg-holder bg-card" style="background-image:url(../assets/img/spot-illustrations/39.png);background-position: bottom right 0px; background-size: auto;"></div>
                  <!--/.bg-holder-->
              ...
              <table class="table fs-9 mb-0 border-top border-translucent">
                ...
                <tbody class="list" id="table-flights-body">
                  <tr>
                    ...
                    <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2" href="#!"><img src="../assets/img/brands/phoenix-firelines.png" alt="" width="32">
                    ...
                    <td class="align-middle route pe-5">
                      <div class="d-flex align-items-center gap-2"><img src="../assets/img/country/usa.png" alt="" width="16">
                        <p class="mb-0 fw-semibold text-bold">LAX</p><span class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                        <p class="mb-0 fw-semibold text-bold">YVR</p><img src="../assets/img/country/canada.png" alt="" width="16">
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2" href="#!"><img src="../assets/img/brands/qatar-airways.png" alt="" width="32">
                    ...
                    <td class="align-middle route pe-5">
                      <div class="d-flex align-items-center gap-2"><img src="../assets/img/country/denmark.png" alt="" width="16">
                        <p class="mb-0 fw-semibold text-bold">EBJ</p><span class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                        <p class="mb-0 fw-semibold text-bold">CDG</p><img src="../assets/img/country/south-korea.png" alt="" width="16">
                      </div>
                    </td>
                    <td class="align-middle destination pe-5 pe-xxl-7">
                  ...
                  <tr>
                    ...
                    <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2" href="#!"><img src="../assets/img/brands/jal.png" alt="" width="32">
                    ...
                    <td class="align-middle route pe-5">
                      <div class="d-flex align-items-center gap-2"><img src="../assets/img/country/china.png" alt="" width="16">
                        <p class="mb-0 fw-semibold text-bold">GOT</p><span class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                        <p class="mb-0 fw-semibold text-bold">BCN</p><img src="../assets/img/country/usa.png" alt="" width="16">
                      </div>
                    </td>
                    <td class="align-middle destination pe-5 pe-xxl-7">
                      <div class="progress overflow-visible" role="progressbar" aria-label="flight-progress-bar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="height: 2px">
                  ...
                  <tr>
                    ...
                    <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2" href="#!"><img src="../assets/img/brands/emirates.png" alt="" width="32">
                    ...
                    <td class="align-middle route pe-5">
                      <div class="d-flex align-items-center gap-2"><img src="../assets/img/country/qatar.png" alt="" width="16">
                        <p class="mb-0 fw-semibold text-bold">DIA</p><span class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                        <p class="mb-0 fw-semibold text-bold">OSL</p><img src="../assets/img/country/norway.png" alt="" width="16">
                      </div>
                    </td>
                    <td class="align-middle destination pe-5 pe-xxl-7">
                    ...
                    <div class="swiper theme-slider" data-swiper='{"loop":true,"spaceBetween":40,"centeredSlides":true,"slidesPerView":"auto","autoplay":{"delay":0},"speed":4000,"grabCursor":true}'>
                      <div class="swiper-wrapper swiper-continuous-autoplay">
                        <div class="swiper-slide w-auto">
                          <div class="d-flex align-items-center">
                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">1</h6><img class="me-1" src="../assets/img/brands/emirates.png" alt="" width="16">
                        ...
                        <div class="swiper-slide w-auto">
                          <div class="d-flex align-items-center">
                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">2</h6><img class="me-1" src="../assets/img/brands/phoenix-firelines.png" alt="" width="16">
                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span class="fa-solid fa-plane text-primary mx-2"></span>
                            <h6 class="mb-0 fw-semibold text-white border-end pe-6">LAX</h6>
                          </div>
                        ...
                        <div class="swiper-slide w-auto">
                          <div class="d-flex align-items-center">
                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">3</h6><img class="me-1" src="../assets/img/brands/qatar-airways.png" alt="" width="16">
                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span class="fa-solid fa-plane text-primary mx-2"></span>
                            <h6 class="mb-0 fw-semibold text-white border-end pe-6">LAX</h6>
                          </div>
                        ...
                        <div class="swiper-slide w-auto">
                          <div class="d-flex align-items-center">
                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">4</h6><img class="me-1" src="../assets/img/brands/jal.png" alt="" width="16">
                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span class="fa-solid fa-plane text-primary mx-2"></span>
                            <h6 class="mb-0 fw-semibold text-white border-end pe-6">LAX</h6>
                          </div>
                        ...
                        <div class="swiper-slide w-auto">
                          <div class="d-flex align-items-center">
                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">5</h6><img class="me-1" src="../assets/img/brands/jal.png" alt="" width="16">
                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span class="fa-solid fa-plane text-primary mx-2"></span>
                            <h6 class="mb-0 fw-semibold text-white border-end pe-6">LAX</h6>
                          </div>
    ...
    <script src="../assets/js/dashboards/travel-agency-dashboard.js"></script>
    <script src="../vendors/mapbox-gl/mapbox-gl.js"></script>
    <script src="../assets/external/@turf/turf@6.5.0/turf.min.js"></script>
