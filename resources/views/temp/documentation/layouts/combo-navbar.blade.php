  ...
  <body>
    ...
    <main class="main" id="top">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-customization" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-customization">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-customization">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('customization/configuration') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Configuration</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('customization/styling') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Styling</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('customization/color') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Color</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('customization/dark-mode') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Dark mode</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('customization/plugin') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-layouts-doc" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-layouts-doc">
                    <div class="d-flex align-items-center">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-layouts-doc">
                      <li class="collapsed-nav-item-title d-none">Layouts doc</li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('vertical-navbar') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Vertical navbar</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('horizontal-navbar') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Horizontal navbar</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link active" href="{{ url('combo-navbar') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Combo navbar</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('dual-nav') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Dual nav</span></div>
                        </a><!-- more inner pages-->
                      </li>
                    </ul>
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-document-layout-right"></span>Documentation</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown dropdown-inside"><a class="dropdown-item dropdown-toggle" id="customization" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ url('customization/configuration') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Configuration</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('customization/styling') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Styling</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('customization/color') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Color</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('customization/dark-mode') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Dark mode</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('customization/plugin') }}">
      ...
      <div class="content">
        ...
        <p class="text-body-tertiary lead mb-2">Here is the default Phoenix's powerful, responsive vertical navigation. The following sections describe how you can customize both the responsive breakpoint and collapsing behavior.</p><a class="btn btn-link p-0" href="{{ url('demo/combo-nav') }}" target="_blank">Combo navbar example<span class="ms-1" data-feather="chevron-right"></span></a>
        <div class="card shadow-none border mb-4 mt-5" data-component-card="data-component-card">
          ...
          <div class="card-body p-0">
            <div class="collapse code-collapse" id="navbar-combo-structure-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;p class=&quot;mb-0&quot;&gt;Add &lt;code&gt;[data-navigation-type=&quot;combo&quot;] &lt;/code&gt;attribute in &lt;code&gt;Html &lt;/code&gt;element to start with combo-navbar&lt;/p&gt;&lt;pre class=&quot;scrollbar my-5&quot;&gt;&lt;code class=&quot;language-html&quot;&gt;&amp;lt;!DOCTYPE html&amp;gt;
...
&amp;lt;/html&amp;gt;&lt;/code&gt;&lt;/pre&gt;</code></pre>
            ...
            <div class="p-4 code-to-copy">
              <p class="mb-0">Add <code>[data-navigation-type="combo"] </code>attribute in <code>Html </code>element to start with combo-navbar</p><pre class="scrollbar my-5"><code class="language-html">&lt;!DOCTYPE html&gt;
&lt;html data-navigation-type=&quot;combo&quot;&gt;
...
&lt;nav class=&quot;navbar navbar-top navbar-expand-lg&quot; data-move-target=&quot;navbarVerticalNav&quot; data-navbar-top=&quot;combo&quot;&gt;&lt;/nav&gt;</code></pre>
        ...
        <div class="card shadow-none border my-4" data-component-card="data-component-card">
          ...
          <div class="card-body p-0">
            <div class="collapse code-collapse" id="collapsing-behavior-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;p&gt;You can control the default collapsing behavior of phoenix's vertical navigation - whether it will show up with the collapsed or expanded state when the page loads.&lt;/p&gt;
...
&lt;/code&gt;&lt;/pre&gt;</code></pre>
  ...
  ...
        ...
        <div class="card shadow-none border my-4" data-component-card="data-component-card">
          ...
          <div class="card-body p-0">
            <div class="collapse code-collapse" id="vertical-navbar-appearance-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;p&gt;You can control Navbar vertical style of phoenix's between defaults and darker.&lt;/p&gt;
...
&lt;p class=&quot;mb-0&quot;&gt;Or to change navbar vertical color add &lt;code&gt;data-navbar-appearance=&quot;darker&quot; &lt;/code&gt;attribute in navber-vertical &lt;/p&gt;&lt;pre class=&quot;scrollbar mt-3&quot;&gt;&lt;code class=&quot;language-html&quot;&gt;&amp;lt;nav class=&amp;quot;navbar navbar-vertical navbar-expand-lg&amp;quot; data-navbar-appearance=&amp;quot;darker&amp;quot;&amp;gt;&amp;lt;/nav&amp;gt;&lt;/code&gt;&lt;/pre&gt;</code></pre>
  ...
  ...
        ...
        <div class="card shadow-none border my-4" data-component-card="data-component-card">
          ...
          <div class="card-body p-0">
            <div class="collapse code-collapse" id="horizontal-navbar-appearance-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;p&gt;You can control top nav style of vertical navbar between defaults and darker.&lt;/p&gt;
...
&lt;p class=&quot;mb-0&quot;&gt;Or to change navbar vertical color just add &lt;code&gt;data-navbar-appearance=&quot;darker&quot; &lt;/code&gt;attribute in navber-vertical &lt;/p&gt;&lt;pre class=&quot;scrollbar mt-3&quot;&gt;&lt;code class=&quot;language-html&quot;&gt;&amp;lt;nav class=&amp;quot;navbar navbar-top&amp;quot; data-navbar-appearance=&amp;quot;darker&amp;quot;&amp;gt;&amp;lt;/nav&amp;gt;&lt;/code&gt;&lt;/pre&gt;</code></pre>
  ...
  ...
              ...
              <p class="mb-0">Or to change navbar vertical color just add <code>data-navbar-appearance="darker" </code>attribute in navber-vertical </p><pre class="scrollbar mt-3"><code class="language-html">&lt;nav class=&quot;navbar navbar-top&quot; data-navbar-appearance=&quot;darker&quot;&gt;&lt;/nav&gt;</code></pre>
            </div>
          </div>
        </div>
        <h2 class="mb-2 lh-sm mt-12" data-anchor="data-anchor">Combo navbar slim</h2>
        <p class="text-body-tertiary lead mb-2">Pheonix provides another layout for navbar vertical with navbar slim.</p><a class="btn btn-link p-0" href="{{ url('demo/combo-nav-slim') }}" target="_blank">Combo navbar slim example<span class="ms-1" data-feather="chevron-right"></span></a>
        <div class="card shadow-none border my-4" data-component-card="data-component-card">
          <div class="card-header p-4 border-bottom bg-body">
            <div class="row g-3 justify-content-between align-items-center">
              <div class="col-12 col-md">
          ...
          <div class="card-body p-0">
            <div class="collapse code-collapse" id="navbar-slim-structure-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;pre class=&quot;scrollbar my-5&quot;&gt;&lt;code class=&quot;language-html&quot;&gt;&amp;lt;!DOCTYPE html&amp;gt;
