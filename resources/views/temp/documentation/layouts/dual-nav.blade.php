  ...
  <body>
    ...
    <main class="main" id="top">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-layouts-doc" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-layouts-doc">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-layouts-doc">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="dual-nav.html">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Dual nav</span></div>
                        </a><!-- more inner pages-->
                      </li>
                    </ul>
      ...
      <div class="content">
        ...
        <p class="text-body-tertiary lead mb-2">Dual Nav is a different horizontal layout system in Phoenix.</p><a class="btn btn-link p-0" href="../../demo/dual-nav.html" target="_blank">Dual nav example<span class="ms-1" data-feather="chevron-right"></span></a>
