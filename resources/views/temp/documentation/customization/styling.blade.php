  ...
  <body>
    ...
    <main class="main" id="top">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <hr class="navbar-vertical-line"><!-- parent pages-->
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{ url('getting-started') }}" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-customization" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-customization">
                    <div class="d-flex align-items-center">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-customization">
                      <li class="collapsed-nav-item-title d-none">Customization</li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('configuration') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Configuration</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link active" href="{{ url('styling') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Styling</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('color') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Color</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('dark-mode') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Dark mode</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('plugin') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-layouts-doc" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-layouts-doc">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-layouts-doc">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('layouts/vertical-navbar') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Vertical navbar</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('layouts/horizontal-navbar') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Horizontal navbar</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('layouts/combo-navbar') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Combo navbar</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('layouts/dual-nav') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Dual nav</span></div>
                        </a><!-- more inner pages-->
                      </li>
                    </ul>
                ...
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{ url('gulp') }}" role="button" data-bs-toggle="" aria-expanded="false">
                ...
                <div class="nav-item-wrapper"><a class="nav-link label-1" href="{{ url('design-file') }}" role="button" data-bs-toggle="" aria-expanded="false">
        ...
        <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center" id="navbarTopCollapse">
          <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-document-layout-right"></span>Documentation</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                <li><a class="dropdown-item" href="{{ url('getting-started') }}">
                ...
                <li class="dropdown dropdown-inside"><a class="dropdown-item dropdown-toggle" id="customization" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="{{ url('styling') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Styling</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('color') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Color</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('dark-mode') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Dark mode</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('plugin') }}">
      ...
      <div class="content">
        ...
        <p class="text-body-tertiary lead mb-2">We recommend you customize your theme styles using the user style files. You can customize the theme’s styles with the following approaches:</p>
        <div class="card shadow-none border my-4" data-component-card="data-component-card">
          ...
          <div class="card-body p-0">
            <div class="collapse code-collapse" id="gulp-based-workflow-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;p class=&quot;mb-1&quot;&gt;You can add your own SCSS and override the theme style in the &lt;code&gt;src/scss/user.scss&lt;/code&gt; file.&lt;/p&gt;
...
&lt;div class=&quot;border border-translucent rounded-1 bg-body-emphasis px-3 py-2&quot;&gt;&lt;code&gt;_bootstrap.scss&lt;/code&gt;&lt;/div&gt;</code></pre>
        ...
        <div class="card shadow-none border my-4" data-component-card="data-component-card">
          ...
          <div class="card-body p-0">
            <div class="collapse code-collapse" id="if-you-are-not-using-gulp-based-workflow-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;p class=&quot;mb-1&quot;&gt;You can add your own CSS and override the theme style in the &lt;code&gt;public/assets/css/user.css&lt;/code&gt; file.&lt;/p&gt;
&lt;div class=&quot;border border-translucent rounded-1 bg-body-emphasis px-3 py-2&quot;&gt;&lt;code&gt;user.css&lt;/code&gt;&lt;/div&gt;</code></pre>
        ...
        <div class="card shadow-none border my-4" data-component-card="data-component-card">
          ...
          <div class="card-body p-0">
            <div class="collapse code-collapse" id="changing-theme-colors-code"><pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;p class=&quot;mb-1&quot;&gt;Changing theme colors &lt;code&gt;public/assets/css/user.css&lt;/code&gt; file.&lt;/p&gt;
&lt;div class=&quot;border border-translucent rounded-1 bg-body-emphasis px-3 py-2&quot;&gt;&lt;code&gt;user.css&lt;/code&gt;&lt;/div&gt;</code></pre>
            </div>
            <div class="p-4 code-to-copy">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body bg-body-highlight">
            ...
            <div class="px-4">
              <p class="mb-1">You can bring your necessary variable colors form <code>src/scss/theme/_colors.scss </code>and paste it into <code>src/scss/_user-variables.scss </code>then update variables as your necessity. We recommend to follow this approach.</p>
              <div class="border border-translucent rounded-1 bg-body-emphasis px-3 py-2 mb-3"><code>_user-variables.scss</code></div>
              <p> Light mode is default theme style in phoenix. So, if you update any bootstrap’s SCSS variables, it will effect in Light mode. If you want to update any color, find the corresponding variable for this color and place theme to _user-variables.scss file. For example:</p><pre><code class="lang-css">//*-----------------------------------------------
//|   Theme Colors
//-----------------------------------------------*/
...
$dark: $gray-1100 !default;  
              ...
              <p class="mt-3">Most of the background and text colors used from body colors, to update the colors change the corresponding variables.</p><pre><code class="lang-css">//*-----------------------------------------------
//|   Body Colors
//-----------------------------------------------*/
...
$body-highlight-bg: $gray-100 !default;
              ...
              <p class="mt-3">If you want to update any theme colors for dark mode, update <code>$theme-colors-dark</code>variable and to update the grays colors you have to update the <code>$grays-dark </code>variable.</p><pre><code class="lang-css">/*-----------------------------------------------
|   Theme Styles
-----------------------------------------------*/
$theme-colors-dark: (
  ...
  'danger': $danger-dark,
              ...
              <p class="mb-1"> All <strong>Phoenix </strong>colors are available as Sass variables and Sass map in <code>src/scss/theme/_colors.scss </code>file. To avoid increased file sizes, we don’t create text or background color classes for each of these variables. Instead, we choose a subset of these colors for a theme palette.</p>
              <p>You'll find all the colors used in the theme in a sass map name <code>$theme-color-shades </code>in <code>src/scss/theme/_colors.scss </code>file.
                If you want to use any <strong>Phoenix </strong>color to generate <code>text/bg </code>utility class, Add the color variable in <code>$theme-color-shades </code>map. If you want to add/change color for dark mode, update the <code>$theme-color-shades-dark </code>map. </p><pre><code class="lang-css">$theme-color-shades: (
  ...
  'info-darker': $cyan-700,
            ...
            <div class="px-4">
              <div class="border border-translucent rounded-1 bg-body-emphasis px-3 py-2 mb-3"><code>_user.scss</code></div>
              <p>To update theme color with this approach, you have to update CSS variable for both modes. If you change any color you have to assign its corresponding RGB color too. Please note that sometimes you may need to update corresponding component's CSS variable. For example:</p><pre><code class="lang-css">/*-----------------------------------------------
|   Theme Styles
-----------------------------------------------*/
$success: #00d27a;
$danger: #e63757;
...
[data-bs-theme='dark']{
  ...
  .card{
    --phoenix-card-bg: #{$success};
              ...
              <p>You can add your own CSS and override the theme style in the <code>public/assets/css/user.css </code>file. You can update all theme colors including grays using css variables. If you change any color you have to assign its corresponding rgb color. Sometimes you may need to update corresponding component's css variable too.</p><pre><code class="lang-css">/*-----------------------------------------------
|   Theme Styles
-----------------------------------------------*/
:root, [data-bs-theme='light'] {
