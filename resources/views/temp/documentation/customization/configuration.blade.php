...
@section('content')
    ...
    <p class="text-body-tertiary lead mb-2">Phoenix has a global configuration system. You can change the theme settings with
        a single global javascript object.</p>
    <div class="mt-4">
        <div class="row g-4">
            <div class="col-12 col-xl-10 order-1 order-xl-0">
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                    ...
                    <div class="card-body p-0">
                        <div class="collapse code-collapse" id="setting-configuration-code">
                            <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;h5&gt;For Gulp based workflow&lt;/h5&gt;
...
&lt;/code&gt;&lt;/pre&gt;</code></pre>
                        ...
                        <div class="p-4 code-to-copy">
                            ...
                            <h5>If you are not using Gulp based workflow</h5>
                            <p>Edit the <code>public/assets/js/config.js</code> file.</p>
                            <h5 class="fs-8">Configuration object:</h5>
                            <pre><code class="lang-js">const initialConfig = {
  phoenixIsNavbarVerticalCollapsed: false,
  phoenixTheme: 'light',
  phoenixNavbarTopStyle: 'default',
  phoenixNavbarVerticalStyle: 'default',
  ...
  phoenixSupportChat: true
                ...
                <div class="card shadow-none border my-5" data-component-card="data-component-card">
                    ...
                    <div class="card-body p-0">
                        <div class="collapse code-collapse" id="available-options-code">
                                ...
                                <table class="table table-bordered border border-translucent fs-9 mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="white-space-nowrap" style="min-width: 7rem"><code>Boolean</code></td>
                                            <td class="white-space-nowrap" style="min-width: 7rem"><code>false</code></td>
                                            <td class="pe-2">Set <code>true</code> to make the vertical navbar stay
                                                collapsed when the page loads. </td>
                                        </tr>
                                        <tr>
                                            <td class="ps-2 white-space-nowrap">phoenixTheme</td>
                                            <td><code>string </code></td>
                                            <td class="white-space-nowrap"> <code>light </code></td>
                                            <td class="pe-2">This option is for setting up the default color mode
                                                (<code>light</code>, <code>dark</code> or <code>auto</code>) for your
                                                project. Set <code>dark</code> to make the default color mode dark.</td>
                                        </tr>
                                        <tr>
                                            <td class="ps-2 white-space-nowrap">phoenixNavbarTopStyle</td>
                                            <td><code>string </code></td>
                                            <td class="white-space-nowrap"> <code>default </code></td>
                                            <td class="pe-2">Set <code>darker </code>to make the top navbar darker when
                                                the page loads.</td>
                                        </tr>
                                        <tr>
                                            <td class="ps-2 white-space-nowrap">phoenixNavbarVerticalStyle</td>
                                            <td><code>string </code></td>
                                            <td class="white-space-nowrap"> <code>default </code></td>
                                            <td class="pe-2">Set <code>darker </code>to make the vertical navbar darker
                                        ...
                                        <tr>
                                            ...
                                            <td><code>string </code></td>
                                            <td class="white-space-nowrap"> <code>vertical </code></td>
                                            <td class="pe-2">This option is for changing the navigation type. Available
                                                values:<ul class="mb-0">
                                                    <li><code>vertical</code></li>
                                                    <li><code>horizontal</code></li>
                                                    <li><code>combo</code></li>
                                                </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td><code>string </code></td>
                                            <td class="white-space-nowrap"> <code>default </code></td>
                                            <td class="pe-2">Set <code>slim </code>to make the top navbar slim when the
                                                page loads.</td>
                                        </tr>
                                        <tr>
                                            <td class="ps-2 white-space-nowrap">phoenixIsRTL</td>
                                            <td><code>Boolean</code></td>
                                            <td><code>false</code></td>
                                            <td class="pe-2">Use <code>true</code> to make the whole layout RTL (Right to
                                                Left). Recommended for languages such as Arabic, Hebrew, or other RTL
                                                languages.</td>
                                        </tr>
                                        <tr>
                                            <td class="ps-2 white-space-nowrap">phoenixSupportChat</td>
                                            <td class="white-space-nowrap"> <code>Boolean </code></td>
                                            <td class="white-space-nowrap"> <code>true</code></td>
                                            <td class="pe-2">This option is for showing the chat widget. Set <code>false
                                                </code>to hide the chat widget when the page loads.</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="col-12 col-xl-2">
                <div class="position-sticky mt-xl-4" style="top: 80px;">
                    ...
                    <ul class="nav nav-vertical flex-column doc-nav" data-doc-nav="data-doc-nav">
                        <li class="nav-item"> <a class="nav-link" href="#setting-configuration">Setting configuration</a>
                        </li>
