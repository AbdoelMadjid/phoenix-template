  ...
  <body>
    ...
    <main class="main" id="top">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-customization" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-customization">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-customization">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('styling') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Styling</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link active" href="{{ url('color') }}">
              ...
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown dropdown-inside"><a class="dropdown-item dropdown-toggle" id="customization" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="{{ url('styling') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Styling</div>
                      </a></li>
                    <li><a class="dropdown-item active" href="{{ url('color') }}">
      ...
      <div class="content">
        ...
        <p class="text-body-tertiary lead mb-2">Phoenix is supported by an extensive color system that themes our styles and components. This enables more comprehensive customization and extension for any project.</p>
        <div class="card mb-3 mt-7">
          <div class="card-header">
            <h5 class="fs-6" data-anchor="data-anchor">Colors</h5>
            <p>Phoenix comes with lots of colors and variants. We added <code>quaternary </code>and <code>body-highlight </code>colors besides <code>secondary </code>and <code>tertiary </code>colors and also theme colors shades.</p>
          </div>
          <div class="card-body">
              ...
              <table class="table table-swatches">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="ps-0">
                      <div class="p-5 rounded-2" style="background-color: var(--phoenix-body-highlight-color)"></div>
                    </td>
                    <td><code>--phoenix-body-highlight-color</code><br><code>--phoenix-body-highlight-color-rgb</code></td>
                  ...
                  <tr>
                    ...
                    <td> <code>--phoenix-body-highlight-bg</code><br><code>--phoenix-body-highlight-bg-rgb</code></td>
                  ...
                  <tr>
                    ...
                    <td><code>--phoenix-secondary-lighter</code><br><code>--phoenix-secondary-lighter-rgb</code></td>
