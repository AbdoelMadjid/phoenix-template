...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg sticky-top py-3" data-navbar-soft-on-scroll="data-navbar-soft-on-scroll">
        <div class="container-small px-0 px-sm-3"><a class="navbar-brand" href="{{ url('dashboard') }}">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-grid d-lg-flex align-items-center"><a class="btn btn-primary" href="https://themewagon.com/themes/phoenix/" target="_blank">Purchase</a></div>
          </div>
        </div>
      </nav>
      <section class="py-0">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-6 position-relative variant-container">
              ...
              </div><a class="stretched-link" href="{{ url('index') }}?theme-control=true&amp;navigation-type=vertical" target="_blank"></a>
            </div>
            <div class="col-lg-6 position-relative variant-container">
              ...
              </div><a class="stretched-link" href="{{ url('index') }}?theme-control=true&amp;color-scheme=dark" target="_blank"></a>
            </div>
            <div class="col-lg-6 position-relative variant-container">
              <div class="d-flex px-4 pt-6 justify-content-center justify-content-lg-end">
                <div class="text-center">
              ...
              </div><a class="stretched-link" href="{{ url('index') }}?theme-control=true&amp;vertical-navbar-appearance=darker&amp;horizontal-navbar-appearance=darker" target="_blank"></a>
            </div>
            <div class="col-lg-6 position-relative variant-container">
              <div class="d-flex px-4 pt-6 justify-content-center justify-content-lg-start">
                <div class="text-center">
              ...
              </div><a class="stretched-link" href="{{ url('index') }}?theme-control=true&amp;horizontal-navbar-shape=slim&amp;horizontal-navbar-appearance=darker" target="_blank"></a>
            </div>
            <div class="col-lg-6 position-relative variant-container">
              <div class="d-flex px-4 pt-6 justify-content-center justify-content-lg-end">
                <div class="text-center">
              ...
              </div><a class="stretched-link" href="{{ url('index') }}?theme-control=true&amp;navigation-type=horizontal" target="_blank"></a>
            </div>
            <div class="col-lg-6 position-relative variant-container">
              <div class="d-flex px-4 pt-6 justify-content-center justify-content-lg-start">
                <div class="text-center">
              ...
              </div><a class="stretched-link" href="{{ url('index') }}?theme-control=true&amp;navigation-type=horizontal&amp;horizontal-navbar-shape=slim&amp;horizontal-navbar-appearance=darker" target="_blank"></a>
            </div>
            <div class="col-lg-6 position-relative variant-container">
              <div class="d-flex px-4 pt-6 justify-content-center justify-content-lg-end">
                <div class="text-center">
              ...
              </div><a class="stretched-link" href="{{ url('index') }}?theme-control=true&amp;navigation-type=combo" target="_blank"></a>
            </div>
            <div class="col-lg-6 position-relative variant-container">
              <div class="d-flex px-4 pt-6 justify-content-center justify-content-lg-start">
                <div class="text-center">
              ...
              </div><a class="stretched-link" href="{{ url('index') }}?theme-control=true&amp;navigation-type=dual-nav" target="_blank"></a>
            </div>
          </div>
      ...
      <!-- ============================================-->
      <!-- <section> begin ============================-->
      <section class="gsap pb-0 overflow-hidden">
      ...
      <!-- ============================================-->
      <!-- <section> begin ============================-->
      <section class="bg-body-highlight pt-14">
        <div class="container-lg">
      ...
      <!-- ============================================-->
      <!-- <section> begin ============================-->
      <section class="pt-9 pt-sm-14">
        <div class="container-small">
          <div class="row flex-center">
            <div class="col-12 col-xl-7">
              <h2 class="text-center mb-6 mb-sm-10">Frequently asked questions</h2>
              <div class="accordion">
                <div class="accordion-item border-top border-translucent">
                  <h2 class="accordion-header" id="headingOne"><button class="accordion-button fs-7 pb-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">What about the update procedure of the theme?</button></h2>
                  <div class="accordion-collapse collapse show" id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="accordion-body pt-0">This is our newest admin dashboard. We'll keep updating it according to users' needs. We keep a changelog with every release, so you'll be able to update the theme from one version to another with that changelog.</div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingTwo"><button class="accordion-button fs-7 pb-3 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="true" aria-controls="collapseOne">Is there any Trial version of Phoenix?</button></h2>
                  <div class="accordion-collapse collapse" id="collapseTwo" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body pt-0">We are sorry to inform you that there is no free or trial version of Phoenix, but you would get a full refund within 10 days if the template does not match your requirement.</div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingThree"><button class="accordion-button fs-7 pb-3 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseOne">Is it possible to build a mobile app using Phoenix components?</button></h2>
                  <div class="accordion-collapse collapse" id="collapseThree" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body pt-0">Phoenix is made out of HTML, CSS, and JS. You can not use Phoenix as a "Native" component library for an android or iOS app. But if you use a web-view for your app or use a framework that uses HTML, CSS, and JS for mobile app UI​, yes, you can use Phoenix in that case.</div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingFour"><button class="accordion-button fs-7 pb-3 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseOne">Can I use Phoenix with Django?</button></h2>
                  <div class="accordion-collapse collapse" id="collapseFour" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                    <div class="accordion-body pt-0">Many of our customers are using Phoenix with Django. Using Phoenix is like using Bootstrap with Django, just with some extra features.For a starter, you need to take all the CSS and JS files from Phoenix's "public/assets" folder to your project and link them to your view files. You can find all the required scripts and styles on the source of the starter page.
                      It is also possible to compile the SCSS and use the ES6 JavaScript partial files with Django using Phoenix's built-in gulp based workflow.</div>
                  </div>
                </div>
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingFive"><button class="accordion-button fs-7 pb-3 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseOne">Does Phoenix incorporate properly with Laravel?</button></h2>
                  <div class="accordion-collapse collapse" id="collapseFive" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                    <div class="accordion-body pt-0">Many of our customers are using Phoenix with Laravel. Using Phoenix is like using Bootstrap with Laravel, just with some extra features.For a starter, you need to take all the CSS and JS files from Phoenix's "public/assets" folder to your project and link them to your view files. You can find all the required scripts and styles on the source of the starter page.
                      It is also possible to compile the SCSS and use the ES6 JavaScript partial files with Laravel using Phoenix's built-in gulp based workflow.</div>
                  </div>
                </div>
              </div>
            </div>
