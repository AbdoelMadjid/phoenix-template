...
@section('content')
    ...
    <div class="card shadow-none border my-4" data-component-card="data-component-card">
        ...
        <div class="card-body p-0">
            <div class="collapse code-collapse" id="introduction-code">
                <pre class="scrollbar" style="max-height:420px"><code class="language-html">&lt;p class=&quot;mt-4&quot;&gt;The &lt;code&gt;gulp&lt;/code&gt; command will build, serve and watch the project with the following gulp tasks:&lt;/p&gt;</code></pre>
            </div>
            <div class="p-4 code-to-copy">
                <p class="mt-4">The <code>gulp</code> command will build, serve and watch the project with the following
                    gulp tasks:</p>
            </div>
        </div>
    </div>
    <div class="card shadow-none border my-4" data-component-card="data-component-card">
        ...
        <div class="card-body p-0">
            <div class="collapse code-collapse" id="commands-code">
...
public/**/*.html
                            ...
                            <tr>
                                <td class="text-nowrap ps-3"><code>style</code></td>
                                <td>Compiles <code>scss/theme.scss</code> and generates <code>theme.css, theme.min.css,
                                        theme-rlt.css, theme-rtl.min.css</code> and <code>theme.css.map, theme.min.css.map,
                                        theme-rlt.css.map, theme-rtl.min.css.map</code> to the <code>public/assets/css/
                                    </code> directory.</td>
                            </tr>
                            <tr>
                                <td class="text-nowrap ps-3"><code>script</code></td>
                                <td>Concat the <code>js</code> files from <code>src/js/</code> and transpiles with babel to
                                    <code>phoenix.js</code> to the <code>public/assets/js/</code> directory.</td>
                            </tr>
                            <tr>
                                <td class="text-nowrap ps-3"><code>compile:all</code></td>
                                <td>Compiles all the <code>js, </code><code>scss, </code><code>pug </code>files from the
                                    <code>src</code> directory.</td>
                            </tr>
                            <tr>
                                <td class="text-nowrap ps-3"><code>vendor</code></td>
                                <td>Runs <code>vendor:clean</code> and <code>vendor:move</code> in series.</td>
                            ...
                            <tr>
                                <td class="text-nowrap ps-3"><code>vendor:clean</code></td>
                                <td>Delete the vendors from <code>public/vendors</code> directory which are included in
                                    <code>vendors.json</code>.</td>
                            </tr>
                            <tr>
                                <td class="text-nowrap ps-3"><code>vendor:move</code></td>
                                <td>Copies the vendors from <code>node_modules/</code> directory to
                                    <code>public/vendors</code> directory according to the <code>vendors.json</code>.</td>
                            </tr>
                            <tr>
                                <td class="text-nowrap ps-3"><code>watch</code></td>
                                <td>All of the following folders are monitored for changes, which will tell the browser to
