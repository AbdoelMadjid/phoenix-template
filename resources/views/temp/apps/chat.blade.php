          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link active label-1" href="{{ url('chat') }}" role="button" data-bs-toggle="" aria-expanded="false">
          ...
          <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li><a class="dropdown-item active" href="{{ url('chat') }}">
                ...
                <div data-chat-thread-tab-content="data-chat-thread-tab-content">
                  <ul class="nav chat-thread-tab flex-column list">
                    <li class="nav-item read" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2  active" data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-1" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/20.webp') }}" alt=""></div>
                    ...
                    <li class="nav-item read" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-2" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/29.webp') }}" alt=""></div>
                        <div class="flex-1 d-sm-none d-xl-block">
                          <div class="d-flex justify-content-between align-items-center">
                    ...
                    <li class="nav-item read" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-3" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/30.webp') }}" alt=""></div>
                        <div class="flex-1 d-sm-none d-xl-block">
                          <div class="d-flex justify-content-between align-items-center">
                    ...
                    <li class="nav-item unread" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2 unread " data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-4" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/25.webp') }}" alt=""><span class="bg-primary rounded-circle top-0 end-0 position-absolute text-white d-flex flex-center fs-10 fw-semibold d-none d-sm-flex d-xl-none lh-1" style="height: 1rem; width: 1rem;">3</span></div>
                        <div class="flex-1 d-sm-none d-xl-block">
                          <div class="d-flex justify-content-between align-items-center">
                    ...
                    <li class="nav-item read" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-5" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/15.webp') }}" alt=""></div>
                        <div class="flex-1 d-sm-none d-xl-block">
                          <div class="d-flex justify-content-between align-items-center">
                    ...
                    <li class="nav-item unread" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2 unread " data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-6" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/59.webp') }}" alt=""></div>
                        <div class="flex-1 d-sm-none d-xl-block">
                          <div class="d-flex justify-content-between align-items-center">
                    ...
                    <li class="nav-item read" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-7" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle avatar-placeholder" src="{{ asset('assets/img/team/avatar.webp') }}" alt=""></div>
                        <div class="flex-1 d-sm-none d-xl-block">
                          <div class="d-flex justify-content-between align-items-center">
                    ...
                    <li class="nav-item read" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-8" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/1.webp') }}" alt=""></div>
                        <div class="flex-1 d-sm-none d-xl-block">
                          <div class="d-flex justify-content-between align-items-center">
                    ...
                    <li class="nav-item read" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-9" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/6.webp') }}" alt=""></div>
                        <div class="flex-1 d-sm-none d-xl-block">
                          <div class="d-flex justify-content-between align-items-center">
                    ...
                    <li class="nav-item read" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-10" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/60.webp') }}" alt=""></div>
                        <div class="flex-1 d-sm-none d-xl-block">
                          <div class="d-flex justify-content-between align-items-center">
                    ...
                    <li class="nav-item read" role="presentation"><a class="nav-link d-flex align-items-center justify-content-center p-2  " data-bs-toggle="tab" data-chat-thread="data-chat-thread" href="#tab-thread-11" role="tab" aria-selected="true">
                        <div class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/57.webp') }}" alt=""></div>
                        <div class="flex-1 d-sm-none d-xl-block">
                          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="tab-pane h-100 fade active show" id="tab-thread-1" role="tabpanel" aria-labelledby="tab-thread-1">
              <div class="d-flex flex-column h-100">
                <div class="card-header p-3 p-md-4 d-flex flex-between-center">
                  ...
                  <div class="d-flex"><button class="btn btn-icon btn-primary me-1"><span class="fa-solid fa-phone"></span></button>
                    ...
                    <div class="d-flex mb-2 flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex hover-actions-trigger">
                          <div class="avatar avatar-m me-3 flex-shrink-0"><img class="rounded-circle" src="{{ asset('assets/img/team/20.webp') }}" alt=""></div>
                          ...
                          <div class="d-none d-sm-flex">
                            <div class="hover-actions position-relative align-self-center me-2"><button class="btn p-2 fs-10"><span class="fa-solid fa-reply"></span></button>
                          ...
                          <div class="d-sm-none hover-actions align-self-center me-2 end-0">
                            <div class="bg-body-emphasis rounded-pill d-flex align-items-center border px-2 actions"><button class="btn p-2" type="button"><span class="fa-solid fa-reply text-primary"></span></button>
                    ...
                    <div class="d-flex mb-2 justify-content-end flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex flex-end-center hover-actions-trigger">
                          ...
                          <div class="d-none d-sm-flex">
                            <div class="hover-actions position-relative align-self-center"><button class="btn p-2 fs-10"><span class="fa-solid fa-reply text-primary"></span></button>
                      ...
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex flex-end-center hover-actions-trigger">
                          ...
                          <div class="chat-message-content me-2 w-min-content">
                            <div class="mb-1 sent-message-content bg-primary rounded-2 p-3 text-white" data-bs-theme="light">
                              <p class="mb-0">Yes, in an organization stature</p><a href="{{ asset('assets/img/chat/1.png') }}" data-gallery="gallery-undefined"><img class="rounded-2 object-fit-cover mt-1" src="{{ asset('assets/img/chat/1.png') }}" alt="" style="max-width: 200px;"></a>
                            </div>
                          </div>
                        </div>
                        <div class="text-end">
                ...
                <div class="card-footer">
                  ...
                  <div class="d-flex justify-content-between align-items-end">
                    <div><button class="btn btn-link py-0 ps-0 pe-2 text-body fs-9 btn-emoji" data-picmo="data-picmo"><span class="fa-regular fa-face-smile"></span></button><label class="btn btn-link py-0 px-2 text-body fs-9" for="chatPhotos-0"><span class="fa-solid fa-image"></span></label><input class="d-none" type="file" accept="image/*" id="chatPhotos-0"><label class="btn btn-link py-0 px-2 text-body fs-9" for="chatAttachment-0"> <span class="fa-solid fa-paperclip"></span></label><input class="d-none" type="file" id="chatAttachment-0"><button class="btn btn-link py-0 px-2 text-body fs-9"><span class="fa-solid fa-microphone"></span></button>
                      <button class="btn btn-link py-0 px-2 text-body fs-9"><span class="fa-solid fa-ellipsis"></span></button>
                    </div>
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-0">
                  <div class="border-bottom border-translucent p-4">
                    <div class="d-flex flex-between-center"><button class="btn p-0" data-phoenix-dismiss="offcanvas"><span class="fa-solid fa-chevron-left text-body-tertiary"></span></button>
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/20.webp') }}" alt=""></div>
                      <h4 class="fw-semibold mb-3">Sharuka Nijibum</h4>
                      <div class="d-flex"><button class="btn btn-primary btn-icon fs-10 me-1"><span class="fas fa-phone"></span></button>
                        <button class="btn btn-primary btn-icon fs-10 me-1"><span class="fas fa-video"></span></button>
                        <button class="btn btn-phoenix-secondary btn-icon fs-10"><span class="fas fa-search"></span></button>
                      </div>
                    </div>
                  </div>
                  <div class="p-4 px-sm-5 scrollbar"><button class="btn d-block p-0 fw-semibold mb-3"><span class="fa-solid fa-user-pen me-3"></span>Nickname</button>
                    <button class="btn d-block p-0 fw-semibold mb-3"><span class="fa-solid fa-palette me-3"></span>Change Color</button>
                    <button class="btn d-block p-0 fw-semibold mb-5"><span class="fa-solid fa-user-plus me-3"></span>Create Group Chat</button>
                    <div class="d-flex mb-5"><span class="fa-solid fa-photo-film me-3 fs-9"></span>
                      <div>
                        <h6 class="fw-semibold mb-2">Shared Media</h6>
                        <div class="row g-2">
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/2.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/2.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/3.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/3.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/4.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/4.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/5.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/5.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/6.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/6.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/7.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/7.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/8.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/8.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/9.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/9.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/10.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/10.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/11.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/11.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/12.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/12.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/13.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/13.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/14.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/14.png') }}" alt="" height="100" width="100"></a></div>
                          <div class="col-auto"><a href="{{ asset('assets/img/chat/2.png') }}" data-gallery="gallery"> <img class="object-fit-cover rounded-2 bg-body-secondary-hover" src="{{ asset('assets/img/chat/2.png') }}" alt="" height="100" width="100"></a></div>
                        </div>
                      </div>
                    </div>
                    ...
                    </div><button class="btn d-block p-0 fw-semibold mb-3"><span class="fa-solid fa-bell-slash me-3"></span>Mute Conversation</button>
                    <button class="btn d-block p-0 fw-semibold mb-3"><span class="fa-solid fa-gear me-3"></span>Manage Settings</button>
                    <button class="btn d-block p-0 fw-semibold mb-3"><span class="fa-solid fa-hand-holding-heart me-3"></span>Get help</button>
                    <button class="btn d-block p-0 fw-semibold mb-3"><span class="fa-solid fa-flag me-3"></span>Report Account</button>
                    <button class="btn d-block p-0 fw-semibold"><span class="fa-solid fa-ban me-3"></span>Block Account</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="card-body p-3 p-sm-4 scrollbar chat-content-body-1">
                  ...
                  <div class="d-flex chat-message">
                    <div class="d-flex mb-2 flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex hover-actions-trigger">
                          <div class="avatar avatar-m me-3 flex-shrink-0"><img class="rounded-circle" src="{{ asset('assets/img/team/29.webp') }}" alt=""></div>
                          <div class="chat-message-content received me-2">
                            <div class="mb-1 received-message-content border rounded-2 p-3">
                          ...
                          <div class="chat-message-content me-2">
                            <div class="mb-1 sent-message-content gallery" data-bs-theme="light">
                              ...
                              <div class="row g-2 mt-0">
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/13.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/13.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/2.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/2.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/3.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/3.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/4.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/4.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/5.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/5.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/6.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/6.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/7.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/7.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/8.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/8.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/9.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/9.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/10.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/10.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/11.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/11.png') }}" alt=""></a></div>
                                <div class="col-6 col-md-4 ol-xl-2 col-xl-3"><a href="{{ asset('assets/img/chat/12.png') }}" data-gallery="gallery-undefined"> <img class="rounded-2 object-fit-cover img-fluid" src="{{ asset('assets/img/chat/12.png') }}" alt=""></a></div>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-1">
                  <div class="border-bottom border-translucent p-4">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/29.webp') }}" alt=""></div>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="card-body p-3 p-sm-4 scrollbar chat-content-body-2">
                  <div class="d-flex chat-message">
                    <div class="d-flex mb-2 flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex hover-actions-trigger">
                          <div class="avatar avatar-m me-3 flex-shrink-0"><img class="rounded-circle" src="{{ asset('assets/img/team/30.webp') }}" alt=""></div>
                          <div class="chat-message-content received me-2">
                            <div class="mb-1 received-message-content border rounded-2 p-3">
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-2">
                  <div class="border-bottom border-translucent p-4">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/30.webp') }}" alt=""></div>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="card-body p-3 p-sm-4 scrollbar chat-content-body-3">
                  ...
                  <div class="d-flex chat-message">
                    <div class="d-flex mb-2 flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex hover-actions-trigger">
                          <div class="avatar avatar-m me-3 flex-shrink-0"><img class="rounded-circle" src="{{ asset('assets/img/team/25.webp') }}" alt=""></div>
                          <div class="chat-message-content received me-2">
                            <div class="mb-1 received-message-content border rounded-2 p-3">
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-3">
                  <div class="border-bottom border-translucent p-4">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/25.webp') }}" alt=""></div>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-4">
                  <div class="border-bottom border-translucent p-4">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/15.webp') }}" alt=""></div>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="card-body p-3 p-sm-4 scrollbar chat-content-body-5">
                  <div class="d-flex chat-message">
                    <div class="d-flex mb-2 flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex hover-actions-trigger">
                          <div class="avatar avatar-m me-3 flex-shrink-0"><img class="rounded-circle" src="{{ asset('assets/img/team/59.webp') }}" alt=""></div>
                          <div class="chat-message-content received me-2">
                            <div class="mb-1 received-message-content border rounded-2 p-3">
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-5">
                  <div class="border-bottom border-translucent p-4">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/59.webp') }}" alt=""></div>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="card-body p-3 p-sm-4 scrollbar chat-content-body-6">
                  <div class="d-flex chat-message">
                    <div class="d-flex mb-2 flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex hover-actions-trigger">
                          <div class="avatar avatar-m me-3 flex-shrink-0"><img class="rounded-circle avatar-placeholder" src="{{ asset('assets/img/team/avatar.webp') }}" alt=""></div>
                          <div class="chat-message-content received me-2">
                            <div class="mb-1 received-message-content border rounded-2 p-3">
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-6">
                  <div class="border-bottom border-translucent p-4">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle avatar-placeholder" src="{{ asset('assets/img/team/avatar.webp') }}" alt=""></div>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="card-body p-3 p-sm-4 scrollbar chat-content-body-7">
                  <div class="d-flex chat-message">
                    <div class="d-flex mb-2 flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex hover-actions-trigger">
                          <div class="avatar avatar-m me-3 flex-shrink-0"><img class="rounded-circle" src="{{ asset('assets/img/team/1.webp') }}" alt=""></div>
                          <div class="chat-message-content received me-2">
                            <div class="mb-1 received-message-content border rounded-2 p-3">
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-7">
                  <div class="border-bottom border-translucent p-4">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/1.webp') }}" alt=""></div>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="card-body p-3 p-sm-4 scrollbar chat-content-body-8">
                  ...
                  <div class="d-flex chat-message">
                    <div class="d-flex mb-2 flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex hover-actions-trigger">
                          <div class="avatar avatar-m me-3 flex-shrink-0"><img class="rounded-circle" src="{{ asset('assets/img/team/6.webp') }}" alt=""></div>
                          <div class="chat-message-content received me-2">
                            <div class="mb-1 received-message-content border rounded-2 p-3">
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-8">
                  <div class="border-bottom border-translucent p-4">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/6.webp') }}" alt=""></div>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="card-body p-3 p-sm-4 scrollbar chat-content-body-9">
                  <div class="d-flex chat-message">
                    <div class="d-flex mb-2 flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex hover-actions-trigger">
                          <div class="avatar avatar-m me-3 flex-shrink-0"><img class="rounded-circle" src="{{ asset('assets/img/team/60.webp') }}" alt=""></div>
                          <div class="chat-message-content received me-2">
                            <div class="mb-1 received-message-content border rounded-2 p-3">
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-9">
                  <div class="border-bottom border-translucent p-4">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/60.webp') }}" alt=""></div>
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="card-body p-3 p-sm-4 scrollbar chat-content-body-10">
                  ...
                  <div class="d-flex chat-message">
                    <div class="d-flex mb-2 flex-1">
                      <div class="w-100 w-xxl-75">
                        <div class="d-flex hover-actions-trigger">
                          <div class="avatar avatar-m me-3 flex-shrink-0"><img class="rounded-circle" src="{{ asset('assets/img/team/57.webp') }}" alt=""></div>
                          <div class="chat-message-content received me-2">
                            <div class="mb-1 received-message-content border rounded-2 p-3">
                ...
                <div class="phoenix-offcanvas phoenix-offcanvas-top h-100 w-100 bg-body-emphasis scrollbar z-index-0 rounded" id="thread-details-10">
                  <div class="border-bottom border-translucent p-4">
                    ...
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="avatar avatar-4xl mb-2"><img class="rounded-circle border border-2 border-light-subtle" src="{{ asset('assets/img/team/57.webp') }}" alt=""></div>
