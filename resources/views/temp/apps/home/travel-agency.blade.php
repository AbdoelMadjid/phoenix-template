...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <body>
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-home">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="{{ url('travel-agency') }}">
        ...
        <div class="row gx-3">
              ...
              <div class="col-12 col-xl-7 col-xxl-12">
                <div class="mt-5 mt-xl-0 mt-xxl-5 mb-5 mb-xxl-0">
                  <div class="row flex-between-end gy-3 gx-2">
                    ...
                    <div class="col-12 col-sm-auto ms-auto order-1 order-sm-0 order-md-1 order-lg-0 order-xxl-1"><select class="form-select form-select-sm pe-9 w-auto" data-activities-options="data-activities-options">
                        <option value="0">Hotel</option>
                        <option value="1">Flight</option>
                        <option value="2">Trip</option>
                      </select></div>
                    <div class="col-auto order-md-1 order-lg-0 order-xxl-1">
                      <div class="dropdown"><button class="btn btn-sm btn-phoenix-secondary bg-body-emphasis bg-body-hover action-btn" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h" data-fa-transform="shrink-2"></span></button>
                        <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="#">Action</a><a class="dropdown-item" href="#">Another action</a><a class="dropdown-item" href="#">Something else here</a></div>
                      </div>
                    </div>
                    <div class="col-12 col-md-auto col-lg-12 col-xxl-auto mx-auto order-1 order-sm-0">
                      <div class="d-flex justify-content-center gap-6 gap-xxl-4"><button class="btn d-flex align-items-center p-0 shadow-none fw-semibold" id="profit"><span class="bg-primary-light me-2" style="width: 16px; height: 6px; border-radius: 1px" data-bs-theme="light"></span><span class="text-body-secondary">Profit</span></button>
          ...
          <div class="col-xxl-5">
            <div class="row g-3">
                    ...
                    <div class="table-responsive scrollbar mt-3">
                      <table class="table fs-10 mb-0">
                        ...
                        <tbody class="list" id="table-country-wise-visitors">
                          <tr>
                            <td class="py-2 white-space-nowrap ps-0 country"><a class="d-flex align-items-center text-primary py-md-1 py-xxl-0" href="#!"><img src="{{ asset('assets/img/country/india-2.png') }}" alt="" width="40">
                          ...
                          <tr>
                            <td class="py-2 white-space-nowrap ps-0 country"><a class="d-flex align-items-center text-primary py-md-1 py-xxl-0" href="#!"><img src="{{ asset('assets/img/country/china-2.png') }}" alt="" width="40">
                          ...
                          <tr>
                            <td class="py-2 white-space-nowrap ps-0 country"><a class="d-flex align-items-center text-primary py-md-1 py-xxl-0" href="#!"><img src="{{ asset('assets/img/country/usa-2.png') }}" alt="" width="40">
              ...
              <div class="col-12">
                <div class="card mb-3">
                  <div class="bg-holder bg-card" style="background-image:url({{ asset('assets/img/spot-illustrations/39.png') }});background-position: bottom right 0px; background-size: auto;"></div>
                  <!--/.bg-holder-->
          ...
          <div class="col-xl-7 col-xxl-5">
            <div class="card h-100">
              <div class="card-header pb-3 d-sm-flex d-xl-block d-xxl-flex justify-content-between align-items-start">
                ...
                </div><select class="form-select form-select-sm pe-9 w-auto mt-3 mt-sm-0 mt-xl-3 mt-xxl-0" data-booking-options="data-booking-options">
                  <option value="0">Hotel</option>
                  <option value="1">Flight</option>
                  <option value="2">Trip</option>
                </select>
          ...
          <div data-list='{"valueNames":["flightNo","vendor","weather","route","destination","status","time"],"page":4}'>
                ...
                <div class="d-flex flex-between-center">
                  <div class="d-flex align-items-center">
                    <div class="search-box ms-xl-6 w-auto">
                      <form class="position-relative"><input class="form-control search-input search" type="search" placeholder="Search by Flight no." aria-label="Search">
                        <span class="fas fa-search search-box-icon"></span>
                      </form>
                    </div><button class="btn btn-phoenix-secondary px-3 ms-2 me-3"><span class="fa-solid fa-filter text-body-secondary" data-fa-transform="down-2"></span></button>
                  </div>
                  <div class="d-flex align-items-center">
                    <div class="pagination d-none"></div>
                    <p class="mb-0 d-none d-md-block me-3 fw-semibold text-body text-nowrap" data-list-info="data-list-info"></p>
                    <div class="d-none d-sm-block"><a class="fw-semibold text-nowrap" href="#!" data-list-view="*">View all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a><a class="fw-semibold d-none text-nowrap" href="#!" data-list-view="less">View Less</a></div><button class="btn btn-phoenix-primary px-3 me-1 ms-sm-4" type="button" title="Previous" data-list-pagination="prev"><span class="fas fa-chevron-left" data-fa-transform="down-1"></span></button>
                    <button class="btn btn-phoenix-primary px-3" type="button" title="Next" data-list-pagination="next"><span class="fas fa-chevron-right" data-fa-transform="down-1"></span></button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <thead>
                  <tr>
                    <th class="white-space-nowrap px-0 py-1">
                      <div class="form-check mb-0 fs-8"><input class="form-check-input" id="checkbox-bulk-flights-select" type="checkbox" data-bulk-select='{"body":"table-flights-body"}'></div>
                    </th>
                    <th class="sort white-space-nowrap align-middle text-body-tertiary ps-0" scope="col" data-sort="flightNo">FLIGHTS NO.</th>
                    <th class="sort align-middle text-body-tertiary" scope="col" data-sort="vendor" style="width:170px;">VENDOR</th>
                    <th class="sort text-start align-middle text-body-tertiary" scope="col" data-sort="weather" style="width:250px;">WEATHER</th>
                    <th class="sort align-middle text-body-tertiary" scope="col" data-sort="route" style="width:180px;">ROUTE</th>
                    <th class="sort align-middle text-body-tertiary" scope="col" style="min-width:280px;" data-sort="destination">DESTINATION</th>
                    <th class="sort text-end align-middle text-body-tertiary" scope="col" data-sort="status" style="min-width:120px;">STATUS</th>
                    <th class="sort align-middle text-end text-body-tertiary" scope="col" data-sort="time" style="min-width:200px;">TIME</th>
                ...
                <tbody class="list" id="table-flights-body">
                  <tr>
                    <td class="fs-9 align-middle px-0">
                      <div class="form-check mb-0 fs-8"><input class="form-check-input" type="checkbox" data-bulk-select-row='{"flightNo":"#24349","vendor":{"image":"/img/brands/phoenix-firelines.png","name":"Phoenix Firelines"},"route":{"from":{"flag":"/img/country/usa.png","airport":"LAX"},"to":{"flag":"/img/country/canada.png","airport":"YVR"}},"destination":{"currentPosition":"180 km, 00h:15m ago","target":"955 km, in 01h:25m","percent":25},"weather":{"temperature":15,"weather":"Stormy","icon":"fa-solid fa-cloud-bolt","color":"text-body-tertiary"},"time":{"time":"08:26 PM","date":"Sunday, Nov 06, 2022"},"status":{"label":"Delayed","type":"warning"}}'></div>
                    </td>
                    <td class="align-middle flightNo ps-0"><a class="fw-bold" href="#!">#24349</a></td>
                    <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2" href="#!"><img src="{{ asset('assets/img/brands/phoenix-firelines.png') }}" alt="" width="32">
                        <h6 class="mb-0 text-primary fw-semibold text-nowrap">Phoenix Firelines</h6>
                      </a></td>
                    <td class="align-middle weather pe-5">
                      <div class="d-flex align-items-center"><span class="fa-solid fa-temperature-quarter me-2 text-info"></span>
                        <p class="mb-0 text-body-tertiary me-3">15°C</p><span class="me-2 fa-solid fa-cloud-bolt text-body-tertiary"></span>
                        <p class="mb-0 text-body-tertiary">Stormy</p>
                      </div>
                    </td>
                    <td class="align-middle route pe-5">
                      <div class="d-flex align-items-center gap-2"><img src="{{ asset('assets/img/country/usa.png') }}" alt="" width="16">
                        <p class="mb-0 fw-semibold text-bold">LAX</p><span class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                        <p class="mb-0 fw-semibold text-bold">YVR</p><img src="{{ asset('assets/img/country/canada.png') }}" alt="" width="16">
                      </div>
                    </td>
                    <td class="align-middle destination pe-5 pe-xxl-7">
                      <div class="progress overflow-visible" role="progressbar" aria-label="flight-progress-bar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="height: 2px">
                        <div class="progress-bar overflow-visible position-relative bg-info-light rounded" style="width: 25%"><span class="fa-solid fa-plane text-info position-absolute end-0"></span></div>
                      </div>
                    ...
                    <td class="status align-middle text-end"><span class="badge badge-phoenix fs-10 badge-phoenix-warning">Delayed</span></td>
                    <td class="align-middle text-end time">
                      <div class="d-flex justify-content-end align-items-center gap-2 mb-2"><span class="fa-regular fa-clock text-body"> </span><span class="text-body fw-semibold">08:26 PM</span></div>
                      <div class="d-flex justify-content-end gap-2"><span class="text-body" data-feather="calendar" style="width:16px; height:16px"></span><span class="text-body fw-semibold">Sunday, Nov 06, 2022</span></div>
                    </td>
                    <td class="align-middle text-end">
                      <div class="btn-reveal-trigger"><button class="btn btn-sm ms-auto dropdown-toggle dropdown-caret-none transition-none d-flex btn-reveal" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h"></span></button>
                        <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="#!">Track flight</a><a class="dropdown-item" href="#!">Download</a><a class="dropdown-item" href="#!">Report abuse</a></div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td class="fs-9 align-middle px-0">
                      <div class="form-check mb-0 fs-8"><input class="form-check-input" type="checkbox" data-bulk-select-row='{"flightNo":"#23421","vendor":{"image":"/img/brands/qatar-airways.png","name":"Qatar Airways"},"route":{"from":{"flag":"/img/country/denmark.png","airport":"EBJ"},"to":{"flag":"/img/country/south-korea.png","airport":"CDG"}},"destination":{"currentPosition":"600 km, 02h:15m ago","target":"1,200 km, in 02h:25m","percent":60},"weather":{"temperature":28,"weather":"Sunny","icon":"fa-solid fa-sun","color":"text-warning"},"time":{"time":"07:23 PM","date":"Monday, Nov 05, 2022"},"status":{"label":"On Time","type":"primary"}}'></div>
                    </td>
                    <td class="align-middle flightNo ps-0"><a class="fw-bold" href="#!">#23421</a></td>
                    <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2" href="#!"><img src="{{ asset('assets/img/brands/qatar-airways.png') }}" alt="" width="32">
                        <h6 class="mb-0 text-primary fw-semibold text-nowrap">Qatar Airways</h6>
                      </a></td>
                    <td class="align-middle weather pe-5">
                      <div class="d-flex align-items-center"><span class="fa-solid fa-temperature-quarter me-2 text-danger"></span>
                        <p class="mb-0 text-body-tertiary me-3">28°C</p><span class="me-2 fa-solid fa-sun text-warning"></span>
                        <p class="mb-0 text-body-tertiary">Sunny</p>
                      </div>
                    </td>
                    <td class="align-middle route pe-5">
                      <div class="d-flex align-items-center gap-2"><img src="{{ asset('assets/img/country/denmark.png') }}" alt="" width="16">
                        <p class="mb-0 fw-semibold text-bold">EBJ</p><span class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                        <p class="mb-0 fw-semibold text-bold">CDG</p><img src="{{ asset('assets/img/country/south-korea.png') }}" alt="" width="16">
                      </div>
                    </td>
                    <td class="align-middle destination pe-5 pe-xxl-7">
                      <div class="progress overflow-visible" role="progressbar" aria-label="flight-progress-bar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="height: 2px">
                        <div class="progress-bar overflow-visible position-relative bg-info-light rounded" style="width: 60%"><span class="fa-solid fa-plane text-info position-absolute end-0"></span></div>
                      </div>
                      <div class="d-flex justify-content-between mt-2">
                    ...
                    <td class="status align-middle text-end"><span class="badge badge-phoenix fs-10 badge-phoenix-primary">On Time</span></td>
                    <td class="align-middle text-end time">
                      <div class="d-flex justify-content-end align-items-center gap-2 mb-2"><span class="fa-regular fa-clock text-body"> </span><span class="text-body fw-semibold">07:23 PM</span></div>
                      <div class="d-flex justify-content-end gap-2"><span class="text-body" data-feather="calendar" style="width:16px; height:16px"></span><span class="text-body fw-semibold">Monday, Nov 05, 2022</span></div>
                    </td>
                    <td class="align-middle text-end">
                      <div class="btn-reveal-trigger"><button class="btn btn-sm ms-auto dropdown-toggle dropdown-caret-none transition-none d-flex btn-reveal" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h"></span></button>
                        <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item" href="#!">Track flight</a><a class="dropdown-item" href="#!">Download</a><a class="dropdown-item" href="#!">Report abuse</a></div>
                  ...
                  <tr>
                    <td class="fs-9 align-middle px-0">
                      <div class="form-check mb-0 fs-8"><input class="form-check-input" type="checkbox" data-bulk-select-row='{"flightNo":"#23132","vendor":{"image":"/img/brands/jal.png","name":"Japan Airlines"},"route":{"from":{"flag":"/img/country/china.png","airport":"GOT"},"to":{"flag":"/img/country/usa.png","airport":"BCN"}},"destination":{"currentPosition":"500 km, 00h:56m ago","target":"3,455 km, in 03h:25m","percent":25},"weather":{"temperature":22,"weather":"Wind","icon":"fa-solid fa-wind","color":"text-info"},"time":{"time":"07:23 PM","date":"Monday, Nov 05, 2022"},"status":{"label":"Departure","type":"success"}}'></div>
                    </td>
                    <td class="align-middle flightNo ps-0"><a class="fw-bold" href="#!">#23132</a></td>
                    <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2" href="#!"><img src="{{ asset('assets/img/brands/jal.png') }}" alt="" width="32">
                        <h6 class="mb-0 text-primary fw-semibold text-nowrap">Japan Airlines</h6>
                      </a></td>
                    <td class="align-middle weather pe-5">
                      <div class="d-flex align-items-center"><span class="fa-solid fa-temperature-quarter me-2 text-info"></span>
                        <p class="mb-0 text-body-tertiary me-3">22°C</p><span class="me-2 fa-solid fa-wind text-info"></span>
                        <p class="mb-0 text-body-tertiary">Wind</p>
                      </div>
                    </td>
                    <td class="align-middle route pe-5">
                      <div class="d-flex align-items-center gap-2"><img src="{{ asset('assets/img/country/china.png') }}" alt="" width="16">
                        <p class="mb-0 fw-semibold text-bold">GOT</p><span class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                        <p class="mb-0 fw-semibold text-bold">BCN</p><img src="{{ asset('assets/img/country/usa.png') }}" alt="" width="16">
                      </div>
                    </td>
                    <td class="align-middle destination pe-5 pe-xxl-7">
                      <div class="progress overflow-visible" role="progressbar" aria-label="flight-progress-bar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="height: 2px">
                    ...
                    <td class="status align-middle text-end"><span class="badge badge-phoenix fs-10 badge-phoenix-success">Departure</span></td>
                    <td class="align-middle text-end time">
                      <div class="d-flex justify-content-end align-items-center gap-2 mb-2"><span class="fa-regular fa-clock text-body"> </span><span class="text-body fw-semibold">07:23 PM</span></div>
                      <div class="d-flex justify-content-end gap-2"><span class="text-body" data-feather="calendar" style="width:16px; height:16px"></span><span class="text-body fw-semibold">Monday, Nov 05, 2022</span></div>
                    </td>
                  ...
                  <tr>
                    <td class="fs-9 align-middle px-0">
                      <div class="form-check mb-0 fs-8"><input class="form-check-input" type="checkbox" data-bulk-select-row='{"flightNo":"#22267","vendor":{"image":"/img/brands/emirates.png","name":"Emirate"},"route":{"from":{"flag":"/img/country/qatar.png","airport":"DIA"},"to":{"flag":"/img/country/norway.png","airport":"OSL"}},"destination":{"currentPosition":"00 km, 00h:00m ago","target":"00 km, in 00h:00m","percent":0},"weather":{"temperature":5,"weather":"Heavy rain","icon":"fa-solid fa-cloud-showers-heavy","color":"text-danger"},"time":{"time":"07:23 PM","date":"Monday, Nov 05, 2022"},"status":{"label":"Cancelled","type":"danger"}}'></div>
                    </td>
                    <td class="align-middle flightNo ps-0"><a class="fw-bold" href="#!">#22267</a></td>
                    <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2" href="#!"><img src="{{ asset('assets/img/brands/emirates.png') }}" alt="" width="32">
                        <h6 class="mb-0 text-primary fw-semibold text-nowrap">Emirate</h6>
                      </a></td>
                    <td class="align-middle weather pe-5">
                      <div class="d-flex align-items-center"><span class="fa-solid fa-temperature-quarter me-2 text-info"></span>
                        <p class="mb-0 text-body-tertiary me-3">5°C</p><span class="me-2 fa-solid fa-cloud-showers-heavy text-danger"></span>
                        <p class="mb-0 text-body-tertiary">Heavy rain</p>
                      </div>
                    </td>
                    <td class="align-middle route pe-5">
                      <div class="d-flex align-items-center gap-2"><img src="{{ asset('assets/img/country/qatar.png') }}" alt="" width="16">
                        <p class="mb-0 fw-semibold text-bold">DIA</p><span class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                        <p class="mb-0 fw-semibold text-bold">OSL</p><img src="{{ asset('assets/img/country/norway.png') }}" alt="" width="16">
                      </div>
                    </td>
                    <td class="align-middle destination pe-5 pe-xxl-7">
                      <div class="progress overflow-visible" role="progressbar" aria-label="flight-progress-bar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="height: 2px">
                        <div class="progress-bar overflow-visible position-relative bg-info-light rounded" style="width: 0%"></div>
                      </div>
                      <div class="d-flex justify-content-between mt-2">
                    ...
                    <td class="status align-middle text-end"><span class="badge badge-phoenix fs-10 badge-phoenix-danger">Cancelled</span></td>
                    <td class="align-middle text-end time">
                      <div class="d-flex justify-content-end align-items-center gap-2 mb-2"><span class="fa-regular fa-clock text-body"> </span><span class="text-body fw-semibold">07:23 PM</span></div>
                      <div class="d-flex justify-content-end gap-2"><span class="text-body" data-feather="calendar" style="width:16px; height:16px"></span><span class="text-body fw-semibold">Monday, Nov 05, 2022</span></div>
                    </td>
                  ...
                  <tr>
                    <td class="fs-9 align-middle px-0">
                      <div class="form-check mb-0 fs-8"><input class="form-check-input" type="checkbox" data-bulk-select-row='{"flightNo":"#41242","vendor":{"image":"/img/brands/emirates.png","name":"Emirate"},"route":{"from":{"flag":"/img/country/qatar.png","airport":"DIA"},"to":{"flag":"/img/country/norway.png","airport":"OSL"}},"destination":{"currentPosition":"26512 km, .02h:56m ago","target":"3,455 km, in 03h:25m","percent":75},"weather":{"temperature":5,"weather":"Heavy rain","icon":"fa-solid fa-cloud-showers-heavy","color":"text-danger"},"time":{"time":"07:23 PM","date":"Monday, Nov 05, 2022"},"status":{"label":"On Time","type":"primary"}}'></div>
                    </td>
                    ...
                    <td class="align-middle destination pe-5 pe-xxl-7">
                      <div class="progress overflow-visible" role="progressbar" aria-label="flight-progress-bar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="height: 2px">
                        <div class="progress-bar overflow-visible position-relative bg-info-light rounded" style="width: 75%"><span class="fa-solid fa-plane text-info position-absolute end-0"></span></div>
                      </div>
                      <div class="d-flex justify-content-between mt-2">
            ...
            <div class="mapbox-container">
              <div class="position-relative">
                ...
                <div class="mapbox-control-btn flight-map-control-btn"><button class="zoomIn d-none d-md-block"><span class="fa-solid fa-plus"></span></button>
                  <button class="zoomOut d-none d-md-block"><span class="fa-solid fa-minus"></span></button>
                  <button class="fullScreen mt-md-3"><span class="fa-solid fa-up-right-and-down-left-from-center"></span></button>
                </div>
              </div>
              <div class="position-absolute top-0 w-100 mt-3 mt-md-5 px-3 px-md-5 px-xl-7">
                <div class="d-flex align-items-center bg-secondary overflow-hidden rounded-1" style="height: 46px">
                  <div class="h-100 px-3 d-flex align-items-center bg-danger-subtle position-relative z-5"><span class="fa-solid fa-circle text-danger me-md-2"></span>
                    <h3 class="mb-0 fw-bold text-nowrap d-none d-md-block">Live Tracking</h3>
                  </div>
                  <div class="swiper-theme-container w-100">
                    <div class="swiper theme-slider" data-swiper='{"loop":true,"spaceBetween":40,"centeredSlides":true,"slidesPerView":"auto","autoplay":{"delay":0},"speed":4000,"grabCursor":true}'>
                      <div class="swiper-wrapper swiper-continuous-autoplay">
                        <div class="swiper-slide w-auto">
                          <div class="d-flex align-items-center">
                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">1</h6><img class="me-1" src="{{ asset('assets/img/brands/emirates.png') }}" alt="" width="16">
                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span class="fa-solid fa-plane text-primary mx-2"></span>
                            <h6 class="mb-0 fw-semibold text-white border-end pe-6">LAX</h6>
                          </div>
                        </div>
                        <div class="swiper-slide w-auto">
                          <div class="d-flex align-items-center">
                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">2</h6><img class="me-1" src="{{ asset('assets/img/brands/phoenix-firelines.png') }}" alt="" width="16">
                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span class="fa-solid fa-plane text-primary mx-2"></span>
                            <h6 class="mb-0 fw-semibold text-white border-end pe-6">LAX</h6>
                          </div>
                        ...
                        <div class="swiper-slide w-auto">
                          <div class="d-flex align-items-center">
                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">3</h6><img class="me-1" src="{{ asset('assets/img/brands/qatar-airways.png') }}" alt="" width="16">
                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span class="fa-solid fa-plane text-primary mx-2"></span>
                            <h6 class="mb-0 fw-semibold text-white border-end pe-6">LAX</h6>
                          </div>
                        ...
                        <div class="swiper-slide w-auto">
                          <div class="d-flex align-items-center">
                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">4</h6><img class="me-1" src="{{ asset('assets/img/brands/jal.png') }}" alt="" width="16">
                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span class="fa-solid fa-plane text-primary mx-2"></span>
                            <h6 class="mb-0 fw-semibold text-white border-end pe-6">LAX</h6>
                          </div>
                        ...
                        <div class="swiper-slide w-auto">
                          <div class="d-flex align-items-center">
                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">5</h6><img class="me-1" src="{{ asset('assets/img/brands/jal.png') }}" alt="" width="16">
                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span class="fa-solid fa-plane text-primary mx-2"></span>
                            <h6 class="mb-0 fw-semibold text-white border-end pe-6">LAX</h6>
                          </div>
              ...
              <div class="flight-desc-card p-3 bg-body-emphasis rounded-3">
                ...
                <div class="d-flex align-items-center gap-2 mt-3">
                  ...
                  <div class="progress flex-1" role="progressbar" aria-label="flight-destination-progress" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                    <div class="progress-bar bg-info overflow-visible" style="width: 50%"><span class="fa-solid fa-plane text-info position-absolute end-0"></span></div>
                  </div>
    ...
    <script src="{{ asset('assets/js/dashboards/travel-agency-dashboard.js') }}"></script>
    <script src="{{ asset('vendors/mapbox-gl/mapbox-gl.js') }}"></script>
    <script src="{{ asset('assets/external/@turf/turf@6.5.0/turf.min.js') }}"></script>
