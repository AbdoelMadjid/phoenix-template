                ...
                <div class="col-12 col-xl-7 col-xxl-12">
                    <div class="mt-5 mt-xl-0 mt-xxl-5 mb-5 mb-xxl-0">
                        <div class="row flex-between-end gy-3 gx-2">
                            ...
                            <div class="col-12 col-sm-auto ms-auto order-1 order-sm-0 order-md-1 order-lg-0 order-xxl-1">
                            ...
                            <div class="col-12 col-md-auto col-lg-12 col-xxl-auto mx-auto order-1 order-sm-0">
                                <div class="d-flex justify-content-center gap-6 gap-xxl-4"><button
                                        ...
                                        id="profit"><span class="bg-primary-light me-2"
                                            ...
                                            class="text-body-secondary">Profit</span></button>
                                    <button class="btn d-flex align-items-center p-0 shadow-none fw-semibold"
                                        id="revenue"><span class="bg-success-light me-2"
                                            style="width: 16px; height: 6px; border-radius: 1px"
                                            data-bs-theme="light"></span><span
                                            class="text-body-secondary">Revenue</span></button>
                                    <button class="btn d-flex align-items-center p-0 shadow-none fw-semibold"
                                        id="expanses"><span class="bg-info-light me-2"
                                            style="width: 16px; height: 6px; border-radius: 1px"
                                            data-bs-theme="light"></span><span
                                            class="text-body-secondary">Expanses</span></button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-3">
                                    ...
                                    <tbody class="list" id="table-country-wise-visitors">
                                        <tr>
                                            <td class="py-2 white-space-nowrap ps-0 country"><a
                                                    ...
                                                    href="#!"><img
                                                        src="{{ asset('assets/img/country/india-2.png') }}" alt=""
                                                        width="40">
                                                    <p class="mb-0 ps-3 fw-bold fs-9">India</p>
                                                </a></td>
                                            <td class="py-2 align-middle users">
                                                <h6>92,896<span class="text-body-tertiary fw-semibold ms-2">(41.6%)</span>
                                                </h6>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="py-2 white-space-nowrap ps-0 country"><a
                                                    class="d-flex align-items-center text-primary py-md-1 py-xxl-0"
                                                    href="#!"><img
                                                        src="{{ asset('assets/img/country/china-2.png') }}" alt=""
                                                        width="40">
                                                    <p class="mb-0 ps-3 fw-bold fs-9">China</p>
                                                </a></td>
                                            <td class="py-2 align-middle users">
                                                <h6>50,496<span class="text-body-tertiary fw-semibold ms-2">(32.8%)</span>
                                                </h6>
                                            </td>
                                            <td class="py-2 align-middle text-end status"><span
                                        ...
                                        <tr>
                                            <td class="py-2 white-space-nowrap ps-0 country"><a
                                                    class="d-flex align-items-center text-primary py-md-1 py-xxl-0"
                                                    href="#!"><img src="{{ asset('assets/img/country/usa-2.png') }}"
                                                        alt="" width="40">
                                                    <p class="mb-0 ps-3 fw-bold fs-9">USA</p>
                                                </a></td>
                                            <td class="py-2 align-middle users">
                                                <h6>45,679<span class="text-body-tertiary fw-semibold ms-2">(24.3%)</span>
                                                </h6>
                                            </td>
                                            <td class="py-2 align-middle text-end status"><span
                ...
                <div class="col-12 col-md-6 col-xxl-12">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="echart-holidays-next-month" style="height: 100%; min-height: 300px; width: 100%">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="card mb-3">
                        <div class="bg-holder bg-card"
                            style="background-image:url({{ asset('assets/img/spot-illustrations/39.png') }});background-position: bottom right 0px; background-size: auto;">
                        </div>
                        <!--/.bg-holder-->
                        <div class="card-body z-5">
                            <div>
                                <h3 class="text-body-highlight mb-3">Phoenix integrations</h3>
                                <p class="text-body-tertiary mb-4 w-75 w-xl-100">Phoenix improves efficiency instantly and
                                    effortlessly <br class="d-none d-xxl-block"> by allowing easy & simple connection <br
                                        class="d-none d-xl-block"> to other popular programs</p><a
        ...
        <div data-list='{"valueNames":["flightNo","vendor","weather","route","destination","status","time"],"page":4}'>
                ...
                <div class="col-auto flex-1">
                    <div class="d-flex flex-between-center">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <button class="btn btn-phoenix-primary px-3" type="button" title="Next"
                    ...
                    <tbody class="list" id="table-flights-body">
                        <tr>
                            ...
                            <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2"
                                    href="#!"><img src="{{ asset('assets/img/brands/phoenix-firelines.png') }}"
                                        alt="" width="32">
                            ...
                            <td class="align-middle route pe-5">
                                <div class="d-flex align-items-center gap-2"><img
                                        src="{{ asset('assets/img/country/usa.png') }}" alt="" width="16">
                                    ...
                                    <p class="mb-0 fw-semibold text-bold">YVR</p><img
                                        src="{{ asset('assets/img/country/canada.png') }}" alt="" width="16">
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2"
                                    href="#!"><img src="{{ asset('assets/img/brands/qatar-airways.png') }}"
                                        alt="" width="32">
                            ...
                            <td class="align-middle route pe-5">
                                <div class="d-flex align-items-center gap-2"><img
                                        src="{{ asset('assets/img/country/denmark.png') }}" alt=""
                                        width="16">
                                    <p class="mb-0 fw-semibold text-bold">EBJ</p><span
                                        class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                                    <p class="mb-0 fw-semibold text-bold">CDG</p><img
                                        src="{{ asset('assets/img/country/south-korea.png') }}" alt=""
                                        width="16">
                                </div>
                            </td>
                            <td class="align-middle destination pe-5 pe-xxl-7">
                        ...
                        <tr>
                            ...
                            <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2"
                                    href="#!"><img src="{{ asset('assets/img/brands/jal.png') }}" alt=""
                                        width="32">
                            ...
                            <td class="align-middle route pe-5">
                                <div class="d-flex align-items-center gap-2"><img
                                        src="{{ asset('assets/img/country/china.png') }}" alt="" width="16">
                        ...
                        <tr>
                            ...
                            <td class="align-middle vendor pe-5"><a class="d-flex align-items-center gap-2"
                                    href="#!"><img src="{{ asset('assets/img/brands/emirates.png') }}"
                                        alt="" width="32">
                            ...
                            <td class="align-middle route pe-5">
                                <div class="d-flex align-items-center gap-2"><img
                                        src="{{ asset('assets/img/country/qatar.png') }}" alt="" width="16">
                                    <p class="mb-0 fw-semibold text-bold">DIA</p><span
                                        class="fa-solid fa-arrow-right text-body-tertiary mx-1"></span>
                                    <p class="mb-0 fw-semibold text-bold">OSL</p><img
                                        src="{{ asset('assets/img/country/norway.png') }}" alt=""
                                        width="16">
                                </div>
                            </td>
                            <td class="align-middle destination pe-5 pe-xxl-7">
            ...
            <div class="mapbox-container">
                <div class="position-relative">
                    ...
                    <div class="mapbox-control-btn flight-map-control-btn"><button class="zoomIn d-none d-md-block"><span
                                class="fa-solid fa-plus"></span></button>
                        <button class="zoomOut d-none d-md-block"><span class="fa-solid fa-minus"></span></button>
                        <button class="fullScreen mt-md-3"><span
                                class="fa-solid fa-up-right-and-down-left-from-center"></span></button>
                    </div>
                </div>
                                    ...
                                    <div class="swiper-slide w-auto">
                                        <div class="d-flex align-items-center">
                                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">1</h6><img
                                                class="me-1" src="{{ asset('assets/img/brands/emirates.png') }}"
                                                alt="" width="16">
                                    ...
                                    <div class="swiper-slide w-auto">
                                        <div class="d-flex align-items-center">
                                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">2</h6><img
                                                class="me-1"
                                                src="{{ asset('assets/img/brands/phoenix-firelines.png') }}"
                                                alt="" width="16">
                                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span
                                                class="fa-solid fa-plane text-primary mx-2"></span>
                                    ...
                                    <div class="swiper-slide w-auto">
                                        <div class="d-flex align-items-center">
                                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">3</h6><img
                                                class="me-1" src="{{ asset('assets/img/brands/qatar-airways.png') }}"
                                                alt="" width="16">
                                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span
                                                class="fa-solid fa-plane text-primary mx-2"></span>
                                    ...
                                    <div class="swiper-slide w-auto">
                                        <div class="d-flex align-items-center">
                                            <h6 class="px-3 py-2 bg-primary-subtle mb-0 fs-10 rounded-1 me-2">4</h6><img
                                                class="me-1" src="{{ asset('assets/img/brands/jal.png') }}"
                                                alt="" width="16">
                                            <h6 class="mb-0 text-white fw-semibold me-3 text-nowrap">EK204 (AK98)</h6>
                                            <h6 class="mb-0 fw-semibold text-white">RIG</h6><span
                                                class="fa-solid fa-plane text-primary mx-2"></span>
