...
@section('content')
    ...
    <div class="mb-7">
        ...
        <div data-list='{"valueNames":["name","beds","guest","bathRooms","amenities","totalRooms"],"page":8}'>
            <div class="d-md-flex mt-5 mb-4"><button class="btn btn-primary me-4"><span
                        class="fas fa-plus me-2"></span>Create Listing</button>
                ...
                <table class="table fs-9 mb-0">
                        ...
                        <tr>
                            <th class="white-space-nowrap fs-9 align-middle ps-0" style="max-width:20px; width:18px;">
                                <div class="form-check mb-0 fs-8"><input class="form-check-input"
                                        ...
                                        data-bulk-select='{"body":"room-listing-table-body"}'></div>
                            </th>
                            <th class="sort text-body-tertiary align-middle white-space-nowrap" scope="col"
                                data-sort="name" style="width:300px;">ROOM INFORMATION</th>
                            <th class="sort text-body-tertiary align-middle px-4" scope="col" style="width:200px;"
                                data-sort="beds">NO. OF BEDS</th>
                            <th class="sort text-body-tertiary align-middle px-4" scope="col" data-sort="guest"
                                style="width:200px;">NO. OF GUESTS</th>
                            <th class="sort text-body-tertiary align-middle px-4" scope="col" data-sort="bathRooms"
                                style="width:140px;">BATHROOM</th>
                            <th class="text-body-tertiary align-middle ps-4" scope="col" data-sort="amenities"
                                style="min-width:450px;">AMENITIES</th>
                            <th class="sort text-body-tertiary align-middle ps-4 text-end" scope="col"
                                data-sort="totalRooms" style="width:180px;">TOTAL ROOM</th>
                    ...
                    <tbody class="list" id="room-listing-table-body">
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="fs-9 align-middle ps-0">
                                <div class="form-check mb-0 fs-8"><input class="form-check-input" type="checkbox"
                                        data-bulk-select-row='{"name":"Bunk Bed","category":"Standard Room","price":332.67,"img":"/img/hotels/17.png","bedRooms":"01","beds":"02","guest":"02","child":"01","bathRooms":"01","totalRooms":65,"amenities":["wifi","tv","common area","bathtub","Heating","Telephone","Television","common area","Kettle","iron","Coffee maker","refrigerator","Room service","Coffee maker","refrigerator","Room service","common area","bathtub","Heating","Telephone"]}'>
                                </div>
                            </td>
                            <td class="align-middle py-4 name">
                                <div class="d-flex align-items-center gap-3"><a href="#!"> <img
                                            class="rounded-1 border border-translucent"
                                            src="{{ asset('assets/img/hotels/17.png') }}" alt="" width="80"></a>
                                    <div> <a class="fs-8 fw-bolder text-body-emphasis text-nowrap" href="#!">Bunk
                                            Bed</a>
                                        <h6 class="fw-seibold text-body text-nowrap mt-1 mb-2"><span
                                                class="fa-solid fa-border-all me-2"></span>Standard Room</h6>
                            ...
                            <td class="align-middle px-4 beds">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center justify-content-center bg-primary-subtle rounded me-2"
                                    ...
                                    <div class="d-flex align-items-center justify-content-center bg-success-subtle rounded me-2"
                                        style="height:24px; width: 24px"><span
                            ...
                            <td class="align-middle px-4 guest">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center justify-content-center bg-warning-subtle rounded me-2"
                                        style="height:24px; width: 24px"><span
                                            class="fa-solid fa-user text-warning-darker"></span></div>
                                    <h5 class="text-body-emphasis fw-semibold mb-0 me-3">02</h5>
                                    <div class="d-flex align-items-center justify-content-center bg-info-subtle rounded me-2"
                                        style="height:24px; width: 24px"><span
                            ...
                            <td class="align-middle ps-4 amenities">
                                <div class="d-flex flex-wrap gap-2"><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">wifi</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">tv</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">common
                                        area</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">bathtub</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Heating</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Telephone</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Television</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">common
                                        area</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Kettle</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">iron</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Coffee
                                        maker</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">refrigerator</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Room
                                        service</span><a class="fw-bold fs-9" href="#!">+7 More</a></div>
                            </td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="fs-9 align-middle ps-0">
                                <div class="form-check mb-0 fs-8"><input class="form-check-input" type="checkbox"
                                        data-bulk-select-row='{"name":"King bed","category":"Presidential Suite","price":450.67,"img":"/img/hotels/18.png","bedRooms":"02","beds":"03","guest":"02","child":"01","bathRooms":"02","totalRooms":23,"amenities":["wifi","tv","common area","bathtub","Heating","Telephone","Television","common area","Kettle","iron","Coffee maker","refrigerator","Room service","Coffee maker","refrigerator","Room service","common area","bathtub","Heating","Telephone","Television","common area"]}'>
                                </div>
                            </td>
                            <td class="align-middle py-4 name">
                                <div class="d-flex align-items-center gap-3"><a href="#!"> <img
                                            class="rounded-1 border border-translucent"
                                            src="{{ asset('assets/img/hotels/18.png') }}" alt=""
                                            width="80"></a>
                                    <div> <a class="fs-8 fw-bolder text-body-emphasis text-nowrap" href="#!">King
                                            bed</a>
                                        <h6 class="fw-seibold text-body text-nowrap mt-1 mb-2"><span
                            ...
                            <td class="align-middle ps-4 amenities">
                                <div class="d-flex flex-wrap gap-2"><span
                                        ...
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">refrigerator</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Room
                                        service</span><a class="fw-bold fs-9" href="#!">+9 More</a></div>
                            </td>
                            <td class="align-middle text-end ps-4 totalRooms">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle ps-4 amenities">
                                <div class="d-flex flex-wrap gap-2"><span
                                        ...
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">refrigerator</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Room
                                        service</span><a class="fw-bold fs-9" href="#!">+10 More</a></div>
                            </td>
                            <td class="align-middle text-end ps-4 totalRooms">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="fs-9 align-middle ps-0">
                                <div class="form-check mb-0 fs-8"><input class="form-check-input" type="checkbox"
                                        data-bulk-select-row='{"name":"Twin bed","category":"Family Room","price":600.41,"img":"/img/hotels/20.png","bedRooms":"03","beds":"05","guest":"07","child":"01","bathRooms":"03","totalRooms":12,"amenities":["wifi","tv","common area","bathtub","Heating","Telephone","Television","common area","Kettle","iron","Coffee maker","refrigerator","Room service","Coffee maker","refrigerator","Room service"]}'>
                                </div>
                            </td>
                            <td class="align-middle py-4 name">
                                <div class="d-flex align-items-center gap-3"><a href="#!"> <img
                                            class="rounded-1 border border-translucent"
                                            src="{{ asset('assets/img/hotels/20.png') }}" alt=""
                                            width="80"></a>
                            ...
                            <td class="align-middle ps-4 amenities">
                                <div class="d-flex flex-wrap gap-2"><span
                                        ...
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">refrigerator</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Room
                                        service</span><a class="fw-bold fs-9" href="#!">+3 More</a></div>
                            </td>
                            <td class="align-middle text-end ps-4 totalRooms">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle ps-4 amenities">
                                <div class="d-flex flex-wrap gap-2"><span
                                        ...
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">refrigerator</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Room
                                        service</span><a class="fw-bold fs-9" href="#!">+5 More</a></div>
                            </td>
                            <td class="align-middle text-end ps-4 totalRooms">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle ps-4 amenities">
                                <div class="d-flex flex-wrap gap-2"><span
                                        ...
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">refrigerator</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Room
                                        service</span><a class="fw-bold fs-9" href="#!">+6 More</a></div>
                            </td>
                            <td class="align-middle text-end ps-4 totalRooms">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="fs-9 align-middle ps-0">
                                <div class="form-check mb-0 fs-8"><input class="form-check-input" type="checkbox"
                                        data-bulk-select-row='{"name":"Twin XL bed","category":"Ocean View Room","price":550.75,"img":"/img/hotels/24.png","bedRooms":"01","beds":"02","guest":"04","child":"01","bathRooms":"02","totalRooms":"06","amenities":["wifi","tv","common area","bathtub","Heating","Telephone","Television","common area","Kettle","iron","Coffee maker","refrigerator","Room service","Coffee maker","refrigerator","Room service"]}'>
                                </div>
                            </td>
                            <td class="align-middle py-4 name">
                                <div class="d-flex align-items-center gap-3"><a href="#!"> <img
                                            class="rounded-1 border border-translucent"
                                            src="{{ asset('assets/img/hotels/24.png') }}" alt=""
                                            width="80"></a>
                                    <div> <a class="fs-8 fw-bolder text-body-emphasis text-nowrap" href="#!">Twin XL
                                            bed</a>
                                        <h6 class="fw-seibold text-body text-nowrap mt-1 mb-2"><span
                                                class="fa-solid fa-border-all me-2"></span>Ocean View Room</h6>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle py-4 name">
                                <div class="d-flex align-items-center gap-3"><a href="#!"> <img
                                            ...
                                            src="{{ asset('assets/img/hotels/20.png') }}" alt=""
                                            width="80"></a>
                                    <div> <a class="fs-8 fw-bolder text-body-emphasis text-nowrap" href="#!">Quad
                                            Bed</a>
                                        <h6 class="fw-seibold text-body text-nowrap mt-1 mb-2"><span
                                                class="fa-solid fa-border-all me-2"></span>Standard Room</h6>
                            ...
                            <td class="align-middle ps-4 amenities">
                                <div class="d-flex flex-wrap gap-2"><span
                                        ...
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">refrigerator</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Room
                                        service</span><a class="fw-bold fs-9" href="#!">+4 More</a></div>
                            </td>
                            <td class="align-middle text-end ps-4 totalRooms">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle py-4 name">
                                <div class="d-flex align-items-center gap-3"><a href="#!"> <img
                                            ...
                                            src="{{ asset('assets/img/hotels/21.png') }}" alt=""
                                            width="80"></a>
                                    <div> <a class="fs-8 fw-bolder text-body-emphasis text-nowrap"
                                            href="#!">Executive Suite</a>
                                        <h6 class="fw-seibold text-body text-nowrap mt-1 mb-2"><span
                                                class="fa-solid fa-border-all me-2"></span>Standard Room</h6>
                            ...
                            <td class="align-middle ps-4 amenities">
                                <div class="d-flex flex-wrap gap-2"><span
                                        ...
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">refrigerator</span><span
                                        class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10">Room
                                        service</span><a class="fw-bold fs-9" href="#!">+17 More</a></div>
                            </td>
                            <td class="align-middle text-end ps-4 totalRooms">
