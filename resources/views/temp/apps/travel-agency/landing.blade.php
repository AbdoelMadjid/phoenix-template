    ...
    <main class="main" id="top">
      ...
      <div class="booking-hero-header d-flex align-items-center">
        ...
        <div class="container-medium position-relative z-5">
          ...
          <h1 class="fs-4 fs-md-1 text-white fw-normal mb-6 overflow-hidden">NEXT <span class="typed-text text-primary" data-typed-text="[&quot;&lt;span class=text-primary&gt;TRIP!&lt;/span&gt;&quot;,&quot;&lt;span class=text-warning&gt;TOUR?&lt;/span&gt;&quot;, &quot;&lt;span class=text-info&gt;SOJOURN?&lt;/span&gt;&quot;, &quot;&lt;span class=text-success&gt;VACAY?&lt;/span&gt;&quot;]"></span></h1>
          <div class="input-group rounded-2 py-1 ps-2 w-lg-50 border border-light">
            <div class="form-icon-container flex-1 d-flex align-items-center" data-fa-transform="down-1"><span class="fa-solid fa-location-dot form-icon text-danger-light"></span><input class="form-control form-icon-input bg-transparent border-0 outline-none fs-8 fs-md-7 text-secondary-light" type="text" placeholder="Search Destination"></div>
            <div class="dropdown d-flex align-items-center"><button class="btn py-0 bg-transparent text-secondary-light fs-8 fs-md-7 fw-semibold border-0 border-start border-light rounded-0" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">Flight<span class="fa-solid fa-chevron-down ms-2" data-fa-transform="down-1 shrink-4"></span></button>
              <div class="dropdown-menu dropdown-menu-end" data-bs-theme="dark"><a class="dropdown-item" href="#!">Flight</a><a class="dropdown-item" href="#!">Trip</a><a class="dropdown-item" href="#!">Hotel</a></div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row g-3 position-relative">
            <div class="col-lg-6">
              <div class="row g-3">
                <div class="col-md-7">
                  ...
                  <h2 class="fs-4 fw-semibold mb-3 mb-md-4">Tour & <span class="text-primary-light fw-bold">Travel</span></h2>
            ...
            <div class="col-lg-6">
              <div class="d-flex flex-column gap-3 h-100">
                ...
                </div><button class="btn btn-primary w-100 py-3 fs-8">Explore more<span class="fa-solid fa-chevron-right ms-2" data-fa-transform="down-2"></span></button>
              </div>
            </div>
          </div>
      ...
      <section class="pb-10 pt-0">
        ...
        <div class="container-medium text-center mb-11 position-relative">
          ...
          <p class="text-body-tertiary mb-0">Working with Phoenix means you’ll have all the plans and the perfect price list to help you plan.</p>
        </div>
                ...
                <div class="swiper-slide w-sm-auto"><a class="position-relative rounded-3 overflow-hidden d-block" href="#!"><img class="w-100 w-sm-auto object-fit-cover" src="../../assets/img/gallery/39.png" alt="" height="220">
                    <div class="img-backdrop-faded">
                      <div class="image-reveal-content mb-3">
                        ...
                        <div class="d-flex align-items-center gap-2"><span class="fa-solid fa-tree-city text-secondary-lighter"></span>
      ...
      <section class="py-0">
        ...
        <div class="container-medium position-relative">
          ...
          <div class="d-xl-flex justify-content-between mb-5 text-center">
            <p class="mb-0 text-body-tertiary">This list will help you get insights into how much you’ll need to spend to afford accommodation.</p><button class="btn btn-link p-0 fs-8">View all<span class="fa-solid fa-chevron-right ms-2" data-fa-transform="shrink-3"></span></button>
          </div>
      ...
      <section class="py-10 overflow-hidden">
        ...
        <div class="container-medium position-relative z-2">
          ...
          <p class="mb-0 text-body-tertiary text-center mb-5">Explore the most popular and frequently visited destinations around the world</p>
          ...
          <div class="d-flex align-items-center justify-content-center gap-3 mt-4">
            ...
            <div class="btn-ping">
              <div class="btn-ping-bg"></div><button class="btn border p-0 fs-8 text-primary d-flex align-items-center justify-content-center"><span class="fa-solid fa-arrow-right"></span></button>
            </div>
          </div>
        </div>
      </section>
              ...
              <div class="swiper-slide rounded-3 overflow-hidden">
                <div class="position-relative w-100 h-100"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/48.png" alt="">
                  <div class="backdrop-faded p-4 p-md-6">
                    ...
                    </div><a class="text-white fw-bold fs-7" href="#!">Beautiful Frence, Let's Travelling!</a>
                  </div>
                </div>
              </div>
              <div class="swiper-slide rounded-3 overflow-hidden">
                <div class="position-relative w-100 h-100"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/49.png" alt="">
                  <div class="backdrop-faded p-4 p-md-6">
                    ...
                    </div><a class="text-white fw-bold fs-7" href="#!">Man Standing on Watching Mountain</a>
                  </div>
                </div>
              </div>
              <div class="swiper-slide rounded-3 overflow-hidden">
                <div class="position-relative w-100 h-100"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/50.png" alt="">
                  <div class="backdrop-faded p-4 p-md-6">
                    ...
                    </div><a class="text-white fw-bold fs-7" href="#!">Beautiful Bali Indonesia, Let's Travelling!</a>
                  </div>
                </div>
              </div>
              <div class="swiper-slide rounded-3 overflow-hidden">
                <div class="position-relative w-100 h-100"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/64.png" alt="">
                  <div class="backdrop-faded p-4 p-md-6">
                    <div class="d-flex align-items-center mb-2"><span class="text-secondary-lighter me-2" data-feather="calendar"></span>
                      ...
                      <h6 class="mb-0 text-secondary-lighter fw-semibold">4.5</h6>
                    </div><a class="text-white fw-bold fs-7" href="#!">Chasing sunsets, making memories worldwide.</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-10 col-xl-7">
              <div class="d-md-flex align-items-center gap-7 text-center text-md-start"><img class="mb-4 mb-md-0 d-dark-none" src="../../assets/img/spot-illustrations/40.png" width="260" alt=""><img class="mb-4 mb-md-0 d-light-none" src="../../assets/img/spot-illustrations/dark_40.png" width="260" alt="">
                <div class="flex-1">
                  ...
                  <form class="d-flex justify-content-center"><input class="form-control me-3" id="ctaEmail1" type="email" placeholder="Email" aria-describedby="ctaEmail1"><button class="btn btn-primary d-flex align-items-center" type="submit"> Subscribe<span class="fa-solid fa-chevron-right ms-2 fs-9"></span></button></form>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="booking-footer pb-6 pb-md-11 pt-15">
        <div class="container-medium">
          ...
          <div class="row gy-3 justify-content-between">
            <div class="col-auto"> <a class="text-white me-4" href="#!"><span class="fa-brands fa-facebook-f"> </span></a><a class="text-white me-4" href="#!"><span class="fa-brands fa-twitter"></span></a><a class="text-white me-4" href="#!"><span class="fa-brands fa-linkedin-in"></span></a><a class="text-white" href="#!"><span class="fa-brands fa-behance"></span></a></div>
            <div class="col-auto">
              <p class="mb-0 text-white">Thank you for creating with Phoenix | 2023 © <a class="text-white" href="https://themewagon.com/">Themewagon</a></p>
            </div>
          </div>
        </div><!-- end of .container-->
      </section><!-- <section> close ============================-->
