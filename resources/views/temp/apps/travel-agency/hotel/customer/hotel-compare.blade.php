...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <body>
      ...
      <div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3 ps-0 " href="homepage.html">Homepage</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  " href="hotel-details.html">Hotel Details</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  text-primary" href="hotel-compare.html">Hotel Compare</a></li>
                        ...
                        <div class="swiper-theme-container rounded-2 overflow-hidden">
                          <div class="swiper theme-slider" data-swiper='{"autoplay":true,"loop":true,"pagination":{"el":".swiper-pagination","clickable":true}}'>
                            <div class="swiper-wrapper">
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/40.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/41.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/42.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/43.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/44.png" alt=""></div>
                            </div>
                    ...
                    <td class="border-0 py-0 ps-3 pe-0" style="min-width: 250px">
                      <div class="position-relative">
                        <div class="swiper-theme-container rounded-2 overflow-hidden">
                          <div class="swiper theme-slider" data-swiper='{"autoplay":true,"loop":true,"pagination":{"el":".swiper-pagination","clickable":true}}'>
                            <div class="swiper-wrapper">
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/45.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/46.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/47.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/48.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/49.png" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                          </div>
                    ...
                    <td class="border-0 py-0 ps-3" style="min-width: 250px">
                      <div class="position-relative">
                        <div class="swiper-theme-container rounded-2 overflow-hidden">
                          <div class="swiper theme-slider" data-swiper='{"autoplay":true,"loop":true,"pagination":{"el":".swiper-pagination","clickable":true}}'>
                            <div class="swiper-wrapper">
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/50.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/51.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/52.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/53.png" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="../../../../assets/img/hotels/54.png" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                          </div>
                  ...
                  <tr>
                    ...
                    <td class="border-translucent px-3 border-end" style="min-width: 250px">
                      <div class="swiper-theme-container">
                        <div class="swiper theme-slider" data-swiper='{"loop":true,"spaceBetween":8,"slidesPerView":3,"centeredSlide":true,"grabCursor":true}'>
                          <div class="swiper-wrapper">
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/55.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/56.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/57.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/58.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/59.png" alt=""></div>
                          </div>
                        </div>
                    ...
                    <td class="border-translucent px-3 border-end" style="min-width: 250px">
                      <div class="swiper-theme-container">
                        <div class="swiper theme-slider" data-swiper='{"loop":true,"spaceBetween":8,"slidesPerView":3,"centeredSlide":true,"grabCursor":true}'>
                          <div class="swiper-wrapper">
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/60.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/61.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/62.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/63.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/64.png" alt=""></div>
                          </div>
                        </div>
                        <div class="swiper-nav swiper-nav-inside">
                          <div class="swiper-button-next bg-transparent border-0"><span class="fas fa-chevron-right text-white" data-fa-transform="shrink-3"></span></div>
                    ...
                    <td class="border-translucent px-3 border-end-lg" style="min-width: 250px">
                      <div class="swiper-theme-container">
                        <div class="swiper theme-slider" data-swiper='{"loop":true,"spaceBetween":8,"slidesPerView":3,"centeredSlide":true,"grabCursor":true}'>
                          <div class="swiper-wrapper">
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/65.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/66.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/67.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/68.png" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="../../../../assets/img/hotels/69.png" alt=""></div>
                          </div>
                        </div>
                        <div class="swiper-nav swiper-nav-inside">
                          <div class="swiper-button-next bg-transparent border-0"><span class="fas fa-chevron-right text-white" data-fa-transform="shrink-3"></span></div>
                ...
                <div class="col-lg-7">
                  <div class="swiper-theme-container">
                    <div class="swiper theme-slider" data-swiper='{"loop":true,"spaceBetween":8,"slidesPerView":"auto","centeredSlide":true,"grabCursor":true}'>
                      <div class="swiper-wrapper">
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="../../../../assets/img/hotels/33.png" alt="" width="158"></div>
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="../../../../assets/img/hotels/34.png" alt="" width="158"></div>
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="../../../../assets/img/hotels/35.png" alt="" width="158"></div>
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="../../../../assets/img/hotels/36.png" alt="" width="158"></div>
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="../../../../assets/img/hotels/37.png" alt="" width="158"></div>
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="../../../../assets/img/hotels/38.png" alt="" width="158"></div>
                      </div>
                    </div>
                    <div class="swiper-nav swiper-nav-inside">
    ...
    <script src="../../../../assets/js/pages/hotel-compare.js"></script>
  </body>
