...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        <nav class="navbar navbar-top navbar-expand-lg container-medium border-0 bg-body px-3 py-2"><button class="navbar-toggler fs-8 ps-2 me-sm-2" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTopCollapse" aria-controls="navbarTopCollapse" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button><a class="navbar-brand flex-1 flex-lg-grow-0 me-lg-8 me-xl-13" href="{{ url('dashboard') }}">
          ...
          <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center pb-0" id="navbarTopCollapse">
            <ul class="navbar-nav travel-nav-top me-auto" data-dropdown-on-hover="data-dropdown-on-hover">
              ...
              <li class="nav-item dropdown"><a class="nav-link fs-8 fw-bold  " href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">Package</a></li>
            </ul>
          </div>
        </nav>
      </div>
      <div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3 ps-0 " href="{{ url('homepage') }}">Homepage</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  " href="{{ url('hotel-details') }}">Hotel Details</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  text-primary" href="{{ url('hotel-compare') }}">Hotel Compare</a></li>
      ...
      <section class="pt-6 pb-9">
        <div class="container-medium">
          ...
          <div class="container-medium-md px-0">
            <div>
              <div class="row gx-0 gy-3 gy-md-0 align-items-center mx-auto p-3 bg-body-emphasis rounded-5 rounded-md-pill position-relative border">
                <div class="col-12 col-md">
                  <div class="form-icon-container border-bottom border-bottom-md-0 border-translucent pb-3 pb-md-0"><input class="form-control form-icon-input border-0 py-0 shadow-none fs-8" type="text" placeholder="Pick a place"><span class="fa-solid fa-map-marker-alt form-icon text-body-tertiary top-0" data-fa-transform="down-2"></span></div>
                </div>
                ...
                <div class="col-6 col-md"><button class="btn px-3 fs-8 fw-semibold text-body-tertiary" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-auto-close="outside"><span class="fa-solid fa-user me-2"></span>1 adult</button>
          ...
          <div class="position-relative scrollbar"><a class="btn p-4 d-flex flex-between-center collapse-indicator text-body-highlight bg-body-highlight position-sticky start-0" data-bs-toggle="collapse" href="#hotelDetailsCollapse" role="button" aria-expanded="true" aria-controls="hotelDetailsCollapse">
              <h4 class="mb-0">Hotel Details</h4><span class="fa-solid fa-chevron-down toggle-icon text-body"></span>
            </a>
                ...
                <tbody>
                    ...
                    <td class="border-0 py-0 ps-3 pe-0" style="min-width: 250px">
                      <div class="position-relative">
                        <div class="swiper-theme-container rounded-2 overflow-hidden">
                          <div class="swiper theme-slider" data-swiper='{"autoplay":true,"loop":true,"pagination":{"el":".swiper-pagination","clickable":true}}'>
                            <div class="swiper-wrapper">
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/40.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/41.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/42.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/43.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/44.png') }}" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                          </div>
                        </div><span class="badge badge-phoenix fs-10 badge-phoenix-warning position-absolute top-0 start-0 ms-3 mt-3"><span class="fa-solid fa-star me-1"></span>3.0</span><button class="btn btn-wish position-absolute top-0 end-0 mt-3 me-3"><span class="far fa-heart"></span></button>
                      </div>
                      <div class="position-relative"><input class="form-control form-control-lg mt-2 pe-5" type="text" placeholder="Enter hotel name" value="Bubble Hotel Bali Ubud"><span class="fa-solid fa-search fs-9 text-body-quaternary position-absolute top-0 end-0 mt-3 me-3" data-fa-transform="down-2"></span></div>
                    </td>
                    <td class="border-0 py-0 ps-3 pe-0" style="min-width: 250px">
                      <div class="position-relative">
                        <div class="swiper-theme-container rounded-2 overflow-hidden">
                          <div class="swiper theme-slider" data-swiper='{"autoplay":true,"loop":true,"pagination":{"el":".swiper-pagination","clickable":true}}'>
                            <div class="swiper-wrapper">
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/45.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/46.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/47.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/48.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/49.png') }}" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                          </div>
                        </div><span class="badge badge-phoenix fs-10 badge-phoenix-warning position-absolute top-0 start-0 ms-3 mt-3"><span class="fa-solid fa-star me-1"></span>4.0</span><button class="btn btn-wish position-absolute top-0 end-0 mt-3 me-3"><span class="far fa-heart"></span></button>
                      </div>
                      <div class="position-relative"><input class="form-control form-control-lg mt-2 pe-5" type="text" placeholder="Enter hotel name" value="ONAYA Bali Resort"><span class="fa-solid fa-search fs-9 text-body-quaternary position-absolute top-0 end-0 mt-3 me-3" data-fa-transform="down-2"></span></div>
                    </td>
                    <td class="border-0 py-0 ps-3" style="min-width: 250px">
                      <div class="position-relative">
                        <div class="swiper-theme-container rounded-2 overflow-hidden">
                          <div class="swiper theme-slider" data-swiper='{"autoplay":true,"loop":true,"pagination":{"el":".swiper-pagination","clickable":true}}'>
                            <div class="swiper-wrapper">
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/50.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/51.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/52.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/53.png') }}" alt=""></div>
                              <div class="swiper-slide"><img class="w-100 h-100" src="{{ asset('assets/img/hotels/54.png') }}" alt=""></div>
                            </div>
                            <div class="swiper-pagination"></div>
                          </div>
                        </div><span class="badge badge-phoenix fs-10 badge-phoenix-warning position-absolute top-0 start-0 ms-3 mt-3"><span class="fa-solid fa-star me-1"></span>5.0</span><button class="btn btn-wish position-absolute top-0 end-0 mt-3 me-3"><span class="far fa-heart"></span></button>
                      </div>
                      <div class="position-relative"><input class="form-control form-control-lg mt-2 pe-5" type="text" placeholder="Enter hotel name" value="Gynandha Ubud Cottage"><span class="fa-solid fa-search fs-9 text-body-quaternary position-absolute top-0 end-0 mt-3 me-3" data-fa-transform="down-2"></span></div>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="px-3 border-end border-translucent">
                      <div class="d-flex align-items-center gap-2"><span class="badge text-bg-primary fs-8">4.0</span>
                        <div class="progress w-100 bg-body-highlight" role="progressbar" aria-label="review" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="height: 8px">
                  ...
                  <tr>
                    ...
                    <td class="px-3 border-end border-translucent">
                      <div class="d-flex align-items-center gap-2"><span class="badge text-bg-primary fs-8">4.5</span>
                        <div class="progress w-100 bg-body-highlight" role="progressbar" aria-label="review" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="height: 8px">
                  ...
                  <tr>
                    ...
                    <td class="px-3 border-end border-translucent">
                      <div class="d-flex align-items-center gap-2"><span class="badge text-bg-primary fs-8">4.8</span>
                        <div class="progress w-100 bg-body-highlight" role="progressbar" aria-label="review" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="height: 8px">
                  ...
                  <tr>
                    ...
                    <td class="px-3 border-end border-translucent">
                      <div class="d-flex align-items-center gap-2"><span class="badge text-bg-primary fs-8">3.5</span>
                        <div class="progress w-100 bg-body-highlight" role="progressbar" aria-label="review" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="height: 8px">
                  ...
                  <tr>
                    ...
                    <td class="px-3 border-end border-translucent">
                      <div class="d-flex align-items-center gap-2"><span class="badge text-bg-primary fs-8">5.0</span>
                        <div class="progress w-100 bg-body-highlight" role="progressbar" aria-label="review" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="height: 8px">
                  ...
                  <tr>
                    ...
                    <td class="border-translucent px-3 border-end">
                      <ul class="columns-xl-2 mb-0 list-unstyled">
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Free - Breakfast</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Beach View</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Airport Shuttle</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Gym</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Swimming Pool</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Free Parking</li>
                      </ul>
                    </td>
                    <td class="border-translucent px-3 border-end">
                      <ul class="columns-xl-2 mb-0 list-unstyled">
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Free - Breakfast</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Fitness Center</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Airport Shuttle</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Bar/Lounge</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Accommodation</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Room Service</li>
                      </ul>
                    </td>
                    <td class="border-translucent px-3 border-end-lg">
                      <ul class="columns-xl-2 mb-0 list-unstyled">
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Reception Desk</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Meeting Rooms</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Restaurant</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>ATM/Banking Services</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Business Center</li>
                        <li class="text-body-highlight fs-9"><span class="fa-solid fa-check text-success me-2"></span>Free Parking</li>
                      </ul>
                    </td>
                  </tr>
            ...
            </div><a class="btn p-4 mt-8 d-flex flex-between-center collapse-indicator text-body-highlight bg-body-highlight position-sticky start-0" data-bs-toggle="collapse" href="#roomDetailsCollapse" role="button" aria-expanded="true" aria-controls="roomDetailsCollapse">
              <h4 class="mb-0">Room Details</h4><span class="fa-solid fa-chevron-down toggle-icon text-body"></span>
            </a>
              ...
              <table class="table table-layout-fixed table-compare mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="border-translucent px-3 border-end">
                      <div class="d-flex flex-wrap flex-between-center gap-2">
                        <h4 class="mb-0">Deluxe Room</h4><button class="btn btn-phoenix-primary" data-bs-toggle="modal" data-bs-target="#changeRoomModal">Change Room</button>
                      </div>
                    </td>
                    <td class="border-translucent px-3 border-end">
                      <div class="d-flex flex-wrap flex-between-center gap-2">
                  ...
                  <tr>
                    ...
                    <td class="border-translucent px-3 border-end">
                      <h3 class="d-flex align-items-center gap-2"><span class="fs-9 text-body-quaternary fw-normal text-decoration-line-through">$279.98</span> $259.65 <span class="fs-9 fw-bold">/ night</span></h3>
                      <p class="mb-0">Inclusive of all taxes and fees</p>
                    </td>
                    <td class="border-translucent px-3 border-end">
                      <h3 class="d-flex align-items-center gap-2"><span class="fs-9 text-body-quaternary fw-normal text-decoration-line-through">$299.76</span> $260.99 <span class="fs-9 fw-bold">/ night</span></h3>
                      <p class="mb-0">Inclusive of all taxes and fees</p>
                    </td>
                    <td class="border-translucent px-3 border-end-lg">
                      <h3 class="d-flex align-items-center gap-2"><span class="fs-9 text-body-quaternary fw-normal text-decoration-line-through">$309.89</span> $299.98 <span class="fs-9 fw-bold">/ night</span></h3>
                      <p class="mb-0">Inclusive of all taxes and fees</p>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="border-translucent px-3 border-end" style="min-width: 250px">
                      <div class="swiper-theme-container">
                        <div class="swiper theme-slider" data-swiper='{"loop":true,"spaceBetween":8,"slidesPerView":3,"centeredSlide":true,"grabCursor":true}'>
                          <div class="swiper-wrapper">
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/55.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/56.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/57.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/58.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/59.png') }}" alt=""></div>
                          </div>
                        </div>
                        <div class="swiper-nav swiper-nav-inside">
                          <div class="swiper-button-next bg-transparent border-0"><span class="fas fa-chevron-right text-white" data-fa-transform="shrink-3"></span></div>
                          <div class="swiper-button-prev bg-transparent border-0"><span class="fas fa-chevron-left text-white" data-fa-transform="shrink-3"></span></div>
                        </div>
                      </div>
                    </td>
                    <td class="border-translucent px-3 border-end" style="min-width: 250px">
                      <div class="swiper-theme-container">
                        <div class="swiper theme-slider" data-swiper='{"loop":true,"spaceBetween":8,"slidesPerView":3,"centeredSlide":true,"grabCursor":true}'>
                          <div class="swiper-wrapper">
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/60.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/61.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/62.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/63.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/64.png') }}" alt=""></div>
                          </div>
                        </div>
                        <div class="swiper-nav swiper-nav-inside">
                          <div class="swiper-button-next bg-transparent border-0"><span class="fas fa-chevron-right text-white" data-fa-transform="shrink-3"></span></div>
                    ...
                    <td class="border-translucent px-3 border-end-lg" style="min-width: 250px">
                      <div class="swiper-theme-container">
                        <div class="swiper theme-slider" data-swiper='{"loop":true,"spaceBetween":8,"slidesPerView":3,"centeredSlide":true,"grabCursor":true}'>
                          <div class="swiper-wrapper">
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/65.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/66.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/67.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/68.png') }}" alt=""></div>
                            <div class="swiper-slide"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/69.png') }}" alt=""></div>
                          </div>
                        </div>
                        <div class="swiper-nav swiper-nav-inside">
                          <div class="swiper-button-next bg-transparent border-0"><span class="fas fa-chevron-right text-white" data-fa-transform="shrink-3"></span></div>
                  ...
                  <tr>
                    ...
                    <td class="border-translucent px-3 border-end">
                      <h6 class="fw-semibold text-body-highlight mb-2"><span class="fa-solid fa-bed me-2 text-primary"></span>01 Double Bed</h6>
                      <h6 class="fw-semibold text-body-highlight mb-2"><span class="fa-solid fa-user me-2 text-primary"></span>02 Adults</h6>
                      <h6 class="fw-semibold text-body-highlight mb-2"><span class="fa-solid fa-baby me-2 text-primary"></span>00 Child</h6>
                      <h6 class="fw-semibold text-body-highlight"><span class="fa-solid fa-bath me-2 text-primary"></span>01 Bathroom</h6>
                    </td>
                    <td class="border-translucent px-3 border-end">
                      <h6 class="fw-semibold text-body-highlight mb-2"><span class="fa-solid fa-bed me-2 text-primary"></span>01 Double Bed</h6>
                      <h6 class="fw-semibold text-body-highlight mb-2"><span class="fa-solid fa-user me-2 text-primary"></span>02 Adults</h6>
                  ...
                  <tr>
                    ...
                    <td class="px-3 align-middle border-end-lg border-translucent">
                      <h6 class="text-body"> <span class="fa-solid fa-circle-check text-success me-2"></span>Available</h6>
                    </td>
                    <td class="px-3 align-middle border-end-lg border-translucent">
                      <h6 class="text-body"> <span class="fa-solid fa-circle-check text-success me-2"></span>Available</h6>
                    </td>
                    <td class="px-3 align-middle border-end-lg border-translucent">
                      <h6 class="text-body"> <span class="fa-solid fa-circle-xmark text-secondary-light me-2"></span>Not Available</h6>
                    </td>
                  </tr>
                  <tr>
                    <td class="px-4 align-middle border-end-lg border-translucent bg-body-highlight">
                  ...
                  <tr>
                    ...
                    <td class="border-0 px-3 pb-0"><a class="btn btn-outline-primary w-100" href="#!">View room details</a></td>
                    <td class="border-0 px-3 pb-0"><a class="btn btn-outline-primary w-100" href="#!">View room details</a></td>
                    <td class="border-0 px-3 pb-0"><a class="btn btn-outline-primary w-100" href="#!">View room details</a></td>
                  </tr>
                </tbody>
      ...
      <div class="modal fade" id="changeRoomModal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="changeRoomModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
            <div class="modal-header justify-content-between p-4">
              <h3 class="mb-0 text-body-highlight" id="changeRoomModalLabel">Select Room</h3><button class="btn btn-phoenix-danger px-3" data-bs-dismiss="modal" aria-label="Close"><span class="fa-solid fa-times" data-fa-transform="down-2"></span></button>
            </div>
            <div class="modal-body p-4">
              <div class="row g-3 mb-4">
                <div class="col-lg-8 col-xxl-7">
                  <div class="d-flex align-items-center mb-2">
                    <h4 class="mb-0 fw-semibold pe-3"><span class="fa-solid fa-circle fs-9 text-body-quaternary me-2" data-fa-transform="up-1"></span>Standard Double Queen</h4><span class="badge badge-phoenix badge-phoenix-info fs-10">10% OFF</span>
                  </div>
                ...
                <div class="col-lg-4 col-xxl-5">
                  <h3 class="mb-2 d-flex align-items-center justify-content-lg-end gap-2"><span class="fs-9 text-body-quaternary fw-normal text-decoration-line-through">$143.65</span>$123.65<span class="fs-9 text-body">/ night</span></h3>
              ...
              <div class="row mb-4 justify-content-between">
                <div class="col-lg-7">
                  <div class="swiper-theme-container">
                    <div class="swiper theme-slider" data-swiper='{"loop":true,"spaceBetween":8,"slidesPerView":"auto","centeredSlide":true,"grabCursor":true}'>
                      <div class="swiper-wrapper">
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="{{ asset('assets/img/hotels/33.png') }}" alt="" width="158"></div>
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="{{ asset('assets/img/hotels/34.png') }}" alt="" width="158"></div>
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="{{ asset('assets/img/hotels/35.png') }}" alt="" width="158"></div>
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="{{ asset('assets/img/hotels/36.png') }}" alt="" width="158"></div>
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="{{ asset('assets/img/hotels/37.png') }}" alt="" width="158"></div>
                        <div class="swiper-slide w-auto"><img class="rounded-2" src="{{ asset('assets/img/hotels/38.png') }}" alt="" width="158"></div>
                      </div>
                    </div>
                    <div class="swiper-nav swiper-nav-inside">
                ...
                <div class="col-lg-5 col-xl-4">
                  <div class="p-4 border border-translucent rounded-2 mt-4 mt-lg-0">
                    <div class="row g-3">
                      <div class="col-6">
                        <h6 class="fw-semibold text-body-secondary"><span class="fa-solid fa-bed text-info me-2"></span>01 Double Bed</h6>
                      </div>
                      <div class="col-6">
                        <h6 class="fw-semibold text-body-secondary"><span class="fa-solid fa-user text-info me-2"> </span>02 Adult</h6>
                      </div>
                      <div class="col-6">
                        <h6 class="fw-semibold text-body-secondary"><span class="fa-solid fa-baby text-info me-2"> </span>00 Child</h6>
                      </div>
                      <div class="col-6">
                        <h6 class="fw-semibold text-body-secondary"><span class="fa-solid fa-bath text-info me-2"> </span>01 Bathrooms</h6>
                      </div>
                    </div>
                  </div><button class="btn btn-outline-primary w-100 mt-3">Add to compare</button>
                </div>
              </div><a class="btn p-3 d-flex flex-between-center collapse-indicator text-body-highlight bg-body-highlight" data-bs-toggle="collapse" href="#amenitiesCollapse-0" role="button" aria-expanded="false" aria-controls="amenitiesCollapse-0">
                <h5 class="mb-0">Room Amenities</h5><span class="fa-solid fa-chevron-down toggle-icon text-body"></span>
              </a>
                ...
                <div class="px-md-4 pt-4">
                  ...
                  <div class="row g-0 mb-5">
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border"><span class="fs-9 text-warning fa-solid fa-car"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Airport shuttle</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-bottom border-top-sm border-end border-start border-start-sm-0"><span class="fs-9 text-warning fa-solid fa-wifi"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Free wifi</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-end border-start border-start-lg-0 border-top-lg border-bottom"><span class="fs-9 text-warning fa-solid fa-utensils"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Restaurant</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-end border-start border-start-sm-0 border-start-lg border-bottom"><span class="fs-9 text-warning fa-solid fa-smoking"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Smoking zone</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-bottom border-end border-start border-start-lg-0"><span class="fs-9 text-warning fa-solid fa-user"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Room service</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-bottom border-end border-start border-start-sm-0"><span class="fs-9 text-warning fa-solid fa-dog"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Pet-Friendly</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-x border-bottom"><span class="fs-9 text-warning fa-solid fa-square-parking"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Free parking</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-bottom border-end border-start border-start-sm-0"><span class="fs-9 text-warning fa-solid fa-umbrella-beach"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Beach-front</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-bottom border-end border-start border-start-lg-0"><span class="fs-9 text-warning fa-solid fa-wheelchair"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Facilities for disabled guests</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-x border-bottom border-start border-start-sm-0 border-start-lg"><span class="fs-9 text-warning fa-solid fa-wine-glass"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Bar</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-bottom border-end border-start border-start-lg-0"><span class="fs-9 text-warning fa-solid fa-utensils"></span>
                        <h5 class="text-body-tertiary mb-0 fw-normal">Free Breakfast</h5>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                      <div class="d-flex align-items-center gap-2 px-4 py-3 h-100 border-translucent border-bottom border-end border-start border-start-sm-0"><span class="fs-9 text-warning fa-solid fa-bell-concierge"></span>
                  ...
                  <div class="row g-2">
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Wifi</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Luggage rack</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Hairdryer</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Toiletries</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Seating area</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Bed sheets</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Room service</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Blankets</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Air conditioning</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Television</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Heating</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Sofa or couch</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Coffee table</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Ironing service</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Dry cleaning</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Coffee maker</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Electric kettle</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Garden view</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Baby cots</h5>
                      </div>
                    </div>
                    <div class="col-lg-4 col-xl-3">
                      <div class="p-3 border border-translucent rounded-2">
                        <h5 class="text-body-secondary fw-semibold mb-0"><span class="fa-solid fa-check text-success me-2"> </span>Desk or workstation</h5>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row g-3 mb-4">
                <div class="col-lg-8 col-xxl-7">
                  <div class="d-flex align-items-center mb-2">
                    <h4 class="mb-0 fw-semibold pe-3"><span class="fa-solid fa-circle fs-9 text-body-quaternary me-2" data-fa-transform="up-1"></span>Deluxe Room</h4><span class="badge badge-phoenix badge-phoenix-info fs-10">10% OFF</span>
                  </div>
                  <p class="mb-0">A Deluxe Room is a spacious and luxurious hotel accommodation offering upgraded amenities and enhanced comfort for a more indulgent stay.</p>
                </div>
                <div class="col-lg-4 col-xxl-5">
                  <h3 class="mb-2 d-flex align-items-center justify-content-lg-end gap-2"><span class="fs-9 text-body-quaternary fw-normal text-decoration-line-through">$199.65</span>$165.98<span class="fs-9 text-body">/ night</span></h3>
                  <h5 class="text-body text-lg-end fw-normal">Inclusive of all taxes and fees</h5>
                </div>
              </div>
              <div class="row mb-4 justify-content-between">
              ...
              </div><a class="btn p-3 d-flex flex-between-center collapse-indicator text-body-highlight bg-body-highlight" data-bs-toggle="collapse" href="#amenitiesCollapse-1" role="button" aria-expanded="false" aria-controls="amenitiesCollapse-1">
                <h5 class="mb-0">Room Amenities</h5><span class="fa-solid fa-chevron-down toggle-icon text-body"></span>
              </a>
              ...
              <div class="row g-3 mb-4">
                <div class="col-lg-8 col-xxl-7">
                  <div class="d-flex align-items-center mb-2">
                    <h4 class="mb-0 fw-semibold pe-3"><span class="fa-solid fa-circle fs-9 text-body-quaternary me-2" data-fa-transform="up-1"></span>Presidential Suite</h4><span class="badge badge-phoenix badge-phoenix-info fs-10">10% OFF</span>
                  </div>
                  <p class="mb-0">The Presidential Suite: The pinnacle of luxury accommodations, reserved for VIPs and boasting the utmost opulence and prestige.</p>
                </div>
                <div class="col-lg-4 col-xxl-5">
                  <h3 class="mb-2 d-flex align-items-center justify-content-lg-end gap-2"><span class="fs-9 text-body-quaternary fw-normal text-decoration-line-through">$156.23</span>$130.65<span class="fs-9 text-body">/ night</span></h3>
                  <h5 class="text-body text-lg-end fw-normal">Inclusive of all taxes and fees</h5>
                </div>
              </div>
              <div class="row mb-4 justify-content-between">
              ...
              </div><a class="btn p-3 d-flex flex-between-center collapse-indicator text-body-highlight bg-body-highlight" data-bs-toggle="collapse" href="#amenitiesCollapse-2" role="button" aria-expanded="false" aria-controls="amenitiesCollapse-2">
                <h5 class="mb-0">Room Amenities</h5><span class="fa-solid fa-chevron-down toggle-icon text-body"></span>
              </a>
              ...
              <div class="row g-3 mb-4">
                <div class="col-lg-8 col-xxl-7">
                  <div class="d-flex align-items-center mb-2">
                    <h4 class="mb-0 fw-semibold pe-3"><span class="fa-solid fa-circle fs-9 text-body-quaternary me-2" data-fa-transform="up-1"></span>Ocean View Room</h4><span class="badge badge-phoenix badge-phoenix-info fs-10">10% OFF</span>
                  </div>
                  <p class="mb-0">An Ocean View Room offers breathtaking vistas of the sea, providing guests with a captivating and serene coastal experience.</p>
                </div>
                <div class="col-lg-4 col-xxl-5">
                  <h3 class="mb-2 d-flex align-items-center justify-content-lg-end gap-2"><span class="fs-9 text-body-quaternary fw-normal text-decoration-line-through">$271.65</span>$240.96<span class="fs-9 text-body">/ night</span></h3>
                  <h5 class="text-body text-lg-end fw-normal">Inclusive of all taxes and fees</h5>
                </div>
              </div>
              <div class="row mb-4 justify-content-between">
              ...
              </div><a class="btn p-3 d-flex flex-between-center collapse-indicator text-body-highlight bg-body-highlight" data-bs-toggle="collapse" href="#amenitiesCollapse-3" role="button" aria-expanded="false" aria-controls="amenitiesCollapse-3">
                <h5 class="mb-0">Room Amenities</h5><span class="fa-solid fa-chevron-down toggle-icon text-body"></span>
              </a>
