        ...
        <div class="container-medium">
          ...
          <div class="row justify-content-between">
            <div class="col-lg-7 col-xl-6">
              <form id="checkoutForm2"><a class="btn btn-phoenix-primary" href="{{ url('checkout') }}"><span class="fas fa-chevron-left me-2" data-fa-transform="shrink-3"></span>Go back</a>
                <hr class="mt-5 mb-7">
                ...
                <hr class="mt-6 mb-5"><a class="btn btn-phoenix-primary me-3" href="{{ url('checkout') }}"><span class="fa-solid fa-chevron-left me-2" data-fa-transform="shrink-3"></span>Go back</a><button class="btn btn-primary px-sm-15">Confirm booking</button>
              </form>
            </div>
