        ...
        <div class="container-medium">
          ...
          <div class="row justify-content-between">
            <div class="col-lg-7 col-xl-6">
              <form id="checkoutForm2"><a class="btn btn-phoenix-primary" href="checkout.html"><span class="fas fa-chevron-left me-2" data-fa-transform="shrink-3"></span>Go back</a>
                <hr class="mt-5 mb-7">
                <h3 class="mb-5">Enter your address</h3>
                <div class="row g-3 mb-5">
                  <div class="col-sm-3"><label class="fw-bold text-body-highlight mb-1" for="country">Country</label><select class="form-select" id="country">
                      <option value="1">India</option>
                      <option value="2">USB</option>
                      <option value="3">UAE</option>
                    </select></div>
                  <div class="col-sm-5 col-lg-4"><label class="fw-bold text-body-highlight mb-1" for="phone-number">Phone number</label><input class="form-control input-spin-none" type="number" id="phone-number" placeholder="Enter phone number"></div>
                </div>
                <div class="row g-3">
                  <div class="col-sm-8 col-lg-7"><label class="fw-bold text-body-highlight mb-1" for="phone-number-type">Email address</label><input class="form-control input-spin-none" type="email" id="phone-number-type" placeholder="Email address"></div>
                </div>
                ...
                <hr class="mt-6 mb-5"><a class="btn btn-phoenix-primary me-3" href="checkout.html"><span class="fa-solid fa-chevron-left me-2" data-fa-transform="shrink-3"></span>Go back</a><button class="btn btn-primary px-sm-15">Confirm booking</button>
              </form>
            </div>
            <div class="col-lg-5 col-xl-4">
              <div class="card mt-5 mt-lg-0">
                <div class="card-body">
                  <h5 class="mb-3">Summary</h5><img class="rounded-2 mb-3" src="../../../../assets/img/hotels/39.png" alt="" width="208">
