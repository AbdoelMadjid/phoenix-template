      ...
      <div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            ...
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  text-primary" href="{{ url('gallery') }}">Gallery</a></li>
      ...
      <section class="pt-6 pb-9">
        <div class="container-medium">
          ...
          <div class="row g-2 g-sm-3">
            <div class="col-md-6">
              <div class="row g-2 g-sm-3">
                <div class="undefined"><a href="{{ asset('assets/img/hotels/84.jpg') }}" data-gallery="default-gallery"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/74.png') }}" alt=""></a></div>
                <div class="col-6"><a href="{{ asset('assets/img/hotels/85.jpg') }}" data-gallery="default-gallery"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/75.png') }}" alt=""></a></div>
                <div class="col-6"><a href="{{ asset('assets/img/hotels/86.jpg') }}" data-gallery="default-gallery"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/76.png') }}" alt=""></a></div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="video-container h-100"><a href="{{ asset('assets/video/3.mp4') }}" data-gallery="default-gallery"><video class="video w-100 h-100 object-fit-cover overflow-hidden rounded-2" muted="" data-play-on-hover="">
            ...
            <div class="col-sm-6"><a href="{{ asset('assets/img/hotels/87.jpg') }}" data-gallery="default-gallery"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/78.png') }}" alt=""></a></div>
            <div class="col-sm-6"><a href="{{ asset('assets/img/hotels/88.jpg') }}" data-gallery="default-gallery"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/79.png') }}" alt=""></a></div>
            <div class="col-md-6"><a href="{{ asset('assets/img/hotels/89.jpg') }}" data-gallery="default-gallery"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/80.png') }}" alt=""></a></div>
            <div class="col-md-6">
              <div class="row g-2 g-sm-3">
                <div class="undefined"><a href="{{ asset('assets/img/hotels/90.jpg') }}" data-gallery="default-gallery"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/81.png') }}" alt=""></a></div>
                <div class="col-6"><a href="{{ asset('assets/img/hotels/91.jpg') }}" data-gallery="default-gallery"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/82.png') }}" alt=""></a></div>
                <div class="col-6"><a href="{{ asset('assets/img/hotels/92.jpg') }}" data-gallery="default-gallery"><img class="img-fluid rounded-2" src="{{ asset('assets/img/hotels/83.png') }}" alt=""></a></div>
              </div>
            </div>
          </div>
