        ...
        <div class="container-small">
          <nav class="navbar navbar-landing navbar-home navbar-expand py-4 px-0">
            <ul class="navbar-nav mx-auto mt-3 mt-lg-0 gap-2">
              <li class="nav-item"><a class="nav-link fw-bold rounded-3 active" aria-current="page" href="{{ url('apps/travel-agency/flight/homepage') }}"> <span class="me-2 fa-solid fa-hotel"></span>Hotel</a></li>
