...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <head>
    ...
    <script>
      ...
      if (phoenixIsRTL) {
        ...
        var userLinkRTL = document.getElementById('user-style-default');
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3 ps-0 text-primary" href="{{ url('apps/travel-agency/hotel/customer/homepage') }}">Homepage</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  " href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel Details</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  " href="{{ url('apps/travel-agency/hotel/customer/hotel-compare') }}">Hotel Compare</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  " href="{{ url('apps/travel-agency/hotel/customer/checkout') }}">Check out</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  " href="{{ url('apps/travel-agency/hotel/customer/payment') }}">Payment</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  " href="{{ url('apps/travel-agency/hotel/customer/gallery') }}">Gallery</a></li>
        ...
        <div class="container-small">
          <nav class="navbar navbar-landing navbar-home navbar-expand py-4 px-0">
            <ul class="navbar-nav mx-auto mt-3 mt-lg-0 gap-2">
              <li class="nav-item"><a class="nav-link fw-bold rounded-3 active" aria-current="page" href="{{ url('apps/travel-agency/hotel/customer/homepage') }}"> <span class="me-2 fa-solid fa-hotel"></span>Hotel</a></li>
              <li class="nav-item"><a class="nav-link fw-bold rounded-3" aria-current="page" href="{{ url('apps/travel-agency/flight/homepage') }}"> <span class="me-2 fa-solid fa-plane"></span>Flight</a></li>
        ...
        <div class="container-medium">
          <div class="py-6">
            <div class="d-flex"><select class="form-select w-sm-auto me-4" id="hotelSort" name="Hotel sort">
              ...
              </select><button class="btn btn-phoenix-secondary text-nowrap px-3 px-md-4 ms-auto me-2"><span class="fa-solid fa-map me-md-2"></span><span class="d-none d-md-inline-block">Show in map</span></button>
              <button class="btn btn-phoenix-secondary text-nowrap px-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#hotelFilterOffcanvas" aria-controls="hotelFilterOffcanvas"><span class="fa-solid fa-filter me-md-2"></span><span class="d-none d-md-inline-block">Filters</span></button>
            </div>
          </div>
          <div class="row g-3 mb-6">
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/1.png') }}" alt="">
                ...
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel Palace</a>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/2.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Silom Furama</a>
                  <p class="mb-2 text-secondary-lighter"><span class="fa-solid fa-map-marker-alt me-2"></span>Bangkok, Thailand</p>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/3.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel Prince Palace</a>
                  <p class="mb-2 text-secondary-lighter"><span class="fa-solid fa-map-marker-alt me-2"></span>Bangkok, Thailand</p>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/4.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel Grandmas Plus</a>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/5.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel Asia Solo</a>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/6.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Golden Inn Kuta</a>
                  <p class="mb-2 text-secondary-lighter"><span class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/7.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">The Shanty House</a>
                  <p class="mb-2 text-secondary-lighter"><span class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/8.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel Kiwi International</a>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/9.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Residences of the Angel</a>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/10.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Brenig Kulm's Gasthaus</a>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/11.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">The Andermatt Chedi</a>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/12.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Interlaken Alplodge</a>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/13.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Inn at Agus Beach</a>
                  <p class="mb-2 text-secondary-lighter"><span class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
                  <div class="d-flex align-items-center gap-3"><span class="badge badge-phoenix badge-phoenix-warning fs-8 fw-normal"><span class="fa-solid fa-star me-1 fs-9" data-fa-transform="up-1"></span><span class="badge-label">4.2</span></span>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/14.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel Cahya Nirwana</a>
                  <p class="mb-2 text-secondary-lighter"><span class="fa-solid fa-map-marker-alt me-2"></span>Jawa Tengah, Indonesia</p>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/15.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Villas at Atoll Haven</a>
                  <p class="mb-2 text-secondary-lighter"><span class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid" src="{{ asset('assets/img/hotels/16.png') }}" alt="">
                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end"><a class="stretched-link fs-7 text-white fw-bold" href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">The Sanchaya Hotel</a>
                  <p class="mb-2 text-secondary-lighter"><span class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
                  <div class="d-flex align-items-center gap-3"><span class="badge badge-phoenix badge-phoenix-warning fs-8 fw-normal"><span class="fa-solid fa-star me-1 fs-9" data-fa-transform="up-1"></span><span class="badge-label">4.5</span></span>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="hotelFilterOffcanvas" aria-labelledby="hotelFilterOffcanvasLabel">
        <div class="offcanvas-header p-4 bg-body-highlight">
          <h5 class="mb-0 text-body-highlight" id="hotelFilterOffcanvasLabel">Filter</h5><button class="btn btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body scrollbar p-4">
          ...
          <div class="row g-3">
            <div class="col-6">
              <div class="form-check"><input class="form-check-input" id="wifi" type="checkbox" value="wifi"><label class="form-check-label fs-8 text-body-highlight fw-normal" for="wifi">Wifi</label></div>
              <div class="form-check"><input class="form-check-input" id="kitchen" type="checkbox" value="kitchen"><label class="form-check-label fs-8 text-body-highlight fw-normal" for="kitchen">Kitchen</label></div>
              <div class="form-check"><input class="form-check-input" id="air-conditioning" type="checkbox" value="air-conditioning"><label class="form-check-label fs-8 text-body-highlight fw-normal" for="air-conditioning">Air conditioning</label></div>
            </div>
            <div class="col-6">
              <div class="form-check"><input class="form-check-input" id="washer" type="checkbox" value="washer"><label class="form-check-label fs-8 text-body-highlight fw-normal" for="washer">Washer</label></div>
              <div class="form-check"><input class="form-check-input" id="dryer" type="checkbox" value="dryer"><label class="form-check-label fs-8 text-body-highlight fw-normal" for="dryer">Dryer</label></div>
              <div class="form-check"><input class="form-check-input" id="heating" type="checkbox" value="heating"><label class="form-check-label fs-8 text-body-highlight fw-normal" for="heating">Heating</label></div>
            </div>
          </div>
          <p class="text-body-tertiary mt-3">Location</p>
          <div class="row g-3">
            <div class="col-6">
              <div class="form-check"><input class="form-check-input" id="beach-front" type="checkbox" value="beach-front"><label class="form-check-label fs-8 text-body-highlight fw-normal" for="beach-front">Beach-front</label></div>
              <div class="form-check"><input class="form-check-input" id="near-markets" type="checkbox" value="near-markets"><label class="form-check-label fs-8 text-body-highlight fw-normal" for="near-markets">Near markets</label></div>
            </div>
            <div class="col-6">
              <div class="form-check"><input class="form-check-input" id="water-front" type="checkbox" value="water-front"><label class="form-check-label fs-8 text-body-highlight fw-normal" for="water-front">Water-front</label></div>
            </div>
          ...
          <div class="input-group gap-2 w-70 w-sm-50" data-quantity="data-quantity"><button class="btn btn-phoenix-primary px-3 rounded" data-type="minus"><span class="fa-solid fa-minus"></span></button><input class="form-control border-translucent input-spin-none text-center rounded" id="private-bathrooms" type="number" value="2"><button class="btn btn-phoenix-primary px-3 rounded" data-type="plus"><span class="fa-solid fa-plus"></span></button></div>
          <h4 class="mb-4 mt-5 text-body-highlight">Number of Bedrooms</h4>
          <div class="input-group gap-2 w-70 w-sm-50" data-quantity="data-quantity"><button class="btn btn-phoenix-primary px-3 rounded" data-type="minus"><span class="fa-solid fa-minus"></span></button><input class="form-control border-translucent input-spin-none text-center rounded" id="bedrooms" type="number" value="2"><button class="btn btn-phoenix-primary px-3 rounded" data-type="plus"><span class="fa-solid fa-plus"></span></button></div>
          <h4 class="mb-4 mt-5 text-body-highlight">Number of Beds</h4>
          <div class="input-group gap-2 w-70 w-sm-50" data-quantity="data-quantity"><button class="btn btn-phoenix-primary px-3 rounded" data-type="minus"><span class="fa-solid fa-minus"></span></button><input class="form-control border-translucent input-spin-none text-center rounded" id="beds" type="number" value="2"><button class="btn btn-phoenix-primary px-3 rounded" data-type="plus"><span class="fa-solid fa-plus"></span></button></div>
          <hr class="my-5">
          <h4 class="mb-4">Rating</h4><input class="rating-radio btn-check" type="radio" name="ratingOption" id="option1" checked="checked"><label class="btn w-100 d-flex align-items-center gap-1 mb-2" for="option1"><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-check ms-auto text-primary check-icon"></span></label><input class="rating-radio btn-check" type="radio" name="ratingOption" id="option2"><label class="btn w-100 d-flex align-items-center gap-1 mb-2" for="option2"><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-star text-warning"></span><span class="fa-regular fa-star text-warning"></span><span class="text-body ms-1 fs-8 fw-normal">and above</span><span class="fa-solid fa-check ms-auto text-primary check-icon"></span></label><input class="rating-radio btn-check" type="radio" name="ratingOption" id="option3"><label class="btn w-100 d-flex align-items-center gap-1 mb-2" for="option3"><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-star text-warning"></span><span class="fa-regular fa-star text-warning"></span><span class="fa-regular fa-star text-warning"></span><span class="text-body ms-1 fs-8 fw-normal">and above</span><span class="fa-solid fa-check ms-auto text-primary check-icon"></span></label><input class="rating-radio btn-check" type="radio" name="ratingOption" id="option4"><label class="btn w-100 d-flex align-items-center gap-1 mb-2" for="option4"><span class="fa-solid fa-star text-warning"></span><span class="fa-solid fa-star text-warning"></span><span class="fa-regular fa-star text-warning"></span><span class="fa-regular fa-star text-warning"></span><span class="fa-regular fa-star text-warning"></span><span class="text-body ms-1 fs-8 fw-normal">and above</span><span class="fa-solid fa-check ms-auto text-primary check-icon"></span></label><input class="rating-radio btn-check" type="radio" name="ratingOption" id="option5"><label class="btn w-100 d-flex align-items-center gap-1" for="option5"><span class="fa-solid fa-star text-warning"></span><span class="fa-regular fa-star text-warning"></span><span class="fa-regular fa-star text-warning"></span><span class="fa-regular fa-star text-warning"></span><span class="fa-regular fa-star text-warning"></span><span class="text-body ms-1 fs-8 fw-normal">and above</span><span class="fa-solid fa-check ms-auto text-primary check-icon"></span></label>
        </div>
        <div class="p-4 border-top border-translucent d-flex gap-2"><button class="btn btn-lg btn-phoenix-primary">Reset</button>
          <button class="btn btn-lg btn-primary flex-1">Show 445 items</button>
        </div>
      </div>
      ...
      <div class="container-medium">
        <div class="row flex-center justify-content-md-between align-items-md-center gy-2 mb-3">
          <div class="col-auto"><a class="navbar-brand" href="{{ url('/') }}">
              <div class="d-flex align-items-center"><img src="{{ asset('assets/img/icons/logo.png') }}" alt="phoenix" width="27">
                <h5 class="logo-text ms-2">phoenix</h5>
              </div>
            </a></div>
