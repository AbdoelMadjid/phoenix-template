...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="ltr" data-navigation-type="default"
    ...
    <head>
        ...
        <link href="{{ asset('assets/css/theme-rtl.min.css') }}?v={{ time() }}" type="text/css"
            rel="stylesheet" id="style-rtl">
        <link href="{{ asset('assets/css/theme.min.css') }}?v={{ time() }}" type="text/css" rel="stylesheet"
            id="style-default">
        <link href="{{ asset('assets/css/user-rtl.min.css') }}?v={{ time() }}" type="text/css" rel="stylesheet"
            id="user-style-rtl">
        <link href="{{ asset('assets/css/user.min.css') }}?v={{ time() }}" type="text/css" rel="stylesheet"
        ...
        <main class="main" id="top">
            <div class="sticky-top bg-body" data-navbar-shadow-on-scroll="data-navbar-shadow-on-scroll">
                <nav class="navbar navbar-top navbar-expand-lg container-medium border-0 bg-body px-3 py-2"><button
                        ...
                        class="navbar-brand flex-1 flex-lg-grow-0 me-lg-8 me-xl-13" href="{{ url('/') }}">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-sm-3 gap-md-4 my-2 order-lg-1">
                        <div class="theme-control-toggle feather-icon-wait"><input
                                ...
                                for="themeControlToggleSm" data-bs-toggle="tooltip" data-bs-placement="left"
                                data-bs-title="Switch theme" style="height:32px;width:32px;"><span class="icon"
                                    data-feather="sun"></span></label></div><a
                            class="btn btn-link text-body-tertiary p-0" href="#!"><span data-feather="map-pin"
                                style="width: 18px; height: 18px"></span></a><a
                            class="btn btn-link text-body-tertiary p-0" href="#!"><span data-feather="bell"
                                style="width: 20px; height: 20px"></span></a><a
                            class="btn btn-link text-body-tertiary p-0"
                            href="{{ url('pages/authentication/card/sign-in') }}" data-bs-toggle="tooltip"
                            data-bs-placement="bottom" data-bs-title="Agent Login"><span data-feather="log-in"
                                style="width: 20px; height: 20px"></span></a><a
                    ...
                    <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center pb-0"
                        ...
                        <ul class="navbar-nav travel-nav-top me-auto" data-dropdown-on-hover="data-dropdown-on-hover">
                            <li class="nav-item dropdown"><a
                                    class="nav-link fs-8 fw-bold dropdown-toggle text-primary" href="#!"
                                    role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                                    aria-haspopup="true" aria-expanded="false">Hotel</a>
                                <ul class="dropdown-menu navbar-dropdown-caret">
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/hotel/customer/homepage') }}">Homepage</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel
                                            Details</a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/hotel/customer/hotel-compare') }}">Hotel
                                            Compare</a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/hotel/customer/checkout') }}">Check
                                            out</a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/hotel/customer/payment') }}">Payment</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/hotel/customer/gallery') }}">Gallery</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown"><a class="nav-link fs-8 fw-bold dropdown-toggle "
                            ...
                            <li class="nav-item dropdown"><a class="nav-link fs-8 fw-bold dropdown-toggle "
                                    href="#!" role="button" data-bs-toggle="dropdown"
                                    data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">Trip</a>
                                <ul class="dropdown-menu navbar-dropdown-caret">
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/trip/homepage') }}">Homepage</a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/trip/trip-details') }}">Trip Details</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/trip/checkout') }}">Checkout</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown"><a class="nav-link fs-8 fw-bold  " href="#!"
                                    role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                                    aria-haspopup="true" aria-expanded="false">Event</a></li>
                            <li class="nav-item dropdown"><a class="nav-link fs-8 fw-bold  " href="#!"
                                    role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                                    aria-haspopup="true" aria-expanded="false">Package</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
                ...
                <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
                    <ul class="navbar-nav justify-content-end align-items-center">
                        <li class="nav-item invisible" data-nav-item="data-nav-item"><a
                                class="nav-link px-3 ps-0 text-primary"
                                href="{{ url('apps/travel-agency/hotel/customer/homepage') }}">Homepage</a></li>
                        <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  "
                                href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel Details</a>
                        </li>
                        <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  "
                                href="{{ url('apps/travel-agency/hotel/customer/hotel-compare') }}">Hotel Compare</a>
                        </li>
                        <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  "
                                href="{{ url('apps/travel-agency/hotel/customer/checkout') }}">Check out</a></li>
                        <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  "
                                href="{{ url('apps/travel-agency/hotel/customer/payment') }}">Payment</a></li>
                        <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  "
                                href="{{ url('apps/travel-agency/hotel/customer/gallery') }}">Gallery</a></li>
                        <li class="nav-item dropdown" data-nav-item="data-nav-item" data-more-item="data-more-item">
                            <a class="nav-link dropdown-toggle dropdown-caret-none fw-bold pe-0 ps-3"
                                href="javascript: void(0)" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false" data-boundary="window"
                            ...
                            <div class="dropdown-menu dropdown-menu-end category-list"
                                aria-labelledby="navbarDropdown" data-category-list="data-category-list"></div>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <nav class="navbar navbar-landing navbar-home navbar-expand py-4 px-0">
                        <ul class="navbar-nav mx-auto mt-3 mt-lg-0 gap-2">
                            <li class="nav-item"><a class="nav-link fw-bold rounded-3 active" aria-current="page"
                                    href="{{ url('apps/travel-agency/hotel/customer/homepage') }}"> <span
            ...
            <div class="container-medium-md px-0 px-md-3">
                <div class="px-3 py-8 position-relative">
                    <div class="bg-holder overlay rounded-md-2"
                        style="background-image:url({{ asset('assets/img/bg/42.png') }});background-position: center; background-size: cover;">
                    </div>
                    <!--/.bg-holder-->
                    <div
                        ...
                        <div class="col-12 col-md">
                            <div
                                ...
                                <input class="form-control form-icon-input border-0 py-0 shadow-none fs-8"
                                    type="text" placeholder="Pick a place"><span
                        ...
                        <div class="col-6 col-md"><button class="btn px-3 fs-8 fw-semibold text-body-tertiary"
                                ...
                                data-bs-auto-close="outside"><span class="fa-solid fa-user me-2"></span>1
                                adult</button>
            ...
            <section class="py-0">
                <div class="container-medium">
                    <div class="py-6">
                        <div class="d-flex"><select class="form-select w-sm-auto me-4" id="hotelSort"
                                name="Hotel sort">
                                ...
                                class="btn btn-phoenix-secondary text-nowrap px-3 px-md-4 ms-auto me-2"><span
                                    class="fa-solid fa-map me-md-2"></span><span class="d-none d-md-inline-block">Show
                                    in map</span></button>
                            <button class="btn btn-phoenix-secondary text-nowrap px-3" type="button"
                                data-bs-toggle="offcanvas" data-bs-target="#hotelFilterOffcanvas"
                                aria-controls="hotelFilterOffcanvas"><span
                                    class="fa-solid fa-filter me-md-2"></span><span
                                    class="d-none d-md-inline-block">Filters</span></button>
                        </div>
                    </div>
                    <div class="row g-3 mb-6">
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/1.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel
                                        Palace</a>
                                    ...
                                    <div class="d-flex align-items-center gap-3"><span
                                            class="badge badge-phoenix badge-phoenix-warning fs-8 fw-normal"><span
                                                class="fa-solid fa-star me-1 fs-9"
                                                data-fa-transform="up-1"></span><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/2.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Silom
                                        Furama</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                                            class="fa-solid fa-map-marker-alt me-2"></span>Bangkok, Thailand</p>
                                    <div class="d-flex align-items-center gap-3"><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/3.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/4.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/5.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel Asia
                                        Solo</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                                            class="fa-solid fa-map-marker-alt me-2"></span>Jawa Tengah, Indonesia</p>
                                    <div class="d-flex align-items-center gap-3"><span
                                            class="badge badge-phoenix badge-phoenix-warning fs-8 fw-normal"><span
                                                class="fa-solid fa-star me-1 fs-9"
                                                data-fa-transform="up-1"></span><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/6.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Golden Inn
                                        Kuta</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                                            class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
                                    <div class="d-flex align-items-center gap-3"><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/7.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">The Shanty
                                        House</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                                            class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
                                    <div class="d-flex align-items-center gap-3"><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/8.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Hotel Kiwi
                                        International</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                                            class="fa-solid fa-map-marker-alt me-2"></span>New Zealand</p>
                                    <div class="d-flex align-items-center gap-3"><span
                                            class="badge badge-phoenix badge-phoenix-warning fs-8 fw-normal"><span
                                                class="fa-solid fa-star me-1 fs-9"
                                                data-fa-transform="up-1"></span><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/9.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Residences
                                        of the Angel</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/10.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Brenig
                                        Kulm's Gasthaus</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/11.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">The
                                        Andermatt Chedi</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/12.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Interlaken
                                        Alplodge</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/13.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Inn at
                                        Agus Beach</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                                            class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
                                    <div class="d-flex align-items-center gap-3"><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/14.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/15.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
                                    class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                                    <a class="stretched-link fs-7 text-white fw-bold"
                                        href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">Villas at
                                        Atoll Haven</a>
                                    <p class="mb-2 text-secondary-lighter"><span
                                            class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
                                    <div class="d-flex align-items-center gap-3"><span
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img
                                    class="img-fluid" src="{{ asset('assets/img/hotels/16.png') }}" alt="">
                                <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button
                                        class="btn btn-wish"><span class="far fa-heart"
                                            data-fa-transform="down-1"></span></button></div>
                                <div
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="hotelFilterOffcanvas"
                ...
                <div class="offcanvas-header p-4 bg-body-highlight">
                    <h5 class="mb-0 text-body-highlight" id="hotelFilterOffcanvasLabel">Filter</h5><button
                        class="btn btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
                <div class="offcanvas-body scrollbar p-4">
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <div class="form-icon-container"><input class="form-control form-icon-input"
                                    type="text" placeholder="Minimum amount: $245"><span
                                    class="fa-solid fa-dollar-sign form-icon text-body-tertiary fs-9"></span></div>
                        </div>
                        <div class="col-6">
                            <div class="form-icon-container"><input class="form-control form-icon-input"
                                    type="text" placeholder="Maximum amount: $245"><span
                                    class="fa-solid fa-dollar-sign form-icon text-body-tertiary fs-9"></span></div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="form-check"><input class="form-check-input" id="wifi" type="checkbox"
                                    value="wifi"><label class="form-check-label fs-8 text-body-highlight fw-normal"
                            ...
                            <div class="form-check"><input class="form-check-input" id="air-conditioning"
                                    type="checkbox" value="air-conditioning"><label
                                    class="form-check-label fs-8 text-body-highlight fw-normal"
                    ...
                    <div class="input-group gap-2 w-70 w-sm-50" data-quantity="data-quantity"><button
                            ...
                            class="form-control border-translucent input-spin-none text-center rounded"
                            id="private-bathrooms" type="number" value="2"><button
                    ...
                    <div class="input-group gap-2 w-70 w-sm-50" data-quantity="data-quantity"><button
                            class="btn btn-phoenix-primary px-3 rounded" data-type="minus"><span
                                class="fa-solid fa-minus"></span></button><input
                            class="form-control border-translucent input-spin-none text-center rounded" id="bedrooms"
                            type="number" value="2"><button class="btn btn-phoenix-primary px-3 rounded"
                            data-type="plus"><span class="fa-solid fa-plus"></span></button></div>
                    <h4 class="mb-4 mt-5 text-body-highlight">Number of Beds</h4>
                    <div class="input-group gap-2 w-70 w-sm-50" data-quantity="data-quantity"><button
                            class="btn btn-phoenix-primary px-3 rounded" data-type="minus"><span
                                class="fa-solid fa-minus"></span></button><input
                            class="form-control border-translucent input-spin-none text-center rounded" id="beds"
                            type="number" value="2"><button class="btn btn-phoenix-primary px-3 rounded"
                            data-type="plus"><span class="fa-solid fa-plus"></span></button></div>
                    <hr class="my-5">
                    <h4 class="mb-4">Rating</h4><input class="rating-radio btn-check" type="radio"
                        name="ratingOption" id="option1" checked="checked"><label
                        class="btn w-100 d-flex align-items-center gap-1 mb-2" for="option1"><span
                            class="fa-solid fa-star text-warning"></span><span
                            class="fa-solid fa-star text-warning"></span><span
                            class="fa-solid fa-star text-warning"></span><span
                            class="fa-solid fa-star text-warning"></span><span
                            class="fa-solid fa-star text-warning"></span><span
                            class="fa-solid fa-check ms-auto text-primary check-icon"></span></label><input
                        class="rating-radio btn-check" type="radio" name="ratingOption" id="option2"><label
                        class="btn w-100 d-flex align-items-center gap-1 mb-2" for="option2"><span
                            ...
                            class="text-body ms-1 fs-8 fw-normal">and above</span><span
                            class="fa-solid fa-check ms-auto text-primary check-icon"></span></label><input
                        class="rating-radio btn-check" type="radio" name="ratingOption" id="option3"><label
                        class="btn w-100 d-flex align-items-center gap-1 mb-2" for="option3"><span
                            ...
                            class="text-body ms-1 fs-8 fw-normal">and above</span><span
                            class="fa-solid fa-check ms-auto text-primary check-icon"></span></label><input
                        class="rating-radio btn-check" type="radio" name="ratingOption" id="option4"><label
                        class="btn w-100 d-flex align-items-center gap-1 mb-2" for="option4"><span
                            ...
                            class="text-body ms-1 fs-8 fw-normal">and above</span><span
                            class="fa-solid fa-check ms-auto text-primary check-icon"></span></label><input
                        class="rating-radio btn-check" type="radio" name="ratingOption" id="option5"><label
                        class="btn w-100 d-flex align-items-center gap-1" for="option5"><span
                            ...
                            class="fa-regular fa-star text-warning"></span><span
                            class="text-body ms-1 fs-8 fw-normal">and above</span><span
                            class="fa-solid fa-check ms-auto text-primary check-icon"></span></label>
                </div>
                <div class="p-4 border-top border-translucent d-flex gap-2"><button
                        class="btn btn-lg btn-phoenix-primary">Reset</button>
                    ...
                    <div class="p-5 p-sm-7 py-xl-12 px-xl-15 rounded-md-2 overflow-hidden position-relative">
                        ...
                        <div class="row g-5 position-relative justify-content-between">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col">
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li class="mb-1"><a class="text-secondary-lighter" href="#!">EMI
                                                    Policy</a></li>
                                            <li class="mb-1"><a class="text-secondary-lighter"
                            ...
                            <div class="col-lg-5">
                                ...
                                <p class="mb-5 text-secondary-lighter">Sign up and get notified<br>about best deals
                                    immediately </p>
                                <div class="d-flex gap-2">
                                    <div class="form-icon-container flex-1"><input
                                            class="form-control form-icon-input" type="text"
                                            placeholder="Your email address"><span
                                            class="fa-solid fa-envelope form-icon text-body fs-9"
                                            data-fa-transform="up-2"></span></div><button
                ...
                <div class="row flex-center justify-content-md-between align-items-md-center gy-2 mb-3">
                    ...
                    <div class="col-auto">
                        <ul class="d-flex flex-center flex-wrap gap-x-5 gap-y-1 list-unstyled mb-0">
                            <li><a class="lh-1 text-body-tertiary fw-semibold fs-9" href="#!">Become a Host</a>
                            </li>
                            ...
                            <li><a class="lh-1 text-body-tertiary fw-semibold fs-9" href="mailto:example@gmail.com">
                                    <span class="fa-regular fa-envelope me-2"
                                        data-fa-transform="down-1"></span>Support</a></li>
                ...
                <div class="container-fluid support-chat">
                    <div class="card bg-body-emphasis">
                        ...
                        class="ping-icon-wrapper mt-n4 ms-n6 mt-sm-0 ms-sm-2 position-absolute position-sm-relative"><span
                            class="ping-icon-bg"></span><span
                            class="fa-solid fa-circle ping-icon"></span></span><span
        ...
        <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
            ...
            <div class="offcanvas-body scrollbar px-card" id="themeController">
                    ...
                    <div class="row gx-2">
                        <div class="col-4"><input class="btn-check" id="themeSwitcherLight" name="theme-color"
                                ...
                                class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherLight"> <span
                                    class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                        src="{{ asset('assets/img/generic/default-light.png') }}"
                        ...
                        <div class="col-4"><input class="btn-check" id="themeSwitcherDark" name="theme-color"
                                ...
                                class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherDark"> <span
                                    class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                        src="{{ asset('assets/img/generic/default-dark.png') }}"
                        ...
                        <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color"
                                ...
                                class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherAuto"> <span
                                    class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                        src="{{ asset('assets/img/generic/auto.png') }}"
                ...
                <div class="setting-panel-item">
                    ...
                    <div class="row gx-2">
                        ...
                        <div class="col-6"><input class="btn-check" id="navbarPositionHorizontal"
                                ...
                                data-theme-control="phoenixNavbarPosition" disabled="disabled"><label
                                class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionHorizontal">
                                <span class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                        ...
                                        src="{{ asset('assets/img/generic/top-default-dark.png') }}"
                        ...
                        <div class="col-6"><input class="btn-check" id="navbarPositionCombo"
                                ...
                                class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionCombo"> <span
                                    class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                        src="{{ asset('assets/img/generic/nav-combo-light.png') }}"
                                        alt=""><img class="img-fluid img-prototype d-light-none"
                                        src="{{ asset('assets/img/generic/nav-combo-dark.png') }}"
                        ...
                        <div class="col-6"><input class="btn-check" id="navbarPositionTopDouble"
                                ...
                                data-theme-control="phoenixNavbarPosition" disabled="disabled"><label
                                class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionTopDouble">
                                <span class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                        src="{{ asset('assets/img/generic/dual-light.png') }}" alt=""><img
                                        class="img-fluid img-prototype d-light-none"
                                        src="{{ asset('assets/img/generic/dual-dark.png') }}"
                    ...
                    <div class="row gx-2">
                        ...
                        <div class="col-6"><input class="btn-check" id="navbar-style-dark" type="radio"
                                ...
                                for="navbar-style-dark"> <img class="img-fluid img-prototype d-dark-none"
                                    ...
                                    class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('assets/img/generic/vertical-lighter.png') }}"
                    ...
                    <div class="row gx-2">
                        ...
                        <div class="col-6"><input class="btn-check" id="navbarShapeSlim" name="navbar-shape"
                                ...
                                for="navbarShapeSlim"> <span class="mb-2 rounded d-block"><img
                                        ...
                                        class="img-fluid img-prototype d-light-none mb-0"
                                        src="{{ asset('assets/img/generic/top-slim-dark.png') }}"
                ...
                <div class="setting-panel-item">
                    ...
                    <div class="row gx-2">
                        <div class="col-6"><input class="btn-check" id="navbarTopDefault"
                                ...
                                class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDefault"> <span
                                    class="mb-2 rounded d-block"><img
                                        class="img-fluid img-prototype d-dark-none mb-0"
                                        src="{{ asset('assets/img/generic/top-default.png') }}"
                                        alt=""><img class="img-fluid img-prototype d-light-none mb-0"
                                        src="{{ asset('assets/img/generic/top-style-darker.png') }}"
                                        alt=""></span><span class="label-text">Default</span></label></div>
                        <div class="col-6"><input class="btn-check" id="navbarTopDarker"
                                ...
                                class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDarker"> <span
                                    class="mb-2 rounded d-block"><img
                                        class="img-fluid img-prototype d-dark-none mb-0"
                                        src="{{ asset('assets/img/generic/navbar-top-style-light.png') }}"
                                        alt=""><img class="img-fluid img-prototype d-light-none mb-0"
                                        src="{{ asset('assets/img/generic/top-style-lighter.png') }}"
                                        alt=""></span><span
                    ...
                    href="https://themewagon.com/themes/phoenix/" target="_blank">Purchase template</a>
            </div>
