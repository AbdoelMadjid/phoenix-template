                            ...
                            <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-hotel-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-hotel-admin">
                              ...
                              <div class="parent-wrapper">
                                <ul class="nav collapse parent show" data-bs-parent="#hotel" id="nv-hotel-admin">
                                  <li class="nav-item"><a class="nav-link active" href="{{ url('add-property') }}">
                                  ...
                                  <li class="nav-item"><a class="nav-link" href="{{ url('room-search') }}">
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="hotel" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="hotel-admin" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                          ...
                          <ul class="dropdown-menu">
                            <li><a class="dropdown-item active" href="{{ url('add-property') }}">
                            ...
                            <li><a class="dropdown-item" href="{{ url('room-search') }}">
                ...
                <div class="row">
                  <div class="col-xxl-8">
                    <div class="tab-content">
                      <div class="tab-pane active" role="tabpanel" aria-labelledby="add-property-wizard-tab1" id="add-property-wizard-tab1">
                        <form id="addPropertyWizardForm1" data-wizard-form="1">
                          ...
                          <div class="form-floating"><input class="form-control" type="text" name="add-property-wizard-name" id="add-property-wizardwizard-name" placeholder="Property Name" value="With help text"><label for="add-property-wizardwizard-name">Property Name</label>
                            <h5 class="text-end text-body-quaternary fw-semibold mt-2"><span class="text-primary">15 </span>/ 60</h5>
                          </div>
                          <div class="form-floating my-3"><textarea class="form-control" placeholder="Description" name="add-property-wizard-message" id="add-property-wizard-wizard-des" style="height: 162px"></textarea><label for="add-property-wizard-wizard-des">DESCRIPTION</label>
                            <h5 class="text-end text-body-quaternary fw-semibold mt-2"><span class="text-primary">0 </span>/ 360</h5>
                          </div>
                          <div class="row g-3">
                            <div class="col-md-8 col-lg-12 col-xl-8">
                              <div class="form-floating"><select class="form-select" name="add-property-wizard-type" id="add-property-wizardproperty-type">
                                  <option selected="selected" value="1">Hotel</option>
                                  <option value="1">Flight</option>
                                  <option value="2">Trip</option>
                                </select><label for="add-property-wizardproperty-type">Property Type</label></div>
                            </div>
                            <div class="col-md-4 col-lg-12 col-xl-4">
                              <div class="form-icon-container">
                                <div class="form-floating"><select class="form-select form-icon-input" name="add-property-wizard-type" id="add-property-wizardrating-type">
                                    <option selected="selected" value="5">5 star</option>
                                    <option value="4">4 star</option>
                                    <option value="3">3 star</option>
                                    <option value="2">2 star</option>
                                    <option value="1">1 star</option>
                                  </select><label class="text-body-tertiary form-icon-label" for="add-property-wizardrating-type">Rating</label></div><span class="fa-solid fa-star text-warning form-icon fs-10"></span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row g-3">
                            <div class="col-md-6">
                              <div class="form-floating"><input class="form-control input-spin-none" type="email" name="add-property-wizard-email" id="add-property-wizardwizard-email" placeholder="Email Address"><label for="add-property-wizardwizard-email">Email Address</label></div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-floating"><input class="form-control input-spin-none" type="number" name="add-property-wizard-phone" id="add-property-wizardwizard-phone" placeholder="Phone number"><label for="add-property-wizardwizard-phone">Phone number</label></div>
                            </div>
                          </div>
                          <h4 class="mt-6 mb-3">Is it part of a hotel / property chain?</h4>
                          <div class="row align-items-center g-3">
                            <div class="col-sm-auto">
                              <div class="form-check form-check-inline me-4 me-sm-7 mb-0"><input class="form-check-input" id="no1" type="radio" name="CheckIsHotelRadio" value="no" checked="checked"><label class="form-check-label" for="no1">No</label></div>
                              <div class="form-check form-check-inline me-0 mb-0"><input class="form-check-input" id="yes1" type="radio" name="CheckIsHotelRadio" value="yes"><label class="form-check-label" for="yes1">Yes</label></div>
                            </div>
                            <div class="col-sm-auto flex-1">
                              <div class="form-floating"><input class="form-control" type="text" name="add-property-wizard-company" id="add-property-wizardwizard-company" placeholder="Name of Company, Group or Chain" value="With help text" disabled="disabled"><label for="add-property-wizardwizard-company">Name of Company, Group or Chain</label></div>
                            </div>
                          </div>
                          <h4 class="mt-6 mb-3">Do you use a Channel Management Systems?</h4>
                          <div class="row align-items-center g-3">
                            <div class="col-sm-auto">
                              <div class="form-check form-check-inline me-4 me-sm-7 mb-0"><input class="form-check-input" id="no2" type="radio" name="CheckUseRadio" value="no"><label class="form-check-label" for="no2">No</label></div>
                              <div class="form-check form-check-inline me-0 mb-0"><input class="form-check-input" id="yes2" type="radio" name="CheckUseRadio" value="yes" checked="checked"><label class="form-check-label" for="yes2">Yes</label></div>
                            </div>
                            <div class="col-sm-auto flex-1">
                              <div class="form-floating"><input class="form-control" type="text" name="add-property-wizard-cms" id="add-property-wizardwizard-cms" placeholder="CMS Provider name" value=""><label for="add-property-wizardwizard-cms">CMS Provider name</label><span class="fa-solid fa-search position-absolute text-body-quaternary fs-9 end-0 top-0 mt-3 me-3" data-fa-transform="down-2"></span></div>
                            </div>
                          </div>
                        </form>
                      </div>
                      <div class="tab-pane" role="tabpanel" aria-labelledby="add-property-wizard-tab2" id="add-property-wizard-tab2">
                        <form id="addPropertyWizardForm2" novalidate="novalidate" data-wizard-form="2">
                          ...
                          <div class="form-icon-container">
                            <div class="form-floating"><input class="form-control form-icon-input" type="text" name="add-property-wizard-search-address" id="add-property-wizardwizard-search-address" placeholder="Search address..."><label class="text-body-tertiary form-icon-label" for="add-property-wizardwizard-search-address">Search address...</label></div><span class="fa-solid fa-location-dot text-body form-icon fs-10"></span><span class="fa-solid fa-location-crosshairs position-absolute text-primary fs-9 end-0 top-0 mt-3 me-3" data-fa-transform="down-2"></span>
                          </div>
                        ...
                        <form id="addPropertyWizardForm6" novalidate="novalidate" data-wizard-form="6">
                          ...
                          <div class="row g-3 align-items-center">
                            <div class="col-12 col-sm-6 col-md-auto flex-md-grow-1">
                              <div class="form-floating"><input class="form-control datetimepicker" id="checkInStarts" type="text" placeholder="H:i" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}'><label for="checkInStarts">Check-in Starts</label></div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-auto flex-md-grow-1">
                              <div class="form-floating"><input class="form-control datetimepicker" id="checkInEnds" type="text" placeholder="H:i" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}'><label for="checkInEnds">Check-in Ends</label></div>
                            </div>
                          ...
                          <div class="form-floating mb-3"><input class="form-control datetimepicker" id="chcckOutBefore" type="text" placeholder="H:i" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}'><label for="chcckOutBefore">Checkout Before</label></div>
                          <div class="form-price-tier border p-3 rounded-2" data-form-price-tier="data-form-price-tier">
                            <div class="d-sm-flex align-items-center gap-3">
                            ...
                            <div class="collapse" data-pricing-collapse="data-pricing-collapse">
                              <div class="p-4 bg-primary-subtle rounded-3 mt-3">
                                ...
                                <div class="form-check mb-4"><input class="form-check-input" id="flexible-checkout-option3" type="checkbox"><label class="form-check-label fw-normal fs-8 fw-semibold" for="flexible-checkout-option3">Option 3</label></div><button class="btn btn-link p-0"><span class="fa-solid fa-plus me-2"></span>Additional Condition</button>
                              </div>
                            </div>
                          </div>
                          ...
                          </div><button class="btn btn-link p-0 mt-3 fs-8"><span class="fa-solid fa-plus me-2"></span>Add Segment</button>
                          ...
                          <div class="form-price-tier border p-3 rounded-2 mb-3" data-form-price-tier="data-form-price-tier">
                            ...
                            <div class="collapse" data-pricing-collapse="data-pricing-collapse">
                              <div class="p-4 bg-primary-subtle rounded-3 mt-3">
                                ...
                                <div class="form-check mb-4"><input class="form-check-input" id="vat-option3" type="checkbox"><label class="form-check-label fw-normal fs-8 fw-semibold" for="vat-option3">Option 3</label></div><button class="btn btn-link p-0"><span class="fa-solid fa-plus me-2"></span>Additional Condition</button>
                              </div>
                            </div>
                          </div>
                          <div class="form-price-tier border p-3 rounded-2 mb-3" data-form-price-tier="data-form-price-tier">
                            ...
                            <div class="collapse" data-pricing-collapse="data-pricing-collapse">
                              <div class="p-4 bg-primary-subtle rounded-3 mt-3">
                                ...
                                <div class="form-check mb-4"><input class="form-check-input" id="gst-option3" type="checkbox"><label class="form-check-label fw-normal fs-8 fw-semibold" for="gst-option3">Option 3</label></div><button class="btn btn-link p-0"><span class="fa-solid fa-plus me-2"></span>Additional Condition</button>
                              </div>
                            </div>
                          </div>
                          <div class="form-price-tier border p-3 rounded-2 mb-3" data-form-price-tier="data-form-price-tier">
                            ...
                            <div class="collapse" data-pricing-collapse="data-pricing-collapse">
                              <div class="p-4 bg-primary-subtle rounded-3 mt-3">
                                ...
                                <div class="form-check mb-4"><input class="form-check-input" id="holet-tax-option3" type="checkbox"><label class="form-check-label fw-normal fs-8 fw-semibold" for="holet-tax-option3">Option 3</label></div><button class="btn btn-link p-0"><span class="fa-solid fa-plus me-2"></span>Additional Condition</button>
                              </div>
                            </div>
                          </div>
                          <div class="form-price-tier border p-3 rounded-2 mb-3" data-form-price-tier="data-form-price-tier">
                            ...
                            <div class="collapse" data-pricing-collapse="data-pricing-collapse">
                              <div class="p-4 bg-primary-subtle rounded-3 mt-3">
                                ...
                                <div class="form-check mb-4"><input class="form-check-input" id="city-tax-option3" type="checkbox"><label class="form-check-label fw-normal fs-8 fw-semibold" for="city-tax-option3">Option 3</label></div><button class="btn btn-link p-0"><span class="fa-solid fa-plus me-2"></span>Additional Condition</button>
                              </div>
                            </div>
                          </div>
                          <div class="form-price-tier border p-3 rounded-2" data-form-price-tier="data-form-price-tier">
                            ...
                            <div class="collapse" data-pricing-collapse="data-pricing-collapse">
                              <div class="p-4 bg-primary-subtle rounded-3 mt-3">
                                ...
                                <div class="form-check mb-4"><input class="form-check-input" id="tourist-tax-option3" type="checkbox"><label class="form-check-label fw-normal fs-8 fw-semibold" for="tourist-tax-option3">Option 3</label></div><button class="btn btn-link p-0"><span class="fa-solid fa-plus me-2"></span>Additional Condition</button>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="tab-pane" role="tabpanel" aria-labelledby="add-property-wizard-tab7" id="add-property-wizard-tab7">
                        ...
                        <div class="accordion-button-arrow-icon accordion mt-2" id="previewAccordion">
                          <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-5">
                            <h5 class="accordion-header"><button class="accordion-button py-0 text-body-highlight" type="button" data-bs-toggle="collapse" data-bs-target="#basicInfo" aria-expanded="true" aria-controls="basicInfo"><img class="me-2 d-dark-none" src="{{ asset('assets/img/icons/info.svg') }}" alt=""><img class="me-2 d-light-none" src="{{ asset('assets/img/icons/info_dark.svg') }}" alt=""><span class="fs-sm-7">Basic Information</span></button></h5>
                          ...
                          <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-5">
                            <h5 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#location" aria-expanded="true" aria-controls="location"><img class="me-2 d-dark-none" src="{{ asset('assets/img/icons/location.svg') }}" alt=""><img class="me-2 d-light-none" src="{{ asset('assets/img/icons/location_dark.svg') }}" alt=""><span class="fs-sm-7">Location</span></button></h5>
                          ...
                          <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-5">
                            <h5 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#generalAmenities" aria-expanded="true" aria-controls="generalAmenities"><img class="me-2 d-dark-none" src="{{ asset('assets/img/icons/bed-double.svg') }}" alt=""><img class="me-2 d-light-none" src="{{ asset('assets/img/icons/bed-double_dark.svg') }}" alt=""><span class="fs-sm-7">General Amenities</span></button></h5>
                          ...
                          <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-5">
                            <h5 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#pictures" aria-expanded="true" aria-controls="pictures"><img class="me-2 d-dark-none" src="{{ asset('assets/img/icons/picture.svg') }}" alt=""><img class="me-2 d-light-none" src="{{ asset('assets/img/icons/picture_dark.svg') }}" alt=""><span class="fs-sm-7">Picture</span></button></h5>
                          ...
                          <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-5">
                            <h5 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#finance" aria-expanded="true" aria-controls="finance"><img class="me-2 d-dark-none" src="{{ asset('assets/img/icons/dollar-alt.svg') }}" alt=""><img class="me-2 d-light-none" src="{{ asset('assets/img/icons/dollar-alt_dark.svg') }}" alt=""><span class="fs-sm-7">Finance</span></button></h5>
                          ...
                          <div class="accordion-item border rounded-3 bg-body-emphasis p-3 p-sm-4 mb-5">
                            <h5 class="accordion-header"><button class="accordion-button py-0 text-body-highlight collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#policy" aria-expanded="true" aria-controls="policy"><img class="me-2 d-dark-none" src="{{ asset('assets/img/icons/file-check-alt.svg') }}" alt=""><img class="me-2 d-light-none" src="{{ asset('assets/img/icons/file-check-alt_dark.svg') }}" alt=""><span class="fs-sm-7">Policy</span></button></h5>
                    ...
                    <div class="mt-6" data-wizard-footer="data-wizard-footer">
                      <div class="d-none" data-wizard-prev-btn="data-wizard-prev-btn"></div><button class="btn btn-primary px-6 px-sm-11" type="submit" data-wizard-next-btn="data-wizard-next-btn">Next</button>
                    </div>
                  </div>
                </div>
              </div>
