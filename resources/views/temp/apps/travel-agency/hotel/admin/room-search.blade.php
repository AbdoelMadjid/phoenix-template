          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-travel-agency" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-travel-agency">
                    <div class="d-flex align-items-center">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-travel-agency">
                      <li class="collapsed-nav-item-title d-none">Travel agency</li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('landing') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Landing</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-hotel" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-hotel">
                          <div class="d-flex align-items-center">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#travel-agency" id="nv-hotel">
                            <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-hotel-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-hotel-admin">
                                <div class="d-flex align-items-center">
                                  <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-text">Admin</span>
                                </div>
                              </a><!-- more inner pages-->
                              <div class="parent-wrapper">
                                <ul class="nav collapse parent show" data-bs-parent="#hotel" id="nv-hotel-admin">
                                  <li class="nav-item"><a class="nav-link" href="{{ url('add-property') }}">
                                      <div class="d-flex align-items-center"><span class="nav-link-text">Add property</span></div>
                                    </a><!-- more inner pages-->
                                  </li>
                                  <li class="nav-item"><a class="nav-link" href="{{ url('add-room') }}">
                                      <div class="d-flex align-items-center"><span class="nav-link-text">Add room</span></div>
                                    </a><!-- more inner pages-->
                                  </li>
                                  <li class="nav-item"><a class="nav-link" href="{{ url('room-listing') }}">
                                      <div class="d-flex align-items-center"><span class="nav-link-text">Room listing</span></div>
                                    </a><!-- more inner pages-->
                                  </li>
                                  <li class="nav-item"><a class="nav-link active" href="{{ url('room-search') }}">
                            ...
                            <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-hotel-customer" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-hotel-customer">
                              ...
                              <div class="parent-wrapper">
                                <ul class="nav collapse parent" data-bs-parent="#hotel" id="nv-hotel-customer">
                                  <li class="nav-item"><a class="nav-link" href="{{ url('customer/homepage') }}">
                                      <div class="d-flex align-items-center"><span class="nav-link-text">Homepage</span></div>
                                    </a><!-- more inner pages-->
                                  </li>
                                  <li class="nav-item"><a class="nav-link" href="{{ url('customer/hotel-details') }}">
                                      <div class="d-flex align-items-center"><span class="nav-link-text">Hotel details</span></div>
                                    </a><!-- more inner pages-->
                                  </li>
                                  <li class="nav-item"><a class="nav-link" href="{{ url('customer/hotel-compare') }}">
                                      <div class="d-flex align-items-center"><span class="nav-link-text">Hotel compare</span></div>
                                    </a><!-- more inner pages-->
                                  </li>
                                  <li class="nav-item"><a class="nav-link" href="{{ url('customer/checkout') }}">
                                      <div class="d-flex align-items-center"><span class="nav-link-text">Checkout</span></div>
                                    </a><!-- more inner pages-->
                                  </li>
                                  <li class="nav-item"><a class="nav-link" href="{{ url('customer/payment') }}">
                                      <div class="d-flex align-items-center"><span class="nav-link-text">Payment</span></div>
                                    </a><!-- more inner pages-->
                                  </li>
                                  <li class="nav-item"><a class="nav-link" href="{{ url('customer/gallery') }}">
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-flight" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-flight">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent" data-bs-parent="#travel-agency" id="nv-flight">
                            <li class="nav-item"><a class="nav-link" href="{{ url('flight/homepage') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Homepage</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('flight/booking') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Booking</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('flight/payment') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Payment</span></div>
                              </a><!-- more inner pages-->
                            </li>
                          </ul>
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-trip" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-trip">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent" data-bs-parent="#travel-agency" id="nv-trip">
                            <li class="nav-item"><a class="nav-link" href="{{ url('trip/homepage') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Homepage</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('trip/trip-details') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Trip details</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('trip/checkout') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Checkout</span></div>
                              </a><!-- more inner pages-->
                            </li>
                          </ul>
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="travel-agency" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ url('landing') }}">
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="hotel" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="hotel-customer" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                          ...
                          <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ url('customer/homepage') }}">
                                <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Homepage</div>
                              </a></li>
                            <li><a class="dropdown-item" href="{{ url('customer/hotel-details') }}">
                                <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Hotel details</div>
                              </a></li>
                            <li><a class="dropdown-item" href="{{ url('customer/hotel-compare') }}">
                                <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Hotel compare</div>
                              </a></li>
                            <li><a class="dropdown-item" href="{{ url('customer/checkout') }}">
                                <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Checkout</div>
                              </a></li>
                            <li><a class="dropdown-item" href="{{ url('customer/payment') }}">
                                <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Payment</div>
                              </a></li>
                            <li><a class="dropdown-item" href="{{ url('customer/gallery') }}">
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="flight" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ url('flight/homepage') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Homepage</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('flight/booking') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Booking</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('flight/payment') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Payment</div>
                          </a></li>
                      </ul>
                    </li>
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="trip" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ url('trip/homepage') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Homepage</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('trip/trip-details') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Trip details</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ url('trip/checkout') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Checkout</div>
                          </a></li>
                      </ul>
                    </li>
          ...
          <div class="row align-items-end mb-5 gy-3">
            ...
            <div class="col-xl">
              <div class="row gx-2 gx-xl-3 gy-3">
                <div class="col-sm-auto order-1 order-sm-0 me-sm-2 d-xl-none"><button class="btn btn-lg btn-phoenix-secondary text-body-tertiary w-100" data-phoenix-toggle="offcanvas" data-phoenix-target="#roomFilterOffcanvas"> <span class="fa-solid fa-filter me-2"></span>Filter</button></div>
                <div class="col col-sm-5 col-xxl-3">
                  <div class="form-floating w-auto"><input class="form-control datetimepicker" id="checkIn" type="text" placeholder="H:i" data-options='{"disableMobile":true,"mode":"range","minDate":"today","dateFormat":"d-m-y"}'><label for="checkIn">Select time range</label><span class="fa-solid fa-calendar-alt position-absolute top-0 end-0 mt-3 me-3"></span></div>
                </div>
                <div class="col col-sm-auto flex-grow-0"><button class="btn btn-lg btn-phoenix-primary px-xxl-6 text-nowrap"><span class="d-none d-xl-inline-block">Update </span><span class="fa-solid fa-search fs-9 ms-xl-2"></span></button></div>
                <div class="col col-sm-auto ms-auto flex-grow-0"><button class="btn btn-lg btn-phoenix-secondary ms-auto text-nowrap"><span class="d-none d-xl-inline-block">Refresh </span><span class="fa-solid fa-rotate fs-9 ms-xl-2"></span></button></div>
              </div>
            </div>
          </div>
          <div class="row gx-6">
            <div class="col-xl-auto">
              <div class="phoenix-offcanvas-filter-xl phoenix-offcanvas phoenix-offcanvas-fixed bg-body scrollbar overflow-x-hidden" id="roomFilterOffcanvas" data-breakpoint="xl">
                <div class="pe-1" data-collapse-all="data-collapse-all">
                  <div class="d-flex align-items-center">
                    <h3 class="text-body-highlight">Filters</h3><button class="btn btn-phoenix-secondary px-3 ms-auto me-2 me-xl-0" data-btn-collapse-all="data-btn-collapse-all">Collapse all</button>
                    <button class="btn d-xl-none p-0" data-phoenix-dismiss="offcanvas"><span class="uil uil-times fs-8"></span></button>
                  </div><a class="btn collapse-indicator px-0 py-2 d-flex align-items-center mt-3" data-bs-toggle="collapse" href="#collapsePriceRange" role="button" aria-expanded="true" aria-controls="collapsePriceRange"><span class="fa-solid fa-caret-down toggle-icon text-body me-2"></span>
                  ...
                  <div class="collapse show" id="collapsePriceRange">
                    <div class="border-bottom pb-4 pt-1">
                      <div class="noUi-target-primary noUi-handle-primary noUi-slider-slim noUi-handle-circle bg-primary-subtle px-2 mb-3" data-nouislider='{"range":{"min":500,"max":2000},"start":[699,1299],"connect":true}'></div>
                      <div class="row g-2">
                        <div class="col-6">
                  ...
                  </div><a class="btn collapse-indicator px-0 py-2 d-flex align-items-center mt-3" data-bs-toggle="collapse" href="#collapseAdult" role="button" aria-expanded="true" aria-controls="collapseAdult"><span class="fa-solid fa-caret-down toggle-icon text-body me-2"></span>
                    <h5 class="text-body-highlight">Adult</h5>
                  </a>
                  <div class="collapse show" id="collapseAdult">
                    <div class="border-bottom pb-4">
                      <div class="input-group gap-2" data-quantity="data-quantity"><button class="btn btn-phoenix-primary px-3 rounded" data-type="minus"><span class="fa-solid fa-minus px-1"></span></button><input class="form-control form-control-lg border-translucent input-spin-none text-center rounded" id="adult" type="number" value="2"><button class="btn btn-phoenix-primary px-3 rounded" data-type="plus"><span class="fa-solid fa-plus px-1"></span></button></div>
                    </div>
                  </div><a class="btn collapse-indicator px-0 py-2 d-flex align-items-center mt-3" data-bs-toggle="collapse" href="#collapseChild" role="button" aria-expanded="true" aria-controls="collapseChild"><span class="fa-solid fa-caret-down toggle-icon text-body me-2"></span>
                    <h5 class="text-body-highlight">Child</h5>
                  </a>
                  <div class="collapse show" id="collapseChild">
                    <div class="border-bottom pb-4">
                      <div class="input-group gap-2" data-quantity="data-quantity"><button class="btn btn-phoenix-primary px-3 rounded" data-type="minus"><span class="fa-solid fa-minus px-1"></span></button><input class="form-control form-control-lg border-translucent input-spin-none text-center rounded" id="child" type="number" value="2"><button class="btn btn-phoenix-primary px-3 rounded" data-type="plus"><span class="fa-solid fa-plus px-1"></span></button></div>
                    </div>
                  </div><a class="btn collapse-indicator px-0 py-2 d-flex align-items-center mt-3" data-bs-toggle="collapse" href="#collapseBedroom" role="button" aria-expanded="true" aria-controls="collapseBedroom"><span class="fa-solid fa-caret-down toggle-icon text-body me-2"></span>
                    <h5 class="text-body-highlight">Bedroom</h5>
                  </a>
                  <div class="collapse show" id="collapseBedroom">
                    <div class="border-bottom pb-4">
                      <div class="input-group gap-2" data-quantity="data-quantity"><button class="btn btn-phoenix-primary px-3 rounded" data-type="minus"><span class="fa-solid fa-minus px-1"></span></button><input class="form-control form-control-lg border-translucent input-spin-none text-center rounded" id="bedroom" type="number" value="2"><button class="btn btn-phoenix-primary px-3 rounded" data-type="plus"><span class="fa-solid fa-plus px-1"></span></button></div>
                    </div>
                  </div><a class="btn collapse-indicator px-0 py-2 d-flex align-items-center mt-3" data-bs-toggle="collapse" href="#collapseNumOfBed" role="button" aria-expanded="true" aria-controls="collapseNumOfBed"><span class="fa-solid fa-caret-down toggle-icon text-body me-2"></span>
                    <h5 class="text-body-highlight">Number of Bed</h5>
                  </a>
                  <div class="collapse show" id="collapseNumOfBed">
                    <div class="border-bottom pb-4">
                      <div class="input-group gap-2" data-quantity="data-quantity"><button class="btn btn-phoenix-primary px-3 rounded" data-type="minus"><span class="fa-solid fa-minus px-1"></span></button><input class="form-control form-control-lg border-translucent input-spin-none text-center rounded" id="numberOfBed" type="number" value="2"><button class="btn btn-phoenix-primary px-3 rounded" data-type="plus"><span class="fa-solid fa-plus px-1"></span></button></div>
                    </div>
                  </div><a class="btn collapse-indicator px-0 py-2 d-flex align-items-center mt-3" data-bs-toggle="collapse" href="#collapseBathroom" role="button" aria-expanded="true" aria-controls="collapseBathroom"><span class="fa-solid fa-caret-down toggle-icon text-body me-2"></span>
                    <h5 class="text-body-highlight">Bathroom</h5>
                  </a>
                  <div class="collapse show" id="collapseBathroom">
                    <div class="border-bottom pb-4">
                      <div class="input-group gap-2" data-quantity="data-quantity"><button class="btn btn-phoenix-primary px-3 rounded" data-type="minus"><span class="fa-solid fa-minus px-1"></span></button><input class="form-control form-control-lg border-translucent input-spin-none text-center rounded" id="bathroom" type="number" value="2"><button class="btn btn-phoenix-primary px-3 rounded" data-type="plus"><span class="fa-solid fa-plus px-1"></span></button></div>
                    </div>
                  </div><a class="btn collapse-indicator px-0 py-2 d-flex align-items-center mt-3" data-bs-toggle="collapse" href="#collapseRoomCategory" role="button" aria-expanded="false" aria-controls="collapseRoomCategory"><span class="fa-solid fa-caret-down toggle-icon text-body me-2"></span>
                  ...
                  </div><a class="btn collapse-indicator px-0 py-2 d-flex align-items-center mt-3" data-bs-toggle="collapse" href="#collapseBedType" role="button" aria-expanded="false" aria-controls="collapseBedType"><span class="fa-solid fa-caret-down toggle-icon text-body me-2"></span>
                  ...
                  </div><a class="btn collapse-indicator px-0 py-2 d-flex align-items-center mt-3" data-bs-toggle="collapse" href="#collapseAmenities" role="button" aria-expanded="false" aria-controls="collapseAmenities"><span class="fa-solid fa-caret-down toggle-icon text-body me-2"></span>
                  ...
                  <div class="sticky-bottom bg-body pt-4 pb-4 pb-xl-0"><button class="btn btn-phoenix-secondary me-2">Reset</button>
            ...
            <div class="col w-xl-25">
                ...
                <div class="card-body">
                  <div class="row gx-4 justify-content-between">
                    <div class="col-auto mb-4">
                      <div class="d-flex gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/70.png') }}" alt="" width="108"></a>
                        <div> <a class="fs-8 fw-bolder text-body-emphasis text-nowrap" href="#!">Double Bed</a>
                          <h6 class="fw-semibold text-body text-nowrap mt-1 mb-2"><span class="fa-solid fa-border-all me-2"></span>Presidential Suite</h6>
                    ...
                    <div class="col-xxl-auto d-flex gap-5 gap-md-6 order-1 order-xxl-0 mb-4">
                      <div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                          <div class="d-sm-flex align-items-center gap-2">
                            <div class="d-flex align-items-center justify-content-center bg-primary-subtle rounded mb-2 mb-sm-0" style="height:24px; width: 24px"><span class="fa-solid fa-person-shelter text-primary-darker"></span></div>
                            <h5 class="text-body fw-semibold mb-0">01</h5>
                          </div>
                          <div class="d-sm-flex align-items-center gap-2">
                            <div class="d-flex align-items-center justify-content-center bg-success-subtle rounded mb-2 mb-sm-0" style="height:24px; width: 24px"><span class="fa-solid fa-bed text-success-darker"></span></div>
                      ...
                      <div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                          <div class="d-sm-flex align-items-center gap-2">
                            <div class="d-flex align-items-center justify-content-center bg-warning-subtle rounded mb-2 mb-sm-0" style="height:24px; width: 24px"><span class="fa-solid fa-user text-warning-darker"></span></div>
                            <h5 class="text-body fw-semibold mb-0">02</h5>
                          </div>
                          <div class="d-sm-flex align-items-center gap-2">
                            <div class="d-flex align-items-center justify-content-center bg-info-subtle rounded mb-2 mb-sm-0" style="height:24px; width: 24px"><span class="fa-solid fa-baby text-info-darker"></span></div>
                            <h5 class="text-body fw-semibold mb-0">01</h5>
                          </div>
                        </div>
                      </div>
                      <div>
                        ...
                        <div class="d-sm-flex align-items-center gap-2">
                          <div class="d-flex align-items-center justify-content-center bg-danger-subtle rounded mb-2 mb-sm-0" style="height:24px; width: 24px"><span class="fa-solid fa-bath text-danger-darker"></span></div>
                          <h5 class="text-body fw-semibold mb-0 me-3">01</h5>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-auto mb-4"><a class="btn btn-phoenix-info collapse-indicator me-2 px-3 d-xxl-block mb-xxl-2" data-bs-toggle="collapse" href="#collapseRoomAvailableOnDates-0" role="button" aria-expanded="true" aria-controls="collapseRoomAvailableOnDates-0"><span class="fa-solid fa-calendar me-2"></span><span class="collapse-show">Show Dates</span><span class="collapse-hide">Hide Dates</span></a><a class="btn btn-primary px-5 px-md-7 px-xxl-5 flex-1" href="#!">Book now</a></div>
                    <div class="col-12">
                      <div class="collapse show" id="collapseRoomAvailableOnDates-0">
                        <div class="px-4 py-3 border border-translucent rounded mb-4 bg-body-highlight">
                          <div class="swiper-theme-container px-4">
                            <div class="swiper theme-slider" data-swiper='{"spaceBetween":24,"slidesPerView":"auto","centeredSlide":true,"grabCursor":true,"breakpoints":{"768":{"spaceBetween":32},"1540":{"spaceBetween":48}}}'>
                  ...
                  <div class="p-3 border border-translucent rounded"><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">wifi</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">tv</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">common area</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">bathtub</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">Heating</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">Telephone</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">Television</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">common area</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">Kettle</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">iron</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">Coffee maker</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">refrigerator</a><a class="badge badge-phoenix bg-primary-subtle text-body-highlight py-1 fs-10 me-2" href="#!">Room service</a><a class="fw-bold pe-0 fs-9 text-nowrap" href="#!">+ 7 more</a></div>
                </div>
              </div>
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row gx-4 justify-content-between">
                    <div class="col-auto mb-4">
                      <div class="d-flex gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/71.png') }}" alt="" width="108"></a>
                        <div> <a class="fs-8 fw-bolder text-body-emphasis text-nowrap" href="#!">Queen bed</a>
                          <h6 class="fw-semibold text-body text-nowrap mt-1 mb-2"><span class="fa-solid fa-border-all me-2"></span>Deluxe Room</h6>
                          <div class="d-flex align-items-baseline gap-1 mb-3">
                            <h6 class="mb-0 fw-semibold">Available:</h6>
                            <h4 class="text-warning-dark fw-bolder mb-0">25<span class="fs-9 text-body-tertiary fw-bold"> / 77</span></h4>
                          </div>
                    ...
                    <div class="col-sm-auto mb-4"><a class="btn btn-phoenix-info collapse-indicator me-2 px-3 d-xxl-block mb-xxl-2" data-bs-toggle="collapse" href="#collapseRoomAvailableOnDates-1" role="button" aria-expanded="false" aria-controls="collapseRoomAvailableOnDates-1"><span class="fa-solid fa-calendar me-2"></span><span class="collapse-show">Show Dates</span><span class="collapse-hide">Hide Dates</span></a><a class="btn btn-primary px-5 px-md-7 px-xxl-5 flex-1" href="#!">Book now</a></div>
                    <div class="col-12">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row gx-4 justify-content-between">
                    <div class="col-auto mb-4">
                      <div class="d-flex gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/72.png') }}" alt="" width="108"></a>
                        <div> <a class="fs-8 fw-bolder text-body-emphasis text-nowrap" href="#!">Twin bed</a>
                          <h6 class="fw-semibold text-body text-nowrap mt-1 mb-2"><span class="fa-solid fa-border-all me-2"></span>Family Room</h6>
                          <div class="d-flex align-items-baseline gap-1 mb-3">
                            <h6 class="mb-0 fw-semibold">Available:</h6>
                            <h4 class="text-warning-dark fw-bolder mb-0">8<span class="fs-9 text-body-tertiary fw-bold"> / 12</span></h4>
                          </div>
                    ...
                    <div class="col-sm-auto mb-4"><a class="btn btn-phoenix-info collapse-indicator me-2 px-3 d-xxl-block mb-xxl-2" data-bs-toggle="collapse" href="#collapseRoomAvailableOnDates-2" role="button" aria-expanded="false" aria-controls="collapseRoomAvailableOnDates-2"><span class="fa-solid fa-calendar me-2"></span><span class="collapse-show">Show Dates</span><span class="collapse-hide">Hide Dates</span></a><a class="btn btn-primary px-5 px-md-7 px-xxl-5 flex-1" href="#!">Book now</a></div>
                    <div class="col-12">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row gx-4 justify-content-between">
                    <div class="col-auto mb-4">
                      <div class="d-flex gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/73.png') }}" alt="" width="108"></a>
                        <div> <a class="fs-8 fw-bolder text-body-emphasis text-nowrap" href="#!">Single bed</a>
                          <h6 class="fw-semibold text-body text-nowrap mt-1 mb-2"><span class="fa-solid fa-border-all me-2"></span>Honeymoon Suite</h6>
                          <div class="d-flex align-items-baseline gap-1 mb-3">
                            <h6 class="mb-0 fw-semibold">Available:</h6>
                            <h4 class="text-warning-dark fw-bolder mb-0">5<span class="fs-9 text-body-tertiary fw-bold"> / 15</span></h4>
                          </div>
                    ...
                    <div class="col-sm-auto mb-4"><a class="btn btn-phoenix-info collapse-indicator me-2 px-3 d-xxl-block mb-xxl-2" data-bs-toggle="collapse" href="#collapseRoomAvailableOnDates-3" role="button" aria-expanded="false" aria-controls="collapseRoomAvailableOnDates-3"><span class="fa-solid fa-calendar me-2"></span><span class="collapse-show">Show Dates</span><span class="collapse-hide">Hide Dates</span></a><a class="btn btn-primary px-5 px-md-7 px-xxl-5 flex-1" href="#!">Book now</a></div>
                    <div class="col-12">
              ...
              <div class="border p-3 rounded-3 mt-5 d-flex flex-end-center gap-3 gap-sm-6 flex-wrap">
                <h2 class="text-body mb-0"><span class="fs-9 text-body-tertiary fw-bold me-2">Total :</span>04</h2><a class="btn btn-primary px-sm-7" href="#!">Confirm Booking<span class="fa-solid fa-chevron-right ms-2"></span></a>
              </div>
            </div>
          </div>
        </div>
