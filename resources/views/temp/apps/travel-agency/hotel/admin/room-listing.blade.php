                            ...
                            <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-hotel-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-hotel-admin">
                              ...
                              <div class="parent-wrapper">
                                <ul class="nav collapse parent show" data-bs-parent="#hotel" id="nv-hotel-admin">
                                  ...
                                  <li class="nav-item"><a class="nav-link active" href="{{ url('room-listing') }}">
                      ...
                      <ul class="dropdown-menu">
                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="hotel-admin" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="{{ url('room-listing') }}">
      ...
      <div class="content">
        ...
        <div class="mb-7">
          ...
          <div data-list='{"valueNames":["name","beds","guest","bathRooms","amenities","totalRooms"],"page":8}'>
            <div class="d-md-flex mt-5 mb-4"><button class="btn btn-primary me-4"><span class="fas fa-plus me-2"></span>Create Listing</button>
                ...
                <tbody class="list" id="room-listing-table-body">
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle py-4 name">
                      <div class="d-flex align-items-center gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/17.png') }}" alt="" width="80"></a>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle py-4 name">
                      <div class="d-flex align-items-center gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/18.png') }}" alt="" width="80"></a>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle py-4 name">
                      <div class="d-flex align-items-center gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/19.png') }}" alt="" width="80"></a>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle py-4 name">
                      <div class="d-flex align-items-center gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/20.png') }}" alt="" width="80"></a>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle py-4 name">
                      <div class="d-flex align-items-center gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/21.png') }}" alt="" width="80"></a>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle py-4 name">
                      <div class="d-flex align-items-center gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/22.png') }}" alt="" width="80"></a>
                        <div> <a class="fs-8 fw-bolder text-body-emphasis text-nowrap" href="#!">Single bed</a>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle py-4 name">
                      <div class="d-flex align-items-center gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/23.png') }}" alt="" width="80"></a>
                  ...
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="align-middle py-4 name">
                      <div class="d-flex align-items-center gap-3"><a href="#!"> <img class="rounded-1 border border-translucent" src="{{ asset('assets/img/hotels/24.png') }}" alt="" width="80"></a>
