            ...
            <div class="py-6">
                <div class="d-flex"><select class="form-select w-sm-auto me-4" id="hotelSort" name="Hotel sort">
                        ...
                        <option>Option 2</option>
                            ...
                            in map</span></button>
                    <button class="btn btn-phoenix-secondary text-nowrap px-3" type="button" data-bs-toggle="offcanvas"
                        data-bs-target="#hotelFilterOffcanvas" aria-controls="hotelFilterOffcanvas"><span
            ...
            <div class="row g-3 mb-6">
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/1.png') }}" alt="">
                        ...
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Hotel
                                Palace</a>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/2.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Silom
                                Furama</a>
                            <p class="mb-2 text-secondary-lighter"><span
                                    class="fa-solid fa-map-marker-alt me-2"></span>Bangkok, Thailand</p>
                            <div class="d-flex align-items-center gap-3"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/3.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/4.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/5.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Hotel Asia
                                Solo</a>
                            <p class="mb-2 text-secondary-lighter"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/6.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Golden Inn
                                Kuta</a>
                            <p class="mb-2 text-secondary-lighter"><span
                                    class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
                            <div class="d-flex align-items-center gap-3"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/7.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">The Shanty
                                House</a>
                            <p class="mb-2 text-secondary-lighter"><span
                                    class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
                            <div class="d-flex align-items-center gap-3"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/8.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Hotel Kiwi
                                International</a>
                            <p class="mb-2 text-secondary-lighter"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/9.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Residences
                                of the Angel</a>
                            <p class="mb-2 text-secondary-lighter"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/10.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Brenig
                                Kulm's Gasthaus</a>
                            <p class="mb-2 text-secondary-lighter"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/11.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">The
                                Andermatt Chedi</a>
                            <p class="mb-2 text-secondary-lighter"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/12.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Interlaken
                                Alplodge</a>
                            <p class="mb-2 text-secondary-lighter"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/13.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Inn at
                                Agus Beach</a>
                            <p class="mb-2 text-secondary-lighter"><span
                                    class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
                            <div class="d-flex align-items-center gap-3"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/14.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/15.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
                                href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Villas at
                                Atoll Haven</a>
                            <p class="mb-2 text-secondary-lighter"><span
                                    class="fa-solid fa-map-marker-alt me-2"></span>Bali, Indonesia</p>
                            <div class="d-flex align-items-center gap-3"><span
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="hover-actions-trigger mx-auto rounded-3 overflow-hidden"><img class="img-fluid"
                            src="{{ asset('assets/img/hotels/16.png') }}" alt="">
                        <div class="hover-actions top-0 end-0 mt-4 me-4 z-5"><button class="btn btn-wish"><span
                                    class="far fa-heart" data-fa-transform="down-1"></span></button></div>
                        <div class="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
                            <a class="stretched-link fs-7 text-white fw-bold"
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="hotelFilterOffcanvas"
        ...
        <div class="offcanvas-body scrollbar p-4">
            ...
            <div class="input-group gap-2 w-70 w-sm-50" data-quantity="data-quantity"><button
                    ...
                    data-type="plus"><span class="fa-solid fa-plus"></span></button></div>
            <hr class="my-5">
            <h4 class="mb-4">Rating</h4><input class="rating-radio btn-check" type="radio" name="ratingOption"
                id="option1" checked="checked"><label class="btn w-100 d-flex align-items-center gap-1 mb-2"
