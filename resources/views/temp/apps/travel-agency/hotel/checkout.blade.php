            ...
            <div class="row justify-content-between">
                <div class="col-lg-7 col-xl-6">
                    <form id="checkoutForm1">
                        ...
                        <div class="form-check form-check-inline me-4"><input class="form-check-input" id="no"
                                type="radio" name="tripTypeRadio" value="no" checked=""><label
                                class="form-check-label" for="no">No</label></div>
                        <div class="form-check form-check-inline"><input class="form-check-input" id="yes"
                                type="radio" name="tripTypeRadio" value="yes"><label class="form-check-label"
                        ...
                        <div class="form-check form-check-inline me-4"><input class="form-check-input" id="me"
                                type="radio" name="bookingPersonRadio" value="no" checked=""><label
                                class="form-check-label" for="me">I am the main guest</label></div>
                        <div class="form-check form-check-inline"><input class="form-check-input" id="else"
                                type="radio" name="bookingPersonRadio" value="yes"><label class="form-check-label"
                                for="else">I am booking for somebody else</label></div>
                        ...
                        <p class="text-info mb-7">By continuing to the next step, you are agreeing to these house rules.
                        </p>
                        <h5 class="mb-3">Special requests</h5>
                        <p class="fs-9 text-body-tertiary mb-4">Special requests cannot be guaranteed, but the property
                            will do its best to meet your needs. You can always make a special request after your booking is
                            complete!</p>
                        <textarea class="form-control" name="requestText" rows="5" id="requestText" placeholder="Type your request"></textarea>
                        <hr class="mt-7 mb-5"><a class="btn btn-primary"
                            href="{{ url('apps/travel-agency/flight/payment') }}">Final details<span
