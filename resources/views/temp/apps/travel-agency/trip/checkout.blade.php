      ...
      <div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            ...
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  text-primary" href="checkout.html">Checkout</a></li>
        ...
        <div class="container-medium">
          <div class="row justify-content-between gy-5 gx-lg-0">
            ...
            <div class="col-lg-5 col-xl-4">
              <div class="card">
                <div class="card-body"><img class="w-100 object-fit-cover rounded-2" src="../../../assets/img/trip/10.png" alt="" height="220">
