...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            ...
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  " href="trip-details.html">Trip Details</a></li>
        ...
        <div class="container-small">
          <nav class="navbar navbar-landing navbar-home navbar-expand py-4 px-0">
            <ul class="navbar-nav mx-auto mt-3 mt-lg-0 gap-2">
              ...
              <li class="nav-item"><a class="nav-link fw-bold rounded-3 active" aria-current="page" href="homepage.html"> <span class="me-2 fa-solid fa-suitcase-rolling"></span>Trip</a></li>
            </ul>
          </nav>
      ...
      <section class="py-0">
        <div class="bg-holder overlay bg-opacity-50" style="background-image:url(../../../assets/img/bg/46.png);background-position: center; background-size: cover;"></div>
        <!--/.bg-holder-->
        ...
        <div class="container-medium">
          <div class="row g-3">
            <div class="col-md-6 col-xl-4">
              <div class="hoverbox rounded"><a href="trip-details.html"><img class="img-fluid" src="../../../assets/img/trip/1.png" alt="">
            ...
            <div class="col-md-6 col-xl-4">
              <div class="hoverbox rounded"><a href="trip-details.html"><img class="img-fluid" src="../../../assets/img/trip/2.png" alt="">
                  <div class="backdrop-faded">
            ...
            <div class="col-md-6 col-xl-4">
              <div class="hoverbox rounded"><a href="trip-details.html"><img class="img-fluid" src="../../../assets/img/trip/3.png" alt="">
                  <div class="backdrop-faded">
            ...
            <div class="col-md-6 col-xl-4">
              <div class="hoverbox rounded"><a href="trip-details.html"><img class="img-fluid" src="../../../assets/img/trip/4.png" alt="">
                  <div class="backdrop-faded">
            ...
            <div class="col-md-6 col-xl-4">
              <div class="hoverbox rounded"><a href="trip-details.html"><img class="img-fluid" src="../../../assets/img/trip/5.png" alt="">
                  <div class="backdrop-faded">
            ...
            <div class="col-md-6 col-xl-4">
              <div class="hoverbox rounded"><a href="trip-details.html"><img class="img-fluid" src="../../../assets/img/trip/6.png" alt="">
                  <div class="backdrop-faded">
