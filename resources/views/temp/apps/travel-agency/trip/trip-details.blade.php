...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        <nav class="navbar navbar-top navbar-expand-lg container-medium border-0 bg-body px-3 py-2"><button class="navbar-toggler fs-8 ps-2 me-sm-2" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTopCollapse" aria-controls="navbarTopCollapse" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button><a class="navbar-brand flex-1 flex-lg-grow-0 me-lg-8 me-xl-13" href="../../../index.html">
          ...
          <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center pb-0" id="navbarTopCollapse">
            <ul class="navbar-nav travel-nav-top me-auto" data-dropdown-on-hover="data-dropdown-on-hover">
              ...
              <li class="nav-item dropdown"><a class="nav-link fs-8 fw-bold dropdown-toggle text-primary" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">Trip</a>
                <ul class="dropdown-menu navbar-dropdown-caret">
                  <li><a class="dropdown-item" href="homepage.html">Homepage</a></li>
                  <li><a class="dropdown-item" href="trip-details.html">Trip Details</a></li>
      ...
      <div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            ...
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  text-primary" href="trip-details.html">Trip Details</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  " href="checkout.html">Checkout</a></li>
      ...
      <section class="py-5">
        <div class="container-medium">
          ...
          <div class="row g-2 g-md-3">
              ...
              <div class="swiper-theme-container rounded-2 overflow-hidden">
                <div class="swiper swiper theme-slider" data-swiper='{"slidesPerView":1,"loop":true,"autoplay":true,"pagination":{"el":".swiper-pagination","clickable":true}}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide"><img class="w-100 h-100 object-fit-cover" src="../../../assets/img/trip/10.png" alt=""></div>
                    <div class="swiper-slide"><img class="w-100 h-100 object-fit-cover" src="../../../assets/img/trip/17.png" alt=""></div>
                    <div class="swiper-slide"><img class="w-100 h-100 object-fit-cover" src="../../../assets/img/trip/18.png" alt=""></div>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <div class="row g-2 g-md-3">
                <div class="col-4"><a href="../../../assets/img/trip/11.jpg" data-gallery="trip-details-gallery"><img class="img-fluid rounded-2" src="../../../assets/img/trip/19.png" alt=""></a></div>
                <div class="col-4"><a href="../../../assets/img/trip/12.jpg" data-gallery="trip-details-gallery"><img class="img-fluid rounded-2" src="../../../assets/img/trip/20.png" alt=""></a></div>
                <div class="col-4"><a href="../../../assets/img/trip/13.jpg" data-gallery="trip-details-gallery"><img class="img-fluid rounded-2" src="../../../assets/img/trip/21.png" alt=""></a></div>
                <div class="col-4"><a href="../../../assets/img/trip/14.jpg" data-gallery="trip-details-gallery"><img class="img-fluid rounded-2" src="../../../assets/img/trip/22.png" alt=""></a></div>
                <div class="col-4"><a href="../../../assets/img/trip/15.jpg" data-gallery="trip-details-gallery"><img class="img-fluid rounded-2" src="../../../assets/img/trip/23.png" alt=""></a></div>
                <div class="col-4">
                  <div class="position-relative rounded-2 overflow-hidden"><a href="../../../assets/img/trip/16.jpg" data-gallery="trip-details-gallery"> <img class="img-fluid" src="../../../assets/img/trip/24.png" alt="" height="43"></a>
                    <div class="position-absolute w-100 h-100 left-0 top-0 d-flex flex-center bg-black bg-opacity-50"><a class="text-white stretched-link fs-7 fs-lg-5 fw-bolder" href="../hotel/customer/gallery.html">24+</a></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row justify-content-between gx-0 gy-5">
                ...
                <div class="col-xl-4">
                  ...
                  <div class="row gx-5 gy-0 position-relative">
                    <div class="bg-holder tour-direction-bg d-none d-sm-block" style="background-image:url(../../../assets/img/bg/bg-41.svg);"></div>
                    <!--/.bg-holder-->
            ...
            <div class="tab-pane fade" id="pills-review" role="tabpanel" aria-labelledby="pills-review-tab" tabindex="0">
              ...
              <div class="card bg-transparent mb-3">
                <div class="card-body">
                  ...
                  <div class="d-flex gap-2 flex-wrap"><a href="../../../assets/img/trip/25_large.jpg" data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2" src="../../../assets/img/trip/25.png" alt=""></a><a href="../../../assets/img/trip/26_large.jpg" data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2" src="../../../assets/img/trip/26.png" alt=""></a><a href="../../../assets/img/trip/27_large.jpg" data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2" src="../../../assets/img/trip/27.png" alt=""></a><a href="../../../assets/img/trip/28_large.jpg" data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2" src="../../../assets/img/trip/28.png" alt=""></a><a href="../../../assets/img/trip/29_large.jpg" data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2" src="../../../assets/img/trip/29.png" alt=""></a><a href="../../../assets/img/trip/30_large.jpg" data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2" src="../../../assets/img/trip/30.png" alt=""></a></div>
                  <div class="mt-5 border-start border-translucent ps-4"><a class="fw-bold" href="#!">Panther Travels Limited</a><span class="ms-1 text-body-quaternary">replied</span>
              ...
              <div class="card bg-transparent">
                <div class="card-body">
                  ...
                  <div class="d-flex gap-2 flex-wrap"><a href="../../../assets/img/trip/31_large.jpg" data-gallery="trip-details-gallery-2"><img class="img-fluid rounded-2" src="../../../assets/img/trip/31.png" alt=""></a><a href="../../../assets/img/trip/32_large.jpg" data-gallery="trip-details-gallery-2"><img class="img-fluid rounded-2" src="../../../assets/img/trip/32.png" alt=""></a><a href="../../../assets/img/trip/33_large.jpg" data-gallery="trip-details-gallery-2"><img class="img-fluid rounded-2" src="../../../assets/img/trip/33.png" alt=""></a></div>
                  <div class="mt-5 border-start border-translucent ps-4"><a class="fw-bold" href="#!">Panther Travels Limited</a><span class="ms-1 text-body-quaternary">replied</span>
                    <p class="mt-2">Thanks for this review. It is a great motivation from you. Hope to see you again in Wakanda. Good luck.</p>
                  </div>
                </div>
          ...
          <div class="row g-3">
            <div class="col-md-6 col-xl-4">
              <div class="hoverbox rounded"><a href="trip-details.html"><img class="img-fluid" src="../../../assets/img/trip/7.png" alt="">
            ...
            <div class="col-md-6 col-xl-4">
              <div class="hoverbox rounded"><a href="trip-details.html"><img class="img-fluid" src="../../../assets/img/trip/8.png" alt="">
                  <div class="backdrop-faded">
            ...
            <div class="col-md-6 col-xl-4">
              <div class="hoverbox rounded"><a href="trip-details.html"><img class="img-fluid" src="../../../assets/img/trip/9.png" alt="">
                  <div class="backdrop-faded">
      ...
      <section class="py-6">
        <div class="container-medium">
          <div class="bg-holder overlay bg-opacity-75" style="background-image:url(../../../assets/img/bg/47.png);background-position: center; background-size: cover;"></div>
          <!--/.bg-holder-->
      ...
      <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body p-4">
            ...
            </select><a class="btn btn-primary btn-lg w-100 mt-6" href="checkout.html">Proceed to booking<span class="fa-solid fa-chevron-right fs-9 ms-2"></span></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <script src="../../../assets/js/pages/trip.js"></script>
  </body>
