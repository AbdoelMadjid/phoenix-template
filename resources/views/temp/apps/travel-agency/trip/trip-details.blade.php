              ...
              <div class="row g-2 g-md-3">
                ...
                <div class="col-4">
                  <div class="position-relative rounded-2 overflow-hidden"><a href="{{ asset('assets/img/trip/16.jpg') }}" data-gallery="trip-details-gallery"> <img class="img-fluid" src="{{ asset('assets/img/trip/24.png') }}" alt="" height="43"></a>
                    <div class="position-absolute w-100 h-100 left-0 top-0 d-flex flex-center bg-black bg-opacity-50"><a class="text-white stretched-link fs-7 fs-lg-5 fw-bolder" href="{{ url('hotel/customer/gallery') }}">24+</a></div>
                  </div>
                </div>
              </div>
            </div>
