...
@section('content')
    ...
    <section class="py-5">
        <div class="container-medium">
            ...
            <div class="row g-2 g-md-3">
                        ...
                        <div class="swiper swiper theme-slider"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img class="w-100 h-100 object-fit-cover"
                                        src="{{ asset('assets/img/trip/10.png') }}" alt=""></div>
                                <div class="swiper-slide"><img class="w-100 h-100 object-fit-cover"
                                        src="{{ asset('assets/img/trip/17.png') }}" alt=""></div>
                                <div class="swiper-slide"><img class="w-100 h-100 object-fit-cover"
                                        src="{{ asset('assets/img/trip/18.png') }}" alt=""></div>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="row g-2 g-md-3">
                        <div class="col-4"><a href="{{ asset('assets/img/trip/11.jpg') }}"
                                data-gallery="trip-details-gallery"><img class="img-fluid rounded-2"
                                    src="{{ asset('assets/img/trip/19.png') }}" alt=""></a></div>
                        <div class="col-4"><a href="{{ asset('assets/img/trip/12.jpg') }}"
                                data-gallery="trip-details-gallery"><img class="img-fluid rounded-2"
                                    src="{{ asset('assets/img/trip/20.png') }}" alt=""></a></div>
                        <div class="col-4"><a href="{{ asset('assets/img/trip/13.jpg') }}"
                                data-gallery="trip-details-gallery"><img class="img-fluid rounded-2"
                                    src="{{ asset('assets/img/trip/21.png') }}" alt=""></a></div>
                        <div class="col-4"><a href="{{ asset('assets/img/trip/14.jpg') }}"
                                data-gallery="trip-details-gallery"><img class="img-fluid rounded-2"
                                    src="{{ asset('assets/img/trip/22.png') }}" alt=""></a></div>
                        <div class="col-4"><a href="{{ asset('assets/img/trip/15.jpg') }}"
                                data-gallery="trip-details-gallery"><img class="img-fluid rounded-2"
                                    src="{{ asset('assets/img/trip/23.png') }}" alt=""></a></div>
                        <div class="col-4">
                            <div class="position-relative rounded-2 overflow-hidden"><a
                                    href="{{ asset('assets/img/trip/16.jpg') }}" data-gallery="trip-details-gallery">
                                    <img class="img-fluid" src="{{ asset('assets/img/trip/24.png') }}" alt=""
                                        height="43"></a>
                                <div
                                    ...
                                    <a class="text-white stretched-link fs-7 fs-lg-5 fw-bolder"
                                        href="{{ url('apps/travel-agency/hotel/customer/gallery') }}">24+</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade show active" id="pills-details" role="tabpanel"
                    ...
                    <div class="row justify-content-between gx-0 gy-5">
                        <div class="col-xl-7"><a
                                ...
                                data-bs-toggle="collapse" href="#collapseWhatToExpect" role="button"
                                aria-expanded="true" aria-controls="collapseWhatToExpect">
                            ...
                            <div class="collapse show" id="collapseWhatToExpect">
                                <div class="py-6 px-4">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <p class="my-2">Observe the Wakandan wildlife in its natural habitat in the
                                            savanna of Alkama.</p>
                                        <div class="d-flex gap-3 gap-xl-4 flex-wrap">
                                            <h5 class="text-body-highlight fw-semibold mb-0"> <span
                                                    class="fa-solid fa-clock text-body-quaternary me-2"></span>Duration :
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <p class="my-2">Visit the tomb of the greatest king of Wakanda, King T'Challa,
                                            the black panther.</p>
                                        <div class="d-flex gap-3 gap-xl-4 flex-wrap">
                                            <h5 class="text-body-highlight fw-semibold mb-0"> <span
                                                    class="fa-solid fa-clock text-body-quaternary me-2"></span>Duration :
                                    ...
                                    <div>
                                        ...
                                        <p class="my-2">Have lunch with the authentic cuisine of Wakanda at the
                                            mountaintop restaurant of Mena Ngai.</p>
                                        <div class="d-flex gap-3 gap-xl-4 flex-wrap">
                                            <h5 class="text-body-highlight fw-semibold mb-0"> <span
                                                    class="fa-solid fa-clock text-body-quaternary me-2"></span>Duration :
                                                <span class="text-body-tertiary fw-normal">1 hour</span>
                                ...
                                <div class="py-6 px-4">
                                    ...
                                    <ul class="list-unstyled mb-4">
                                        <li class="mb-1 d-flex"><span
                                                ...
                                                data-fa-transform="down-13 shrink-4"></span>PhoenixTrip experience
                                            brokerage free</li>
                                        <li class="mb-1 d-flex"><span
                                                class="fa-solid fa-circle text-secondary-light me-3 fs-11"
                            ...
                            <div class="collapse" id="collapseDeparture">
                                ...
                                class="btn px-4 py-3 py-sm-4 d-flex flex-between-center collapse-indicator bg-body-highlight mt-4"
                                data-bs-toggle="collapse" href="#collapseAccessibility" role="button"
                                aria-expanded="false" aria-controls="collapseAccessibility">
                            ...
                            <div class="collapse" id="collapseAdditionalInfo">
                                <div class="py-6 px-4">
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-1 d-flex"><span
                                                class="fa-solid fa-circle text-secondary-light me-3 fs-11"
                                                data-fa-transform="down-13 shrink-4"></span>Confirmation will be received
                                            at time of booking</li>
                                        <li class="mb-1 d-flex"><span
                                                class="fa-solid fa-circle text-secondary-light me-3 fs-11"
                                    ...
                                    <div class="card bg-transparent">
                                        <div class="card-body">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li class="mb-1 d-flex mb-3"><span
                                                        class="fa-solid fa-circle text-secondary-light me-3 fs-11"
                                                        data-fa-transform="down-13 shrink-4"></span>50% fee must be paid
                                                    for any child between the age of five (5) and ten (10) years old.</li>
                                                <li class="mb-1 d-flex mb-3"><span
                                                        class="fa-solid fa-circle text-secondary-light me-3 fs-11"
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="row gx-5 gy-0 position-relative">
                                <div class="bg-holder tour-direction-bg d-none d-sm-block"
                                    style="background-image:url({{ asset('assets/img/bg/bg-41.svg') }});"></div>
                                <!--/.bg-holder-->
                    ...
                    <div class="card bg-transparent mb-3">
                        <div class="card-body">
                            ...
                            <div class="mt-5 border-start border-translucent ps-4"><a class="fw-bold"
                                ...
                                <p class="mt-2">Great to have your review on our tour. It's our honor to get a tourist
                                    like you. Good luck to you. Hope to see you again.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card bg-transparent mb-3">
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-2 flex-wrap"><a href="{{ asset('assets/img/trip/25_large.jpg') }}"
                                    data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2"
                                        src="{{ asset('assets/img/trip/25.png') }}" alt=""></a><a
                                    href="{{ asset('assets/img/trip/26_large.jpg') }}"
                                    data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2"
                                        src="{{ asset('assets/img/trip/26.png') }}" alt=""></a><a
                                    href="{{ asset('assets/img/trip/27_large.jpg') }}"
                                    data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2"
                                        src="{{ asset('assets/img/trip/27.png') }}" alt=""></a><a
                                    href="{{ asset('assets/img/trip/28_large.jpg') }}"
                                    data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2"
                                        src="{{ asset('assets/img/trip/28.png') }}" alt=""></a><a
                                    href="{{ asset('assets/img/trip/29_large.jpg') }}"
                                    data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2"
                                        src="{{ asset('assets/img/trip/29.png') }}" alt=""></a><a
                                    href="{{ asset('assets/img/trip/30_large.jpg') }}"
                                    data-gallery="trip-details-gallery-1"><img class="img-fluid rounded-2"
                                        src="{{ asset('assets/img/trip/30.png') }}" alt=""></a></div>
                            <div class="mt-5 border-start border-translucent ps-4"><a class="fw-bold"
                                    href="#!">Panther Travels Limited</a><span
                                    class="ms-1 text-body-quaternary">replied</span>
                                <p class="mt-2">Thanks for this review. It is a great motivation from you. Hope to see
                                    you again in Wakanda. Good luck.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card bg-transparent">
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-2 flex-wrap"><a href="{{ asset('assets/img/trip/31_large.jpg') }}"
                                    data-gallery="trip-details-gallery-2"><img class="img-fluid rounded-2"
                                        src="{{ asset('assets/img/trip/31.png') }}" alt=""></a><a
                                    href="{{ asset('assets/img/trip/32_large.jpg') }}"
                                    data-gallery="trip-details-gallery-2"><img class="img-fluid rounded-2"
                                        src="{{ asset('assets/img/trip/32.png') }}" alt=""></a><a
                                    href="{{ asset('assets/img/trip/33_large.jpg') }}"
                                    data-gallery="trip-details-gallery-2"><img class="img-fluid rounded-2"
                                        src="{{ asset('assets/img/trip/33.png') }}" alt=""></a></div>
                            <div class="mt-5 border-start border-translucent ps-4"><a class="fw-bold"
                                    href="#!">Panther Travels Limited</a><span
                                    class="ms-1 text-body-quaternary">replied</span>
                                <p class="mt-2">Thanks for this review. It is a great motivation from you. Hope to see
            ...
            <div class="row g-3">
                <div class="col-md-6 col-xl-4">
                    <div class="hoverbox rounded"><a href="{{ url('trip-details') }}"><img class="img-fluid"
                                src="{{ asset('assets/img/trip/7.png') }}" alt="">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="hoverbox rounded"><a href="{{ url('trip-details') }}"><img class="img-fluid"
                                src="{{ asset('assets/img/trip/8.png') }}" alt="">
                            <div class="backdrop-faded">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="hoverbox rounded"><a href="{{ url('trip-details') }}"><img class="img-fluid"
                                src="{{ asset('assets/img/trip/9.png') }}" alt="">
                            <div class="backdrop-faded">
    ...
    <div class="modal fade" id="trilAvailabilityModal" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="trilAvailabilityModal">
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header justify-content-between align-items-start gap-5 px-4 pt-4 pb-3 border-0">
                    <h2 class="mb-0">Walk where the king walked once in Wakanda</h2><button
                        class="btn p-0 text-body-quaternary fs-6" data-bs-dismiss="modal" aria-label="Close"><span
                            class="fas fa-times"></span></button>
                </div>
                <div class="modal-body p-4">
                    <div class="row g-5 mb-4">
                        <div class="col-md-5"> <label class="fw-bold mb-2 fs-7 text-body-emphasis" for="tripDate">Choose
                                your preferred date</label>
                            <div class="form-icon-container flatpickr-input-container"><input
                                    class="form-control form-icon-input datetimepicker" id="tripDate" type="text"
                                    placeholder="22 May, 2024" data-options='{"disableMobile":true}'><span
                                    class="fa-solid fa-calendar text-body fs-9 form-icon"></span></div>
                        </div>
                        <div class="col-md-7">
                            <div class="row g-3">
                                <div class="col-auto col-sm-6"><label
                                        class="fw-bold mb-2 fs-7 text-body-emphasis">Adults</label>
                                ...
                                <div class="col-auto col-sm-6"><label
                                        class="fw-bold mb-2 fs-7 text-body-emphasis">Children</label>
                                    <div class="input-group gap-2" data-quantity="data-quantity"><button
                                            class="btn btn-phoenix-primary rounded px-3" data-type="minus"><span
                                                class="fa-solid fa-minus"></span></button><input
                                            class="form-control border-translucent input-spin-none text-center rounded"
                    ...
                    </div><input class="card-form-check-input d-none" type="radio" name="availableOption"
                        id="Economy-Plan" checked="checked">
                    <div class="position-relative"><label class="stretched-link" for="Economy-Plan"></label>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="d-flex mb-1"><span class="fa-solid fa-circle text-secondary-light me-3"
                                            style="width: 6px; height: 6px" data-fa-transform="down-20"></span>Non A/C
                                        transport</li>
                                    <li class="d-flex mb-1"><span class="fa-solid fa-circle text-secondary-light me-3"
                                            style="width: 6px; height: 6px" data-fa-transform="down-20"></span>No extra
                                        luggage carrier</li>
                                </ul>
                                <hr class="my-4">
                    ...
                    <div class="position-relative"><label class="stretched-link" for="Business/Premium-Plan"></label>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="d-flex mb-1"><span class="fa-solid fa-circle text-secondary-light me-3"
                                            style="width: 6px; height: 6px" data-fa-transform="down-20"></span>A/C
                                        transport</li>
                                    <li class="d-flex mb-1"><span class="fa-solid fa-circle text-secondary-light me-3"
                                            style="width: 6px; height: 6px" data-fa-transform="down-20"></span>Extra
                                        luggage carrier</li>
                                </ul>
                                <hr class="my-4">
                    ...
                    </div><label class="fw-bold mb-2 mt-5 fs-7 text-body-emphasis" for="selectTime">Select
                        time</label><select class="form-select w-sm-50" id="selectTime">
                        <option value="">8:00 AM</option>
                        <option value="">12:00 PM</option>
                        <option value="">3:00 PM</option>
                    </select><a class="btn btn-primary btn-lg w-100 mt-6" href="{{ url('checkout') }}">Proceed to
                        booking<span class="fa-solid fa-chevron-right fs-9 ms-2"></span></a>
                </div>
            </div>
        </div>
    </div>
