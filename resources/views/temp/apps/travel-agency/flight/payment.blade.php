      ...
      <div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            ...
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  text-primary" href="{{ url('payment') }}">Payment</a></li>
            ...
            <div class="col-sm">
              <div class="theme-wizard flight-booking-wizard" style="width: 18.125rem">
                <ul class="nav justify-content-between nav-wizard nav-wizard-success">
                  ...
                  <li class="nav-item"><a class="done complete nav-link fw-semibold" href="{{ url('booking') }}" data-wizard-step="2">
                      <div class="d-inline-block text-center"><span class="nav-item-circle-parent"><span class="d-block nav-item-circle"><span class="fas fa-check"></span></span></span><span class="mt-1 fs-9">Booking</span></div>
                    </a></li>
                  <li class="nav-item"><a class="active nav-link fw-semibold" href="{{ url('payment') }}" data-wizard-step="3">
          ...
          <div class="row g-0 gap-6">
            <div class="col-lg">
              <div>
                ...
                <div class="mb-4"> <img class="img-fluid rounded-3" src="{{ asset('assets/img/brand/qatar-airline.png') }}" alt="" style="height: 3.5rem">
                  <h5 class="text-nowrap fw-normal d-inline-block ms-2 mb-0">Qatar Airways</h5>
                </div>
                <p class="text-body-emphasis">Travelling from <strong>Dhaka </strong>to <strong>Cox’s Bazar</strong></p>
                <div class="d-flex gap-2 flex-wrap">
                  <p class="mb-0 text-body-emphasis text-nowrap">Tuesday, 29 January<span class="fas fa-circle text-body-tertiary fs-11 mx-2" data-fa-transform="shrink-6"></span>5:00 pm</p>
                  <p class="mb-0 text-body-emphasis text-nowrap"><span class="text-body-tertiary me-2">-</span>Tuesday, 29 January<span class="fas fa-circle text-body-tertiary fs-11 mx-2" data-fa-transform="shrink-6"></span>5:30 pm</p>
                </div>
              </div>
              <hr class="my-5">
              <div>
                ...
                <div class="bg-body-highlight rounded-2 p-4">
                  <div class="row g-0 gy-5 flex-column flex-sm-row">
                    <div class="col pe-4">
                      ...
                      <p class="mb-0">Adult <span class="fas fa-circle text-body-tertiary fs-11 mx-2" data-fa-transform="shrink-5"></span>Male</p>
                    </div>
                    <div class="col border-start-sm border-top-sm-0 border-top border-translucent ps-sm-4 pt-4 pt-sm-0">
              ...
              <div>
                ...
                <div class="d-flex gap-3 mb-4"> <span class="fas fa-circle text-body-quaternary fs-11 mx-2" data-fa-transform="down-8"></span>
                  <div>
                ...
                <div class="d-flex gap-3"> <span class="fas fa-circle text-body-quaternary fs-11 mx-2" data-fa-transform="down-8"></span>
                  <div>
                ...
                <div class="card-body">
                  <form id="flightCheckoutForm">
                    ...
                    <div class="row gx-xxl-6 mb-5">
                      ...
                      <div class="col-md-auto">
                        <div class="form-check"><input class="form-check-input" id="paypal" type="radio" name="paymentMethod"><label class="form-check-label fs-8 text-body text-nowrap" for="paypal">Paypal</label></div>
                      </div>
                      <div class="col-md-auto">
                        <div class="form-check"><input class="form-check-input" id="coupon" type="radio" name="paymentMethod"><label class="form-check-label fs-8 text-body text-nowrap" for="coupon">Coupon</label></div>
                      </div>
                    </div>
      ...
      <div class="flight-bottom-bar bg-secondary" data-bs-theme="light">
        <div class="container-small py-3">
          <div class="d-flex gap-4 gap-sm-6 align-items-center justify-content-end">
            <h6 class="text-white"> <span class="me-2">Total </span><span class="me-2">: </span>BDT<span class="fs-5 ms-2">4,609</span></h6><a class="btn btn-primary flex-1 text-nowrap" href="#!" style="max-width: 17rem"> Continue<span class="fa-solid fa-chevron-right fs-9 ms-2"></span></a>
          </div>
        </div>
      </div>
