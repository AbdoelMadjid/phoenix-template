      ...
      <div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            ...
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  text-primary" href="payment.html">Payment</a></li>
            ...
            <div class="col-sm">
              <div class="theme-wizard flight-booking-wizard" style="width: 18.125rem">
                <ul class="nav justify-content-between nav-wizard nav-wizard-success">
                  ...
                  <li class="nav-item"><a class="done complete nav-link fw-semibold" href="booking.html" data-wizard-step="2">
                  ...
                  <li class="nav-item"><a class="active nav-link fw-semibold" href="payment.html" data-wizard-step="3">
          ...
          <div class="row g-0 gap-6">
            <div class="col-lg">
              <div>
                ...
                <div class="mb-4"> <img class="img-fluid rounded-3" src="../../../assets/img/brand/qatar-airline.png" alt="" style="height: 3.5rem">
