...
<div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            ...
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  text-primary" href="{{ url('apps/travel-agency/flight/booking') }}">Booking</a></li>
            ...
            <div class="col-sm">
              <div class="theme-wizard flight-booking-wizard" style="width: 18.125rem">
                <ul class="nav justify-content-between nav-wizard nav-wizard-success">
                  <li class="nav-item"><a class="done complete nav-link fw-semibold" href="{{ url('apps/travel-agency/flight/homepage') }}" data-wizard-step="1">
                  ...
                  <li class="nav-item"><a class="active nav-link fw-semibold" href="{{ url('apps/travel-agency/flight/booking') }}" data-wizard-step="2">
                  ...
                  <li class="nav-item"><a class="nav-link fw-semibold" href="{{ url('apps/travel-agency/flight/payment') }}" data-wizard-step="3">
      ...
      <div class="flight-bottom-bar bg-secondary" data-bs-theme="light">
        <div class="container-small py-3">
          <div class="d-flex gap-4 gap-sm-6 align-items-center justify-content-end">
            <h6 class="text-white"> <span class="me-2">Total </span><span class="me-2">: </span>BDT<span class="fs-5 ms-2">4,609</span></h6><a class="btn btn-primary flex-1 text-nowrap" href="{{ url('apps/travel-agency/flight/payment') }}" style="max-width: 17rem"> Continue<span class="fa-solid fa-chevron-right fs-9 ms-2"></span></a>
          </div>
        </div>
      </div>
