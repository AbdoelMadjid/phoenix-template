      ...
      <div class="navbar-responsive-navitems navbar-expand border-y bg-body-emphasis border-translucent py-2">
        <div class="container-medium d-flex flex-between-center" data-navbar="data-navbar">
          <ul class="navbar-nav justify-content-end align-items-center">
            ...
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link px-3  text-primary" href="booking.html">Booking</a></li>
            ...
            <div class="col-sm">
              <div class="theme-wizard flight-booking-wizard" style="width: 18.125rem">
                <ul class="nav justify-content-between nav-wizard nav-wizard-success">
                  <li class="nav-item"><a class="done complete nav-link fw-semibold" href="homepage.html" data-wizard-step="1">
                  ...
                  <li class="nav-item"><a class="active nav-link fw-semibold" href="booking.html" data-wizard-step="2">
                  ...
                  <li class="nav-item"><a class="nav-link fw-semibold" href="payment.html" data-wizard-step="3">
                  ...
                  <div class="row gy-4">
                    ...
                    <div class="col-12">
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto text-md-center"> <img src="../../../assets/img/icons/long-arrow-down.svg" alt=""></div>
                        <div class="col-auto">
                  ...
                  <div class="ps-lg-6 pt-5 pt-lg-0 border-top border-top-lg-0 border-start-lg border-translucent">
                    <div class="row g-lg-3 g-md-0 g-3 flex-between-center">
                      <div class="col-md-auto col-lg-12">
                        <div class="text-nowrap"> <img class="rounded-2" src="../../../assets/img/brand/qatar-airline.png" alt="" width="32">
                    ...
                    <div class="row g-3">
                      <div class="col-md-6">
                        <div class="dropzone dropzone-multiple p-0" id="passportFrontPage-1" data-dropzone="data-dropzone" data-options='{"url":"valid/url","maxFiles":1,"dictDefaultMessage":"Choose or Drop a file here"}'>
                          ...
                          <div class="dz-message text-body-tertiary text-opacity-85" data-dz-message="data-dz-message">
                            ...
                            <h6 class="mb-3 text-body-secondary">The photo of the front page of your passport</h6><img class="mt-3 me-2" src="../../../assets/img/icons/image-icon.png" width="42" alt="">
                          </div>
                      ...
                      <div class="col-md-6">
                        <div class="dropzone dropzone-multiple p-0" id="passportBackPage-1" data-dropzone="data-dropzone" data-options='{"url":"valid/url","maxFiles":1,"dictDefaultMessage":"Choose or Drop a file here"}'>
                          ...
                          <div class="dz-message text-body-tertiary text-opacity-85" data-dz-message="data-dz-message">
                            <h6 class="mb-1 text-body-quaternary">Upload or drag</h6>
                            <h6 class="mb-3 text-body-secondary">The photo of the back page of your passport</h6><img class="mt-3 me-2" src="../../../assets/img/icons/image-icon.png" width="42" alt="">
                          </div>
                          <div class="dz-preview dz-preview-multiple m-0 d-flex flex-column">
                            <div class="d-flex pb-3 border-bottom border-translucent media px-2">
                              <div class="border p-2 rounded-2 me-2"><img class="rounded-2 dz-image" src="../../../assets/img/icons/file.png" alt="..." data-dz-thumbnail="data-dz-thumbnail"></div>
      ...
      <div class="flight-bottom-bar bg-secondary" data-bs-theme="light">
        <div class="container-small py-3">
          <div class="d-flex gap-4 gap-sm-6 align-items-center justify-content-end">
            <h6 class="text-white"> <span class="me-2">Total </span><span class="me-2">: </span>BDT<span class="fs-5 ms-2">4,609</span></h6><a class="btn btn-primary flex-1 text-nowrap" href="payment.html" style="max-width: 17rem"> Continue<span class="fa-solid fa-chevron-right fs-9 ms-2"></span></a>
          </div>
        </div>
      </div>
