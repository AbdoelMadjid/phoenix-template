...
@section('content')
    ...
    <div class="row gx-6 gy-3 mb-4 align-items-center">
        ...
        <div class="col-auto"><a class="btn btn-primary px-5" href="{{ url('create-new') }}"><span
                    class="fa-solid fa-plus me-2"></span>Add new project</a></div>
    </div>
            ...
            <div class="d-flex align-items-center">
                <div class="search-box me-3">
                    ...
                    data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="List view"><span
                        class="fa-solid fa-list fs-10"></span></a><a
                    class="btn btn-phoenix-primary px-3 me-1 border-0 text-body" href="{{ url('project-board-view') }}"
                    data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Board view"><svg width="9"
                        ...
                        <path
                            ...
                            fill="currentColor"></path>
                    </svg></a><a class="btn btn-phoenix-primary px-3" href="{{ url('project-card-view') }}"
                    data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Card view"><svg width="9"
                        height="9" viewbox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
    ...
    <div class="row g-3 mb-9">
        <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
            <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                <div class="bg-holder"
                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url({{ asset('assets/img/generic/51.png') }})">
                </div>
                <div class="position-relative h-100 d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-center"><span
                            class="badge badge-phoenix fs-10 badge-phoenix-primary" data-bs-theme="light">Ongoing</span>
                        <div class="z-2"><button
        ...
        <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
            <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                <div class="bg-holder"
                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url({{ asset('assets/img/generic/52.png') }})">
                </div>
                <div class="position-relative h-100 d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-center"><span
                            class="badge badge-phoenix fs-10 badge-phoenix-warning" data-bs-theme="light">Completed</span>
                        <div class="z-2"><button
                                class="btn btn-icon btn-reveal dropdown-toggle dropdown-caret-none transition-none"
                                data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true"
                                aria-expanded="false" data-bs-reference="parent"><span
        ...
        <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
            <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                <div class="bg-holder"
                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url({{ asset('assets/img/generic/53.png') }})">
                </div>
                <div class="position-relative h-100 d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-center"><span
                            class="badge badge-phoenix fs-10 badge-phoenix-warning" data-bs-theme="light">Completed</span>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
            <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                <div class="bg-holder"
                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url({{ asset('assets/img/generic/54.png') }})">
                </div>
                <div class="position-relative h-100 d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-center"><span
                            class="badge badge-phoenix fs-10 badge-phoenix-info" data-bs-theme="light">Inactive</span>
                        <div class="z-2"><button
                                class="btn btn-icon btn-reveal dropdown-toggle dropdown-caret-none transition-none"
                                data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true"
                                aria-expanded="false" data-bs-reference="parent"><span
        ...
        <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
            <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                <div class="bg-holder"
                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url({{ asset('assets/img/generic/55.png') }})">
                </div>
                <div class="position-relative h-100 d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-center"><span
                            class="badge badge-phoenix fs-10 badge-phoenix-warning" data-bs-theme="light">Completed</span>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
            <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                <div class="bg-holder"
                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url({{ asset('assets/img/generic/56.png') }})">
                </div>
                <div class="position-relative h-100 d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-center"><span
                            class="badge badge-phoenix fs-10 badge-phoenix-primary" data-bs-theme="light">Ongoing</span>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-xxl-3">
            <div class="btn-reveal-trigger position-relative rounded-2 overflow-hidden p-4" style="height: 236px;">
                <div class="bg-holder"
                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0) 39.41%, rgba(0, 0, 0, 0.4) 100%), url({{ asset('assets/img/generic/57.png') }})">
                </div>
                <div class="position-relative h-100 d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-center"><span
                            class="badge badge-phoenix fs-10 badge-phoenix-warning" data-bs-theme="light">Completed</span>
                ...
                <div class="modal-body p-0">
                    <div class="row gx-0 gy-3 border-bottom px-5 px-lg-6 py-4 p-xl-0">
                        <div class="col-12 col-xl-5 border-end-xl">
                            <div
                                class="row h-100 align-items-center px-xl-6 justify-content-between justify-content-xl-start">
                                <div class="col-auto">
                                    <p class="text-body-tertiary fs-10 fw-semibold mb-0">Created</p>
                                    <p class="text-body-highlight fs-9 mb-0">Jan 3, 3:24 pm</p>
                                </div>
                                <div class="col-7 col-lg-6">
                                    <div class="flatpickr-input-container flatpickr-input-sm"><input
                                ...
                                <div class="row g-2 align-items-center">
                                    <div class="col-auto col-12 col-lg-auto d-flex flex-1">
                                        <div class="dropdown"><button
                                                class="d-none d-sm-block btn btn-subtle-secondary dropdown-toggle dropdown-caret-none d-flex align-items-center me-2"
                                                type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false"> Add to card <span class="fa-solid fa-plus ms-2">
                                                </span></button>
                                            <button
                                                class="d-sm-none btn btn-icon btn-icon-lg btn-subtle-secondary dropdown-toggle dropdown-caret-none d-flex align-items-center me-2"
                                                type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false"> <span class="fa-solid fa-plus"> </span></button>
                                            <div class="dropdown-menu dropdown-menu-end px-2"><button
                                                    class="btn btn-sm btn-subtle-secondary rounded-2 d-flex align-items-center w-100 mb-2"><span
                                                ...
                                                <button
                                                    class="btn btn-sm btn-subtle-secondary rounded-2 d-flex align-items-center w-100"><span
                                                        class="me-2 fa-solid fa-calendar-days"></span>Dates</button>
                                            </div>
                                        </div>
                                        <div class="dropdown"><button
                                                class="btn btn-icon btn-icon-lg bg-body-highlight text-body-emphasis bg-body-secondary-hover rounded-2 me-2"
                                                type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false"> <span
                                                    class="fa-solid fa-ellipsis-vertical"></span></button>
                                            <div class="dropdown-menu dropdown-menu-end px-2"><button
                                                    class="btn btn-sm btn-subtle-secondary rounded-2 d-flex align-items-center w-100 mb-2"><span
                                    ...
                                    <div class="col-auto col-lg-auto d-flex">
                                        <div class="dropdown"><button
                                                class="btn btn-subtle-info dropdown-toggle dropdown-caret-none d-flex align-items-center me-2"
                                                type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false"> Review <span class="fa-solid fa-angle-down ms-2">
                                                </span></button>
                                            <div class="dropdown-menu dropdown-menu-end py-2"><a class="dropdown-item"
                                        ...
                                        <div class="btn btn-subtle-secondary btn-icon btn-icon-lg"><span
                    ...
                    <div class="row g-0">
                        <div class="col-12 col-xl-5 border-end">
                            <div class="px-5 px-lg-6 py-4">
                                <h3 class="fw-bolder lh-sm mb-5">It was popularised in the 1960s with the release of
                                    Letraset</h3>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="d-flex align-items-center"><span
                                            ...
                                            class="text-body fw-bolder fs-9 lh-1 text-decoration-none" href="#!">
                                            <span class="fa-solid fa-plus me-1"></span>Add another</a></div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <p class="text-body-highlight">The female circus horse-rider is a recurring subject in
                                        ...
                                        gouaches...<a class="fw-semibold" href="#!">see more </a></p>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12 col-sm">
                                        ...
                                        <div class="d-flex">
                                            <p class="mb-0 fs-9 fw-semibold text-body-highlight"><span
                                                    class="fa-solid fa-circle text-primary" data-fa-transform="shrink-8">
                                                </span>Doing</p><span class="text-body-secondary fs-9 mx-2">to</span>
                                            <p class="mb-0 fs-9 fw-semibold text-body-highlight"><span
                                                    class="fa-solid fa-circle text-primary" data-fa-transform="shrink-8">
                                                </span>Review</p>
                                        </div>
                            ...
                            <div class="px-5 px-lg-6 py-4">
                                <div class="mb-7">
                                    ...
                                    <div
                                        ...
                                        <div class="col-12 col-lg-auto flex-1">
                                            <div data-todo-offcanvas-toogle="data-todo-offcanvas-toogle"
                                                ...
                                                <div class="form-check mb-1 mb-md-0 d-flex align-items-center lh-1"><input
                                                        ...
                                                        class="badge badge-phoenix fs-10 badge-phoenix-primary">DRAFT</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-auto">
                                            <div class="d-flex ms-4 lh-1 align-items-center"><button
                                                ...
                                                <p class="text-body-tertiary fs-10 mb-md-0 me-2 me-lg-3 mb-0">12 Nov, 2021
                                                </p>
                                                <div class="d-none d-lg-block end-0 position-absolute" style="top: 23%;">
                                                    <div class="hover-actions end-0"><button
                                                        ...
                                                        <button
                                                            class="btn btn-phoenix-secondary btn-icon fs-10 text-danger px-0"><span
                                                                class="fas fa-trash"></span></button>
                                                    </div>
                                                </div>
                                                <div class="hover-lg-hide">
                                                    <p
                                                        class="text-body-tertiary fs-10 ps-lg-3 border-start-lg fw-bold mb-md-0 mb-0">
                                                        12:00 PM</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-auto flex-1">
                                            <div data-todo-offcanvas-toogle="data-todo-offcanvas-toogle"
                                                ...
                                                <div class="form-check mb-1 mb-md-0 d-flex align-items-center lh-1"><input
                                                        ...
                                                        class="form-check-label mb-0 fs-8 me-2 line-clamp-1"
                                                        for="checkbox-todo-1">Hiring a motion graphic designer</label><span
                                                        class="badge badge-phoenix fs-10 badge-phoenix-warning">URGENT</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-auto">
                                        ...
                                        <div class="col-12 col-lg-auto flex-1">
                                            <div data-todo-offcanvas-toogle="data-todo-offcanvas-toogle"
                                                ...
                                                <div class="form-check mb-1 mb-md-0 d-flex align-items-center lh-1"><input
                                                        ...
                                                        class="badge badge-phoenix fs-10 badge-phoenix-info">ON
                                                        PROCESS</span></div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-auto">
                                            <div class="d-flex ms-4 lh-1 align-items-center"><button
                                                ...
                                                <p class="text-body-tertiary fs-10 mb-md-0 me-2 me-lg-3 mb-0">12 Dec, 2021
                                                </p>
                                                <div class="d-none d-lg-block end-0 position-absolute" style="top: 23%;">
                                                    <div class="hover-actions end-0"><button
                                                            class="btn btn-phoenix-secondary btn-icon me-1 fs-10 text-body px-0 me-1"><span
                                        ...
                                        <div class="col-12 col-lg-auto flex-1">
                                            <div data-todo-offcanvas-toogle="data-todo-offcanvas-toogle"
                                                ...
                                                <div class="form-check mb-1 mb-md-0 d-flex align-items-center lh-1"><input
                                                        ...
                                                        class="form-check-label mb-0 fs-8 me-2 line-clamp-1"
                                                        for="checkbox-todo-3">Finalizing the geometric shapes</label></div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-auto">
                                            <div class="d-flex ms-4 lh-1 align-items-center"><button
                                        ...
                                        <div class="col-12 col-lg-auto flex-1">
                                            <div data-todo-offcanvas-toogle="data-todo-offcanvas-toogle"
                                                ...
                                                <div class="form-check mb-1 mb-md-0 d-flex align-items-center lh-1"><input
                                                        ...
                                                        class="form-check-label mb-0 fs-8 me-2 line-clamp-1"
                                                        for="checkbox-todo-4">Daily meeting with team members</label></div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-auto">
                                            <div class="d-flex ms-4 lh-1 align-items-center">
                                                <p class="text-body-tertiary fs-10 mb-md-0 me-2 me-lg-3 mb-0">1 Nov, 2021
                                                </p>
                                                <div class="d-none d-lg-block end-0 position-absolute" style="top: 23%;">
                                                    <div class="hover-actions end-0"><button
                                                            class="btn btn-phoenix-secondary btn-icon me-1 fs-10 text-body px-0 me-1"><span
                                    ...
                                    <div
                                        ...
                                        <div class="col-12 col-lg-auto">
                                            <div class="d-flex ms-4 lh-1 align-items-center">
                                                <p class="text-body-tertiary fs-10 mb-md-0 me-2 me-lg-3 mb-0">13 Nov, 2021
                                                </p>
                                                <div class="d-none d-lg-block end-0 position-absolute" style="top: 23%;">
                                                    <div class="hover-actions end-0"><button
                                                            class="btn btn-phoenix-secondary btn-icon me-1 fs-10 text-body px-0 me-1"><span
