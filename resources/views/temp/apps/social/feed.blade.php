                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-home">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="{{ url('feed') }}">
          ...
          <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-chart-pie"></span>Home</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li><a class="dropdown-item active" href="{{ url('feed') }}">
        ...
        <div class="pb-10">
          <div class="row gy-3 gx-5 gx-xxl-6">
            ...
            <div class="col-lg-7 col-xl-8">
              <div class="card d-flex flex-column mb-5"><textarea class="form-control border-translucent rounded-bottom-0 border-0 flex-1 fs-8" rows="7" placeholder="Write something..."></textarea>
                ...
                <div class="mb-5">
                  <div class="card mb-4">
                    ...
                    <div class="bg-body-highlight border-top border-translucent p-3 p-sm-4">
                      <div class="d-flex align-items-center"><a href="{{ url('profile') }}">
                          <div class="avatar avatar-m  me-2">
                            <img class="rounded-circle " src="{{ asset('assets/img/team/61.webp') }}" alt="">
                          </div>
                        </a>
                        <div class="flex-1"><input class="form-control" type="text" placeholder="Add comment"></div>
                      </div>
                  ...
                  <div class="card mb-4">
                    <div class="card-body p-3 p-sm-4">
                      <div class="border-bottom border-translucent mb-3">
                        ...
                        <p class="text-body-secondary">Some paintings I love</p>
                        <div class="row g-1 mb-5">
                          <div class="col-3"><a href="{{ asset('assets/img/gallery/20.png') }}" data-gallery="gallery-posts-2"><img class="rounded h-100 w-100" src="{{ asset('assets/img/gallery/20.png') }}" alt="..."></a></div>
                          <div class="col-3"><a href="{{ asset('assets/img/gallery/21.png') }}" data-gallery="gallery-posts-2"><img class="rounded h-100 w-100" src="{{ asset('assets/img/gallery/21.png') }}" alt="..."></a></div>
                        </div>
                      </div>
                      <div class="d-flex"><button class="btn btn-link p-0 me-3 fs-10 fw-bolder" type="button"><span class="fa-solid fa-heart me-1"></span>345 Likes</button>
                        <button class="btn btn-link text-body p-0 fs-10 me-3 fw-bolder" type="button"><span class="fa-solid fa-comment me-1"></span>45 Comments</button>
