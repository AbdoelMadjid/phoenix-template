    ...
    <main class="main" id="top">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-home">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('feed') }}">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-social" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-social">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-social">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="{{ url('profile') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Profile</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('settings') }}">
          ...
          <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-chart-pie"></span>Home</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li><a class="dropdown-item" href="{{ url('feed') }}">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="social" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item active" href="{{ url('profile') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Profile</div>
                      </a></li>
      ...
      <div class="content">
                  ...
                  <div class="card mb-4">
                    <div class="card-body p-3 p-sm-4">
                      <div class="border-bottom border-translucent mb-3">
                        <div class="d-flex align-items-center mb-3"><a href="{{ url('profile') }}">
                          ...
                          <div class="flex-1"><a class="fw-bold mb-0 text-body-emphasis" href="{{ url('profile') }}">Erza Bridgest</a>
                        ...
                        <div class="row g-1 mb-5">
                          <div class="col-3"><a href="{{ asset('assets/img/gallery/22.png') }}" data-gallery="gallery-posts-0"><img class="rounded h-100 w-100" src="{{ asset('assets/img/gallery/22.png') }}" alt="..."></a></div>
                          <div class="col-3"><a href="{{ asset('assets/img/gallery/23.png') }}" data-gallery="gallery-posts-0"><img class="rounded h-100 w-100" src="{{ asset('assets/img/gallery/23.png') }}" alt="..."></a></div>
                          <div class="col-6"><a href="{{ asset('assets/img/gallery/24.png') }}" data-gallery="gallery-posts-0"><img class="rounded h-100 w-100" src="{{ asset('assets/img/gallery/24.png') }}" alt="..."></a></div>
                        </div>
                      </div>
                    ...
                    <div class="bg-body-highlight border-top border-translucent p-3 p-sm-4">
                      <div class="d-flex align-items-start"><a href="{{ url('profile') }}">
                        ...
                        <div class="flex-1">
                          <div class="d-flex align-items-center"><a class="fw-bold mb-0 text-body-emphasis" href="{{ url('profile') }}">Mamur Fechetti</a><span class="text-body-tertiary text-opacity-85 fw-semibold fs-10 ms-2">35 mins ago</span></div>
                          ...
                          <div class="d-flex align-items-start mb-3"><a href="{{ url('profile') }}">
                            ...
                            <div class="flex-1">
                              <div class="d-flex align-items-center"><a class="fw-bold mb-0 text-body-emphasis" href="{{ url('profile') }}">Zingko Kudobum</a><span class="text-body-tertiary text-opacity-85 fw-semibold fs-10 ms-2">5 mins ago</span></div>
                  ...
                  <div class="card mb-4">
                    <div class="card-body p-3 p-sm-4">
                      <div class="border-bottom border-translucent mb-3">
                        <div class="d-flex align-items-center mb-3"><a href="{{ url('profile') }}">
                          ...
                          <div class="flex-1"><a class="fw-bold mb-0 text-body-emphasis" href="{{ url('profile') }}">Zingko Kudobum</a>
                        ...
                        <div class="row g-1 mb-5">
                          <div class="col-3"><a href="{{ asset('assets/img/gallery/25.png') }}" data-gallery="gallery-posts-2"><img class="rounded h-100 w-100" src="{{ asset('assets/img/gallery/25.png') }}" alt="..."></a></div>
                          <div class="col-3"><a href="{{ asset('assets/img/gallery/26.png') }}" data-gallery="gallery-posts-2"><img class="rounded h-100 w-100" src="{{ asset('assets/img/gallery/26.png') }}" alt="..."></a></div>
                        </div>
                      </div>
                      <div class="d-flex"><button class="btn btn-link p-0 me-3 fs-10 fw-bolder" type="button"><span class="fa-solid fa-heart me-1"></span>345 Likes</button>
                        <button class="btn btn-link text-body p-0 fs-10 me-3 fw-bolder" type="button"><span class="fa-solid fa-comment me-1"></span>45 Comments</button>
                    ...
                    <div class="bg-body-highlight border-top border-translucent p-3 p-sm-4">
                      <div class="d-flex align-items-start"><a href="{{ url('profile') }}">
                        ...
                        <div class="flex-1">
                          <div class="d-flex align-items-center"><a class="fw-bold mb-0 text-body-emphasis" href="{{ url('profile') }}">Sutanuka Gomez</a><span class="text-body-tertiary text-opacity-85 fw-semibold fs-10 ms-2">35 mins ago</span></div>
        ...
        <div class="navbar-bottom d-xl-none">
          <div class="nav"><a class="nav-link" aria-current="page" href="{{ url('feed') }}"><span class="fa-solid fa-home nav-icon"></span><span class="nav-label">Home</span></a><a class="nav-link active" href="{{ url('profile') }}"><span class="fa-solid fa-user nav-icon"></span><span class="nav-label">Profile</span></a><a class="nav-link" href="#!"><span class="fa-solid fa-image nav-icon"></span><span class="nav-label">Photos</span></a><a class="nav-link" href="{{ url('chat') }}"><span class="fa-solid fa-message nav-icon"></span><span class="nav-label">Messages</span></a><a class="nav-link" href="{{ url('events/event-detail') }}"><span class="fa-solid fa-calendar-days nav-icon"></span><span class="nav-label">Events</span></a></div>
        </div>
