...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <body>
    ...
    <main class="main" id="top">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-kanban" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-kanban">
                    <div class="d-flex align-items-center">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-kanban">
                      ...
                      <li class="nav-item"><a class="nav-link" href="boards.html">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Boards</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link active" href="create-kanban-board.html">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="kanban" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="kanban.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Kanban</div>
                      </a></li>
                    <li><a class="dropdown-item" href="boards.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Boards</div>
                      </a></li>
                    <li><a class="dropdown-item active" href="create-kanban-board.html">
      ...
      <div class="content">
        <div class="d-flex align-items-center"><img class="me-3" src="../../assets/img/kanban/board.png" alt="">
        ...
        <div class="kanban-create-board row">
                        ...
                        <div class="tab-content mt-10" id="myTabContent">
                          ...
                          <div class="tab-pane fade" id="tab-bg" role="tabpanel" aria-labelledby="bg-tab">
                            <div class="row g-3 mb-4">
                              <div class="col-6"><input class="btn-check kanban-swatch-radio" type="radio" value="assets/img/kanban/bg1.jpg" checked="checked" name="board-img" id="img0"><label class="kanban-radio-bg-image w-100" for="img0"><img class="me-2 cursor-pointer rounded-3 object-fit-cover w-100" src="../../assets/img/kanban/bg1.jpg" alt="" style="height: 100px"></label></div>
                              <div class="col-6"><input class="btn-check kanban-swatch-radio" type="radio" value="assets/img/kanban/bg2.jpg" name="board-img" id="img1"><label class="kanban-radio-bg-image w-100" for="img1"><img class="me-2 cursor-pointer rounded-3 object-fit-cover w-100" src="../../assets/img/kanban/bg2.jpg" alt="" style="height: 100px"></label></div>
                              <div class="col-6"><input class="btn-check kanban-swatch-radio" type="radio" value="assets/img/kanban/bg3.jpg" name="board-img" id="img2"><label class="kanban-radio-bg-image w-100" for="img2"><img class="me-2 cursor-pointer rounded-3 object-fit-cover w-100" src="../../assets/img/kanban/bg3.jpg" alt="" style="height: 100px"></label></div>
                              <div class="col-6"><input class="btn-check kanban-swatch-radio" type="radio" value="assets/img/kanban/bg4.jpg" name="board-img" id="img3"><label class="kanban-radio-bg-image w-100" for="img3"><img class="me-2 cursor-pointer rounded-3 object-fit-cover w-100" src="../../assets/img/kanban/bg4.jpg" alt="" style="height: 100px"></label></div>
                              <div class="col-6"><input class="btn-check kanban-swatch-radio" type="radio" value="assets/img/kanban/bg5.jpg" name="board-img" id="img4"><label class="kanban-radio-bg-image w-100" for="img4"><img class="me-2 cursor-pointer rounded-3 object-fit-cover w-100" src="../../assets/img/kanban/bg5.jpg" alt="" style="height: 100px"></label></div>
                              <div class="col-6"><input class="btn-check kanban-swatch-radio" type="radio" value="assets/img/kanban/bg6.jpg" name="board-img" id="img5"><label class="kanban-radio-bg-image w-100" for="img5"><img class="me-2 cursor-pointer rounded-3 object-fit-cover w-100" src="../../assets/img/kanban/bg6.jpg" alt="" style="height: 100px"></label></div>
          ...
          <div class="col-xxl-7 col-xl-6 col-12 text-center kanban-board-bg"><img class="d-dark-none mt-5 position-sticky" src="../../assets/img/kanban/board-ligth.png" alt="" style="top: 200px"><img class="d-light-none position-sticky" src="../../assets/img/kanban/board-dark.png" alt="" style="top: 200px"></div>
        </div>
