...
@section('content_class', 'kanban-content')
...
@section('content')
    <div class="kanban-header">
        <div class="row gx-0 justify-content-between justify-content-md-start">
            <div class="col-auto">
                <div class="dropdown"><button class="btn btn-link text-decoration-none text-body-emphasis fs-8 ps-0"
                        type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span
                            class="fs-7 me-2">Phoenix</span><span
                            class="fas fa-angle-down text-body-quaternary d-inline-block" data-fa-transform="up-2"
                            style="min-width: 12px"></span></button>
                    <div class="dropdown-menu py-0"> <a class="dropdown-item" href="#!">Sparrow</a><a
                            class="dropdown-item" href="#!">Boreas</a><a class="dropdown-item"
                            href="#!">Erebus</a></div>
                </div>
            </div>
            <div class="col-auto d-flex align-items-center">
                <div class="avatar-group"><a class="dropdown-toggle dropdown-caret-none d-inline-block" href="#"
                        ...
                        <div class="bg-body-emphasis">
                            ...
                            <ul class="nav d-flex flex-column py-3 border-bottom">
                                <li class="nav-item"><a class="nav-link px-3 d-flex flex-between-center" href="#!">
                                        <span class="me-2 text-body d-inline-block" data-feather="clipboard"></span><span
                                            class="text-body-highlight flex-1">Assigned Projects</span><span
                                            class="fa-solid fa-chevron-right fs-11"></span></a></li>
                                <li class="nav-item"><a class="nav-link px-3 d-flex flex-between-center" href="#!">
                                        <span class="me-2 text-body" data-feather="pie-chart"></span><span
                            ...
                            <div class="p-3">
                                ...
                                <div class="text-center">
                                    <div
                                        class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2 mb-2">
                                        <img class="rounded-circle border border-light-subtle"
                                            src="{{ asset('assets/img/team/5.webp') }}" alt=""></div>
                ...
                </div><button class="btn btn-primary ms-4 fs-10 px-3"><span class="fas fa-user-plus d-inline-block"
                        style="min-width: 14px"></span><span class="d-none d-sm-inline ms-2">invite</span></button>
            </div>
            <div class="col-md-auto d-flex align-items-center ms-auto mt-2 mt-md-0">
                <ul class="nav w-100 fs-9">
                    <li class="nav-item"><a class="nav-link d-flex align-items-center text-body ps-0 pe-2 px-xl-3 fw-bold"
                            href="#!" data-bs-toggle="modal" data-bs-target="#searchBoxModal"><span
                                class="me-1 fas fa-search" data-fa-transform="up-2" style="min-width: 14px"></span><span
                    ...
                    <li class="nav-item"><a class="nav-link d-flex align-items-center text-body px-2 px-xl-3 fw-bold"
                            href="#!"><span class="me-1 fa-solid fa-right-left" data-fa-transform="up-2"
                                style="min-width: 14px"></span><span class="d-none d-xxl-inline">Export/import</span></a>
                    </li>
                    <li class="nav-item"><a class="nav-link d-flex align-items-center text-body px-2 px-xl-3 fw-bold"
                    ...
                    <li class="nav-item ms-auto"><a
                            ...
                            data-phoenix-toggle="offcanvas" data-phoenix-target="#offcanvasKanban"
                            href="#offcanvasKanban" role="button"><span class="fa-solid fa-bars d-inline"
                                data-fa-transform="up-2" style="min-width: 14px"></span></a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Develop a new feature for the phoenix mobile app
                            </p>
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Conduct user research to gather feedback on the
                                latest product iteration</p>
                            <div class="d-flex mt-2 align-items-center"></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body py-3 px-3">
                            <div class="kanban-status mb-1 position-relative lh-1"><span
                                    ...
                                    class="badge badge-phoenix fs-10 badge-phoenix-warning"><span>Issue</span><span
                                        class="ms-1 d-inline-block fa-solid fa-triangle-exclamation"
                                        data-fa-transform="up-2" style="height:7.8px;width:7.8px;"></span></span><button
                                    class="btn btn-sm btn-phoenix-default kanban-item-dropdown-btn hover-actions"
                                    type="button" data-boundary="viewport" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false"><span
                                        class="fas fa-ellipsis-h fa-rotate-90"
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Review and approve marketing materials for the
                                upcoming product launch</p>
                            <div class="d-flex mt-2 align-items-center"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            <div class="position-relative mb-2 overflow-hidden rounded" style="height:200px; width:100%">
                                <div class="bg-holder"
                                    style="background-image:url({{ asset('assets/img/kanban/1.jpg') }});"></div>
                                <!--/.bg-holder-->
                            </div>
                            <div class="kanban-status mb-1 position-relative lh-1"><span
                                    class="fa fa-circle me-2 d-inline-block text-danger" style="min-width:1rem"
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Test and debug code for the e-commerce website
                                checkout process</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1"><span
                                        class="fa-solid fa-paperclip fs-9 me-2 d-inline-block"
                                        style="min-width: 1rem;"></span>15</p>
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Write a blog post on industry trends and best
                                practices</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1 me-3 white-space-nowrap"><span
                                        class="fa-solid fa-calendar-xmark fs-9 me-2 d-inline-block"
                                        style="min-width: 1rem;"></span>Jan 25</p>
                                <div class="avatar-group ms-auto">
                                    <div class="avatar avatar-s  border border-light-subtle rounded-pill">
                                        <img class="rounded-circle " src="{{ asset('assets/img/team/30.webp') }}"
                                            alt="">
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Create wireframes for a new phoenix landing page
                                design</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1 me-3 white-space-nowrap"><span
                                        class="fa-solid fa-calendar-xmark fs-9 me-2 d-inline-block"
                                ...
                                <div class="avatar-group ms-auto">
                                    ...
                                    <div class="avatar avatar-s  border border-light-subtle rounded-pill">
                                        <div class="avatar-name rounded-circle text-warning bg-warning-subtle">
                                            <span>R</span></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Set up and configure a new software tool for the
                                marketing team</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1"><span
                                        class="fa fa-check-square fs-9 me-2 d-inline-block"
                                        style="min-width: 1rem;"></span>5/34</p>
                                <div class="avatar-group ms-auto">
                                    <div class="avatar avatar-s  border border-light-subtle rounded-pill">
                                        <img class="rounded-circle " src="{{ asset('assets/img/team/25.webp') }}"
                                            alt="">
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Draft and send a press release to announce a new
                                partnership</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1 me-3 white-space-nowrap"><span
                                        class="fa-solid fa-calendar-xmark fs-9 me-2 d-inline-block"
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            <div class="position-relative mb-2 overflow-hidden rounded" style="height:200px; width:100%">
                                <div class="bg-holder"
                                    style="background-image:url({{ asset('assets/img/kanban/glass.jpg') }});"></div>
                                <!--/.bg-holder-->
                            </div>
                            <div class="kanban-status mb-1 position-relative lh-1"><span
                                    class="fa fa-circle me-2 d-inline-block text-warning" style="min-width:1rem"
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Conduct a security audit of the phoenix web
                                applications</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1 me-3 white-space-nowrap"><span
                                        class="fa-solid fa-calendar-xmark fs-9 me-2 d-inline-block"
        ...
        <div class="kanban-column scrollbar">
            <div class="kanban-column-header px-4 hover-actions-trigger">
                <div class="d-flex align-items-center border-bottom border-3 py-3 border-info">
                    ...
                    <div class="hover-actions-trigger"><button
                            class="btn btn-sm btn-phoenix-default kanban-header-dropdown-btn hover-actions"
            ...
            <div class="kanban-items-container" data-sortable="data-sortable">
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Design and develop a new logo for the phoenix</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1"><span
                                        class="fa-solid fa-paperclip fs-9 me-2 d-inline-block"
                                        style="min-width: 1rem;"></span>15</p>
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Create a fresh visual identity for Phoenix with a
                                new logo design</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1"><span
                                        class="fa fa-check-square fs-9 me-2 d-inline-block"
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Identify best software vendors for company-wide
                                system through comprehensive research and evaluation</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1"><span
                                        class="fa-solid fa-paperclip fs-9 me-2 d-inline-block"
                                        style="min-width: 1rem;"></span>15</p>
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            <div class="position-relative mb-2 overflow-hidden rounded"
                                style="height:200px; width:100%">
                                <div class="bg-holder"
                                    style="background-image:url({{ asset('assets/img/kanban/wall.jpg') }});"></div>
                                <!--/.bg-holder-->
                            </div>
                            <div class="kanban-status mb-1 position-relative lh-1"><span
                                    class="fa fa-circle me-2 d-inline-block text-primary" style="min-width:1rem"
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Write and edit copy for a new email marketing
                                campaign</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1"><span
                                        class="fa-solid fa-paperclip fs-9 me-2 d-inline-block"
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Improve Phoenix website usability through user
                                testing</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1"><span
                                        class="fa-solid fa-paperclip fs-9 me-2 d-inline-block"
                    ...
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            <div class="position-relative mb-2 overflow-hidden rounded"
                                style="height:200px; width:100%">
                                <div class="bg-holder"
                                    style="background-image:url({{ asset('assets/img/kanban/home.jpg') }});"></div>
                                <!--/.bg-holder-->
                            </div>
                            <div class="kanban-status mb-1 position-relative lh-1"><span
                                    class="fa fa-circle me-2 d-inline-block text-danger" style="min-width:1rem"
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Develop and deliver a training program for new
                                employees</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1"><span
                                        class="fa-solid fa-paperclip fs-9 me-2 d-inline-block"
                ...
                <div class="sortable-item-wrapper border-bottom border-translucent px-2 py-2">
                    <div class="card sortable-item hover-actions-trigger">
                        <div class="card-body py-3 px-3">
                            ...
                            <p class="mb-0 stretched-link" data-bs-toggle="modal"
                                data-bs-target="#KanbanItemDetailsModal">Organize and lead a brainstorming session to
                                generate new product ideas</p>
                            <div class="d-flex mt-2 align-items-center">
                                <p class="mb-0 text-body-tertiary text-opacity-85 fs-9 lh-1"><span
                                        class="fa-solid fa-paperclip fs-9 me-2 d-inline-block"
                                        style="min-width: 1rem;"></span>15</p>
    ...
    <div class="phoenix-offcanvas phoenix-offcanvas-end bg-body-highlight position-fixed outline-none" tabindex="-1"
        ...
        <div class="offcanvas-body">
                            ...
                            <div class="p-3">
                                ...
                                <div class="text-center">
                                    <div
                                        class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2 mb-2">
                                        <img class="rounded-circle border border-light-subtle"
                                            src="{{ asset('assets/img/team/65.webp') }}" alt=""></div>
                                    <h6 class="text-white">Igor Borvibson</h6>
                                    <p class="text-light text-opacity-50 fw-semibold fs-10 mb-2">@tyrion222</p>
                                    <div class="d-flex flex-center mb-3">
                                        <h6 class="text-white mb-0">224 <span
                            ...
                            <div class="p-3">
                                ...
                                <div class="text-center">
                                    <div
                                        class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2 mb-2">
                                        <img class="rounded-circle border border-light-subtle"
                                            src="{{ asset('assets/img/team/3.webp') }}" alt=""></div>
                                    <h6 class="text-white">Milind Mikuja</h6>
                                    <p class="text-light text-opacity-50 fw-semibold fs-10 mb-2">@tyrion222</p>
                                    <div class="d-flex flex-center mb-3">
                                        <h6 class="text-white mb-0">224 <span
                            ...
                            <div class="p-3">
                                ...
                                <div class="text-center">
                                    <div
                                        class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2 mb-2">
                                        <img class="rounded-circle border border-light-subtle"
                                            src="{{ asset('assets/img/team/4.webp') }}" alt=""></div>
                                    <h6 class="text-white">Stanly Drinkwater</h6>
                                    <p class="text-light text-opacity-50 fw-semibold fs-10 mb-2">@tyrion222</p>
                                    <div class="d-flex flex-center mb-3">
                                        <h6 class="text-white mb-0">224 <span
            ...
            <h4 class="text-body-highlight fw-semibold mb-0 mt-7 mb-3 border-bottom border-translucent pb-3">Description
                <span class="fas fa-pencil text-body fs-9 ms-3 cursor-pointer" data-fa-transform="up-2"></span></h4>
            <p>Phoenix is a rich and complex symbol that continues to capture the imagination of people across cultures and
                time periods. Whether seen as a symbol of hope, renewal, or mystery, the Phoenix remains an enduring icon of
                the human spirit.</p>
            <ul class="list-unstyled mb-0">
                <li><a class="text-body-highlight fw-semibold text-decoration-none d-flex flex-between-center py-3  border-bottom"
                        href="#!"><span>Board Setting</span><span class="fas fa-angle-right fs-9 me-3"></span></a>
                </li>
                <li><a class="text-body-highlight fw-semibold text-decoration-none d-flex flex-between-center py-3  border-bottom"
                        href="#!"><span>Duplicate Board</span><span
                            class="fas fa-angle-right fs-9 me-3"></span></a></li>
                <li><a class="text-body-highlight fw-semibold text-decoration-none d-flex flex-between-center py-3  border-bottom"
                        href="#!"><span>Manage Labels</span><span class="fas fa-angle-right fs-9 me-3"></span></a>
                </li>
                <li><a class="text-body-highlight fw-semibold text-decoration-none d-flex flex-between-center py-3  border-bottom"
                        href="#!"><span>Go to Archive</span><span class="fas fa-angle-right fs-9 me-3"></span></a>
                </li>
                <li><a class="text-body-highlight fw-semibold text-decoration-none d-flex flex-between-center py-3  border-bottom"
                ...
                <li><a class="text-body-highlight fw-semibold text-decoration-none d-flex flex-between-center py-3  border-bottom"
                        href="#!"><span>Integrations</span><span class="fas fa-angle-right fs-9 me-3"></span></a>
                </li>
                <li><a class="text-body-highlight fw-semibold text-decoration-none d-flex flex-between-center py-3  border-bottom"
                        href="#!"><span>Privacy Settings</span><span
                            class="fas fa-angle-right fs-9 me-3"></span></a></li>
                <li><a class="text-body-highlight fw-semibold text-decoration-none d-flex flex-between-center py-3  border-bottom"
                        href="#!"><span>Automation</span><span class="fas fa-angle-right fs-9 me-3"></span></a>
                </li>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row gx-3 gy-4">
                        <div class="col-sm-6 col-md-12">
                            <div class="form-floating"><input class="form-control" id="kanbanTaskTitle"
                                    type="text" placeholder="title" value=""><label
                                    for="kanbanTaskTitle">Title</label></div>
                        </div>
                        <div class="col-12 gy-4">
                            <div class="form-floating">
                                <textarea class="form-control" id="floatingProjectDescription" placeholder="Leave a comment here"
                                    style="height: 128px"></textarea><label for="floatingProjectDescription">ADD A
                                    DESCRIPTION</label>
                            </div>
                        </div>
                        <div class="col-12 gy-4">
                            <div class="dropzone dropzone-multiple bg-transparent p-0" id="Kanbandropzone"
                                ...
                                <div class="dz-message py-3" data-dz-message="data-dz-message">
                                    <div class="dz-message-text text-center text-body-secondary"><img class="mb-2"
                                            src="{{ asset('assets/img/icons/image-icon.png') }}" width="24"
                                            alt=""><br>Add cover image </div>
                                </div>
                                <div class="dz-preview dz-preview-multiple m-0 d-flex flex-column">
                                    <div class="d-flex pb-3 border-bottom border-translucent media px-2">
                                        <div class="border border-dashed p-2 rounded-2 me-2"><img
                ...
                <div class="modal-footer justify-content-between"><button class="btn p-1" type="button"
                        data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times fs-10 me-1"
                            data-fa-transform="up-1"></span>Close</button>
            ...
            <div class="modal-content overflow-hidden">
                <div class="modal-body p-0">
                    <div class="position-relative" style="height:200px; width:100%">
                        <div class="bg-holder"
                            style="background-image:url({{ asset('assets/img/kanban/modal-bg.jpg') }});"></div>
                        <!--/.bg-holder-->
                    </div>
                    <div class="row gy-4 py-0 gx-0">
                        <div class="col-lg-8 col-12">
                            <div class="row mt-0 gy-4 pb-3 gx-0 px-3">
                                ...
                                <div class="col-8 col-sm-9">
                                    <p class="fs-9 mb-0">Reproduced below for those interested" is a phrase used to
                                        provide additional content or details for individuals who have expressed interest in
                                        a particular topic. It signals that what follows is optional and caters specifically
                                        to those who want to delve deeper into the subject matter.</p>
                                </div>
                                <div class="col-4 col-sm-3">
                                ...
                                <div class="col-8 col-sm-9">
                                    <p
                                        class="mb-0 text-body-emphasis fw-semibold d-inline-block kanban-column-underline-warning">
                                        Doing</p>
                                </div>
                                <div class="col-4 col-sm-3">
                                                ...
                                                <div class="p-3">
                                                    ...
                                                    <div class="text-center">
                                                        <div
                                                            class="avatar avatar-xl status-online position-relative me-2 me-sm-0 me-xl-2 mb-2">
                                                            <img class="rounded-circle border border-light-subtle"
                                                                src="{{ asset('assets/img/team/30.webp') }}"
                                                                alt=""></div>
                                                        <h6 class="text-white">Stanly Drinkwater</h6>
                                ...
                                <div class="col-8 col-sm-9">
                                    <p class="mb-0 text-body-emphasis fw-semibold"><span
                                            class="fa fa-circle m text-warning"
                                ...
                                <div class="col-8 col-sm-9">
                                    <div class="border-bottom border-translucent d-flex flex-row pb-3"><a
                                            href="{{ asset('assets/img/kanban/a1.jpg') }}"
                                            data-gallery="gallery-kanban-attachment"> <img class="rounded-3"
                                                src="{{ asset('assets/img/kanban/a1.jpg') }}" width="64"
                                                height="64" alt=""></a>
                                        <div class="flex-1 ms-3 d-flex flex-column">
                                            <h5 class="lh-sm">Silly_sight_1.png</h5>
                                            <p class="lh-1 fs-9 text-body-tertiary fw-medium mb-0">21st Decemver, 12:56 PM
                                            </p>
                                            <div class="d-flex mt-auto"><button
                                                    class="btn p-0 fs-8 text-body-tertiary me-3"><span
                                                        class="fas fa-comment"
                                                        data-fa-transform="shrink-4"></span></button>
                                                <button class="btn p-0 fs-8 text-body-tertiary me-3"><span
                                                        class="fas fa-trash"
                                                        data-fa-transform="shrink-4"></span></button>
                                                <button class="btn p-0 fs-8 text-body-tertiary"><span
                                                        class="fas fa-pencil"
                                                        data-fa-transform="shrink-4"></span></button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="border-bottom border-translucent d-flex flex-row pb-3 mt-3">
                                        <div class="border border-translucent rounded-3 flex-center d-flex"
                                            ...
                                            <div
                                                class="fa-solid fa-file-zipper fa-2x text-body-quaternary text-opacity-75">
                                            </div>
                                        </div>
                                        <div class="flex-1 ms-3 d-flex flex-column">
                            ...
                            <div class="scrollbar" style="max-height: 667px;">
                                <div class="px-3">
                                    ...
                                    <ul class="nav flex-column flex-sm-row flex-lg-column list-unstyled">
                                        ...
                                        <li class="kanban-action-item lh-sm nav-item me-2"><a
                                                class="nav-link text-body-emphasis fw-semibold fs-9 stretched-link"
                                                href="#!"><span class="me-2 fa-solid fa-clone"></span>Duplicate</a>
                                        </li>
                                        <li class="kanban-action-item lh-sm nav-item me-2"><a
                                                class="nav-link text-body-emphasis fw-semibold fs-9 stretched-link"
                                                href="#!"><span
                                        ...
                                        <li class="kanban-action-item lh-sm nav-item me-2"><a
                                                class="nav-link text-body-emphasis fw-semibold fs-9 stretched-link"
                                                href="#!"><span class="me-2 fa-solid fa-square-plus"></span>Create
                                                template</a></li>
                                        <li class="kanban-action-item lh-sm nav-item me-2"><a
                                                class="nav-link text-body-emphasis fw-semibold fs-9 stretched-link"
                                                href="#!"><span
                                        ...
                                        <li class="kanban-action-item lh-sm nav-item me-2"><a
                                                class="nav-link text-body-emphasis fw-semibold fs-9 stretched-link"
                                                href="#!"><span class="me-2 fa-solid fa-box-archive"></span>Move to
                                                Archive</a></li>
                                        <li class="kanban-action-item lh-sm nav-item me-2"><a
                                                class="nav-link text-body-emphasis fw-semibold fs-9 stretched-link"
                                                href="#!"><span class="me-2 fa-solid fa-trash-can"></span>Move to
                                                Trash</a></li>
                                        <li class="kanban-action-item lh-sm nav-item me-2"><a
                                                class="nav-link text-body-emphasis fw-semibold fs-9 stretched-link"
                                                href="#!"><span
                                    ...
                                    <div class="d-flex border-bottom ">
                                        ...
                                        <div class="activity-item ps-2 py-3">
                                            <p class="mb-1 fs-9"><span class="fw-bold"> Alfen Loebe </span> Moved the
                                                task <a href="#!">"the standard chunk" </a>from <span
                                                    class="fw-bold">Doing</span> to <span class="fw-bold">To Do</span>
                                            </p>
                                            <div class="d-flex">
                                                <p class="mb-0 fs-9 me-3"> <span
                                                        class="fa-regular fa-clock me-1"></span>10:41 AM</p>
                                    ...
                                    <div class="d-flex border-bottom ">
                                        <div class="pt-3 text-info"><span
                                                ...
                                                data-fa-transform="shrink-4"></span></div>
                                        <div class="activity-item ps-2 py-3">
                                            <p class="mb-1 fs-9"><span class="fw-bold"> Jessie Samson </span> Attached
                                                image3.png to the task <a href="#!">"the standard chunk" </a></p>
                                            <div class="d-flex">
                                                <p class="mb-0 fs-9 me-3"> <span
                                                        class="fa-regular fa-clock me-1"></span>10:41 AM</p>
                                                <p class="mb-0 fs-9">Aughst 7,2022</p>
                                    ...
                                    <div class="d-flex border-bottom ">
                                        <div class="pt-3 text-info"><span
                                                class="border border-translucent rounded-pill p-1 fas fa-plus"
                                                data-fa-transform="shrink-4"></span></div>
                                        <div class="activity-item ps-2 py-3">
                                            <p class="mb-1 fs-9"><span class="fw-bold"> Alfen Loebe </span> Moved the
                                                task <a href="#!">"the standard chunk" </a>from <span
                ...
                <div class="modal-footer justify-content-between"><button class="btn p-1" type="button"
                        data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times fs-10 me-1"
                            data-fa-transform="up-1"></span>Close</button>
                    <button class="btn btn-phoenix-primary px-6" type="button" data-bs-target="#kanbanAddTask"
                        data-bs-toggle="modal">Edit<span class="fas fa-edit ms-2"
