  ...
  <body>
    ...
    <main class="main" id="top">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-events" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-events">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-events">
                      ...
                      <li class="nav-item"><a class="nav-link" href="create-an-event.html">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Create an event</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link active" href="event-detail.html">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="events" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="create-an-event.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Create an event</div>
                      </a></li>
                    <li><a class="dropdown-item active" href="event-detail.html">
      ...
      <div class="content">
        ...
        <div class="pb-9">
          <h2 class="mb-4 mb-lg-6">Event details</h2><img class="rounded w-100 object-fit-cover mb-5 mb-md-6 mb-xl-8" src="../../assets/img/generic/34.png" alt="" style="min-height: 250px;">
          <div class="row gx-lg-9">
            <div class="col-xl-8 border-end-xl">
              ...
              <div class="row g-1 g-sm-2 mb-7 mb-xxl-8">
                <div class="col-3"><a href="../../assets/img/gallery/19.jpg" data-gallery="gallery-posts-undefined"><img class="rounded h-100 w-100 object-fit-cover" src="../../assets/img/gallery/19.jpg" alt="..."></a></div>
                <div class="col-3"><a href="../../assets/img/gallery/20.jpg" data-gallery="gallery-posts-undefined"><img class="rounded h-100 w-100 object-fit-cover" src="../../assets/img/gallery/20.jpg" alt="..."></a></div>
                <div class="col-6"><a href="../../assets/img/gallery/21.jpg" data-gallery="gallery-posts-undefined"><img class="rounded h-100 w-100 object-fit-cover" src="../../assets/img/gallery/21.jpg" alt="..."></a></div>
              </div>
            ...
            <div class="col-xl-4">
              ...
              <div class="row g-2 mb-6 align-items-center">
                <div class="col-auto"><img class="rounded img-fluid" src="../../assets/img/brand2/b.png" alt="..." width="40" height="40"></div>
