                                            ...
                                            <div
                                                ...
                                                <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                    ...
                                                    title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                        ...
                                                        class="far fa-heart d-none-hover"
                                                        data-fa-transform="down-1"></span></button><img class="img-fluid"
                                                    src="{{ asset('assets/img/products/1.png') }}" alt=""><span
                                            ...
                                            <div
                                                ...
                                                <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                    ...
                                                    title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                        ...
                                                        class="far fa-heart d-none-hover"
                                                        data-fa-transform="down-1"></span></button><img class="img-fluid"
                                                    src="{{ asset('assets/img/products/25.png') }}" alt="">
                                            </div>
                                            <a class="stretched-link"
                                                href="{{ url('apps/e-commerce/product-details') }}">
                                            ...
                                            <div
                                                ...
                                                <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                    ...
                                                    title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                        ...
                                                        class="far fa-heart d-none-hover"
                                                        data-fa-transform="down-1"></span></button><img class="img-fluid"
                                                    src="{{ asset('assets/img/products/27.png') }}" alt="">
                                            </div>
                                            <a class="stretched-link"
                                                href="{{ url('apps/e-commerce/product-details') }}">
                                            ...
                                            <div
                                                ...
                                                <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                    ...
                                                    title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                        ...
                                                        class="far fa-heart d-none-hover"
                                                        data-fa-transform="down-1"></span></button><img class="img-fluid"
                                                    src="{{ asset('assets/img/products/26.png') }}" alt="">
                                            </div>
                                            <a class="stretched-link"
                                                href="{{ url('apps/e-commerce/product-details') }}">
                                            ...
                                            <div
                                                ...
                                                <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                    ...
                                                    title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                        ...
                                                        class="far fa-heart d-none-hover"
                                                        data-fa-transform="down-1"></span></button><img
                                                    class="img-fluid" src="{{ asset('assets/img/products/20.png') }}"
                                                    alt="">
                                            </div><a class="stretched-link"
                                                href="{{ url('apps/e-commerce/product-details') }}">
