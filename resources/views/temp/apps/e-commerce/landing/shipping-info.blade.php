      ...
      <nav class="navbar-responsive-navitems navbar-expand navbar-light bg-body-emphasis justify-content-between">
        <div class="container-small d-flex flex-between-center" data-navbar="data-navbar">
          ...
          <ul class="navbar-nav justify-content-end align-items-center">
            ...
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a class="nav-link active" href="{{ url('shipping-info') }}">Shipping Info</a></li>
          ...
          <div class="row">
            <div class="col-lg-7 mb-4 mb-lg-0">
              <form>
                ...
                <div class="row g-4">
                  <div class="col-12"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputName">Full name</label><input class="form-control" id="inputName" type="text" placeholder="Full name"></div>
                  <div class="col-md-6"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputEmail">Email</label><input class="form-control" id="inputEmail" type="email" placeholder="Email"></div>
                  <div class="col-md-6"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputPhone">Phone</label><input class="form-control" id="inputPhone" type="tel" placeholder="+1234567890"></div>
                  <div class="col-12"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputAddress1">Address line 1</label><input class="form-control" id="inputAddress1" type="text" placeholder="Address line 1"></div>
                  <div class="col-12"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputAddress2">Address line 2</label><input class="form-control" id="inputAddress2" type="text" placeholder="Address line 2"></div>
                  <div class="col-md-4"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputCity">City</label><select class="form-select text-body-emphasis" id="inputCity">
                      <option selected="selected">Van Nuys</option>
                      <option value="los-angeles">Los Angeles</option>
                      <option value="chicago">Chicago</option>
                      <option value="houston">Houston</option>
                    </select></div>
                  <div class="col-md-4"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputState">State</label><select class="form-select text-body-emphasis" id="inputState">
                      <option selected="selected">California</option>
                      <option value="Alaska">Alaska</option>
                      <option value="alabama">Alabama</option>
                      <option value="florida">Florida</option>
                    </select></div>
                  <div class="col-md-4"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputZipCode">Zip code</label><input class="form-control number-arrows-none" id="inputZipCode" type="number" placeholder="Zip code"></div>
                  <div class="col-md-4 mb-3"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none" for="inputCountry">Country</label><select class="form-select text-body-emphasis" id="inputCountry">
                      <option selected="selected">USA</option>
                      <option value="uk">UK</option>
                      <option value="aus">AUS</option>
                      <option value="nz">NZ</option>
                    </select></div>
                  <div class="col-12"><button class="btn btn-primary px-8 px-sm-11 me-2" type="submit">Save</button>
                    <button class="btn btn-phoenix-secondary text-nowrap" type="submit">Exit Without Saving</button>
                  </div>
                </div>
              </form>
            </div>
                    ...
                    <div class="ms-n2">
                      <div class="row align-items-center mb-2 g-3">
                        <div class="col-8 col-md-7 col-lg-8">
                          <div class="d-flex align-items-center"><img class="me-2 ms-1" src="{{ asset('assets/img/products/1.png') }}" width="40" alt="">
                      ...
                      <div class="row align-items-center mb-2 g-3">
                        <div class="col-8 col-md-7 col-lg-8">
                          <div class="d-flex align-items-center"><img class="me-2 ms-1" src="{{ asset('assets/img/products/2.png') }}" width="40" alt="">
                      ...
                      <div class="row align-items-center mb-5 g-3">
                        <div class="col-8 col-md-7 col-lg-8">
                          <div class="d-flex align-items-center"><img class="me-2 ms-1" src="{{ asset('assets/img/products/3.png') }}" width="40" alt="">
