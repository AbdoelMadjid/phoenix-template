            ...
            <div class="col-12 col-sm-auto flex-grow-1">
                <div class="row align-items-center flex-wrap gy-1">
                    <div class="col-auto flex-grow-1">
                        <p class="text-body-secondary lh-sm mb-0">Customer ID : <a class="fw-bold ms-1"
                                href="#!">2364847</a></p>
                    </div>
                    <div class="col-auto">
                        <div class="dropdown"><button class="btn dropdown-toggle dropdown-caret-none px-0 text-body"
                                type="button" data-bs-toggle="dropdown" aria-expanded="false">More action<span
                                    class="fas fa-chevron-down ms-2 fs-10"></span></button>
            ...
            <div class="col-12 col-xl-4 col-xxl-3">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Refund Amount</h4><input class="form-control mb-4"
                                    id="refundInput" type="text" placeholder="Amount"><button
                                    class="btn btn-primary w-100">Refund $500</button>
                            </div>
                        </div>
                    </div>
                </div>
