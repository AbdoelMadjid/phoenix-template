...
@section('content')
    ...
    <div class="mb-9">
        ...
        <div class="d-sm-flex flex-between-center mb-3">
            <p class="text-body-secondary lh-sm mb-0 mt-2 mt-sm-0">Customer ID : <a class="fw-bold" href="#!">
                    2364847</a></p>
            <div class="d-flex"><button class="btn btn-link pe-3 ps-0 text-body"><span
                        class="fas fa-print me-2"></span>Print</button>
                <button class="btn btn-link px-3 text-body"><span class="fas fa-undo me-2"></span>Refund</button>
                <div class="dropdown"><button class="btn text-body dropdown-toggle dropdown-caret-none ps-3 pe-0"
                        type="button" data-bs-toggle="dropdown" aria-expanded="false">More action<span
                        ...
                        <table class="table fs-9 mb-0 border-top border-translucent">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort align-middle ps-4" scope="col" data-sort="color"
                                        style="width:150px;">COLOR</th>
                                    <th class="sort align-middle ps-4" scope="col" data-sort="size" style="width:300px;">
                                        SIZE</th>
                            ...
                            <tbody class="list" id="order-table-body">
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    <td class="align-middle white-space-nowrap py-2"><a
                                            ...
                                            href="{{ url('landing/product-details') }}"><img
                                                ...
                                                width="53"></a></td>
                                    <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0"
                                            href="{{ url('landing/product-details') }}">Fitbit Sense Advanced Smartwatch
                                            with Tools for Heart Health, Stress Management &amp; Skin Temperature Trends,
                                            Carbon/Graphite, One Size (S &amp; L Bands)</a></td>
                                    <td class="color align-middle white-space-nowrap text-body py-0 ps-4">Pure matte black
                                    </td>
                                    <td
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0"
                                            ...
                                            Display M1 8 Core CPU, 7 Core GPU, 256GB SSD, Green (MJV83ZP/A) 2021</a></td>
                ...
                <div class="row gx-4 gy-6 g-xl-7 justify-content-sm-center justify-content-xl-start">
                        ...
                        <div class="row g-4 flex-sm-column">
                            ...
                            <div class="col-6 col-sm-12 order-sm-1">
                                ...
                                <div class="ms-4">
                                    ...
                                    <p class="text-body-secondary mb-0 fs-9">Vancouver, British Columbia,<br
                                            class="d-none d-sm-block">Canada</p>
                                </div>
                            </div>
                            <div class="col-6 col-sm-12">
                    ...
                    <div class="col-12 col-sm-auto">
                        ...
                        <div class="row g-4 flex-sm-column">
                            ...
                            <div class="col-6 col-sm-12">
                                <div class="d-flex align-items-center mb-1"><span class="me-2" data-feather="package"
                                        style="stroke-width:2.5;"> </span>
                            ...
                            <div class="col-6 col-sm-12">
                                <div class="d-flex align-items-center mb-1"><span class="me-2" data-feather="file-text"
                                        style="stroke-width:2.5;"> </span>
                            ...
                            <div class="col-6 col-sm-12">
                                ...
                                <div class="ms-4">
                                    <p class="text-body-secondary fs-9 mb-0">Happy Birthday Shiniga <br>Lots of Love Buga
                                        Buga!!</p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="mb-2">Payment status</h6><select class="form-select mb-4"
