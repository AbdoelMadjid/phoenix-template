                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-admin">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="{{ url('order-details') }}">
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="admin" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item active" href="{{ url('order-details') }}">
                  ...
                  <table class="table fs-9 mb-0 border-top border-translucent">
                    ...
                    <tbody class="list" id="order-table-body">
                      <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/1.png') }}" alt="" width="53"></a></td>
                        <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('landing/product-details') }}">Fitbit Sense Advanced Smartwatch with Tools for Heart Health, Stress Management &amp; Skin Temperature Trends, Carbon/Graphite, One Size (S &amp; L Bands)</a></td>
                      ...
                      <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/2.png') }}" alt="" width="53"></a></td>
                        <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('landing/product-details') }}">iPhone 13 pro max-Pacific Blue-128GB storage</a></td>
                      ...
                      <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/3.png') }}" alt="" width="53"></a></td>
                        <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('landing/product-details') }}">Apple MacBook Pro 13 inch-M1-8/256GB-space</a></td>
                        <td class="color align-middle white-space-nowrap text-body py-0 ps-4">Glossy black</td>
                      ...
                      <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/4.png') }}" alt="" width="53"></a></td>
                        <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('landing/product-details') }}">Apple iMac 24&quot; 4K Retina Display M1 8 Core CPU, 7 Core GPU, 256GB SSD, Green (MJV83ZP/A) 2021</a></td>
                      ...
                      <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/5.png') }}" alt="" width="53"></a></td>
                        <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('landing/product-details') }}">Razer Kraken v3 x Wired 7.1 Surroung Sound Gaming headset</a></td>
                      ...
                      <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                        <td class="align-middle white-space-nowrap py-2"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/6.png') }}" alt="" width="53"></a></td>
                        <td class="products align-middle py-0"><a class="fw-semibold line-clamp-2 mb-0" href="{{ url('landing/product-details') }}">PlayStation 5 DualSense Wireless Controller</a></td>
