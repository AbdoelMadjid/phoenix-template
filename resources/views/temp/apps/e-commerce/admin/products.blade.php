            ...
            <div class="mb-4">
                <div class="d-flex flex-wrap gap-3">
                    ...
                    <div class="ms-xxl-auto"><button class="btn btn-link text-body me-4 px-0"><span
                        ...
                        <button class="btn btn-primary" id="addBtn"><span class="fas fa-plus me-2"></span>Add
                            product</button>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="sort white-space-nowrap align-middle fs-10" scope="col" style="width:70px;">
                                </th>
                        ...
                        <tbody class="list" id="products-table-body">
                            <tr class="position-static">
                                ...
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">Fitbit Sense Advanced Smartwatch with
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        class="d-block border border-translucent rounded-2"
                                        href="{{ url('landing/product-details') }}"><img
                                            src="{{ asset('assets/img/products/2.png') }}" alt=""
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">iPhone 13 pro max-Pacific Blue-128GB
                                        storage</a></td>
                                <td class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                    $87</td>
                                <td
                                ...
                                <td class="align-middle review fs-8 text-center ps-4"><span
                                        class="fas fa-star text-warning"></span></td>
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        ...
                                        href="{{ url('landing/product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">Apple iMac 24&quot; 4K Retina Display
                                        M1 8 Core CPU...</a></td>
                                <td class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                    $8 - $58</td>
                                <td
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        ...
                                        href="{{ url('landing/product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">Razer Kraken v3 x Wired 7.1 Surroung
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        ...
                                        href="{{ url('landing/product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">PlayStation 5 DualSense Wireless
                                        Controller</a></td>
                                <td class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                    $239</td>
                                <td
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        ...
                                        href="{{ url('landing/product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">2021 Apple 12.9-inch iPad Pro (Wi‑Fi,
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        ...
                                        href="{{ url('landing/product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">Amazon Basics Matte Black Wired
                            ...
                            <tr class="position-static">
                                ...
                                <td class="vendor align-middle text-start fw-semibold ps-4"><a href="#!">Eastacy</a>
                                </td>
                                <td class="time align-middle white-space-nowrap text-body-tertiary text-opacity-85 ps-4">
                                    Nov 1, 9:39 AM</td>
                                <td class="align-middle white-space-nowrap text-end pe-0 ps-4 btn-reveal-trigger">
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        ...
                                        href="{{ url('landing/product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">HORI Racing Wheel Apex for PlayStation
                                        4_3, and PC</a></td>
                                <td class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                    $17</td>
                                <td
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        class="d-block border border-translucent rounded-2"
                                        href="{{ url('landing/product-details') }}"><img
                                            src="{{ asset('assets/img/products/21.png') }}" alt=""
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">Apple Pencil (2nd Generation)</a></td>
                                <td class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                    $28</td>
                                <td
                                    class="category align-middle white-space-nowrap text-body-quaternary fs-9 ps-4 fw-semibold">
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        ...
                                        href="{{ url('landing/product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">Apple AirPods (2nd Generation)</a>
                                </td>
                                <td class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                    $20</td>
                                <td
                            ...
                            <tr class="position-static">
                                ...
                                <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                        ...
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Magic</span></a><a
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Performance</span></a><a
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Apex</span></a></td>
                                <td class="align-middle review fs-8 text-center ps-4">
                                    <div class="d-toggle-container">
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        class="d-block border border-translucent rounded-2"
                                        href="{{ url('landing/product-details') }}"><img
                                            src="{{ asset('assets/img/products/18.png') }}" alt=""
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">Seagate Portable 2TB External Hard
                                ...
                                <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Portable</span></a><a
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Gaming</span></a><a
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Magic</span></a><a
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        class="d-block border border-translucent rounded-2"
                                        href="{{ url('landing/product-details') }}"><img
                                            src="{{ asset('assets/img/products/19.png') }}" alt=""
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">Intel Core i9-11900K Desktop Processor
                                ...
                                <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Intel</span></a><a
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Gaming</span></a><a
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Apex</span></a><a
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Performance</span></a><a
                                        class="text-decoration-none" href="#!"><span
                                            class="badge badge-tag me-2 mb-2">Lifestyle</span></a></td>
                                <td class="align-middle review fs-8 text-center ps-4"><span
                                        class="fas fa-star text-warning"></span></td>
                                <td class="vendor align-middle text-start fw-semibold ps-4"><a
                                        href="#!">BrewerBro</a></td>
                            ...
                            <tr class="position-static">
                                ...
                                <td class="align-middle white-space-nowrap py-0"><a
                                        class="d-block border border-translucent rounded-2"
                                        href="{{ url('landing/product-details') }}"><img
                                            src="{{ asset('assets/img/products/20.png') }}" alt=""
                                            width="53"></a></td>
                                <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                        href="{{ url('landing/product-details') }}">ASUS TUF Gaming F15 Gaming Laptop</a>
                                </td>
                                <td
