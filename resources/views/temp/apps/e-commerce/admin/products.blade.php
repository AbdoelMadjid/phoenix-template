                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-admin">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="{{ url('products') }}">
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="admin" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item active" href="{{ url('products') }}">
          ...
          <div id="products" data-list='{"valueNames":["product","price","category","tags","vendor","time"],"page":10,"pagination":true}'>
            <div class="mb-4">
              <div class="d-flex flex-wrap gap-3">
                ...
                <div class="ms-xxl-auto"><button class="btn btn-link text-body me-4 px-0"><span class="fa-solid fa-file-export fs-9 me-2"></span>Export</button>
                ...
                <table class="table fs-9 mb-0">
                  ...
                  <tbody class="list" id="products-table-body">
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/1.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Fitbit Sense Advanced Smartwatch with Tools for Heart Health, Stress Management &amp; Skin Temperature Trends, Carbon/Graphite, One Size (S &amp; ...</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/2.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">iPhone 13 pro max-Pacific Blue-128GB storage</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/3.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Apple MacBook Pro 13 inch-M1-8/256GB-space</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/4.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Apple iMac 24&quot; 4K Retina Display M1 8 Core CPU...</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/5.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Razer Kraken v3 x Wired 7.1 Surroung Sound Gaming headset</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/6.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">PlayStation 5 DualSense Wireless Controller</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/7.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, 128GB) - Space Gray</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/8.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Amazon Basics Matte Black Wired Keyboard - US Layout (QWERTY)</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/10.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Apple Magic Mouse (Wireless, Rechargable) - Silver</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/12.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">HORI Racing Wheel Apex for PlayStation 4_3, and PC</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/21.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Apple Pencil (2nd Generation)</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/16.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Apple AirPods (2nd Generation)</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/17.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Xbox Series S</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/18.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Seagate Portable 2TB External Hard Drive Portable HDD</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/19.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">Intel Core i9-11900K Desktop Processor 8 Cores up to 5.3 GHz Unlocked</a></td>
                    ...
                    <tr class="position-static">
                      ...
                      <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/20.png') }}" alt="" width="53"></a></td>
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="{{ url('landing/product-details') }}">ASUS TUF Gaming F15 Gaming Laptop</a></td>
