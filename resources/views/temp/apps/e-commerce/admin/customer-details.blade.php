                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-admin">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="{{ url('customer-details') }}">
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="admin" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item active" href="{{ url('customer-details') }}">
                  ...
                  <div class="table-responsive scrollbar">
                    <table class="table fs-9 mb-0">
                      ...
                      <tbody class="list" id="customer-wishlist-table-body">
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap py-1"><a class="border border-translucent rounded-2 d-inline-block" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/1.png') }}" alt="" width="40" height="40"></a></td>
                          <td class="products align-middle"><a class="fw-semibold mb-0" href="{{ url('landing/product-details') }}">Fitbit Sense Advanced Smartwatch wi...</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap py-1"><a class="border border-translucent rounded-2 d-inline-block" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/7.png') }}" alt="" width="40" height="40"></a></td>
                          <td class="products align-middle"><a class="fw-semibold mb-0" href="{{ url('landing/product-details') }}">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, ...</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap py-1"><a class="border border-translucent rounded-2 d-inline-block" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/6.png') }}" alt="" width="40" height="40"></a></td>
                          <td class="products align-middle"><a class="fw-semibold mb-0" href="{{ url('landing/product-details') }}">PlayStation 5 DualSense Wireless Cont...</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap py-1"><a class="border border-translucent rounded-2 d-inline-block" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/3.png') }}" alt="" width="40" height="40"></a></td>
                          <td class="products align-middle"><a class="fw-semibold mb-0" href="{{ url('landing/product-details') }}">Apple MacBook Pro 13 inch-M1-8/256G...</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap py-1"><a class="border border-translucent rounded-2 d-inline-block" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/4.png') }}" alt="" width="40" height="40"></a></td>
                          <td class="products align-middle"><a class="fw-semibold mb-0" href="{{ url('landing/product-details') }}">Apple iMac 24&quot; 4K Retina Display M1 8 C...</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap py-1"><a class="border border-translucent rounded-2 d-inline-block" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/10.png') }}" alt="" width="40" height="40"></a></td>
                          <td class="products align-middle"><a class="fw-semibold mb-0" href="{{ url('landing/product-details') }}">Apple Magic Mouse (Wireless, Recharg...</a></td>
                          <td class="color align-middle white-space-nowrap fs-9 text-body">White</td>
                          <td class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">Regular</td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap py-1"><a class="border border-translucent rounded-2 d-inline-block" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/8.png') }}" alt="" width="40" height="40"></a></td>
                          <td class="products align-middle"><a class="fw-semibold mb-0" href="{{ url('landing/product-details') }}">Amazon Basics Matte Black Wired Keybo...</a></td>
                          <td class="color align-middle white-space-nowrap fs-9 text-body">Black</td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap py-1"><a class="border border-translucent rounded-2 d-inline-block" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/12.png') }}" alt="" width="40" height="40"></a></td>
                          <td class="products align-middle"><a class="fw-semibold mb-0" href="{{ url('landing/product-details') }}">HORI Racing Wheel Apex for PlayStation...</a></td>
                          <td class="color align-middle white-space-nowrap fs-9 text-body">Black</td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle white-space-nowrap py-1"><a class="border border-translucent rounded-2 d-inline-block" href="{{ url('landing/product-details') }}"><img src="{{ asset('assets/img/products/17.png') }}" alt="" width="40" height="40"></a></td>
                          <td class="products align-middle"><a class="fw-semibold mb-0" href="{{ url('landing/product-details') }}">Xbox Series S</a></td>
                          <td class="color align-middle white-space-nowrap fs-9 text-body">Space Gray</td>
                  ...
                  <div class="table-responsive scrollbar">
                    <table class="table fs-9 mb-0">
                      ...
                      <tbody class="list" id="customer-rating-table-body">
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product white-space-nowrap"><a class="fw-semibold" href="{{ url('landing/product-details') }}">Apple Magic Mouse (Wireless, Rech...</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product white-space-nowrap"><a class="fw-semibold" href="{{ url('landing/product-details') }}">Fitbit Sense Advanced Smartwatch ...</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product white-space-nowrap"><a class="fw-semibold" href="{{ url('landing/product-details') }}">HORI Racing Wheel Apex for PlaySt...</a></td>
                          <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
                          <td class="align-middle review" style="min-width:350px;">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product white-space-nowrap"><a class="fw-semibold" href="{{ url('landing/product-details') }}">Razer Kraken v3 x Wired 7.1 Surro...</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product white-space-nowrap"><a class="fw-semibold" href="{{ url('landing/product-details') }}">iPhone 13 pro max-Pacific Blue-12...</a></td>
                          <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
                          <td class="align-middle review" style="min-width:350px;">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product white-space-nowrap"><a class="fw-semibold" href="{{ url('landing/product-details') }}">Apple MacBook Pro 13 inch-M1-8/25...</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product white-space-nowrap"><a class="fw-semibold" href="{{ url('landing/product-details') }}">Apple iMac 24&quot; 4K Retina Display ...</a></td>
                          <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
                          <td class="align-middle review" style="min-width:350px;">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product white-space-nowrap"><a class="fw-semibold" href="{{ url('landing/product-details') }}">PlayStation 5 DualSense Wireless ...</a></td>
                          <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
                          <td class="align-middle review" style="min-width:350px;">
                            <p class="fw-semibold text-body-highlight mb-0">My son says these are the greatest he's ever tasted.</p>
                          </td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product white-space-nowrap"><a class="fw-semibold" href="{{ url('landing/product-details') }}">2021 Apple 12.9-inch iPad Pro (Wi...</a></td>
                          <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt star-icon text-warning"></span></td>
                          <td class="align-middle review" style="min-width:350px;">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          <td class="align-middle product white-space-nowrap"><a class="fw-semibold" href="{{ url('landing/product-details') }}">Amazon Basics Matte Black Wired K...</a></td>
                          <td class="align-middle rating white-space-nowrap fs-10"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span><span class="fa-regular fa-star text-warning-light" data-bs-theme="light"></span></td>
                          <td class="align-middle review" style="min-width:350px;">
                            <p class="fw-semibold text-body-highlight mb-0">I chose wisely. The phone is in excellent condition, with no scratches or dents, excellent battery life, and flawless...<a href='#!'>See more</a></p>
                          </td>
