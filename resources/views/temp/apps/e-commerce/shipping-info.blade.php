            ...
            <div class="row">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    <form>
                        ...
                        <div class="row g-4">
                            <div class="col-12"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none"
                            ...
                            <div class="col-md-6"><label
                                    ...
                                    for="inputEmail">Email</label><input class="form-control" id="inputEmail" type="email"
                            ...
                            <div class="col-12"><label class="form-label fs-8 text-body-highlight ps-0 text-transform-none"
                                    for="inputAddress2">Address line 2</label><input class="form-control" id="inputAddress2"
                                    type="text" placeholder="Address line 2"></div>
                            <div class="col-md-4"><label
                                    class="form-label fs-8 text-body-highlight ps-0 text-transform-none"
                                    for="inputCity">City</label><select class="form-select text-body-emphasis"
                                    id="inputCity">
                            ...
                            <div class="col-md-4"><label
                                    class="form-label fs-8 text-body-highlight ps-0 text-transform-none"
                                    for="inputState">State</label><select class="form-select text-body-emphasis"
                                    id="inputState">
                            ...
                            <div class="col-md-4"><label
                                    class="form-label fs-8 text-body-highlight ps-0 text-transform-none"
                                    for="inputZipCode">Zip code</label><input class="form-control number-arrows-none"
                                    id="inputZipCode" type="number" placeholder="Zip code"></div>
                            <div class="col-md-4 mb-3"><label
                                    class="form-label fs-8 text-body-highlight ps-0 text-transform-none"
                                    for="inputCountry">Country</label><select class="form-select text-body-emphasis"
                                    id="inputCountry">
                            ...
                            <div class="col-12"><button class="btn btn-primary px-8 px-sm-11 me-2"
                                ...
                                <button class="btn btn-phoenix-secondary text-nowrap" type="submit">Exit Without
                                    Saving</button>
                            </div>
                        </div>
                    </form>
