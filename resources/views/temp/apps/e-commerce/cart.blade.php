                                ...
                                <tbody class="list" id="cart-table-body">
                                    <tr class="cart-table-row btn-reveal-trigger">
                                        ...
                                        <td class="products align-middle"><a class="fw-semibold mb-0 line-clamp-2"
                                                href="{{ url('product-details') }}">Fitbit Sense Advanced Smartwatch with
                                    ...
                                    <tr class="cart-table-row btn-reveal-trigger">
                                        <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="{{ url('product-details') }}"><img
                                                    ...
                                                    width="53"></a></td>
                                        <td class="products align-middle"><a class="fw-semibold mb-0 line-clamp-2"
                                                href="{{ url('product-details') }}">iPhone 13 pro max-Pacific Blue-128GB
                                                storage</a></td>
                                        <td class="color align-middle white-space-nowrap fs-9 text-body">Glossy black</td>
                                        <td
                                            class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-between-center mb-3">
                                <h3 class="card-title mb-0">Summary</h3><a class="btn btn-link p-0" href="#!">Edit
                                    cart </a>
