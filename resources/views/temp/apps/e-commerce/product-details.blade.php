                    ...
                    <div class="col-12 col-lg-6">
                        <div class="d-flex flex-column justify-content-between h-100">
                            <div>
                                ...
                                <p class="mb-2 text-body-secondary"><strong class="text-body-highlight">Do you want it on
                                        Saturday, July 29th?</strong> Choose <strong class="text-body-highlight">Saturday
                                        Delivery </strong>at checkout if you want your order delivered within 12 hours 43
                                    minutes, <a class="fw-bold" href="#!">Details. </a><strong
                                        class="text-body-highlight">Gift wrapping is available.</strong></p>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex product-color-variants"
                                        ...
                                        <div class="rounded-1 border border-translucent me-2 active" data-variant="Blue"
                                            ...
                                            <img src="{{ asset('assets/img/products/details/blue_front.png') }}"
                                                alt="" width="38">
                                        </div>
                                        <div class="rounded-1 border border-translucent me-2" data-variant="Red"
                                            ...
                                            <img src="{{ asset('assets/img/products/details/red_front.png') }}"
                                                alt="" width="38">
                                        </div>
                                        <div class="rounded-1 border border-translucent me-2" data-variant="Green"
                                            ...
                                            <img src="{{ asset('assets/img/products/details/green_front.png') }}"
                                                alt="" width="38">
                                        </div>
                                        <div class="rounded-1 border border-translucent me-2" data-variant="Purple"
                                            ...
                                            <img src="{{ asset('assets/img/products/details/purple_front.png') }}"
                                                alt="" width="38">
                                        </div>
                                        <div class="rounded-1 border border-translucent me-2" data-variant="Silver"
                                            ...
                                            <img src="{{ asset('assets/img/products/details/silver_front.png') }}"
                                                alt="" width="38">
                                        </div>
                                        <div class="rounded-1 border border-translucent me-2" data-variant="Yellow"
                                            ...
                                            <img src="{{ asset('assets/img/products/details/yellow_front.png') }}"
                                                alt="" width="38">
                                        </div>
                                        <div class="rounded-1 border border-translucent me-2" data-variant="Orange"
                                            ...
                                            <img src="{{ asset('assets/img/products/details/orange_front.png') }}"
                                                alt="" width="38">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-content" id="productTabContent">
                            <div class="tab-pane pe-lg-6 pe-xl-12 fade show active text-body-emphasis"
                                ...
                                <p class="mb-5">CUPERTINO, CA , The M1 CPU allows Apple to deliver an all-new iMac with a
                                    ...
                                    href="{{ asset('assets/img/products/23.png') }}"
                                    data-gallery="gallery-description"><img class="img-fluid mb-5 rounded-3"
                                        src="{{ asset('assets/img/products/23.png') }}" alt=""></a>
                            ...
                            <div class="tab-pane fade" id="tab-reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                <div class="bg-body-emphasis rounded-3 p-4 border border-translucent">
                                                            ...
                                                            <div class="dz-preview d-flex flex-wrap">
                                                                <div class="border border-translucent bg-body-emphasis rounded-3 d-flex flex-center position-relative me-2 mb-2"
                                                                    style="height:80px;width:80px;"><img class="dz-image"
                                                                        src="{{ asset('assets/img/products/23.png') }}"
                                    ...
                                    <div class="mb-4 hover-actions-trigger btn-reveal-trigger">
                                        ...
                                        <div class="row g-2 mb-2">
                                            <div class="col-auto"><a
                                                    href="{{ asset('assets/img/e-commerce/review-11.jpg') }}"
                                                    data-gallery="gallery-0"><img
                                                        src="{{ asset('assets/img/e-commerce/review-11.jpg') }}"
                                                        alt="" height="164"></a></div>
                                            <div class="col-auto"><a
                                                    href="{{ asset('assets/img/e-commerce/review-12.jpg') }}"
                                                    data-gallery="gallery-0"><img
                                                        src="{{ asset('assets/img/e-commerce/review-12.jpg') }}"
                                                        alt="" height="164"></a></div>
                                            <div class="col-auto"><a
                                                    href="{{ asset('assets/img/e-commerce/review-13.jpg') }}"
                                                    data-gallery="gallery-0"><img
                                                        src="{{ asset('assets/img/e-commerce/review-13.jpg') }}"
                                                        alt="" height="164"></a></div>
                                        </div>
                                    ...
                                    <div class="mb-4 hover-actions-trigger btn-reveal-trigger">
                                        ...
                                        <p class="text-body-highlight mb-1">Over the years, I've preferred Apple products.
                                            My job has allowed me to use Windows products on laptops and PCs. I've owned
                                            Windows laptops and desktops for home use in the past and will never use them
                                            again.</p>
                                        <div class="hover-actions top-0"><button
                                                class="btn btn-sm btn-phoenix-secondary me-2"><span
                                                    class="fas fa-thumbs-up"></span></button>
                                    ...
                                    <div class="mb-4 hover-actions-trigger btn-reveal-trigger">
                                        ...
                                        <div class="row g-2 mb-2">
                                            <div class="col-auto"><a
                                                    href="{{ asset('assets/img/e-commerce/review-14.jpg') }}"
                                                    data-gallery="gallery-3"><img
                                                        src="{{ asset('assets/img/e-commerce/review-14.jpg') }}"
                                                        alt="" height="164"></a></div>
                                            <div class="col-auto"><a
                                                    href="{{ asset('assets/img/e-commerce/review-15.jpg') }}"
                                                    data-gallery="gallery-3"><img
                                                        src="{{ asset('assets/img/e-commerce/review-15.jpg') }}"
                                                        alt="" height="164"></a></div>
                                            <div class="col-auto"><a
                                                    href="{{ asset('assets/img/e-commerce/review-16.jpg') }}"
                                                    data-gallery="gallery-3"><img
                                                        src="{{ asset('assets/img/e-commerce/review-16.jpg') }}"
                                                        alt="" height="164"></a></div>
                                        </div>
                                        <div class="hover-actions top-0"><button
                                                class="btn btn-sm btn-phoenix-secondary me-2"><span
                                ...
                                <div class="border-dashed border-y border-translucent py-4">
                                    <div class="d-flex align-items-center mb-5">
                                        <div class="form-check mb-0"><input class="form-check-input" type="checkbox"
                                            ...
                                            href="{{ url('apps/e-commerce/product-details') }}"> <img
                                                class="border border-translucent rounded"
                                                src="{{ asset('assets/img/products/2.png') }}" width="53"
                                                alt=""></a>
                                        <div class="ms-2"><a class="fs-9 fw-bold line-clamp-2 mb-2"
                                                href="{{ url('apps/e-commerce/product-details') }}"> iPhone 13 pro
                                                max-Pacific Blue-
                                                128GB</a>
                                            <h5>$899.99</h5>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center mb-5">
                                        <div class="form-check mb-0"><input class="form-check-input" type="checkbox"
                                            ...
                                            href="{{ url('apps/e-commerce/product-details') }}"> <img
                                                class="border border-translucent rounded"
                                                src="{{ asset('assets/img/products/16.png') }}" width="53"
                                                alt=""></a>
                                        <div class="ms-2"><a class="fs-9 fw-bold line-clamp-2 mb-2"
                                                href="{{ url('apps/e-commerce/product-details') }}">Apple AirPods Pro</a>
                                            <h5>$59.00</h5>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center mb-0">
                                        <div class="form-check mb-0"><input class="form-check-input"
                                            ...
                                            href="{{ url('apps/e-commerce/product-details') }}"> <img
                                                class="border border-translucent rounded"
                                                src="{{ asset('assets/img/products/10.png') }}" width="53"
                                                alt=""></a>
                                        <div class="ms-2"><a class="fs-9 fw-bold line-clamp-2 mb-2"
                                                href="{{ url('apps/e-commerce/product-details') }}">Apple Magic Mouse
                                                (Wireless,
                                ...
                                <div class="d-flex flex-column justify-content-between h-100">
                                    <div>
                                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                                            ...
                                            href="{{ url('apps/e-commerce/product-details') }}">
                                        ...
                                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                                            <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                ...
                                                title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                    ...
                                                    class="far fa-heart d-none-hover"
                                                    data-fa-transform="down-1"></span></button><img class="img-fluid"
                                                src="{{ asset('assets/img/products/5.png') }}" alt="">
                                        </div><a class="stretched-link"
                                            href="{{ url('apps/e-commerce/product-details') }}">
                                        ...
                                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                                            <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                ...
                                                title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                    ...
                                                    class="far fa-heart d-none-hover"
                                                    data-fa-transform="down-1"></span></button><img class="img-fluid"
                                                src="{{ asset('assets/img/products/2.png') }}" alt=""><span
                                        ...
                                        <div class="border border-1 border-translucent rounded-3 position-relative mb-3">
                                            <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                ...
                                                title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                    ...
                                                    class="far fa-heart d-none-hover"
                                                    data-fa-transform="down-1"></span></button><img class="img-fluid"
                                                src="{{ asset('assets/img/products/16.png') }}" alt="">
                                        </div><a class="stretched-link"
                                            href="{{ url('apps/e-commerce/product-details') }}">
