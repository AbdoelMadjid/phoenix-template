                        ...
                        <tbody class="list" id="profile-wishlist-table-body">
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                ...
                                <td class="products align-middle pe-11"><a class="fw-semibold mb-0 line-clamp-1"
                                        href="{{ url('product-details') }}">Fitbit Sense Advanced Smartwatch with Tools for
                                        Heart Health, Stress Management &amp; Skin Temperature Trends, Carbon/Graphite, One
                                        Size (S &amp; L Bands)</a></td>
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                <td class="align-middle white-space-nowrap ps-0 py-0"><a
                                        ...
                                        href="{{ url('product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="products align-middle pe-11"><a class="fw-semibold mb-0 line-clamp-1"
                                        href="{{ url('product-details') }}">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, 128GB) -
                                        Space Gray</a></td>
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                <td class="align-middle white-space-nowrap ps-0 py-0"><a
                                        ...
                                        href="{{ url('product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="products align-middle pe-11"><a class="fw-semibold mb-0 line-clamp-1"
                                        href="{{ url('product-details') }}">PlayStation 5 DualSense Wireless Controller</a>
                                </td>
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                <td class="align-middle white-space-nowrap ps-0 py-0"><a
                                        ...
                                        href="{{ url('product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="products align-middle pe-11"><a class="fw-semibold mb-0 line-clamp-1"
                                        href="{{ url('product-details') }}">Apple MacBook Pro 13 inch-M1-8/256GB-space</a>
                                </td>
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                <td class="align-middle white-space-nowrap ps-0 py-0"><a
                                        ...
                                        href="{{ url('product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="products align-middle pe-11"><a class="fw-semibold mb-0 line-clamp-1"
                                        href="{{ url('product-details') }}">Apple iMac 24&quot; 4K Retina Display M1 8
                                        Core CPU, 7 Core GPU, 256GB SSD, Green (MJV83ZP/A) 2021</a></td>
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                <td class="align-middle white-space-nowrap ps-0 py-0"><a
                                        ...
                                        href="{{ url('product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="products align-middle pe-11"><a class="fw-semibold mb-0 line-clamp-1"
                                        href="{{ url('product-details') }}">Apple Magic Mouse (Wireless, Rechargable) -
                                        Silver</a></td>
                                <td class="color align-middle white-space-nowrap fs-9 text-body">White</td>
                                <td class="size align-middle white-space-nowrap text-body-tertiary fs-9 fw-semibold">
                                    Regular</td>
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                <td class="align-middle white-space-nowrap ps-0 py-0"><a
                                        ...
                                        href="{{ url('product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="products align-middle pe-11"><a class="fw-semibold mb-0 line-clamp-1"
                                        href="{{ url('product-details') }}">Amazon Basics Matte Black Wired Keyboard - US
                                        Layout (QWERTY)</a></td>
                                <td class="color align-middle white-space-nowrap fs-9 text-body">Black</td>
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                <td class="align-middle white-space-nowrap ps-0 py-0"><a
                                        ...
                                        href="{{ url('product-details') }}"><img
                                            ...
                                            width="53"></a></td>
                                <td class="products align-middle pe-11"><a class="fw-semibold mb-0 line-clamp-1"
                                        href="{{ url('product-details') }}">HORI Racing Wheel Apex for PlayStation 4_3,
                                        and PC</a></td>
                                <td class="color align-middle white-space-nowrap fs-9 text-body">Black</td>
