                    ...
                    <div class="col-12 col-xl-6">
                        <div
                            ...
                            <div class="row align-items-center w-sm-100">
                                ...
                                <div class="col-4"><img class="w-100 w-sm-75"
                                        src="{{ asset('assets/img/e-commerce/5.png') }}" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row g-4 mb-6">
                                        ...
                                        <div class="position-relative text-decoration-none product-card h-100">
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                <div>
                                                    ...
                                                    </div><a class="stretched-link" href="{{ url('product-details') }}">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="position-relative text-decoration-none product-card h-100">
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                ...
                                                <div>
                                                    <div class="d-flex align-items-center mb-1">
                                                        <p class="me-2 text-body text-decoration-line-through mb-0">$49.99
                                                        </p>
                                                        <h3 class="text-body-emphasis mb-0">$34.99</h3>
                                                    </div>
                                                    <p class="text-success fw-bold fs-9 lh-1 mb-0">Deal time ends in days
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative text-decoration-none product-card h-100">
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                    ...
                                                    <div
                                                        ...
                                                        <button
                                                            ...
                                                            title="Add to wishlist"><span
                                                                ...
                                                                data-fa-transform="down-1"></span></button><img
                                                            class="img-fluid"
                                                            src="{{ asset('assets/img/products/2.png') }}"
                                                            alt=""></div><a class="stretched-link"
                                                        href="{{ url('product-details') }}">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex align-items-center mb-1">
                                                        <p class="me-2 text-body text-decoration-line-through mb-0">$899.99
                                                        </p>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="position-relative text-decoration-none product-card h-100">
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                    ...
                                                    <div
                                                        ...
                                                        <button
                                                            ...
                                                            title="Add to wishlist"><span
                                                                ...
                                                                data-fa-transform="down-1"></span></button><img
                                                            class="img-fluid"
                                                            src="{{ asset('assets/img/products/3.png') }}"
                                                            alt=""></div><a class="stretched-link"
                                                        href="{{ url('product-details') }}">
                                                ...
                                                <div>
                                                    <p class="fs-9 text-body-highlight fw-bold mb-2">Apple care included
                                                    </p>
                                                    <div class="d-flex align-items-center mb-1">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="position-relative text-decoration-none product-card h-100">
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                    ...
                                                    <div
                                                        ...
                                                        <button
                                                            ...
                                                            title="Add to wishlist"><span
                                                                ...
                                                                data-fa-transform="down-1"></span></button><img
                                                            class="img-fluid"
                                                            src="{{ asset('assets/img/products/4.png') }}"
                                                            alt=""></div><a class="stretched-link"
                                                        href="{{ url('product-details') }}">
                                                ...
                                                <div>
                                                    <p class="fs-9 text-body-highlight fw-bold mb-2">Exchange with kidney
                                                    </p>
                                                    <div class="d-flex align-items-center mb-1">
                                                        <p class="me-2 text-body text-decoration-line-through mb-0">
                                                            $1499.00</p>
                                                    ...
                                                    <div
                                                        ...
                                                        <button
                                                            ...
                                                            title="Add to wishlist"><span
                                                                ...
                                                                data-fa-transform="down-1"></span></button><img
                                                            class="img-fluid"
                                                            src="{{ asset('assets/img/products/5.png') }}"
                                                            alt=""></div><a class="stretched-link"
                                                        href="{{ url('product-details') }}">
                    ...
                    <div class="col-lg-3 d-none d-lg-block col-xxl-2">
                        <div class="h-100 position-relative rounded-3 overflow-hidden">
                            <div class="bg-holder"
                                style="background-image:url({{ asset('assets/img/e-commerce/4.png') }});"></div>
                            <!--/.bg-holder-->
                        </div>
                    </div>
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/5.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                    <h6 class="mb-2 lh-sm line-clamp-3 product-name">Razer Kraken v3 x
                                                        Wired 7.1 Surroung Sound Gaming headset</h6>
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/7.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/12.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button
                                                        ...
                                                        title="Remove from wishlist"><span class="fas fa-heart"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/1.png') }}"
                                                        alt=""><span
                                                        class="badge text-bg-success fs-10 product-verified-badge">Verified<span
                                                            class="fas fa-check ms-1"></span></span></div><a
                                                    class="stretched-link" href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/16.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/10.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/8.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/25.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/27.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/26.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/18.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/17.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                                                ...
                                                <div
                                                    ...
                                                    <button class="btn btn-wish btn-wish-primary z-2 d-toggle-container"
                                                        ...
                                                        title="Add to wishlist"><span class="fas fa-heart d-block-hover"
                                                            ...
                                                            class="far fa-heart d-none-hover"
                                                            data-fa-transform="down-1"></span></button><img
                                                        class="img-fluid" src="{{ asset('assets/img/products/24.png') }}"
                                                        alt=""></div><a class="stretched-link"
                                                    href="{{ url('product-details') }}">
                    ...
                    <div class="col-auto">
                        <div class="text-center text-lg-start">
                            ...
                            <h1 class="display-3 fw-semibold mb-4">Become a <span class="text-primary fw-bolder">member
                                ...
                                href="{{ url('pages/authentication/simple/sign-up') }}">Sign up<span
