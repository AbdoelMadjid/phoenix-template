                ...
                <div class="hoverbox" style="width: 150px; height: 150px">
                    ...
                    <div
                        ...
                        <div class="avatar avatar-5xl"><img class="rounded-circle"
                                src="{{ asset('assets/img/team/150x150/58.webp') }}" alt=""></div><label
            ...
            <form class="row g-3 mb-9">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputFirstname" type="text"
                            placeholder="First name"><label for="floatingInputFirstname">First name</label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputLastname" type="text"
                            placeholder="Last name"><label for="floatingInputLastname">Last name</label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputCompany" type="text"
                            placeholder="Company"><label for="floatingInputCompany">Company</label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputTitle" type="text"
                            placeholder="title"><label for="floatingInputTitle">Title</label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputAlternativeEmail" type="text"
                            placeholder="alternative email"><label for="floatingInputAlternativeEmail">Alternative
                            Email</label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputWebsite" type="text"
                            placeholder="website"><label for="floatingInputWebsite">Website</label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputLinkedin" type="text"
                            placeholder="linkedin"><label for="floatingInputLinkedin">linkedin</label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputSkype" type="text"
                            placeholder="skype"><label for="floatingInputSkype">Skype id</label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputTwitter" type="text"
                            placeholder="twitter"><label for="floatingInputTwitter">Twitter </label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputEmployees" type="text"
                            placeholder="employees"><label for="floatingInputEmployees">Number of employees</label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputRevenue" type="text"
                            placeholder="revenue"><label for="floatingInputRevenue">Annual revenue </label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="form-floating"><input class="form-control" id="floatingInputStreet" type="text"
                            placeholder="street"><label for="floatingInputStreet">Street</label></div>
                </div>
                <div class="col-sm-6 col-md-4">
                ...
                <div class="col-sm-6">
                    <div class="form-floating"><input class="form-control" id="floatingInputZipcode" type="text"
                            placeholder="zip code"><label for="floatingInputZipcode">zip code</label></div>
                </div>
                <h4 class="mt-6">Description</h4>
                <div class="col-12">
                    <div class="form-floating">
                        <textarea class="form-control" id="floatingProjectOverview" placeholder="Leave a comment here"
                            style="height: 128px"></textarea><label for="floatingProjectOverview">Lead description</label>
                    </div>
                </div>
                <div class="col-12 d-flex justify-content-end mt-6"><button class="btn btn-primary">Create lead</button>
                </div>
            </form>
        </div>
    </div>
