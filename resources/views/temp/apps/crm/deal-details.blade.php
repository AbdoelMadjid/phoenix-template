                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-CRM" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-CRM">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-CRM">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="{{ url('deal-details') }}">
              ...
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="CRM" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="{{ url('deal-details') }}">
      ...
      <div class="content">
        ...
        <div class="pb-9">
          <div class="row align-items-center justify-content-between g-3 mb-4">
            ...
            <div class="col-12 col-md-auto d-flex"><button class="btn btn-phoenix-secondary px-3 px-sm-5 me-2"><span class="fa-solid fa-edit me-sm-2"></span><span class="d-none d-sm-inline">Edit		</span></button>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row g-3">
                      <div class="col-12">
                        ...
                        <div class="mb-4">
                          <h5 class="mb-0 text-body-highlight mb-2">Priority</h5><select class="form-select mb-3" aria-label="priority">
                        ...
                        <div class="mb-4">
                          <h5 class="mb-0 text-body-highlight mb-2">Stage</h5><select class="form-select mb-3" aria-label="stage">
                        ...
                        <div class="mb-4">
                          <div class="d-flex flex-wrap justify-content-between mb-2">
                            <h5 class="mb-0 text-body-highlight me-2">Lead Source</h5><a class="fw-bold fs-9" href="#!">Add new</a>
                        ...
                        <div>
                          <div class="d-flex flex-wrap justify-content-between mb-2">
                            <h5 class="mb-0 text-body-highlight me-2">Campaign Source</h5><a class="fw-bold fs-9" href="#!">Add new</a>
            ...
            <div class="col-xl-7 col-xxl-8">
              ...
              <div class="tab-content" id="myTabContent">
                  ...
                  <div class="row align-items-center g-3 justify-content-between justify-content-start">
                    <div class="col-12 col-sm-auto">
                      <div class="search-box mb-2 mb-sm-0">
                        <form class="position-relative"><input class="form-control search-input search" type="search" placeholder="Search Activity" aria-label="Search">
                          <span class="fas fa-search search-box-icon"></span>
                        </form>
                      </div>
                    </div>
                ...
                <div class="tab-pane fade" id="tab-notes" role="tabpanel" aria-labelledby="notes-tab">
                  <h2 class="mb-4">Notes</h2><textarea class="form-control mb-3" id="notes" rows="4"> </textarea>
                  <div class="row gy-4">
                ...
                <div class="tab-pane fade" id="tab-meeting" role="tabpanel" aria-labelledby="meeting-tab">
                  ...
                  <div class="row align-items-center g-2 flex-wrap justify-content-start mb-3">
                    <div class="col-12 col-sm-auto">
                      <div class="search-box mb-2 mb-sm-0">
                        <form class="position-relative"><input class="form-control search-input search" type="search" placeholder="Search meeting" aria-label="Search">
                          <span class="fas fa-search search-box-icon"></span>
                        </form>
                      </div>
                    </div>
                    <div class="col-auto d-flex flex-md-grow-1">
                      <p class="mb-0 fs-9 text-body-tertiary fw-bold"><span class="fas fa-filter me-1 fw-extra-bold fs-10"></span>23 tasks</p><button class="btn btn-link p-0 ms-3 fs-9 text-primary fw-bold text-decoration-none"><span class="fas fa-sort me-1 fw-extra-bold fs-10"></span>Sorting</button>
                    </div>
                      ...
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <div class="d-flex align-items-center"><span class="badge badge-phoenix me-2 badge-phoenix-primary ">today</span>
                            <div class="d-flex align-items-center flex-1"><span class="fa-solid fa-circle me-1 text-danger" data-fa-transform="shrink-6 up-1"></span><span class="fw-bold fs-9 text-body">Urgent</span></div><button class="btn btn-phoenix-primary"><span class="fa-solid fa-video me-2 d-none d-sm-inline-block"></span>Join</button>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <div class="d-flex align-items-center"><span class="badge badge-phoenix me-2 badge-phoenix-warning">tomorrow</span>
                            <div class="d-flex align-items-center flex-1"><span class="fa-solid fa-circle me-1 text-success" data-fa-transform="shrink-6 up-1"></span><span class="fw-bold fs-9 text-body">Medium</span></div><button class="btn btn-phoenix-primary"><span class="fa-solid fa-video me-2 d-none d-sm-inline-block"></span>Join</button>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-xxl-6">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <div class="d-flex align-items-center"><span class="badge badge-phoenix me-2 badge-phoenix-warning">tomorrow</span>
                            <div class="d-flex align-items-center flex-1"><span class="fa-solid fa-circle me-1 text-warning" data-fa-transform="shrink-6 up-1"></span><span class="fw-bold fs-9 text-body">High</span></div><button class="btn btn-phoenix-primary"><span class="fa-solid fa-video me-2 d-none d-sm-inline-block"></span>Join</button>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-xxl-6">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <div class="d-flex align-items-center"><span class="badge badge-phoenix me-2 badge-phoenix-warning">tomorrow</span>
                            <div class="d-flex align-items-center flex-1"><span class="fa-solid fa-circle me-1 text-info" data-fa-transform="shrink-6 up-1"></span><span class="fw-bold fs-9 text-body">Low</span></div><button class="btn btn-phoenix-primary"><span class="fa-solid fa-video me-2 d-none d-sm-inline-block"></span>Join</button>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <tbody class="list" id="lead-details-table-body">
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="name align-middle white-space-nowrap py-2 ps-0"><a class="d-flex align-items-center text-body-highlight" href="#!">
                                <div class="avatar avatar-m me-3 status-online"><img class="rounded-circle" src="{{ asset('assets/img/team/35.webp') }}" alt=""></div>
                          ...
                          <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="name align-middle white-space-nowrap py-2 ps-0"><a class="d-flex align-items-center text-body-highlight" href="#!">
                                <div class="avatar avatar-m me-3 status-offline"><img class="rounded-circle" src="{{ asset('assets/img/team/9.webp') }}" alt=""></div>
                ...
                <div class="tab-pane fade" id="tab-attachments" role="tabpanel" aria-labelledby="attachments-tab">
                  ...
                  <div class="border-top border-dashed pt-3 pb-4">
                    ...
                    <p class="fs-9 text-body-tertiary mb-3"><span>768kB</span><span class="text-body-quaternary mx-1">| </span><a href="#!">Shantinan Mekalan </a><span class="text-body-quaternary mx-1">| </span><span class="text-nowrap">21st Dec, 12:56 PM</span></p><img class="rounded-2" src="{{ asset('assets/img/generic/40.png') }}" alt="">
                  </div>
