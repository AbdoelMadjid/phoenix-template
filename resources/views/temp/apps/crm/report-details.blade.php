...
@section('content')
    ...
    <div class="pb-9">
        ...
        <div class="row g-3 justify-content-between mb-4">
            <div class="col-auto">
                <div class="d-flex flex-wrap gap-2"><button class="btn btn-primary"><span
                            class="fas fa-envelope me-2"></span>Send mail</button>
                    <button class="btn btn-phoenix-primary"><span class="fas fa-pencil me-2"></span>Edit</button>
                    <button class="btn btn-phoenix-secondary text-body"><span
            ...
            <div class="col-auto">
                <div class="d-flex">
                    ...
                    </div><button class="btn px-3 btn-phoenix-secondary me-2 d-xl-none"><span
                            class="fa-solid fa-search"></span></button>
                    <button class="btn px-3 btn-phoenix-primary" type="button" data-bs-toggle="modal"
                        data-bs-target="#filterModal" data-boundary="window" aria-haspopup="true" aria-expanded="false"
                        data-bs-reference="parent"><span class="fa-solid fa-filter"
                                ...
                                <form id="addEventForm" autocomplete="off">
                                    <div class="modal-header justify-content-between border-translucent p-4">
                                        <h5 class="modal-title text-body-highlight fs-6 lh-sm">Filter</h5><button
                                            class="btn p-1 text-danger" type="button" data-bs-dismiss="modal"
                                    ...
                                    <div
                                        ...
                                        <button class="btn btn-sm btn-phoenix-primary px-4 fs-10 my-0" type="submit"> <span
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive scrollbar">
                            <table class="reports-details-chart-table table table-sm fs-9 mb-0">
                                <thead>
                                    <tr>
                                        <th class="align-middle pe- text-body-tertiary fw-bold fs-10 text-uppercase text-nowrap ps-0"
                                            scope="col" style="width:35%;">Report stage</th>
                                        <th class="align-middle text-end ps-4 text-body-tertiary fw-bold fs-10 text-uppercase text-nowrap"
                                            scope="col" style="width:35%;">total count</th>
                                        <th class="align-middle text-end ps-4 text-body-tertiary fw-bold fs-10 text-uppercase"
                                            scope="col" style="width:30%;">Status</th>
                                    </tr>
                                </thead>
                                <tbody class="list" id="report-data-body">
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        <td class="align-middle white-space-nowrap fw-semibold text-body-highlight py-2">
                                            Analysis</td>
                                        <td
                                            class="align-middle text-end white-space-nowrap fw-semibold text-body-highlight ps-4 py-2">
                                            03</td>
                                        <td
                                            class="align-middle text-end white-space-nowrap ps-4 fw-semibold text-body-highlight">
                                            <span class="badge badge-phoenix badge-phoenix-info">+15.21%</span></td>
                                    </tr>
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        <td class="align-middle white-space-nowrap fw-semibold text-body-highlight py-2">
                                            Statement</td>
                                        ...
                                        <td
                                            class="align-middle text-end white-space-nowrap ps-4 fw-semibold text-body-highlight">
                                            <span class="badge badge-phoenix badge-phoenix-warning">+05.21%</span></td>
                                    </tr>
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        <td class="align-middle white-space-nowrap fw-semibold text-body-highlight py-2">
                                            Action</td>
                                        ...
                                        <td
                                            class="align-middle text-end white-space-nowrap ps-4 fw-semibold text-body-highlight">
                                            <span class="badge badge-phoenix badge-phoenix-primary">+22.12%</span></td>
                                    </tr>
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        <td class="align-middle white-space-nowrap fw-semibold text-body-highlight py-2">
                                            Offering</td>
                                        ...
                                        <td
                                            class="align-middle text-end white-space-nowrap ps-4 fw-semibold text-body-highlight">
                                            <span class="badge badge-phoenix badge-phoenix-danger">-14.21%</span></td>
                                    </tr>
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        <td class="align-middle white-space-nowrap fw-semibold text-body-highlight py-2">
                                            Interlocution</td>
                            ...
                            <table class="table table-sm fs-9 leads-table">
                                    ...
                                    <tr>
                                        <th class="white-space-nowrap fs-9 align-middle ps-0"
                                            ...
                                            <div class="form-check mb-0 fs-8"><input class="form-check-input"
                                                    type="checkbox" data-bulk-select='{"body":"purchasers-sellers-body"}'>
                                            </div>
                                        </th>
                                        <th class="sort align-middle ps-0 pe-5 text-uppercase text-nowrap" scope="col"
                                            data-sort="deals_name" style="min-width:120px;">Deal name</th>
                                        <th class="sort align-middle ps-4 pe-5 text-uppercase text-nowrap" scope="col"
                                            data-sort="deal_owner" style="min-width:50px;">Deal owner</th>
                                        <th class="sort align-middle ps-4 pe-5 text-uppercase text-nowrap" scope="col"
                                            data-sort="account_name" style="min-width:250px;">Account name</th>
                                        <th class="sort align-middle pe-5 text-uppercase text-nowrap" scope="col"
                                            data-sort="stage" style="min-width:160px;">Stage</th>
                                        <th class="sort align-middle ps-4 pe-5 text-uppercase text-nowrap" scope="col"
                                            data-sort="amount" style="min-width:50px;">Amount</th>
                                ...
                                <tbody class="list" id="purchasers-sellers-body">
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="deals_name align-middle white-space-nowrap fw-semibold text-body-highlight ps-0 py-0">
                                            <a class="fw-bold text-primary" href="#!">Jo_Td01</a></td>
                                        <td
                                            class="deal_owner align-middle white-space-nowrap fw-semibold text-body-emphasis ps-4 py-0">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-m me-3"><img
                                                        class="rounded-circle avatar-placeholder"
                                                        src="{{ asset('assets/img/team/avatar.webp') }}" alt="">
                                                </div><a class="text-body-highlight fw-bold stretched-link"
                                                    href="#!">Ally Aagaard</a>
                                            </div>
                                        </td>
                                        <td
                                            class="account_name align-middle white-space-nowrap ps-4 fw-semibold text-body py-0">
                                            Themewagon</td>
                                        <td class="stage align-middle white-space-nowrap fw-bold text-body py-2">
                                            <div class="d-flex align-items-center gap-3">
                                                <div style="--phoenix-circle-progress-bar:20"><svg
                                                        class="circle-progress-svg" width="38" height="38"
                                                        viewbox="0 0 125 125">
                                                        <circle class="progress-bar-rail" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round"
                                                            stroke-width="15"></circle>
                                                        <circle class="progress-bar-top" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round" stroke="#3874FF"
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $140<span class="ms-2 text-danger" data-feather="trending-down"
                                                style="min-height:8px; width:14px;"></span></td>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="deals_name align-middle white-space-nowrap fw-semibold text-body-highlight ps-0 py-0">
                                            <a class="fw-bold text-primary" href="#!">Printing Dimensions</a></td>
                                        <td
                                            class="deal_owner align-middle white-space-nowrap fw-semibold text-body-emphasis ps-4 py-0">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-m me-3"><img class="rounded-circle"
                                                        src="{{ asset('assets/img/team/35.webp') }}" alt=""></div>
                                                <a class="text-body-highlight fw-bold stretched-link" href="#!">Alex
                                                    Abadi</a>
                                            </div>
                                        </td>
                                        <td
                                        ...
                                        <td class="stage align-middle white-space-nowrap fw-bold text-body py-2">
                                            <div class="d-flex align-items-center gap-3">
                                                <div style="--phoenix-circle-progress-bar:40"><svg
                                                        class="circle-progress-svg" width="38" height="38"
                                                        viewbox="0 0 125 125">
                                                        <circle class="progress-bar-rail" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round"
                                                            stroke-width="15"></circle>
                                                        <circle class="progress-bar-top" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round" stroke="#0097EB"
                                                            stroke-width="12"></circle>
                                                    </svg></div>
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $214<span class="ms-2 text-success" data-feather="trending-up"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="deals_name align-middle white-space-nowrap fw-semibold text-body-highlight ps-0 py-0">
                                            <a class="fw-bold text-primary" href="#!">MM_TD_120</a></td>
                                        <td
                                            class="deal_owner align-middle white-space-nowrap fw-semibold text-body-emphasis ps-4 py-0">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-m me-3"><img class="rounded-circle"
                                                        src="{{ asset('assets/img/team/32.webp') }}" alt=""></div>
                                                <a class="text-body-highlight fw-bold stretched-link" href="#!">Kylia
                                                    Abbott</a>
                                            </div>
                                        </td>
                                        <td
                                        ...
                                        <td class="stage align-middle white-space-nowrap fw-bold text-body py-2">
                                            <div class="d-flex align-items-center gap-3">
                                                <div style="--phoenix-circle-progress-bar:50"><svg
                                                        class="circle-progress-svg" width="38" height="38"
                                                        viewbox="0 0 125 125">
                                                        <circle class="progress-bar-rail" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round"
                                                            stroke-width="15"></circle>
                                                        <circle class="progress-bar-top" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round" stroke="#E5780B"
                                                            stroke-width="12"></circle>
                                                    </svg></div>
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $412<span class="ms-2 text-success" data-feather="trending-up"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="deals_name align-middle white-space-nowrap fw-semibold text-body-highlight ps-0 py-0">
                                            <a class="fw-bold text-primary" href="#!">Truhlar And Truhlar Attys</a>
                                        </td>
                                        <td
                                            class="deal_owner align-middle white-space-nowrap fw-semibold text-body-emphasis ps-4 py-0">
                                            <div class="d-flex align-items-center position-relative">
                                        ...
                                        <td class="stage align-middle white-space-nowrap fw-bold text-body py-2">
                                            <div class="d-flex align-items-center gap-3">
                                                <div style="--phoenix-circle-progress-bar:60"><svg
                                                        class="circle-progress-svg" width="38" height="38"
                                                        viewbox="0 0 125 125">
                                                        <circle class="progress-bar-rail" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round"
                                                            stroke-width="15"></circle>
                                                        <circle class="progress-bar-top" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round" stroke="#6E7891"
                                                            stroke-width="12"></circle>
                                                    </svg></div>
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $110<span class="ms-2 text-success" data-feather="trending-up"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="deals_name align-middle white-space-nowrap fw-semibold text-body-highlight ps-0 py-0">
                                            <a class="fw-bold text-primary" href="#!">Morlong Associates</a></td>
                                        <td
                                            class="deal_owner align-middle white-space-nowrap fw-semibold text-body-emphasis ps-4 py-0">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-m me-3"><img class="rounded-circle"
                                                        src="{{ asset('assets/img/team/59.webp') }}" alt=""></div>
                                                <a class="text-body-highlight fw-bold stretched-link" href="#!">Lyla
                                                    Nicole</a>
                                            </div>
                                        </td>
                                        <td
                                        ...
                                        <td class="stage align-middle white-space-nowrap fw-bold text-body py-2">
                                            <div class="d-flex align-items-center gap-3">
                                                <div style="--phoenix-circle-progress-bar:100"><svg
                                                        class="circle-progress-svg" width="38" height="38"
                                                        viewbox="0 0 125 125">
                                                        <circle class="progress-bar-rail" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round"
                                                            stroke-width="15"></circle>
                                                        <circle class="progress-bar-top" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round" stroke="#25B003"
                                                            stroke-width="12"></circle>
                                                    </svg></div>
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $325<span class="ms-2 text-danger" data-feather="trending-down"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="deals_name align-middle white-space-nowrap fw-semibold text-body-highlight ps-0 py-0">
                                            <a class="fw-bold text-primary" href="#!">Product Order</a></td>
                                        <td
                                            class="deal_owner align-middle white-space-nowrap fw-semibold text-body-emphasis ps-4 py-0">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-m me-3"><img class="rounded-circle"
                                                        src="{{ asset('assets/img/team/18.webp') }}" alt=""></div>
                                                <a class="text-body-highlight fw-bold stretched-link"
                                                    href="#!">Hunter Leader</a>
                                            </div>
                                        </td>
                                        <td
                                            class="account_name align-middle white-space-nowrap ps-4 fw-semibold text-body py-0">
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $198<span class="ms-2 text-warning" data-feather="trending-down"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="deals_name align-middle white-space-nowrap fw-semibold text-body-highlight ps-0 py-0">
                                            <a class="fw-bold text-primary" href="#!">Feltz Printing Service</a></td>
                                        <td
                                            class="deal_owner align-middle white-space-nowrap fw-semibold text-body-emphasis ps-4 py-0">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-m me-3"><img
                                        ...
                                        <td class="stage align-middle white-space-nowrap fw-bold text-body py-2">
                                            <div class="d-flex align-items-center gap-3">
                                                <div style="--phoenix-circle-progress-bar:80"><svg
                                                        class="circle-progress-svg" width="38" height="38"
                                                        viewbox="0 0 125 125">
                                                        <circle class="progress-bar-rail" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round"
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $142<span class="ms-2 text-success" data-feather="trending-up"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="deals_name align-middle white-space-nowrap fw-semibold text-body-highlight ps-0 py-0">
                                            <a class="fw-bold text-primary" href="#!">Flat Plate SP</a></td>
                                        <td
                                            class="deal_owner align-middle white-space-nowrap fw-semibold text-body-emphasis ps-4 py-0">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-m me-3"><img
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $457<span class="ms-2 text-success" data-feather="trending-up"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="deals_name align-middle white-space-nowrap fw-semibold text-body-highlight ps-0 py-0">
                                            <a class="fw-bold text-primary" href="#!">Evacuated Tube</a></td>
                                        <td
                                            class="deal_owner align-middle white-space-nowrap fw-semibold text-body-emphasis ps-4 py-0">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-m me-3"><img class="rounded-circle"
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $120<span class="ms-2 text-warning" data-feather="trending-down"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            class="deals_name align-middle white-space-nowrap fw-semibold text-body-highlight ps-0 py-0">
                                            <a class="fw-bold text-primary" href="#!">Product Delivery</a></td>
                                        <td
                                            class="deal_owner align-middle white-space-nowrap fw-semibold text-body-emphasis ps-4 py-0">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-m me-3"><img class="rounded-circle"
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $150<span class="ms-2 text-danger" data-feather="trending-down"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td
                                            ...
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-m me-3"><img class="rounded-circle"
                                                        src="{{ asset('assets/img/team/18.webp') }}" alt="">
                                                </div><a class="text-body-highlight fw-bold stretched-link"
                                                    href="#!">Hunter Leader</a>
                                            </div>
                                        </td>
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $140<span class="ms-2 text-warning" data-feather="trending-down"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $122<span class="ms-2 text-success" data-feather="trending-up"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $321<span class="ms-2 text-success" data-feather="trending-up"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                        ...
                                        <td class="stage align-middle white-space-nowrap fw-bold text-body py-2">
                                            <div class="d-flex align-items-center gap-3">
                                                <div style="--phoenix-circle-progress-bar:100"><svg
                                                        ...
                                                        <circle class="progress-bar-top" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round"
                                                            stroke="#E5780B" stroke-width="12"></circle>
                                                    </svg></div>
                                                <h6 class="mb-0 text-body">Action</h6>
                                            </div>
                                        </td>
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $104<span class="ms-2 text-warning" data-feather="trending-down"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="stage align-middle white-space-nowrap fw-bold text-body py-2">
                                            <div class="d-flex align-items-center gap-3">
                                                <div style="--phoenix-circle-progress-bar:100"><svg
                                                        class="circle-progress-svg" width="38" height="38"
                                                        viewbox="0 0 125 125">
                                                        <circle class="progress-bar-rail" cx="65"
                                                            cy="45" r="54" fill="none"
                                                            stroke-linecap="round" stroke-width="15"></circle>
                                                        <circle class="progress-bar-top" cx="65" cy="45"
                                                            r="54" fill="none" stroke-linecap="round"
                                        ...
                                        <td class="amount align-middle white-space-nowrap fw-bold ps-4 text-body py-0">
                                            $124<span class="ms-2 text-danger" data-feather="trending-down"
                                                style="min-height:8px; width:14px;"></span></td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4">
                                            <div class="btn-reveal-trigger position-static"><button
                                                    class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal fs-10"
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/report-details.js') }}"></script>
@endpush
