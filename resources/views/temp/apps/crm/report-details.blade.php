                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-CRM" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-CRM">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-CRM">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="{{ url('report-details') }}">
              ...
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="CRM" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="{{ url('report-details') }}">
      ...
      <div class="content">
        ...
        <div class="pb-9">
          ...
          <div class="row g-3 justify-content-between mb-4">
            <div class="col-auto">
              <div class="d-flex flex-wrap gap-2"><button class="btn btn-primary"><span class="fas fa-envelope me-2"></span>Send mail</button>
                <button class="btn btn-phoenix-primary"><span class="fas fa-pencil me-2"></span>Edit</button>
                <button class="btn btn-phoenix-secondary text-body"><span class="fa-solid fa-file-export fs-9 me-2"></span>Export</button>
              </div>
            </div>
            <div class="col-auto">
              <div class="d-flex">
                ...
                </div><button class="btn px-3 btn-phoenix-secondary me-2 d-xl-none"><span class="fa-solid fa-search"></span></button>
