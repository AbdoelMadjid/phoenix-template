                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-CRM" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-CRM">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-CRM">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('report-details') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Report details</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('add-contact') }}">
              ...
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="CRM" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="{{ url('report-details') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Report details</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('add-contact') }}">
        ...
        <div>
          <div class="px-4 px-lg-6">
            ...
            <div class="d-xl-flex justify-content-between">
              <div class="mb-3"><button class="btn btn-primary me-4" type="button" data-bs-toggle="modal" data-bs-target="#addDealModal" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-plus me-2"></span>Add Deal</button>
            ...
            <div class="deals">
              <div class="deals-col me-4">
                <div class="d-flex align-items-center justify-content-between position-sticky top-0 z-1 bg-body">
                  ...
                  <div class="d-flex gap-3"><button class="btn p-0" type="button" data-bs-toggle="modal" data-bs-target="#addDealModal" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fa-solid fa-plus"></span></button>
                ...
                <div class="scrollbar deals-items-container">
                  <div class="w-100 min-vh-50" data-sortable="data-sortable">
                        ...
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-1" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-1"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 30, 2022<span class="text-body-quaternary"> . 2:15 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">Jo_Td01</a>
                            ...
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$14,000.00</p>
                          </div>
                              ...
                              <tr>
                                <td class="py-1">
                                  <div class="d-flex align-items-center"><span class="me-2 text-body-tertiary" data-feather="dollar-sign"></span>
                                    <p class="fw-semibold fs-9 mb-0 text-body-tertiary">Expected Revenue</p>
                                  </div>
                                </td>
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">$14,000.00</p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                  <div class="d-flex align-items-center"><span class="me-2 text-body-tertiary" data-feather="user" style="width:16px; height:16px"></span>
                                    <p class="fw-semibold fs-9 mb-0 text-body-tertiary">Company Name</p>
                                  </div>
                                </td>
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis d-flex align-items-center gap-2">Knitkake.inc<a href="#!"> <span class="fa-solid fa-square-phone text-body-tertiary"></span></a><a href="#!"> <span class="fa-solid fa-square-envelope text-body-tertiary"></span></a><a href="#!"> <span class="fab fa-whatsapp-square text-body-tertiary"></span></a></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                  <div class="d-flex align-items-center"><span class="me-2 text-body-tertiary" data-feather="calendar" style="width:16px; height:16px"></span>
                                    <p class="fw-semibold fs-9 mb-0 text-body-tertiary">Closing Date &amp; Time</p>
                                  </div>
                                </td>
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">27-12-2022<span> . 11:19 PM</span></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-2" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-2"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 29, 2022<span class="text-body-quaternary"> . 12:15 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">Dimensions for Printing</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Marketplace</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$23,000.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                            <div class="d-flex align-items-center"><span class="uil uil-user me-2"></span>
                          ...
                          <div class="collapse" id="collapseWidthDeals-2">
                            <div class="d-flex gap-2 mb-5"><span class="badge badge-phoenix badge-phoenix-info">New</span><span class="badge badge-phoenix badge-phoenix-success">Medium</span></div>
                            <table class="mb-4 w-100 table-stats table-stats">
                              <tr>
                                <th></th>
                                <th></th>
                              ...
                              <tr>
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">$23,000.00</p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis d-flex align-items-center gap-2">Kibikaba Clothings<a href="#!"> <span class="fa-solid fa-square-phone text-body-tertiary"></span></a><a href="#!"> <span class="fa-solid fa-square-envelope text-body-tertiary"></span></a><a href="#!"> <span class="fab fa-whatsapp-square text-body-tertiary"></span></a></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">25-12-2022<span> . 2:00 PM</span></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
              ...
              <div class="deals-col me-4">
                ...
                <div class="scrollbar deals-items-container">
                  <div class="w-100 min-vh-50" data-sortable="data-sortable">
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-3" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-3"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 30, 2022<span class="text-body-quaternary"> . 06:15 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">True and True Attorneys</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Financial</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$33,000.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                            <div class="d-flex align-items-center"><span class="uil uil-user me-2"></span>
                          ...
                          <div class="collapse" id="collapseWidthDeals-3">
                            <div class="d-flex gap-2 mb-5"><span class="badge badge-phoenix badge-phoenix-primary">In Progress</span><span class="badge badge-phoenix badge-phoenix-warning">High</span></div>
                            <table class="mb-4 w-100 table-stats table-stats">
                              <tr>
                                <th></th>
                                <th></th>
                              ...
                              <tr>
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">$33,000.00</p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis d-flex align-items-center gap-2">PBR Holdings<a href="#!"> <span class="fa-solid fa-square-phone text-body-tertiary"></span></a><a href="#!"> <span class="fa-solid fa-square-envelope text-body-tertiary"></span></a><a href="#!"> <span class="fab fa-whatsapp-square text-body-tertiary"></span></a></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                            ...
                            <p class="fs-9 mb-1"> Probability:</p>
                            <div class="progress" style="height:8px">
                              <div class="progress-bar rounded-pill bg-primary" role="progressbar" style="width: 40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-4" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-4"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 30, 2022<span class="text-body-quaternary"> . 08:20 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">The Morlong Corporation</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Marketplace</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$45,300.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                            <div class="d-flex align-items-center"><span class="uil uil-user me-2"></span>
                          ...
                          <div class="collapse" id="collapseWidthDeals-4">
                            <div class="d-flex gap-2 mb-5"><span class="badge badge-phoenix badge-phoenix-primary">In Progress</span><span class="badge badge-phoenix badge-phoenix-info">Low</span></div>
                            <table class="mb-4 w-100 table-stats table-stats">
                              <tr>
                                <th></th>
                                <th></th>
                              ...
                              <tr>
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">$45,300.00</p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis d-flex align-items-center gap-2">Giraffes Studio<a href="#!"> <span class="fa-solid fa-square-phone text-body-tertiary"></span></a><a href="#!"> <span class="fa-solid fa-square-envelope text-body-tertiary"></span></a><a href="#!"> <span class="fab fa-whatsapp-square text-body-tertiary"></span></a></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">26-12-2022<span> . 12:10 PM</span></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-5" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-5"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 30, 2022<span class="text-body-quaternary"> . 3:25 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">Product List</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Marketplace</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$23,000.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                          ...
                          <div class="collapse" id="collapseWidthDeals-5">
                            <div class="d-flex gap-2 mb-5"><span class="badge badge-phoenix badge-phoenix-primary">In Progress</span><span class="badge badge-phoenix badge-phoenix-danger">Urgent</span></div>
                            <table class="mb-4 w-100 table-stats table-stats">
                              <tr>
                                <th></th>
                                <th></th>
                              ...
                              <tr>
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis d-flex align-items-center gap-2">Birds eye<a href="#!"> <span class="fa-solid fa-square-phone text-body-tertiary"></span></a><a href="#!"> <span class="fa-solid fa-square-envelope text-body-tertiary"></span></a><a href="#!"> <span class="fab fa-whatsapp-square text-body-tertiary"></span></a></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
              ...
              <div class="deals-col me-4">
                ...
                <div class="scrollbar deals-items-container">
                  <div class="w-100 min-vh-50" data-sortable="data-sortable">
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-6" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-6"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 30, 2022<span class="text-body-quaternary"> . 3:15 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">Printing Services by Feltz</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Marketplace</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$23,400.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                            <div class="d-flex align-items-center"><span class="uil uil-user me-2"></span>
                          ...
                          <div class="collapse" id="collapseWidthDeals-6">
                            <div class="d-flex gap-2 mb-5"><span class="badge badge-phoenix badge-phoenix-warning">Pending</span><span class="badge badge-phoenix badge-phoenix-warning">High</span></div>
                            <table class="mb-4 w-100 table-stats table-stats">
                              <tr>
                                <th></th>
                                <th></th>
                              ...
                              <tr>
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">$23,400.00</p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis d-flex align-items-center gap-2">Ant Family<a href="#!"> <span class="fa-solid fa-square-phone text-body-tertiary"></span></a><a href="#!"> <span class="fa-solid fa-square-envelope text-body-tertiary"></span></a><a href="#!"> <span class="fab fa-whatsapp-square text-body-tertiary"></span></a></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                            ...
                            <p class="fs-9 mb-1"> Probability:</p>
                            <div class="progress" style="height:8px">
                              <div class="progress-bar rounded-pill bg-warning" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="deals-col me-4">
                ...
                <div class="scrollbar deals-items-container">
                  <div class="w-100 min-vh-50" data-sortable="data-sortable">
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-7" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-7"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 31, 2022<span class="text-body-quaternary"> . 01:30 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">SP Flat Plate</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Financial</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$14,000.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                          ...
                          <div class="collapse" id="collapseWidthDeals-7">
                            <div class="d-flex gap-2 mb-5"><span class="badge badge-phoenix badge-phoenix-secondary">Canceled</span><span class="badge badge-phoenix badge-phoenix-success">Medium</span></div>
                            <table class="mb-4 w-100 table-stats table-stats">
                              <tr>
                                <th></th>
                                <th></th>
                              ...
                              <tr>
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">29-12-2022<span> . 01:30 PM</span></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                            ...
                            <p class="fs-9 mb-1"> Probability:</p>
                            <div class="progress" style="height:8px">
                              <div class="progress-bar rounded-pill bg-300" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-8" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-8"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 31, 2022<span class="text-body-quaternary"> . 2:15 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">Ventilated Pipe</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Marketplace</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$14,000.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                          ...
                          <div class="collapse" id="collapseWidthDeals-8">
                            <div class="d-flex gap-2 mb-5"><span class="badge badge-phoenix badge-phoenix-secondary">Canceled</span><span class="badge badge-phoenix badge-phoenix-info">Low</span></div>
                            <table class="mb-4 w-100 table-stats table-stats">
                              <tr>
                                <th></th>
                                <th></th>
                              ...
                              <tr>
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">29-12-2022<span> . 02:15 PM</span></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
              ...
              <div class="deals-col me-4">
                ...
                <div class="scrollbar deals-items-container">
                  <div class="w-100 min-vh-50" data-sortable="data-sortable">
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-9" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-9"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 29, 2022<span class="text-body-quaternary"> . 03:12 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">Product Shipping</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Financial</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$15,000.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                            <div class="d-flex align-items-center"><span class="uil uil-user me-2"></span>
                              <p class="text-body-secondary fw-bold fs-9 mb-0">Birds eye</p>
                          ...
                          <div class="collapse" id="collapseWidthDeals-9">
                            <div class="d-flex gap-2 mb-5"><span class="badge badge-phoenix badge-phoenix-success">Completed</span><span class="badge badge-phoenix badge-phoenix-danger">Urgent</span></div>
                            <table class="mb-4 w-100 table-stats table-stats">
                              <tr>
                                <th></th>
                                <th></th>
                              ...
                              <tr>
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">$15,000.00</p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                            ...
                            <p class="fs-9 mb-1"> Probability:</p>
                            <div class="progress" style="height:8px">
                              <div class="progress-bar rounded-pill bg-success" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-10" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-10"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 29, 2022<span class="text-body-quaternary"> . 06:15 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">Product List</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Financial</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$33,00.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                            <div class="d-flex align-items-center"><span class="uil uil-user me-2"></span>
                          ...
                          <div class="collapse" id="collapseWidthDeals-10">
                            <div class="d-flex gap-2 mb-5"><span class="badge badge-phoenix badge-phoenix-success">Completed</span><span class="badge badge-phoenix badge-phoenix-info">Low</span></div>
                            <table class="mb-4 w-100 table-stats table-stats">
                              <tr>
                                <th></th>
                                <th></th>
                              ...
                              <tr>
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">$33,00.00</p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis d-flex align-items-center gap-2">Ink Incorporated<a href="#!"> <span class="fa-solid fa-square-phone text-body-tertiary"></span></a><a href="#!"> <span class="fa-solid fa-square-envelope text-body-tertiary"></span></a><a href="#!"> <span class="fab fa-whatsapp-square text-body-tertiary"></span></a></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">28-12-2022<span> . 12:20 PM</span></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-11" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-11"><span class="fa-solid fa-angle-down"></span></a>
                          <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex"><span class="me-2" data-feather="clock" style="stroke-width:2;"></span>
                              <p class="mb-0 fs-9 fw-semibold text-body-tertiary date">Dec 29, 2022<span class="text-body-quaternary"> . 2:15 PM</span></p>
                            </div>
                          </div>
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="{{ url('deal-details') }}">Dimensions for Printing</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Marketplace</p>
                          ...
                          <div class="collapse" id="collapseWidthDeals-11">
                            ...
                            <table class="mb-4 w-100 table-stats table-stats">
                              ...
                              <tr>
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis d-flex align-items-center gap-2">Slim Apes<a href="#!"> <span class="fa-solid fa-square-phone text-body-tertiary"></span></a><a href="#!"> <span class="fa-solid fa-square-envelope text-body-tertiary"></span></a><a href="#!"> <span class="fab fa-whatsapp-square text-body-tertiary"></span></a></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
                                ...
                                <td class="py-1 d-none d-sm-block pe-sm-2">:</td>
                                <td class="py-1">
                                  <p class="ps-6 ps-sm-0 fw-semibold fs-9 mb-0 mb-0 pb-3 pb-sm-0 text-body-emphasis">28-12-2022<span> . 02:19 PM</span></p>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-1">
              ...
              <div class="deals-col position-relative">
                <div class="d-flex flex-center flex-column h-100">
                  <h3 class="mb-4">Add new stage</h3><button class="btn btn-sm btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#addStageModal" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fa-solid fa-plus me-2"></span>New Stage</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border border-translucent">
          <form id="addEventForm" autocomplete="off">
            ...
            <div class="modal-footer d-flex justify-content-end align-items-center px-4 pb-4 border-0 pt-3"><button class="btn btn-sm btn-phoenix-primary px-4 fs-10 my-0" type="submit"> <span class="fas fa-arrows-rotate me-2 fs-10"></span>Reset</button>
    ...
    <div class="modal fade" id="addDealModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addDealModal" aria-hidden="true">
      <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content bg-body-highlight">
          <div class="modal-header justify-content-between border-0 px-6 pt-6 mb-2">
            <h3 class="mb-0">Deal Informations</h3><button class="btn btn-sm btn-phoenix-secondary" data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times text-danger"></span></button>
          </div>
          <div class="modal-body px-6">
            <div class="row g-4">
              <div class="col-lg-6">
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Deal Owner</label><select class="form-select">
                ...
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Deal Name</label><input class="form-control" type="text" placeholder="Enter deal name"></div>
                <div class="mb-4">
                  <div class="row g-3">
                    <div class="col-sm-6 col-lg-12 col-xl-6"><label class="text-body-highlight fw-bold mb-2">Deal Amount</label>
                      <div class="row g-2">
                        <div class="col"><input class="form-control" type="number" placeholder="$ Enter amount"></div>
                ...
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Deal Code</label><input class="form-control" type="text" placeholder="Enter deals code"></div>
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Deal Type<button class="btn btn-link p-0 ms-3"><span class="fa-solid fa-plus me-1"></span><span>Add new</span></button></label><select class="form-select">
                    <option>Select</option>
                ...
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Category<button class="btn btn-link p-0 ms-3"><span class="fa-solid fa-plus me-1"></span><span>Add new</span></button></label><select class="form-select">
                    <option>Select</option>
                ...
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Probability (%)</label><input class="form-control" type="text" placeholder="Enter value"></div>
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Expected Revenue</label>
                  <div class="row g-2">
                    <div class="col"><input class="form-control" type="number" placeholder="$ Enter amount"></div>
                    <div class="col-auto"><select class="form-select">
                        <option>USD</option>
              ...
              <div class="col-lg-6">
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Contact Name</label><input class="form-control" type="text" placeholder="Enter contact name"></div>
                <div class="mb-4">
                  <div class="row g-3">
                    <div class="col-6"><label class="text-body-highlight fw-bold mb-2">Phone Number</label><input class="form-control" type="text" placeholder="Enter phone number"></div>
                    <div class="col-6"><label class="text-body-highlight fw-bold mb-2">Email Address</label><input class="form-control" type="text" placeholder="Enter email address"></div>
                  </div>
                </div>
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Lead Source<button class="btn btn-link p-0 ms-3"><span class="fa-solid fa-plus me-1"></span><span>Add new</span></button></label><select class="form-select">
                    <option>Select</option>
                ...
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Campaign Source<button class="btn btn-link p-0 ms-3"><span class="fa-solid fa-plus me-1"></span><span>Add new</span></button></label><select class="form-select">
                    <option>Select</option>
                    <option>Online Campaign</option>
                    <option>Offline Campaign</option>
                  </select></div>
                <div class="mb-4"><label class="text-body-highlight fw-bold mb-2">Time Zone</label><select class="form-select">
                ...
                <div class="mb-4">
                  <div class="row g-3">
                    <div class="col-6"><label class="text-body-highlight fw-bold mb-2">Create Date</label><input class="form-control datetimepicker" type="text" placeholder="dd / mm / yyyy" data-options='{"disableMobile":true}'></div>
                    <div class="col-6"><label class="text-body-highlight fw-bold mb-2">Start Time</label><input class="form-control datetimepicker" type="text" placeholder="H:i" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}'></div>
                  </div>
                </div>
                <div class="mb-4">
                  <div class="row g-3">
                    <div class="col-6"><label class="text-body-highlight fw-bold mb-2">Closing Date</label><input class="form-control datetimepicker" type="text" placeholder="dd / mm / yyyy" data-options='{"disableMobile":true}'></div>
                    <div class="col-6"><label class="text-body-highlight fw-bold mb-2">Closing Time</label><input class="form-control datetimepicker" type="text" placeholder="H:i" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}'></div>
                  </div>
                </div>
                <div class="row g-3">
                  <div class="col-6"><label class="text-body-highlight fw-bold mb-2">Stage</label><select class="form-select">
                      <option>Select</option>
                      <option>New</option>
                  ...
                  <div class="col-6"><label class="text-body-highlight fw-bold mb-2">Priority</label><select class="form-select">
          ...
          <div class="modal-footer border-0pt-4 px-6 pb-6"><button class="btn btn-link text-danger px-3 my-0" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
            <button class="btn btn-primary my-0">Create Deal</button>
          </div>
        </div>
      </div>
    </div>
    <div class="modal fade" id="addStageModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addStageModal" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-body p-4">
            <h3 class="mb-5 text-body-highlight">Create New Stage</h3>
            <div class="mb-4"><label class="mb-2 fw-bold text-body-highlight">Column Name</label><input class="form-control" type="text" placeholder="Enter stage name"></div><label class="mb-2 fw-bold text-body-highlight">Forecast Revenue</label><input class="form-control" type="text" placeholder="$  Enter amount">
          </div>
          <div class="modal-footer border-0 pt-3 px-4 pb-4"><button class="btn btn-link text-danger px-4 m-0" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
            <button class="btn btn-primary px-6 m-0">Create New Stage</button>
          </div>
        </div>
      </div>
    </div>
