...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <body>
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-CRM" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-CRM">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-CRM">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="deals.html">
                      ...
                      <li class="nav-item"><a class="nav-link" href="leads.html">
                      ...
                      <li class="nav-item"><a class="nav-link" href="report-details.html">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="CRM" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="analytics.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Analytics</div>
                      </a></li>
                    <li><a class="dropdown-item active" href="deals.html">
                    ...
                    <li><a class="dropdown-item" href="report-details.html">
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-1" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-1"><span class="fa-solid fa-angle-down"></span></a>
                          ...
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="deal-details.html">Jo_Td01</a>
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-2" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-2"><span class="fa-solid fa-angle-down"></span></a>
                          ...
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="deal-details.html">Dimensions for Printing</a>
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-3" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-3"><span class="fa-solid fa-angle-down"></span></a>
                          ...
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="deal-details.html">True and True Attorneys</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Financial</p>
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-4" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-4"><span class="fa-solid fa-angle-down"></span></a>
                          ...
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="deal-details.html">The Morlong Corporation</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Marketplace</p>
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-5" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-5"><span class="fa-solid fa-angle-down"></span></a>
                          ...
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="deal-details.html">Product List</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Marketplace</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$23,000.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-6" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-6"><span class="fa-solid fa-angle-down"></span></a>
                          ...
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="deal-details.html">Printing Services by Feltz</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Marketplace</p>
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-7" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-7"><span class="fa-solid fa-angle-down"></span></a>
                          ...
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="deal-details.html">SP Flat Plate</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Financial</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$14,000.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-8" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-8"><span class="fa-solid fa-angle-down"></span></a>
                          ...
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="deal-details.html">Ventilated Pipe</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Marketplace</p>
                            <p class="ms-auto fs-9 text-body-emphasis fw-semibold mb-0 deals-revenue">$14,000.00</p>
                          </div>
                          <div class="deals-company-agent d-flex flex-between-center">
                    ...
                    <div>
                      <div class="card mb-3">
                        <div class="card-body"><a class="dropdown-indicator-icon position-absolute text-body-tertiary" href="#collapseWidthDeals-9" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseWidthDeals-9"><span class="fa-solid fa-angle-down"></span></a>
                          ...
                          <div class="deals-items-head d-flex align-items-center mb-2"><a class="text-primary fw-bold line-clamp-1 me-3 mb-0 fs-7" href="deal-details.html">Product Shipping</a>
                            <p class="deals-category fs-10 mb-0 mt-1 d-none"><span class="me-1 text-body-quaternary" data-feather="grid" style="stroke-width:2; height: 12px; width: 12px"></span>Financial</p>
    ...
    <script src="../../assets/js/pages/kanban.js"></script>
  </body>
