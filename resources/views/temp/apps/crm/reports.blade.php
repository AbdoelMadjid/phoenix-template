            ...
            <div class="row g-3 justify-content-between mb-2">
                <div class="col-12">
                    <div class="d-md-flex justify-content-between">
                        <div class="mb-3"><button class="btn btn-primary me-4"><span
                                    class="fas fa-plus me-2"></span>Create Report</button>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            </div><button class="btn px-3 btn-phoenix-secondary" type="button" data-bs-toggle="modal"
                        ...
                        <div class="card-body">
                            <div class="border-bottom border-translucent">
                                <div class="d-flex align-items-start mb-1">
                                    ...
                                    <div class="d-sm-flex align-items-center ps-2"><a
                                            class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4"
                                            href="{{ url('report-details') }}">Purchasers and sellers</a>
                                        <div class="d-flex align-items-center"><span
                                                class="fa-solid fa-circle me-1 text-danger"
                                                data-fa-transform="shrink-6 up-1"></span><span
                                                class="fw-bold fs-9 text-body lh-2">Urgent</span></div>
                                    </div>
                                </div>
                            ...
                            <div class="row g-1 g-sm-3 mt-2 lh-1">
                                <div class="col-12 col-sm-auto flex-1 text-truncate"><a class="fw-semibold fs-9"
                                        href="#!"><span class="fa-regular fa-folder me-2 reportsby"></span>Reports by
                                        email</a></div>
                                <div class="col-12 col-sm-auto">
                                    <div class="d-flex align-items-center"><span class="me-2" data-feather="grid"
                        ...
                        <div class="card-body">
                            <div class="border-bottom border-translucent">
                                <div class="d-flex align-items-start mb-1">
                                    ...
                                    <div class="d-sm-flex align-items-center ps-2"><a
                                            class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4"
                                            href="{{ url('report-details') }}">Useful Solutions</a>
                                        <div class="d-flex align-items-center"><span
                                                class="fa-solid fa-circle me-1 text-danger"
                                                data-fa-transform="shrink-6 up-1"></span><span
                                                class="fw-bold fs-9 text-body lh-2">Urgent</span></div>
                        ...
                        <div class="card-body">
                            <div class="border-bottom border-translucent">
                                <div class="d-flex align-items-start mb-1">
                                    ...
                                    <div class="d-sm-flex align-items-center ps-2"><a
                                            class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4"
                                            href="{{ url('report-details') }}">Category Products</a>
                                        <div class="d-flex align-items-center"><span
                                                class="fa-solid fa-circle me-1 text-success"
                                                data-fa-transform="shrink-6 up-1"></span><span
                                                class="fw-bold fs-9 text-body lh-2">Medium</span></div>
                                    </div>
                                </div>
                                <p class="fs-9 fw-semibold text-body ms-4 text mb-4 ps-2">Based on the percentage of
                                    recipients</p>
                            </div>
                            <div class="row g-1 g-sm-3 mt-2 lh-1">
                                <div class="col-12 col-sm-auto flex-1 text-truncate"><a class="fw-semibold fs-9"
                                        href="#!"><span class="fa-regular fa-folder me-2 reportsby"></span>Reports on
                                        Sales Orders</a></div>
                                <div class="col-12 col-sm-auto">
                                    <div class="d-flex align-items-center"><span class="me-2" data-feather="grid"
                                            style="stroke-width:2;"></span>
                        ...
                        <div class="card-body">
                            <div class="border-bottom border-translucent">
                                <div class="d-flex align-items-start mb-1">
                                    ...
                                    <div class="d-sm-flex align-items-center ps-2"><a
                                            class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4"
                                            href="{{ url('report-details') }}">Current Deals</a>
                                        <div class="d-flex align-items-center"><span
                                                class="fa-solid fa-circle me-1 text-success"
                                                data-fa-transform="shrink-6 up-1"></span><span
                                                class="fw-bold fs-9 text-body lh-2">Medium</span></div>
                            ...
                            <div class="row g-1 g-sm-3 mt-2 lh-1">
                                <div class="col-12 col-sm-auto flex-1 text-truncate"><a class="fw-semibold fs-9"
                                        href="#!"><span class="fa-regular fa-folder me-2 reportsby"></span>Reviews of
                                        Products</a></div>
                                <div class="col-12 col-sm-auto">
                                    <div class="d-flex align-items-center"><span class="me-2" data-feather="grid"
                                            style="stroke-width:2;"></span>
                                ...
                                <div class="d-flex align-items-start mb-1">
                                    ...
                                    <div class="d-sm-flex align-items-center ps-2"><a
                                        ...
                                        <div class="d-flex align-items-center"><span
                                                ...
                                                data-fa-transform="shrink-6 up-1"></span><span
                                                class="fw-bold fs-9 text-body lh-2">Low</span></div>
                                    </div>
                                </div>
                                <p class="fs-9 fw-semibold text-body ms-4 text mb-4 ps-2">Obtaining leads today</p>
                            </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="border-bottom border-translucent">
                                ...
                                <p class="fs-9 fw-semibold text-body ms-4 text mb-4 ps-2">Sums up the many existing
                                    businesses.</p>
                            </div>
                            <div class="row g-1 g-sm-3 mt-2 lh-1">
                                <div class="col-12 col-sm-auto flex-1 text-truncate"><a class="fw-semibold fs-9"
                        ...
                        <div class="card-body">
                            <div class="border-bottom border-translucent">
                                <div class="d-flex align-items-start mb-1">
                                    ...
                                    <div class="d-sm-flex align-items-center ps-2"><a
                                            class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4"
                                            href="{{ url('report-details') }}">Lost of Deals</a>
                                        <div class="d-flex align-items-center"><span
                                                class="fa-solid fa-circle me-1 text-warning"
                                                data-fa-transform="shrink-6 up-1"></span><span
                                                class="fw-bold fs-9 text-body lh-2">High</span></div>
                                    </div>
                                </div>
                                <p class="fs-9 fw-semibold text-body ms-4 text mb-4 ps-2">Emails sent by users to all
                                    records,</p>
                            </div>
                            <div class="row g-1 g-sm-3 mt-2 lh-1">
                                <div class="col-12 col-sm-auto flex-1 text-truncate"><a class="fw-semibold fs-9"
                        ...
                        <div class="card-body">
                            <div class="border-bottom border-translucent">
                                <div class="d-flex align-items-start mb-1">
                                    ...
                                    <div class="d-sm-flex align-items-center ps-2"><a
                                            class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4"
                                            href="{{ url('report-details') }}">Important Accounts</a>
                                        <div class="d-flex align-items-center"><span
                                                class="fa-solid fa-circle me-1 text-info"
                                                data-fa-transform="shrink-6 up-1"></span><span
                                                class="fw-bold fs-9 text-body lh-2">Low</span></div>
                                ...
                                <p class="fs-9 fw-semibold text-body ms-4 text mb-4 ps-2">Contracts closed by a salesman
                                </p>
                            </div>
                            <div class="row g-1 g-sm-3 mt-2 lh-1">
                                <div class="col-12 col-sm-auto flex-1 text-truncate"><a class="fw-semibold fs-9"
                        ...
                        <div class="card-body">
                            <div class="border-bottom border-translucent">
                                <div class="d-flex align-items-start mb-1">
                                    ...
                                    <div class="d-sm-flex align-items-center ps-2"><a
                                            class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4"
                                            href="{{ url('report-details') }}">Analytics for Email</a>
                                        <div class="d-flex align-items-center"><span
                                                class="fa-solid fa-circle me-1 text-success"
                                                data-fa-transform="shrink-6 up-1"></span><span
                                                class="fw-bold fs-9 text-body lh-2">Medium</span></div>
                        ...
                        <div class="card-body">
                            <div class="border-bottom border-translucent">
                                <div class="d-flex align-items-start mb-1">
                                    ...
                                    <div class="d-sm-flex align-items-center ps-2"><a
                                            class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4"
                                            href="{{ url('report-details') }}">Types of Deals</a>
                                        <div class="d-flex align-items-center"><span
                                                class="fa-solid fa-circle me-1 text-success"
                                                data-fa-transform="shrink-6 up-1"></span><span
                                                class="fw-bold fs-9 text-body lh-2">Medium</span></div>
                                ...
                                <p class="fs-9 fw-semibold text-body ms-4 text mb-4 ps-2">Products support will stop this
                                    month</p>
                            </div>
                            <div class="row g-1 g-sm-3 mt-2 lh-1">
                                <div class="col-12 col-sm-auto flex-1 text-truncate"><a class="fw-semibold fs-9"
                        ...
                        <div class="card-body">
                            <div class="border-bottom border-translucent">
                                <div class="d-flex align-items-start mb-1">
                                    ...
                                    <div class="d-sm-flex align-items-center ps-2"><a
                                            class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4"
                                            href="{{ url('report-details') }}">Current Sales</a>
                                        <div class="d-flex align-items-center"><span
                                                class="fa-solid fa-circle me-1 text-danger"
                                                data-fa-transform="shrink-6 up-1"></span><span
                                                class="fw-bold fs-9 text-body lh-2">Urgent</span></div>
