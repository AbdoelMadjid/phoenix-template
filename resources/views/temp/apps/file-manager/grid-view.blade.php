                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-file-manager" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-file-manager">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-file-manager">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="{{ url('grid-view') }}">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Grid view</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="{{ url('list-view') }}">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="file-manager" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item active" href="{{ url('grid-view') }}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Grid view</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ url('list-view') }}">
              ...
              <div class="card mt-5">
                <div class="card-header py-3 px-4">
                  <div class="row g-3 flex-between-center">
                    ...
                    <div class="col-auto d-flex"><a class="border-primary text-primary btn btn-phoenix-secondary btn-square me-2" href="{{ url('grid-view') }}" data-bs-toggle="tooltip" data-bs-title="Grid view"><span class="fa-solid fa-table-cells-large"></span></a><a class="btn btn-phoenix-secondary btn-square" href="{{ url('list-view') }}" data-bs-toggle="tooltip" data-bs-title="List view"><span class="fa-solid fa-list"></span></a><select class="form-select mx-2 mx-sm-3">
                      ...
                      <div class="files-container" data-files-container="data-files-container">
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="2" data-bulk-select-row="data-bulk-select-row" data-file="2"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="2" data-file="2" data-file-thumbnail="img/file-manager/9.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="{{ asset('assets/img/file-manager/9.png') }}" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                          ...
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="4" data-bulk-select-row="data-bulk-select-row" data-file="4"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="4" data-file="4" data-file-thumbnail="video/2.mp4"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden">
                                <div class="video-container h-100"><video class="video d-block h-100 w-100 overflow-hidden object-fit-cover" muted="muted" data-play-on-hover="data-play-on-hover" poster="{{ asset('assets/video/2.png') }}">
                                    <source src="{{ asset('assets/video/2.mp4') }}" type="video/mp4">
                                  </video></div>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="6" data-bulk-select-row="data-bulk-select-row" data-file="6"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="6" data-file="6" data-file-thumbnail="img/file-manager/11.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="{{ asset('assets/img/file-manager/11.png') }}" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="11" data-bulk-select-row="data-bulk-select-row" data-file="11"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="11" data-file="11" data-file-thumbnail="img/file-manager/12.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="{{ asset('assets/img/file-manager/12.png') }}" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center" data-play-on-container-hover="data-play-on-container-hover">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="14" data-bulk-select-row="data-bulk-select-row" data-file="14"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="14" data-file="14" data-file-thumbnail="video/3.mp4"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden">
                                <div class="video-container h-100"><video class="video d-block h-100 w-100 overflow-hidden object-fit-cover" muted="muted" data-play-on-hover="data-play-on-hover" poster="{{ asset('assets/video/3.png') }}">
                                    <source src="{{ asset('assets/video/3.mp4') }}" type="video/mp4">
                                  </video></div>
                              </div><button class="btn p-0 circle-icon-item-md bg-body-emphasis bg-opacity-50 position-absolute top-50 start-50 translate-middle z-3" data-bs-theme="light" data-video-controller="data-video-controller"><span class="play-icon pointer-events-none"><span class="fa-solid fa-play text-body-secondary fs-9" data-fa-transform="down-1"></span></span><span class="pause-icon pointer-events-none"><span class="fa-solid fa-pause text-body-secondary fs-9" data-fa-transform="down-1"></span></span></button>
                            </div>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="16" data-bulk-select-row="data-bulk-select-row" data-file="16"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="16" data-file="16" data-file-thumbnail="img/file-manager/13.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="{{ asset('assets/img/file-manager/13.png') }}" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="17" data-bulk-select-row="data-bulk-select-row" data-file="17"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="17" data-file="17" data-file-thumbnail="img/file-manager/15.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="{{ asset('assets/img/file-manager/15.png') }}" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="19" data-bulk-select-row="data-bulk-select-row" data-file="19"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="19" data-file="19" data-file-thumbnail="img/file-manager/16.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="{{ asset('assets/img/file-manager/16.png') }}" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
