          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-file-manager" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-file-manager">
                    <div class="d-flex align-items-center">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-file-manager">
                      <li class="collapsed-nav-item-title d-none">File manager</li>
                      <li class="nav-item"><a class="nav-link active" href="grid-view.html">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Grid view</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="list-view.html">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="file-manager" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item active" href="grid-view.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Grid view</div>
                      </a></li>
                    <li><a class="dropdown-item" href="list-view.html">
          ...
          <div class="row gx-4">
            <div class="col-auto file-manager-sidebar">
              <div class="phoenix-offcanvas phoenix-offcanvas-fixed bg-body scrollbar overflow-x-hidden" id="fileManagerSideBar" data-breakpoint="lg">
                ...
                <hr class="my-4">
                <div class="text-center"> <img class="d-dark-none img-fluid" src="../../assets/img/spot-illustrations/45.png" alt="" width="98"><img class="d-light-none img-fluid" src="../../assets/img/spot-illustrations/dark_45.png" alt="" width="98">
                        ...
                        <div class="img-zoom-hover mask-image-none overflow-hidden border rounded-3">
                          <div class="position-relative">
                            <div class="mask-image-recent-file overflow-hidden">
                              <div class="ratio ratio-16x9"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/file-manager/1.png" alt=""></div><span class="badge badge-phoenix fs-10 position-absolute top-0 start-0 mt-3 ms-3 badge-phoenix-warning">Edited 5 min ago</span>
                            </div>
                          </div>
                          <div class="bg-body p-3 pe-2 d-flex justify-content-between align-items-start rounded-bottom-3">
                            <div class="w-75"><a class="text-body-highlight fw-bold mb-2 stretched-link d-block text-truncate" href="../../assets/img/generic/67.pdf" data-gallery="recent-file" data-width="90%" data-height="90vh">Verification Letter.pdf</a>
                    ...
                    <div class="col-sm-6 col-xl-6 col-xxl-3">
                      <div class="position-relative" data-play-on-container-hover="data-play-on-container-hover">
                        <div class="img-zoom-hover mask-image-none overflow-hidden border rounded-3">
                          <div class="position-relative">
                            <div class="mask-image-recent-file overflow-hidden">
                              <div class="video-container rounded-3 h-100 ratio ratio-16x9"><video class="video d-block h-100 w-100 object-fit-cover" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/2.png">
                          ...
                          <div class="bg-body p-3 pe-2 d-flex justify-content-between align-items-start rounded-bottom-3">
                            <div class="w-75"><a class="text-body-highlight fw-bold mb-2 stretched-link d-block text-truncate" href="../../assets/video/2.mp4" data-gallery="recent-file" data-width="" data-height="">Travel Tales.mp4</a>
                    ...
                    <div class="col-sm-6 col-xl-6 col-xxl-3">
                      <div class="position-relative">
                        <div class="img-zoom-hover mask-image-none overflow-hidden border rounded-3">
                          <div class="position-relative">
                            <div class="mask-image-recent-file overflow-hidden">
                              <div class="ratio ratio-16x9"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/file-manager/2.png" alt=""></div><span class="badge badge-phoenix fs-10 position-absolute top-0 start-0 mt-3 ms-3 badge-phoenix-info">Upload 6 min ago</span>
                            </div>
                          </div>
                          <div class="bg-body p-3 pe-2 d-flex justify-content-between align-items-start rounded-bottom-3">
                            <div class="w-75"><a class="text-body-highlight fw-bold mb-2 stretched-link d-block text-truncate" href="../../assets/img/file-manager/2.png" data-gallery="recent-file" data-width="" data-height="">Mountain During.jpg</a>
                    ...
                    <div class="col-sm-6 col-xl-6 col-xxl-3">
                      <div class="position-relative" data-play-on-container-hover="data-play-on-container-hover">
                        <div class="img-zoom-hover mask-image-none overflow-hidden border rounded-3">
                          <div class="position-relative">
                            <div class="mask-image-recent-file overflow-hidden">
                              <div class="video-container rounded-3 h-100 ratio ratio-16x9"><video class="video d-block h-100 w-100 object-fit-cover" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/3.png">
                          ...
                          <div class="bg-body p-3 pe-2 d-flex justify-content-between align-items-start rounded-bottom-3">
                            <div class="w-75"><a class="text-body-highlight fw-bold mb-2 stretched-link d-block text-truncate" href="../../assets/video/3.mp4" data-gallery="recent-file" data-width="" data-height="">Cinematic Adventures.mp4</a>
                        ...
                        <div class="col-sm-6 col-xl-6 col-xxl-3">
                          <div class="position-relative" data-play-on-container-hover="data-play-on-container-hover">
                            <div class="img-zoom-hover mask-image-none overflow-hidden border rounded-3">
                              <div class="position-relative">
                                <div class="mask-image-recent-file overflow-hidden">
                                  <div class="video-container rounded-3 h-100 ratio ratio-16x9"><video class="video d-block h-100 w-100 object-fit-cover" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/1.png">
                                      <source src="../../assets/video/1.mp4" type="video/mp4">
                                    </video></div><span class="badge badge-phoenix fs-10 position-absolute top-0 start-0 mt-3 ms-3 badge-phoenix-info">Upload 6 min ago</span>
                                </div><button class="btn p-0 circle-icon-item-md position-absolute top-50 start-50 translate-middle bg-body-emphasis bg-opacity-50 z-5" data-bs-theme="light" data-video-controller="data-video-controller"><span class="play-icon pointer-events-none"><span class="fa-solid fa-play text-body-secondary fs-9" data-fa-transform="down-1"></span></span><span class="pause-icon pointer-events-none"><span class="fa-solid fa-pause text-body-secondary fs-9" data-fa-transform="down-1"></span></span></button>
                              </div>
                              <div class="bg-body p-3 pe-2 d-flex justify-content-between align-items-start rounded-bottom-3">
                                <div class="w-75"><a class="text-body-highlight fw-bold mb-2 stretched-link d-block text-truncate" href="../../assets/video/1.mp4" data-gallery="recent-file" data-width="" data-height="">Travel Tales.mp4</a>
                                  <h6 class="mb-0 fw-semibold text-body-tertiary">65 mb</h6>
                                </div>
                                <div class="dropdown position-static z-5"><button class="btn btn-square-sm position-relative mt-n1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                                  <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                        ...
                        <div class="col-sm-6 col-xl-6 col-xxl-3">
                          <div class="position-relative">
                            <div class="img-zoom-hover mask-image-none overflow-hidden border rounded-3">
                              <div class="position-relative">
                                <div class="mask-image-recent-file overflow-hidden">
                                  <div class="ratio ratio-16x9"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/file-manager/6.png" alt=""></div><span class="badge badge-phoenix fs-10 position-absolute top-0 start-0 mt-3 ms-3 badge-phoenix-info">Upload 6 min ago</span>
                                </div>
                              </div>
                              <div class="bg-body p-3 pe-2 d-flex justify-content-between align-items-start rounded-bottom-3">
                                <div class="w-75"><a class="text-body-highlight fw-bold mb-2 stretched-link d-block text-truncate" href="../../assets/img/file-manager/6.png" data-gallery="recent-file" data-width="" data-height="">Hot air balloons.png</a>
                                  <h6 class="mb-0 fw-semibold text-body-tertiary">5.8 mb</h6>
                                </div>
                                <div class="dropdown position-static z-5"><button class="btn btn-square-sm position-relative mt-n1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                                  <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                        ...
                        <div class="col-sm-6 col-xl-6 col-xxl-3">
                          <div class="position-relative">
                            <div class="img-zoom-hover mask-image-none overflow-hidden border rounded-3">
                              <div class="position-relative">
                                <div class="mask-image-recent-file overflow-hidden">
                                  <div class="ratio ratio-16x9"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/file-manager/7.png" alt=""></div><span class="badge badge-phoenix fs-10 position-absolute top-0 start-0 mt-3 ms-3 badge-phoenix-warning">Edited 5 min ago</span>
                                </div>
                              </div>
                              <div class="bg-body p-3 pe-2 d-flex justify-content-between align-items-start rounded-bottom-3">
                                <div class="w-75"><a class="text-body-highlight fw-bold mb-2 stretched-link d-block text-truncate" href="../../assets/img/file-manager/7.png" data-gallery="recent-file" data-width="" data-height="">Aurora Borealis.jpg</a>
                        ...
                        <div class="col-sm-6 col-xl-6 col-xxl-3">
                          <div class="position-relative" data-play-on-container-hover="data-play-on-container-hover">
                            <div class="img-zoom-hover mask-image-none overflow-hidden border rounded-3">
                              <div class="position-relative">
                                <div class="mask-image-recent-file overflow-hidden">
                                  <div class="video-container rounded-3 h-100 ratio ratio-16x9"><video class="video d-block h-100 w-100 object-fit-cover" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/4.png">
                                      <source src="../../assets/video/4.mp4" type="video/mp4">
                                    </video></div><span class="badge badge-phoenix fs-10 position-absolute top-0 start-0 mt-3 ms-3 badge-phoenix-info">Upload 8 min ago</span>
                                </div><button class="btn p-0 circle-icon-item-md position-absolute top-50 start-50 translate-middle bg-body-emphasis bg-opacity-50 z-5" data-bs-theme="light" data-video-controller="data-video-controller"><span class="play-icon pointer-events-none"><span class="fa-solid fa-play text-body-secondary fs-9" data-fa-transform="down-1"></span></span><span class="pause-icon pointer-events-none"><span class="fa-solid fa-pause text-body-secondary fs-9" data-fa-transform="down-1"></span></span></button>
                              </div>
                              <div class="bg-body p-3 pe-2 d-flex justify-content-between align-items-start rounded-bottom-3">
                                <div class="w-75"><a class="text-body-highlight fw-bold mb-2 stretched-link d-block text-truncate" href="../../assets/video/4.mp4" data-gallery="recent-file" data-width="" data-height="">Cinematic Adventures.mp4</a>
                                  <h6 class="mb-0 fw-semibold text-body-tertiary">54 mb</h6>
                                </div>
                                <div class="dropdown position-static z-5"><button class="btn btn-square-sm position-relative mt-n1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                                  <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
              ...
              <div class="card mt-5">
                <div class="card-header py-3 px-4">
                  <div class="row g-3 flex-between-center">
                    ...
                    <div class="col-auto d-flex"><a class="border-primary text-primary btn btn-phoenix-secondary btn-square me-2" href="grid-view.html" data-bs-toggle="tooltip" data-bs-title="Grid view"><span class="fa-solid fa-table-cells-large"></span></a><a class="btn btn-phoenix-secondary btn-square" href="list-view.html" data-bs-toggle="tooltip" data-bs-title="List view"><span class="fa-solid fa-list"></span></a><select class="form-select mx-2 mx-sm-3">
                    ...
                    <div class="d-none" id="file-manager-actions">
                      <div class="d-flex align-items-center"><button class="btn p-0 text-body-secondary fs-8 me-2 me-sm-3" data-remove-bulk-check="data-remove-bulk-check"><span class="fa-solid fa-xmark" data-fa-transform="down-1"></span></button>
                        ...
                        <div class="d-flex gap-1 gap-sm-2"><button class="btn btn-phoenix-secondary fs-10 btn-square-sm d-none d-sm-block" data-bs-toggle="tooltip" data-bs-title="Download"><span class="fa-solid fa-download"></span></button>
                          ...
                          <div class="dropdown"><button class="btn btn-phoenix-secondary fs-10 btn-square-sm" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fa-solid fa-ellipsis"></span></button>
                  ...
                  <div class="row gx-xxl-9" id="bulk-select-body">
                    <div class="col">
                      <div class="files-container" data-files-container="data-files-container">
                        <div class="form-check d-none"><input class="form-check-input" id="bulk-select-file-manager" type="checkbox" data-bulk-select='{"body":"bulk-select-body","actions":"bulk-select-actions","replacedElement":"bulk-select-replace-element"}'></div>
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="1" data-bulk-select-row="data-bulk-select-row" data-file="1"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="1" data-file="1"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-folder fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                              </div>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="2" data-bulk-select-row="data-bulk-select-row" data-file="2"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="2" data-file="2" data-file-thumbnail="img/file-manager/9.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/file-manager/9.png" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="3" data-bulk-select-row="data-bulk-select-row" data-file="3"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="3" data-file="3"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-folder fs-3 text-info-light"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center" data-play-on-container-hover="data-play-on-container-hover">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="4" data-bulk-select-row="data-bulk-select-row" data-file="4"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="4" data-file="4" data-file-thumbnail="video/2.mp4"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden">
                                <div class="video-container h-100"><video class="video d-block h-100 w-100 overflow-hidden object-fit-cover" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/2.png">
                                    <source src="../../assets/video/2.mp4" type="video/mp4">
                                  </video></div>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="5" data-bulk-select-row="data-bulk-select-row" data-file="5"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="5" data-file="5"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-folder fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="6" data-bulk-select-row="data-bulk-select-row" data-file="6"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="6" data-file="6" data-file-thumbnail="img/file-manager/11.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/file-manager/11.png" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="7" data-bulk-select-row="data-bulk-select-row" data-file="7"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="7" data-file="7"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-folder fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="8" data-bulk-select-row="data-bulk-select-row" data-file="8"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="8" data-file="8"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-folder fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="9" data-bulk-select-row="data-bulk-select-row" data-file="9"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="9" data-file="9"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-file-excel fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="10" data-bulk-select-row="data-bulk-select-row" data-file="10"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="10" data-file="10"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-file-zipper fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="11" data-bulk-select-row="data-bulk-select-row" data-file="11"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="11" data-file="11" data-file-thumbnail="img/file-manager/12.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/file-manager/12.png" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="12" data-bulk-select-row="data-bulk-select-row" data-file="12"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="12" data-file="12"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-file-csv fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="13" data-bulk-select-row="data-bulk-select-row" data-file="13"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="13" data-file="13"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-file-invoice fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center" data-play-on-container-hover="data-play-on-container-hover">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="14" data-bulk-select-row="data-bulk-select-row" data-file="14"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="14" data-file="14" data-file-thumbnail="video/3.mp4"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden">
                                <div class="video-container h-100"><video class="video d-block h-100 w-100 overflow-hidden object-fit-cover" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/3.png">
                                    <source src="../../assets/video/3.mp4" type="video/mp4">
                                  </video></div>
                              </div><button class="btn p-0 circle-icon-item-md bg-body-emphasis bg-opacity-50 position-absolute top-50 start-50 translate-middle z-3" data-bs-theme="light" data-video-controller="data-video-controller"><span class="play-icon pointer-events-none"><span class="fa-solid fa-play text-body-secondary fs-9" data-fa-transform="down-1"></span></span><span class="pause-icon pointer-events-none"><span class="fa-solid fa-pause text-body-secondary fs-9" data-fa-transform="down-1"></span></span></button>
                            </div>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="15" data-bulk-select-row="data-bulk-select-row" data-file="15"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="15" data-file="15"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-file-pdf fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="16" data-bulk-select-row="data-bulk-select-row" data-file="16"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="16" data-file="16" data-file-thumbnail="img/file-manager/13.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/file-manager/13.png" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="17" data-bulk-select-row="data-bulk-select-row" data-file="17"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="17" data-file="17" data-file-thumbnail="img/file-manager/15.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/file-manager/15.png" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="18" data-bulk-select-row="data-bulk-select-row" data-file="18"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="18" data-file="18"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-file-zipper fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="19" data-bulk-select-row="data-bulk-select-row" data-file="19"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="19" data-file="19" data-file-thumbnail="img/file-manager/16.png"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><img class="w-100 h-100 object-fit-cover" src="../../assets/img/file-manager/16.png" alt=""></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
                        ...
                        <div class="text-center">
                          <div class="file-box-wrapper img-zoom-hover"><input class="form-check-input form-check-input-transparent position-absolute top-0 start-0 mt-3 ms-3 z-1" type="checkbox" name="fileManagerFiles" id="20" data-bulk-select-row="data-bulk-select-row" data-file="20"><label class="stretched-link position-absolute top-0 start-0 w-100 h-100" for="20" data-file="20"></label>
                            <div class="position-relative h-100">
                              <div class="file-box overflow-hidden"><span class="fa-solid fa-file-word fs-3 text-body-tertiary"></span></div>
                            </div>
                            <div class="dropdown lh-1 position-absolute top-0 end-0 mt-2 me-2"><button class="btn btn-square-sm text-body position-relative z-1" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-v" data-fa-transform="shrink-2"></span></button>
                              <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item fw-semibold text-decoration-none" href="#">Share</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Download</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Duplicate</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Rename</a><a class="dropdown-item fw-semibold text-decoration-none" href="#">Move to Bin</a>
                                <hr class="dropdown-divider"><a class="dropdown-item fw-semibold text-decoration-none text-danger" href="#">Delete</a>
