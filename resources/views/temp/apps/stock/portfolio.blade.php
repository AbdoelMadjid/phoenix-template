...
@section('content')
    ...
    <div class="row flex-between-center g-3 g-lg-5 mb-3">
        ...
        <div class="col-auto"> <button class="btn btn-phoenix-secondary bg-body-emphasis me-2">Create new Portfolio <span
                    class="fa-solid fa-add ms-2"> </span></button>
            <button class="btn btn-phoenix-secondary bg-body-emphasis btn-sm px-md-4"><span class="fa-solid fa-print">
                </span><span class="d-none d-md-inline ms-2"> Print</span></button>
            <button class="btn btn-sm btn-phoenix-secondary bg-body-emphasis d-xl-none ms-2" id="portfolioOffcanvas"
                data-bs-toggle="offcanvas" data-bs-target="#portfolioSidebar" aria-controls="portfolioSidebar"><span
                    class="fa-solid fa-mattress-pillow"></span></button>
        </div>
    </div>
    <div class="row g-3 g-lg-5 pb-5 pb-md-7 pb-xl-9">
                        ...
                        <div class="col-12 col-xxl-auto">
                            <div class="scrollbar">
                                <div class="btn-group btn-group-sm stock-btn-group" role="group"
                                    aria-label="portfolio-chart-btn-group"><button class="btn btn-phoenix-secondary"
                                        data-line-filter="data-line-filter" data-value="1d">1D</button>
                                    <button class="btn btn-phoenix-secondary" data-line-filter="data-line-filter"
                                    ...
                                    <button class="btn btn-phoenix-secondary active" data-line-filter="data-line-filter"
                                        data-value="1y">1Y</button>
                                    <button class="btn btn-phoenix-secondary" data-line-filter="data-line-filter"
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    <div id="portfolioTable"
                        data-list='{"valueNames":["portfolioName","symbols","costBasis","marketValue","dayChange","unrealized","realized"],"page":7}'>
                                ...
                                <thead>
                                    <tr class="text-uppercase border-top text-body fw-bold fs-9">
                                        <th class="sort white-space-nowrap align-middle ps-0" scope="col"
                                            style="min-width:180px;" data-sort="portfolioName">Portfolio Name</th>
                                        <th class="sort align-middle text-center" scope="col" data-sort="symbols"
                                            style="min-width:120px;">symbols</th>
                                        <th class="sort align-middle ps-3" scope="col" data-sort="costBasis"
                                            style="min-width:150px;">cost basis</th>
                                        <th class="sort align-middle ps-3" scope="col" style="min-width:160px;"
                                            data-sort="marketValue">Market value</th>
                                        <th class="sort ps-3 align-middle" scope="col" style="min-width:140px;"
                                            data-sort="dayChange">Day Change</th>
                                        <th class="sort pe-3 text-end align-middle" scope="col"
                                            style="min-width:220px;" data-sort="unrealized">Unrealized gain / loss</th>
                                        <th class="sort align-middle text-end" scope="col" style="min-width:180px;"
                                            data-sort="realized">realized gain / loss</th>
                                    </tr>
                                </thead>
                                <tbody class="list">
                                    <tr>
        ...
        <div class="col-xl-5 portfolio-sidebar-container">
            <div class="offcanvas offcanvas-end stock-offcanvas-xl bg-body-emphasis border-xl rounded-xl scrollbar"
                id="portfolioSidebar" tabindex="-1" aria-labelledby="portfolioOffcanvas">
                    ...
                    <div class="card border-0">
                        <div class="card-body">
                            <div class="row flex-between-center mb-4">
                                ...
                                <div class="col-auto d-xl-none"> <button
                                        class="btn btn-link btn-sm fs-8 p-0 text-body-secondary"
                            ...
                            <div class="search-box w-100 mb-3">
                                <form class="position-relative"><input class="form-control search-input search"
                                        type="search" placeholder="Search symbol" aria-label="Search">
                                    ...
                                    <tbody class="border-top">
                                        <tr>
                                            ...
                                            <td class="align-middle white-space-nowrap" style="min-width: 112px;">
                                                ...
                                                <p class="fs-9 mb-0 text-success"><span
                                                        class="me-1 fw-bold">+$0.42</span><span>+0.35%</span></p>
                                            </td>
                                            <td class="align-middle white-space-nowrap d-flex justify-content-end justify-content-xl-start align-items-center"
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle white-space-nowrap" style="min-width: 112px;">
                                                ...
                                                <p class="fs-9 mb-0 text-danger"><span
                                                        class="me-1 fw-bold">-$0.42</span><span>-0.35%</span></p>
                                            </td>
                                            <td class="align-middle white-space-nowrap d-flex justify-content-end justify-content-xl-start align-items-center"
                                                style="min-width: 112px;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle white-space-nowrap" style="min-width: 112px;">
                                                ...
                                                <p class="fs-9 mb-0 text-danger"><span
                                                        class="me-1 fw-bold">-$2.42</span><span>-2.35%</span></p>
                                            </td>
                                            <td class="align-middle white-space-nowrap d-flex justify-content-end justify-content-xl-start align-items-center"
                                                style="min-width: 112px;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle white-space-nowrap" style="min-width: 112px;">
                                                ...
                                                <p class="fs-9 mb-0 text-success"><span
                                                        class="me-1 fw-bold">+$5.42</span><span>+1.21%</span></p>
                                            </td>
                                            <td class="align-middle white-space-nowrap d-flex justify-content-end justify-content-xl-start align-items-center"
                                                style="min-width: 112px;">
                                                <div class="echart-stock-overview-chart"
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle white-space-nowrap" style="min-width: 112px;">
                                                <h5 class="text-body">$232.98</h5>
                                                <p class="fs-9 mb-0 text-success"><span
                                                        class="me-1 fw-bold">+$0.42</span><span>+0.54%</span></p>
                                            </td>
                                            <td class="align-middle white-space-nowrap d-flex justify-content-end justify-content-xl-start align-items-center"
                                                style="min-width: 112px;">
                                                <div class="echart-stock-overview-chart"
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle white-space-nowrap" style="min-width: 112px;">
                                                ...
                                                <p class="fs-9 mb-0 text-success"><span
                                                        class="me-1 fw-bold">+$1.11</span><span>+0.35%</span></p>
                                            </td>
                                            <td class="align-middle white-space-nowrap d-flex justify-content-end justify-content-xl-start align-items-center"
                                                style="min-width: 112px;">
                                                <div class="echart-stock-overview-inverted-chart"
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle white-space-nowrap d-flex justify-content-end justify-content-xl-start align-items-center"
                                                ...
                                                <div class="echart-stock-overview-mixed-chart"
                                                    style="width: 80px; min-height: 44px"
                                                    data-echarts='{"data":[-120,200,230,-230,-190,300,-110,100,-100,250,200,190,-80,80,50,200,-200,220,150,140,310,-150]}'>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="align-middle white-space-nowrap d-flex justify-content-end justify-content-xl-start align-items-center"
                                                ...
                                                <div class="echart-stock-overview-chart"
                                                    style="width: 80px; min-height: 44px"
                                                    data-echarts='{"data":[390,356,348,287,245,214,123,130,95,84,120,103,210,198,210,196,193,200,45,85,70,50]}'>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="align-middle white-space-nowrap d-flex justify-content-end justify-content-xl-start align-items-center"
                                                ...
                                                <div class="echart-stock-overview-chart"
                                                    style="width: 80px; min-height: 44px"
                                                    data-echarts='{"data":[500,450,600,690,700,550,400,450,480,450,445,300,420,600]}'>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
