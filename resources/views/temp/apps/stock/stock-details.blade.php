...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
  ...
  <body>
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-admin">
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/admin/add-product.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Add product</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/admin/products.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Products</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/admin/customers.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Customers</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/admin/customer-details.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Customer details</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/admin/orders.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Orders</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/admin/order-details.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Order details</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/admin/refund.html">
                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-customer" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-customer">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-customer">
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/homepage.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Homepage</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/product-details.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Product details</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/products-filter.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Products filter</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/cart.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Cart</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/checkout.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Checkout</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/shipping-info.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Shipping info</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/profile.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Profile</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/favourite-stores.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Favourite stores</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/wishlist.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Wishlist</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/order-tracking.html">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Order tracking</span></div>
                              </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../e-commerce/landing/invoice.html">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-stock" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-stock">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-stock">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="stock-details.html">
                      ...
                      <li class="nav-item"><a class="nav-link" href="watchlist.html">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="stock" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item active" href="stock-details.html">
                    ...
                    <li><a class="dropdown-item" href="watchlist.html">
            ...
            <div class="tab-content" id="stockDetailsTabContent">
                    ...
                    <table class="table fs-9 mb-0 border-top border-translucent">
                      ...
                      <tbody class="list" id="table-most-recent-forecast-body">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          ...
                          <td class="align-middle analyst white-space-nowrap"><a class="d-flex align-items-center text-body" href="#!">
                              <div class="avatar avatar-m"><img class="rounded-circle" src="../../assets/img/team/5.webp" alt=""></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                          ...
                          <td class="align-middle analyst white-space-nowrap"><a class="d-flex align-items-center text-body" href="#!">
                              <div class="avatar avatar-m"><img class="rounded-circle" src="../../assets/img/team/8.webp" alt=""></div>
                  ...
                  <div class="col-12">
                    <div class="row g-4 mb-4">
                      <div class="col-12 col-xxl-6">
                        <div class="card overflow-hidden h-xxl-100" style="max-height: 390px;"><img class="card-img-top h-xxl-100" src="../../assets/img/stock/news/10.png" alt="">
                      ...
                      <div class="col-12 col-xxl-6">
                        <div class="row g-0 mb-4">
                          <div class="col-12 col-sm-4"><img class="h-100 w-100 rounded-top rounded-top-sm-0 rounded-start-sm" src="../../assets/img/stock/news/1.png" alt=""></div>
                        ...
                        <div class="row g-0">
                          <div class="col-12 col-sm-4"><img class="h-100 w-100 rounded-start-sm rounded-top rounded-top-sm-0" src="../../assets/img/stock/news/2.png" alt=""></div>
                          <div class="col-12 col-sm-8">
                            <div class="card rounded-0 rounded-end-sm h-100">
                              <div class="card-body">
                    ...
                    <div class="row g-4">
                      <div class="col-12 col-sm-6 col-xxl-4">
                        <div class="card h-100"> <img class="card-img-top" src="../../assets/img/stock/news/3.png" alt="image">
                          <div class="card-body">
                      ...
                      <div class="col-12 col-sm-6 col-xxl-4">
                        <div class="card h-100"> <img class="card-img-top" src="../../assets/img/stock/news/4.png" alt="image">
                          <div class="card-body">
                      ...
                      <div class="col-12 col-sm-6 col-xxl-4">
                        <div class="card h-100"> <img class="card-img-top" src="../../assets/img/stock/news/5.png" alt="image">
                          <div class="card-body">
                      ...
                      <div class="col-12 col-sm-6 col-xxl-4">
                        <div class="card h-100"> <img class="card-img-top" src="../../assets/img/stock/news/6.png" alt="image">
                          <div class="card-body">
                      ...
                      <div class="col-12 col-sm-6 col-xxl-4">
                        <div class="card h-100"> <img class="card-img-top" src="../../assets/img/stock/news/7.png" alt="image">
                          <div class="card-body">
                      ...
                      <div class="col-12 col-sm-6 col-xxl-4">
                        <div class="card h-100"> <img class="card-img-top" src="../../assets/img/stock/news/8.png" alt="image">
                          <div class="card-body">
              ...
              <div class="tab-pane fade" id="events-tab" role="tabpanel" aria-labelledby="tab-events">
                          ...
                          <div class="row g-4">
                            <div class="col-12 col-xxl-9">
                              ...
                              <div class="d-flex align-items-center gap-1">
                                <div class="avatar-group align-items-center"> <a class="avatar avatar-s" href="#!"><img class="rounded-circle" src="../../assets/img/team/1.webp" alt=""></a><a class="avatar avatar-s" href="#!"><img class="rounded-circle" src="../../assets/img/team/2.webp" alt=""></a><a class="avatar avatar-s" href="#!"><img class="rounded-circle" src="../../assets/img/team/3.webp" alt=""></a><a class="fs-10 ms-1 fw-semibold text-body-quaternary d-i" href="#!"> +604 people going</a></div>
                ...
                <div class="offcanvas offcanvas-end bg-body-emphasis stock-events-offcanvas" id="stockEventsSidebar">
                  ...
                  <div class="offcanvas-body scrollbar p-4 border-top"> <img class="img-fluid rounded-2 mb-4" src="../../assets/img/stock/offcanvas-image.jpeg" alt="">
                    ...
                    <div class="collapse show" id="speaker">
                      <div class="p-4">
                        <div class="d-flex align-items-center gap-2">
                          <div class="avatar avatar-xl avatar-bordered"><img class="rounded-circle" src="../../assets/img/team/30.webp" alt=""></div>
                          <div>
                      ...
                      <div class="card-body position-relative">
                        <div class="d-sm-flex gap-3">
                          ...
                          <div class="flex-1">
                            ...
                            <div class="d-flex align-items-center gap-1">
                              <div class="avatar-group align-items-center"> <a class="avatar avatar-s" href="#!"><img class="rounded-circle" src="../../assets/img/team/1.webp" alt=""></a><a class="avatar avatar-s" href="#!"><img class="rounded-circle" src="../../assets/img/team/2.webp" alt=""></a><a class="avatar avatar-s" href="#!"><img class="rounded-circle" src="../../assets/img/team/3.webp" alt=""></a></div><a class="fs-10 ms-1 fw-semibold text-body-quaternary" href="#!"> +604 people going</a>
                              <ul class="ps-3 mb-0 text-body-quaternary fs-10">
                                <li>1k people interested</li>
                              </ul>
                            </div>
    ...
    <script src="../../assets/js/pages/stock-details.js"></script>
