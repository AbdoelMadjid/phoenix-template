                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-gallery" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-gallery">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-gallery">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="gallery-masonry.html">
              ...
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="gallery" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="gallery-masonry.html">
        ...
        <div class="mb-9">
          ...
          <div class="row g-3" id="gallery-masonry" data-sl-isotope='{"layoutMode":"packery","packery":{"gutter":0}}'>
            <div class="col-sm-6 col-md-8 col-xl-4 isotope-item ecommerce">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a href="../../assets/img/gallery/89_large.png" data-gallery="gallery-masonry"><img class="rounded-2 w-100 h-100 object-fit-cover" src="../../assets/img/gallery/89.png" alt="">
            ...
            <div class="col-sm-6 col-md-4 col-xl-2 isotope-item photography">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a href="../../assets/img/gallery/86.png" data-gallery="gallery-masonry"><img class="rounded-2 w-100 h-100 object-fit-cover" src="../../assets/img/gallery/90.png" alt="">
                  <div class="backdrop-faded position-absolute w-100 bottom-0 start-0 p-3">
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item project-management">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a href="../../assets/img/gallery/91_large.png" data-gallery="gallery-masonry"><img class="rounded-2 w-100 h-100 object-fit-cover" src="../../assets/img/gallery/91.png" alt="">
                  <div class="backdrop-faded position-absolute w-100 bottom-0 start-0 p-3">
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item ecommerce">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a href="../../assets/img/gallery/92_large.png" data-gallery="gallery-masonry"><img class="rounded-2 w-100 h-100 object-fit-cover" src="../../assets/img/gallery/92.png" alt="">
                  <div class="backdrop-faded position-absolute w-100 bottom-0 start-0 p-3">
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item project-management">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a class="video-container" href="../../assets/img/gallery/96.mp4" data-gallery="gallery-masonry"><video class="video d-block h-100 w-100 overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/img/gallery/96.png">
            ...
            <div class="col-sm-6 col-md-8 col-xl-3 isotope-item ecommerce">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a class="video-container" href="../../assets/img/gallery/97.mp4" data-gallery="gallery-masonry"><video class="video d-block h-100 w-100 overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/img/gallery/97.png">
            ...
            <div class="col-sm-6 col-md-4 col-xl-2 isotope-item photography">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a href="../../assets/img/gallery/79.png" data-gallery="gallery-masonry"><img class="rounded-2 w-100 h-100 object-fit-cover" src="../../assets/img/gallery/93.png" alt="">
                  <div class="backdrop-faded position-absolute w-100 bottom-0 start-0 p-3">
            ...
            <div class="col-sm-6 col-md-4 col-xl-2 isotope-item ecommerce">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a href="../../assets/img/gallery/77.png" data-gallery="gallery-masonry"><img class="rounded-2 w-100 h-100 object-fit-cover" src="../../assets/img/gallery/94.png" alt="">
                  <div class="backdrop-faded position-absolute w-100 bottom-0 start-0 p-3">
            ...
            <div class="col-sm-6 col-md-4 col-xl-2 isotope-item project-management">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a href="../../assets/img/gallery/95_large.png" data-gallery="gallery-masonry"><img class="rounded-2 w-100 h-100 object-fit-cover" src="../../assets/img/gallery/95.png" alt="">
                  <div class="backdrop-faded position-absolute w-100 bottom-0 start-0 p-3">
            ...
            <div class="col-sm-6 col-md-4 col-xl-2 isotope-item photography">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a href="../../assets/img/gallery/108_large.png" data-gallery="gallery-masonry"><img class="rounded-2 w-100 h-100 object-fit-cover" src="../../assets/img/gallery/108.png" alt="">
                  <div class="backdrop-faded position-absolute w-100 bottom-0 start-0 p-3">
            ...
            <div class="col-sm-6 col-md-8 col-xl-4 isotope-item project-management">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a href="../../assets/img/gallery/107_large.png" data-gallery="gallery-masonry"><img class="rounded-2 w-100 h-100 object-fit-cover" src="../../assets/img/gallery/119.png" alt="">
                  <div class="backdrop-faded position-absolute w-100 bottom-0 start-0 p-3">
            ...
            <div class="col-sm-6 col-md-4 col-xl-2 isotope-item photography">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a href="../../assets/img/gallery/106_large.png" data-gallery="gallery-masonry"><img class="rounded-2 w-100 h-100 object-fit-cover" src="../../assets/img/gallery/106.png" alt="">
                  <div class="backdrop-faded position-absolute w-100 bottom-0 start-0 p-3">
            ...
            <div class="col-sm-6 col-md-8 col-xl-4 isotope-item photography">
              <div class="img-zoom-hover position-relative rounded-2 overflow-hidden"><a class="video-container" href="../../assets/img/gallery/99.mp4" data-gallery="gallery-masonry"><video class="video d-block h-100 w-100 overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/img/gallery/99.png">
