      ...
      <div class="content">
        ...
        <div class="mb-9">
          ...
          <div class="d-md-flex d-lg-block d-xl-flex justify-content-between gap-4 my-4">
            <div class="d-flex gap-2 mb-3 mb-md-0 mb-lg-3 mb-xl-0 order-md-1 order-lg-0 order-xl-1"><a class="btn btn-phoenix-secondary btn-square" href="gallery-column.html" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Column view"><span class="fa-solid fa-grip-vertical"></span></a><a class="btn btn-phoenix-secondary btn-square" href="gallery-grid.html" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Grid view"><span class="fa-solid fa-th-large"></span></a><a class="btn btn-phoenix-secondary btn-square" href="grid-with-title.html" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Grid view with title"><span class="fa-solid fa-th-large"></span></a><a class="btn btn-phoenix-secondary btn-square" href="gallery-masonry.html" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Masonry view"><span class="fa-solid fa-th"></span></a><a class="btn btn-phoenix-secondary btn-square border-primary text-primary" href="gallery-slider.html" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Slider view"><span class="fa-solid fa-mattress-pillow"></span></a></div>
            <div class="scrollbar">
              ...
              <div class="swiper-theme-container swiper-slider-gallery">
                <div class="swiper theme-slider" data-swiper='{"speed":500,"spaceBetween":16,"slidesPerView":"auto","simulateTouch":false,"centeredSlides":true,"initialSlide":1,"thumb":{"slidesPerView":4,"spaceBetween":8,"freeMode":true,"loop":true,"watchSlidesProgress":true,"watchSlidesVisibility":true,"grabCursor":true,"breakpoints":{"540":{"slidesPerView":7},"768":{"slidesPerView":8},"1200":{"slidesPerView":9}}}}'>
                  <div class="swiper-wrapper align-items-center" id="gallery-slider-all">
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape ecommerce"><a href="../../assets/img/gallery/100.png" data-gallery="gallery-slider-all"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/100.png" alt=""></a>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape photography"><a href="../../assets/img/gallery/101.png" data-gallery="gallery-slider-all"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/101.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden portrait ecommerce"><a href="../../assets/img/gallery/102.png" data-gallery="gallery-slider-all"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/102.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden square project-management"><a href="../../assets/img/gallery/103.png" data-gallery="gallery-slider-all"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/103.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape ecommerce photography"><a href="../../assets/img/gallery/104.png" data-gallery="gallery-slider-all"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/104.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden portrait project-management photography"><a href="../../assets/img/gallery/71.png" data-gallery="gallery-slider-all"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/71.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Sunset</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape photography"><a href="../../assets/img/gallery/105.png" data-gallery="gallery-slider-all"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/105.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Ear Buds</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden square ecommerce photography"><a href="../../assets/video/2.mp4" data-gallery="gallery-slider-all">
                        <div class="video-container h-100"><video class="video w-100 h-100 object-fit-cover overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/2.png">
                        ...
                        </div><img class="d-none" src="../../assets/video/2.png" alt="">
                      </a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape project-management"><a href="../../assets/video/3.mp4" data-gallery="gallery-slider-all">
                        <div class="video-container h-100"><video class="video w-100 h-100 object-fit-cover overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/3.png">
                            <source src="../../assets/video/3.mp4" type="video/mp4">
                          </video>
                          <div class="circle-icon-item position-absolute top-50 start-50 translate-middle bg-body-emphasis rounded-pill bg-opacity-50"><span class="fa-solid fa-video text-body fs-9 fs-sm-8"></span></div>
                        </div><img class="d-none" src="../../assets/video/3.png" alt="">
                      </a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden portrait project-management"><a href="../../assets/img/gallery/66.png" data-gallery="gallery-slider-all"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/66.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden square project-management"><a href="../../assets/img/gallery/42.png" data-gallery="gallery-slider-all"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/42.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
              ...
              <div class="swiper-theme-container swiper-slider-gallery">
                <div class="swiper theme-slider" data-swiper='{"speed":500,"spaceBetween":16,"slidesPerView":"auto","simulateTouch":false,"centeredSlides":true,"initialSlide":1,"thumb":{"slidesPerView":4,"spaceBetween":8,"freeMode":true,"loop":false,"watchSlidesProgress":true,"watchSlidesVisibility":true,"grabCursor":true,"breakpoints":{"540":{"slidesPerView":7},"768":{"slidesPerView":8},"1200":{"slidesPerView":9}}}}'>
                  <div class="swiper-wrapper align-items-center" id="gallery-slider-ecommerce">
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape ecommerce"><a href="../../assets/img/gallery/100.png" data-gallery="gallery-slider-ecommerce"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/100.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Nature</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden portrait ecommerce"><a href="../../assets/img/gallery/102.png" data-gallery="gallery-slider-ecommerce"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/102.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Sunset</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape ecommerce photography"><a href="../../assets/img/gallery/104.png" data-gallery="gallery-slider-ecommerce"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/104.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Sunset Horizon</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden square ecommerce photography"><a href="../../assets/video/2.mp4" data-gallery="gallery-slider-ecommerce">
                        <div class="video-container h-100"><video class="video w-100 h-100 object-fit-cover overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/2.png">
                            <source src="../../assets/video/2.mp4" type="video/mp4">
                          </video>
                          <div class="circle-icon-item position-absolute top-50 start-50 translate-middle bg-body-emphasis rounded-pill bg-opacity-50"><span class="fa-solid fa-video text-body fs-9 fs-sm-8"></span></div>
              ...
              <div class="swiper-theme-container swiper-slider-gallery">
                <div class="swiper theme-slider" data-swiper='{"speed":500,"spaceBetween":16,"slidesPerView":"auto","simulateTouch":false,"centeredSlides":true,"initialSlide":1,"thumb":{"slidesPerView":4,"spaceBetween":8,"freeMode":true,"loop":false,"watchSlidesProgress":true,"watchSlidesVisibility":true,"grabCursor":true,"breakpoints":{"540":{"slidesPerView":7},"768":{"slidesPerView":8},"1200":{"slidesPerView":9}}}}'>
                  <div class="swiper-wrapper align-items-center" id="gallery-slider-project-management">
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden square project-management"><a href="../../assets/img/gallery/103.png" data-gallery="gallery-slider-project-management"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/103.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Ear Buds</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden portrait project-management photography"><a href="../../assets/img/gallery/71.png" data-gallery="gallery-slider-project-management"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/71.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Sunset</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape project-management"><a href="../../assets/video/3.mp4" data-gallery="gallery-slider-project-management">
                        <div class="video-container h-100"><video class="video w-100 h-100 object-fit-cover overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/3.png">
                            <source src="../../assets/video/3.mp4" type="video/mp4">
                          </video>
                          <div class="circle-icon-item position-absolute top-50 start-50 translate-middle bg-body-emphasis rounded-pill bg-opacity-50"><span class="fa-solid fa-video text-body fs-9 fs-sm-8"></span></div>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden portrait project-management"><a href="../../assets/img/gallery/66.png" data-gallery="gallery-slider-project-management"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/66.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Desert Photography</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden square project-management"><a href="../../assets/img/gallery/42.png" data-gallery="gallery-slider-project-management"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/42.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">London</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
              ...
              <div class="swiper-theme-container swiper-slider-gallery">
                <div class="swiper theme-slider" data-swiper='{"speed":500,"spaceBetween":16,"slidesPerView":"auto","simulateTouch":false,"centeredSlides":true,"initialSlide":1,"thumb":{"slidesPerView":4,"spaceBetween":8,"freeMode":true,"loop":false,"watchSlidesProgress":true,"watchSlidesVisibility":true,"grabCursor":true,"breakpoints":{"540":{"slidesPerView":7},"768":{"slidesPerView":8},"1200":{"slidesPerView":9}}}}'>
                  <div class="swiper-wrapper align-items-center" id="gallery-slider-photography">
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape photography"><a href="../../assets/img/gallery/101.png" data-gallery="gallery-slider-photography"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/101.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Pixel 4</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape ecommerce photography"><a href="../../assets/img/gallery/104.png" data-gallery="gallery-slider-photography"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/104.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Sunset Horizon</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden portrait project-management photography"><a href="../../assets/img/gallery/71.png" data-gallery="gallery-slider-photography"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/71.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Sunset</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden landscape photography"><a href="../../assets/img/gallery/105.png" data-gallery="gallery-slider-photography"> <img class="w-100 h-100 object-fit-cover" src="../../assets/img/gallery/105.png" alt=""></a>
                      <div class="backdrop-faded d-flex justify-content-between p-5">
                        <div>
                          <h3 class="text-white mb-2">Ear Buds</h3>
                          <p class="mb-0 text-secondary-light">Description text</p>
                    ...
                    <div class="swiper-slide position-relative rounded-2 overflow-hidden square ecommerce photography"><a href="../../assets/video/2.mp4" data-gallery="gallery-slider-photography">
                        <div class="video-container h-100"><video class="video w-100 h-100 object-fit-cover overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="../../assets/video/2.png">
                            <source src="../../assets/video/2.mp4" type="video/mp4">
                          </video>
                          <div class="circle-icon-item position-absolute top-50 start-50 translate-middle bg-body-emphasis rounded-pill bg-opacity-50"><span class="fa-solid fa-video text-body fs-9 fs-sm-8"></span></div>
