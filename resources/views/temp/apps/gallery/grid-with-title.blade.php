    ...
    <main class="main" id="top">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-gallery" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-gallery">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-gallery">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="{{ url('grid-with-title') }}">
              ...
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="gallery" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="{{ url('grid-with-title') }}">
      ...
      <div class="content">
        ...
        <div class="mb-9">
          ...
          <div class="row g-3" id="image_gallery" data-sl-isotope='{"layoutMode":"packery"}'><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/77.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/77.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
              <h4 class="title mt-2">Basketball Shoes</h4>
              <p class="mb-0 text-body-tertiary text-capitalize">ecommerce</p>
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/78.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/78.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
            ...
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/79.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/79.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
              ...
              <p class="mb-0 text-body-tertiary text-capitalize">photography</p>
            </a><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/80.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/80.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
              ...
              <p class="mb-0 text-body-tertiary text-capitalize">ecommerce</p>
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/81.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/81.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
              ...
              <p class="mb-0 text-body-tertiary text-capitalize">photography</p>
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/82.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/82.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
              ...
              <p class="mb-0 text-body-tertiary text-capitalize">photography</p>
            </a><a class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/83.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/83.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
            ...
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/84.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/84.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
              ...
              <p class="mb-0 text-body-tertiary text-capitalize">photography</p>
            </a><a class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/85.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/85.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
              ...
              <p class="mb-0 text-body-tertiary text-capitalize">project management</p>
            </a><a class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/86.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/86.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
              ...
              <p class="mb-0 text-body-tertiary text-capitalize">project management</p>
            </a><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/87.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/87.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
              ...
              <p class="mb-0 text-body-tertiary text-capitalize">ecommerce</p>
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item text-center text-decoration-none img-zoom-hover" href="{{ asset('assets/img/gallery/88.png') }}" data-gallery="gallery-grid-title">
              <div class="hoverbox rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/88.png') }}" alt="">
                <div class="hoverbox-content flex-center">
                  <div class="rounded-pill bg-white d-flex flex-center" style="width: 38px; height: 38px"><span class="fa-solid fa-magnifying-glass-plus text-secondary"></span></div>
                </div>
              </div>
