                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-gallery" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-gallery">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-gallery">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="{{ url('album') }}">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ url('gallery-slider') }}">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="gallery" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item active" href="{{ url('album') }}">
                    ...
                    <li><a class="dropdown-item" href="{{ url('gallery-slider') }}">
        ...
        <div class="mb-9">
          ...
          <div class="row g-4" id="gallery-album" data-sl-isotope='{"layoutMode":"packery","packery":{"gutter":0}}'>
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item image">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/109.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/77.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/78.png') }}" alt=""></div>
                  </div>
                  <h4 class="mt-5 title">Trip</h4>
                  <p class="mb-0 fs-9 text-body">43 Items</p>
                </a>
                <div class="dropdown position-absolute top-0 end-0 mt-3 me-3 z-5"><button class="btn btn-sm px-3 dropdown-toggle dropdown-caret-none" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h"></span></button>
              ...
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top">
                      <div class="video-container"><video class="video d-block h-100 w-100 overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="{{ asset('assets/video/1.png') }}">
                    ...
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/81.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/80.png') }}" alt=""></div>
                  </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item image">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/111.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/82.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/83.png') }}" alt=""></div>
                  </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item video">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top">
                      <div class="video-container"><video class="video d-block h-100 w-100 overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="{{ asset('assets/video/2.png') }}">
                          <source src="{{ asset('assets/video/2.mp4') }}" type="video/mp4">
                        </video>
                        <div class="circle-icon-item position-absolute top-50 start-50 translate-middle bg-body-emphasis rounded-pill bg-opacity-50"><span class="fa-solid fa-video text-body fs-9 fs-sm-8"></span></div>
                      </div>
                    </div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/84.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/85.png') }}" alt=""></div>
                  </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item image">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/112.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/86.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/87.png') }}" alt=""></div>
                  </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item image">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/113.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/88.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/89.png') }}" alt=""></div>
                  </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item image">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/114.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/90.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/91.png') }}" alt=""></div>
                  </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item image">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/115.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/92.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/93.png') }}" alt=""></div>
                  </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item image">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/116.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/94.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/95.png') }}" alt=""></div>
                  </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item video">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top">
                      <div class="video-container"><video class="video d-block h-100 w-100 overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="{{ asset('assets/video/3.png') }}">
                          <source src="{{ asset('assets/video/3.mp4') }}" type="video/mp4">
                        </video>
                        <div class="circle-icon-item position-absolute top-50 start-50 translate-middle bg-body-emphasis rounded-pill bg-opacity-50"><span class="fa-solid fa-video text-body fs-9 fs-sm-8"></span></div>
                      </div>
                    </div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/96.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/97.png') }}" alt=""></div>
                  </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item video">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top">
                      <div class="video-container"><video class="video d-block h-100 w-100 overflow-hidden rounded-2" muted="muted" data-play-on-hover="data-play-on-hover" poster="{{ asset('assets/video/4.png') }}">
                          <source src="{{ asset('assets/video/4.mp4') }}" type="video/mp4">
                        </video>
                        <div class="circle-icon-item position-absolute top-50 start-50 translate-middle bg-body-emphasis rounded-pill bg-opacity-50"><span class="fa-solid fa-video text-body fs-9 fs-sm-8"></span></div>
                      </div>
                    </div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/98.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/99.png') }}" alt=""></div>
                  </div>
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 isotope-item image">
              <div class="album-item position-relative overflow-hidden"><a class="text-decoration-none" href="{{ url('gallery-grid') }}">
                  <div class="photo-stack">
                    <div class="rounded-2 overflow-hidden photo-stack-top"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/117.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-middle"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/100.png') }}" alt=""></div>
                    <div class="rounded-2 overflow-hidden photo-stack-bottom"><img class="w-100 object-fit-cover" src="{{ asset('assets/img/gallery/101.png') }}" alt=""></div>
                  </div>
