    ...
    <main class="main" id="top">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-gallery" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-gallery">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-gallery">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="{{ url('gallery-grid') }}">
              ...
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="gallery" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="{{ url('gallery-grid') }}">
      ...
      <div class="content">
        ...
        <div class="mb-9">
          ...
          <div class="row g-3" id="image_gallery" data-sl-isotope='{"layoutMode":"packery"}'><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/77.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/77.png') }}" alt="">
            ...
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/78.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/78.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
                  <h4 class="text-white">Beach Sunset</h4>
                  <p class="mb-0 text-secondary-lighter text-capitalize">photography</p>
                </div>
              </div>
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/79.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/79.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
                  <h4 class="text-white">Camera</h4>
                  <p class="mb-0 text-secondary-lighter text-capitalize">photography</p>
                </div>
              </div>
            </a><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/80.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/80.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
                  <h4 class="text-white">Telephone</h4>
                  <p class="mb-0 text-secondary-lighter text-capitalize">ecommerce</p>
                </div>
              </div>
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/81.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/81.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
                  <h4 class="text-white">Sea Beach</h4>
                  <p class="mb-0 text-secondary-lighter text-capitalize">photography</p>
                </div>
              </div>
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/82.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/82.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
                  <h4 class="text-white">Wooden Beetle</h4>
                  <p class="mb-0 text-secondary-lighter text-capitalize">photography</p>
                </div>
              </div>
            </a><a class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/83.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/83.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
                  <h4 class="text-white">Boat on Water</h4>
                  <p class="mb-0 text-secondary-lighter text-capitalize">project management</p>
                </div>
              </div>
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/84.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/84.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
                  <h4 class="text-white">Sunset Horizon</h4>
                  <p class="mb-0 text-secondary-lighter text-capitalize">photography</p>
                </div>
              </div>
            </a><a class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/85.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/85.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
                  <h4 class="text-white">Trail Ahead</h4>
                  <p class="mb-0 text-secondary-lighter text-capitalize">project management</p>
                </div>
              </div>
            </a><a class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/86.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/86.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
                  <h4 class="text-white">Mountain Sunset</h4>
                  <p class="mb-0 text-secondary-lighter text-capitalize">project management</p>
                </div>
              </div>
            </a><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/87.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/87.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
                  <h4 class="text-white">Dog Sitting</h4>
                  <p class="mb-0 text-secondary-lighter text-capitalize">ecommerce</p>
                </div>
              </div>
            </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item" href="{{ asset('assets/img/gallery/88.png') }}" data-gallery="gallery-grid">
              <div class="hoverbox img-zoom-hover rounded-2"><img class="img-fluid" src="{{ asset('assets/img/gallery/88.png') }}" alt="">
                <div class="hoverbox-content flex-center flex-column">
