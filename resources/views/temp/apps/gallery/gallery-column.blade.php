                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-gallery" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-gallery">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-gallery">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="gallery-column.html">
              ...
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="gallery" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="gallery-column.html">
      ...
      <div class="content">
        ...
        <div class="mb-9">
          ...
          <div class="position-relative">
            <div class="row gx-7 gy-5 overflow-hidden" id="image_gallery" data-gallery-column="data-gallery-column" data-sl-isotope='{"layoutMode":"packery"}'><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/65.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/65.png" alt=""></div>
              ...
              </a><a class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/68.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/68.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
              ...
              </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/71.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/71.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
              ...
              </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/74.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/74.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
              ...
              </a><a class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/75.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/75.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
              ...
              </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/66.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/66.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
              ...
              </a><a class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/69.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/69.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
              ...
              </a><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/72.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/72.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
              ...
              </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/76.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/76.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
              ...
              </a><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/70.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/70.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
              ...
              </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/67.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/67.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
              ...
              </a><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none" href="../../assets/img/gallery/73.png" data-gallery="gallery-column">
                <div class="overflow-hidden rounded"><img class="img-fluid" src="../../assets/img/gallery/73.png" alt=""></div>
                <div class="d-flex mt-3">
                  <div>
