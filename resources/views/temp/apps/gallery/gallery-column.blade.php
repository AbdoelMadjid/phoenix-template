    ...
    <div class="mb-9">
        ...
        <div class="d-md-flex d-lg-block d-xl-flex justify-content-between gap-4 my-4">
            <div class="d-flex gap-2 mb-3 mb-md-0 mb-lg-3 mb-xl-0 order-md-1 order-lg-0 order-xl-1"><a
                    ...
                    href="{{ url('gallery-column') }}" data-bs-toggle="tooltip" data-bs-placement="top"
                    data-bs-title="Column view"><span class="fa-solid fa-grip-vertical"></span></a><a
                    class="btn btn-phoenix-secondary btn-square" href="{{ url('gallery-grid') }}" data-bs-toggle="tooltip"
                    data-bs-placement="top" data-bs-title="Grid view"><span class="fa-solid fa-th-large"></span></a><a
        ...
        <div class="position-relative">
            <div class="row gx-7 gy-5 overflow-hidden" id="image_gallery" data-gallery-column="data-gallery-column"
                data-sl-isotope='{"layoutMode":"packery"}'><a
                    class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none"
                    href="{{ asset('assets/img/gallery/65.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/65.png') }}" alt=""></div>
                    ...
                    class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none"
                    href="{{ asset('assets/img/gallery/68.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/68.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
                ...
                </a><a class="photography col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none"
                    href="{{ asset('assets/img/gallery/71.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/71.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
                    ...
                    href="{{ asset('assets/img/gallery/74.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/74.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
                    ...
                    class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none"
                    href="{{ asset('assets/img/gallery/75.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/75.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
                    ...
                    href="{{ asset('assets/img/gallery/66.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/66.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
                    ...
                    class="project-management col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none"
                    href="{{ asset('assets/img/gallery/69.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/69.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
                ...
                </a><a class="ecommerce col-sm-6 col-md-4 col-xl-3 isotope-item img-zoom-hover text-decoration-none"
                    href="{{ asset('assets/img/gallery/72.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/72.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
                    ...
                    href="{{ asset('assets/img/gallery/76.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/76.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
                    ...
                    href="{{ asset('assets/img/gallery/70.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/70.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
                    ...
                    href="{{ asset('assets/img/gallery/67.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/67.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
                    ...
                    href="{{ asset('assets/img/gallery/73.png') }}" data-gallery="gallery-column">
                    <div class="overflow-hidden rounded"><img class="img-fluid"
                            src="{{ asset('assets/img/gallery/73.png') }}" alt=""></div>
                    <div class="d-flex mt-3">
                        <div>
