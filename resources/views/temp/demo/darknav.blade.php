                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-layouts" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-layouts">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-layouts">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="darknav.html">
                      ...
                      <li class="nav-item"><a class="nav-link" href="navbar-horizontal.html" target="_blank">
                          <div class="d-flex align-items-center"><span class="nav-link-text">Navbar horizontal</span></div>
                        </a><!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="horizontal-slim.html" target="_blank">
                      ...
                      <li class="nav-item"><a class="nav-link" href="dual-nav.html" target="_blank">
              ...
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="layouts" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="darknav.html">
