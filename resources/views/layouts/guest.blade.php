                ...
                <div class="row align-items-center gx-0 gy-7">
                  ...
                  <div class="col-auto bg-body-highlight dark__bg-gray-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                    ...
                    <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7 pb-md-7">
                      <h3 class="mb-3 text-body-emphasis fs-7">{{ config('app.name', 'Phoenix') }} Auth</h3>
                      <p class="text-body-tertiary">Experience hassle-free development with Phoenix Admin Template!</p>
                      <ul class="list-unstyled mb-0 w-max-content w-md-auto">
                        <li class="d-flex align-items-center"><span class="uil uil-check-circle text-success me-2"></span><span class="text-body-tertiary fw-semibold">Laravel 13 Scaffolded</span></li>
                        <li class="d-flex align-items-center"><span class="uil uil-check-circle text-success me-2"></span><span class="text-body-tertiary fw-semibold">Breeze Authentication</span></li>
                        <li class="d-flex align-items-center"><span class="uil uil-check-circle text-success me-2"></span><span class="text-body-tertiary fw-semibold">Responsive & Fast</span></li>
                      </ul>
                    </div>
                  ...
                  <div class="col mx-auto">
                    <div class="auth-form-box px-3 px-md-5">
                      <div class="text-center mb-4">
                        <a class="d-flex flex-center text-decoration-none mb-3" href="{{ url('/') }}">
                          <div class="d-flex align-items-center fw-bolder fs-3 d-inline-block">
                            <img src="{{ asset('assets/img/icons/logo.png') }}" alt="phoenix" width="50">
                          </div>
                        </a>
                      </div>
