                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    ...
                                                    src="{{ asset('assets/img/team/40x40/avatar.webp') }}"
                                                    alt=""></div>
                                            <div class="flex-1 me-sm-3">
                                                <h4 class="fs-9 text-body-emphasis">Jessie Samson</h4>
                                                <p class="fs-9 text-body-highlight mb-2 mb-sm-3 fw-normal"><span
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="{{ asset('assets/img/team/40x40/57.webp') }}" alt="">
                                            </div>
                                            <div class="flex-1 me-sm-3">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="{{ asset('assets/img/team/40x40/59.webp') }}" alt="">
                                            </div>
                                            <div class="flex-1 me-sm-3">
                                ...
                                <div class="px-2 px-sm-3 py-3 notification-card position-relative read ">
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="{{ asset('assets/img/team/40x40/58.webp') }}"
                                                    alt=""></div>
                                            <div class="flex-1 me-sm-3">
                        ...
                        <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                            <div class="row text-center align-items-center gx-0 gy-0">
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('assets/img/nav-icons/google-cloud.webp') }}"
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('assets/img/nav-icons/google-drive.webp') }}"
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img src="{{ asset('assets/img/nav-icons/ln.webp') }}"
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('assets/img/nav-icons/google-maps.webp') }}" alt=""
                                            width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('assets/img/nav-icons/google-photos.webp') }}"
                                            alt="" width="30">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <button type="submit"
                                        class="btn btn-phoenix-secondary d-flex flex-center w-100"><span
                                            class="me-2" data-feather="log-out"></span>Sign out</button>
                                </form>
                            </div>
...
<nav class="navbar navbar-top navbar-slim fixed-top navbar-expand" id="topNavSlim" style="display:none;">
    <div class="collapse navbar-collapse justify-content-between">
        <div class="navbar-logo">
            ...
            <a class="navbar-brand navbar-brand" href="{{ url('dashboard') }}">phoenix <span
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end notification-dropdown-menu py-0 shadow border navbar-dropdown-caret"
                    ...
                    <div class="card position-relative border-0">
                                ...
                                <div class="px-2 px-sm-3 py-3 notification-card position-relative read border-bottom">
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="{{ asset('assets/img/team/40x40/30.webp') }}"
                                                    alt=""></div>
                                            <div class="flex-1 me-sm-3">
                                                <h4 class="fs-9 text-body-emphasis">Jessie Samson</h4>
                                                <p class="fs-9 text-body-highlight mb-2 mb-sm-3 fw-normal"><span
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="{{ asset('assets/img/team/40x40/57.webp') }}"
                                                    alt=""></div>
                                            <div class="flex-1 me-sm-3">
                                                <h4 class="fs-9 text-body-emphasis">Kiera Anderson</h4>
                                                <p class="fs-9 text-body-highlight mb-2 mb-sm-3 fw-normal"><span
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="{{ asset('assets/img/team/40x40/59.webp') }}"
                                                    alt=""></div>
                                            <div class="flex-1 me-sm-3">
                                                <h4 class="fs-9 text-body-emphasis">Herman Carter</h4>
                                                <p class="fs-9 text-body-highlight mb-2 mb-sm-3 fw-normal"><span
                        ...
                        <div class="card-footer p-0 border-top border-translucent border-0">
                            <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a
                                    class="fw-bolder" href="{{ url('pages/notifications') }}">Notification
                                    history</a></div>
                        </div>
                    </div>
                </div>
        ...
        <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button"
                ...
                <ul class="dropdown-menu navbar-dropdown-caret">
                    <li><a class="dropdown-item active" href="{{ url('dashboard') }}">
                    ...
                    <li><a class="dropdown-item" href="{{ url('dashboard/stock') }}">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"
                                    data-feather="dollar-sign"></span>Stock</div>
                        </a></li>
                ...
                <ul class="dropdown-menu navbar-dropdown-caret">
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="e-commerce" href="#"
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="admin"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/admin/add-product') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Add
                                                product</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/admin/products') }}">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Products</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/admin/customers') }}">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Customers</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/admin/customer-details') }}">
                                            <div class="dropdown-item-wrapper"><span
                                    ...
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/admin/order-details') }}">
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="customer"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/landing/homepage') }}">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Homepage</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/landing/product-details') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Product
                                                details</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/landing/products-filter') }}">
                                            <div class="dropdown-item-wrapper"><span
                                    ...
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/landing/checkout') }}">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Checkout</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/landing/shipping-info') }}">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Shipping info</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/landing/profile') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Profile
                                            </div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/landing/favourite-stores') }}">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Favourite stores</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/landing/wishlist') }}">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Wishlist</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/landing/order-tracking') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Order
                                                tracking</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/e-commerce/landing/invoice') }}">
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="project-management"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item"
                                    href="{{ url('apps/project-management/project-list-view') }}">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Project list
                                        view</div>
                                </a></li>
                            <li><a class="dropdown-item"
                                    href="{{ url('apps/project-management/project-card-view') }}">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Project card
                                        view</div>
                                </a></li>
                            <li><a class="dropdown-item"
                                    href="{{ url('apps/project-management/project-board-view') }}">
                            ...
                            <li><a class="dropdown-item"
                                    href="{{ url('apps/project-management/project-details') }}">
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="travel-agency"
                            ...
                            <div class="dropdown-item-wrapper"><span
                                    class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                        class="me-2 uil" data-feather="briefcase"></span>Travel agency</span></div>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="hotel"
                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="hotel-admin"
                                            href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                        class="me-2 uil"></span>Admin</span></div>
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item"
                                                    href="{{ url('apps/travel-agency/hotel/admin/add-property') }}">
                                                    <div class="dropdown-item-wrapper"><span
                                                            class="me-2 uil"></span>Add property</div>
                                                </a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ url('apps/travel-agency/hotel/admin/add-room') }}">
                                                    <div class="dropdown-item-wrapper"><span
                                                            class="me-2 uil"></span>Add room</div>
                                                </a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ url('apps/travel-agency/hotel/admin/room-listing') }}">
                                                    <div class="dropdown-item-wrapper"><span
                                                            class="me-2 uil"></span>Room listing</div>
                                                </a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ url('apps/travel-agency/hotel/admin/room-search') }}">
                                                    <div class="dropdown-item-wrapper"><span
                                    ...
                                    <li class="dropdown"><a class="dropdown-item dropdown-toggle"
                                            id="hotel-customer" href="#" data-bs-toggle="dropdown"
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item"
                                                    href="{{ url('apps/travel-agency/hotel/customer/homepage') }}">
                                                    <div class="dropdown-item-wrapper"><span
                                                            class="me-2 uil"></span>Homepage</div>
                                                </a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ url('apps/travel-agency/hotel/customer/hotel-details') }}">
                                                    <div class="dropdown-item-wrapper"><span
                                                            class="me-2 uil"></span>Hotel details</div>
                                                </a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ url('apps/travel-agency/hotel/customer/hotel-compare') }}">
                                                    <div class="dropdown-item-wrapper"><span
                                                            class="me-2 uil"></span>Hotel compare</div>
                                                </a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ url('apps/travel-agency/hotel/customer/checkout') }}">
                                                    <div class="dropdown-item-wrapper"><span
                                                            class="me-2 uil"></span>Checkout</div>
                                                </a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ url('apps/travel-agency/hotel/customer/payment') }}">
                                                    <div class="dropdown-item-wrapper"><span
                                                            class="me-2 uil"></span>Payment</div>
                                                </a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ url('apps/travel-agency/hotel/customer/gallery') }}">
                                                    <div class="dropdown-item-wrapper"><span
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="flight"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/flight/homepage') }}">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Homepage</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/flight/booking') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Booking
                                            </div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/flight/payment') }}">
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="trip"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/trip/homepage') }}">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Homepage</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/trip/trip-details') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Trip
                                                details</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('apps/travel-agency/trip/checkout') }}">
                                            <div class="dropdown-item-wrapper"><span
                                                    class="me-2 uil"></span>Checkout</div>
                                        </a></li>
                                </ul>
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="stock" href="#"
                            data-bs-toggle="dropdown" data-bs-auto-close="outside">
                            <div class="dropdown-item-wrapper"><span
                                    class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                        class="me-2 uil" data-feather="dollar-sign"></span>Stock</span></div>
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ url('apps/stock/stock-details') }}">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Stock details
                                    </div>
                                </a></li>
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="gallery" href="#"
                            data-bs-toggle="dropdown" data-bs-auto-close="outside">
                            <div class="dropdown-item-wrapper"><span
                                    class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ url('apps/gallery/gallery-column') }}">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Gallery column
                                    </div>
                                </a></li>
                            <li><a class="dropdown-item" href="{{ url('apps/gallery/gallery-grid') }}">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Gallery grid
                                    </div>
                                </a></li>
                            <li><a class="dropdown-item" href="{{ url('apps/gallery/grid-with-title') }}">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Grid with title
                                    </div>
                                </a></li>
                            <li><a class="dropdown-item" href="{{ url('apps/gallery/gallery-masonry') }}">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Gallery masonry
                                    </div>
                                </a></li>
                            <li><a class="dropdown-item" href="{{ url('apps/gallery/gallery-slider') }}">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Gallery slider
                                    </div>
                                </a></li>
                        </ul>
                    </li>
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="file-manager"
                            ...
                            <div class="dropdown-item-wrapper"><span
                                    class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                        class="me-2 uil" data-feather="folder"></span>File manager</span></div>
                        </a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="authentication"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="split"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/split/sign-in') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign in
                                            </div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/split/sign-up') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign up
                                            </div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/split/sign-out') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign
                                                out</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/split/forgot-password') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Forgot
                                                password</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/split/reset-password') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Reset
                                                password</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/split/lock-screen') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Lock
                                                screen</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/split/2FA') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>2FA
                                            </div>
                                        </a></li>
                                </ul>
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="Card"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/card/sign-in') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign in
                                            </div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/card/sign-up') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign up
                                            </div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/card/sign-out') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign
                                                out</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/card/forgot-password') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Forgot
                                                password</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/card/reset-password') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Reset
                                                password</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/card/lock-screen') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Lock
                                                screen</div>
                                        </a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('pages/authentication/card/2FA') }}">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>2FA
                                            </div>
                                        </a></li>
                                </ul>
                            ...
                            <div class="row gx-4 gy-5">
                                <div class="col-12 col-sm-6 col-md-4">
                                    <div class="dropdown-item-group"><span class="me-2" data-feather="file-text"
                                        ...
                                        href="{{ url('modules/forms/basic/form-control') }}">Form control</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/basic/input-group') }}">Input group</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/basic/select') }}">Select</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/basic/checks') }}">Checks</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/basic/range') }}">Range</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/basic/floating-labels') }}">Floating
                                        labels</a><a class="dropdown-link"
                                        href="{{ url('modules/forms/basic/layout') }}">Layout</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/advance/advance-select') }}">Advance
                                        select</a><a class="dropdown-link"
                                        href="{{ url('modules/forms/advance/date-picker') }}">Date picker</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/advance/editor') }}">Editor</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/advance/file-uploader') }}">File uploader</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/advance/range') }}">Range</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/advance/rating') }}">Rating</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/advance/emoji-button') }}">Emoji button</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/forms/validation') }}">Validation</a><a
                                        class="dropdown-link" href="{{ url('modules/forms/wizard') }}">Wizard</a>
                                    <div class="dropdown-item-group mt-5"><span class="me-2" data-feather="grid"
                                            style="stroke-width:2;"></span>
                                        <h6 class="dropdown-item-title">Icons</h6>
                                    </div><a class="dropdown-link"
                                        href="{{ url('modules/icons/feather') }}">Feather</a><a
                                        class="dropdown-link" href="{{ url('modules/icons/font-awesome') }}">Font
                                        awesome</a><a class="dropdown-link"
                                        href="{{ url('modules/icons/unicons') }}">Unicons</a>
                                    <div class="dropdown-item-group mt-5"><span class="me-2"
                                        ...
                                        href="{{ url('modules/echarts/line-charts') }}">Line charts</a><a
                                        class="dropdown-link" href="{{ url('modules/echarts/bar-charts') }}">Bar
                                        charts</a><a class="dropdown-link"
                                        href="{{ url('modules/echarts/candlestick-charts') }}">Candlestick
                                        charts</a><a class="dropdown-link"
                                        href="{{ url('modules/echarts/geo-map') }}">Geo map</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/echarts/scatter-charts') }}">Scatter charts</a><a
                                        class="dropdown-link" href="{{ url('modules/echarts/pie-charts') }}">Pie
                                        charts</a><a class="dropdown-link"
                                        href="{{ url('modules/echarts/gauge-chart') }}">Gauge chart</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/echarts/radar-charts') }}">Radar charts</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/echarts/heatmap-charts') }}">Heatmap charts</a><a
                                        class="dropdown-link" href="{{ url('modules/echarts/how-to-use') }}">How
                                        to use</a>
                                </div>
                                <div class="col-12 col-sm-6 col-md-4">
                                    <div class="dropdown-item-group"><span class="me-2" data-feather="package"
                                        ...
                                        href="{{ url('modules/components/accordion') }}">Accordion</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/avatar') }}">Avatar</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/alerts') }}">Alerts</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/badge') }}">Badge</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/breadcrumb') }}">Breadcrumb</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/button') }}">Buttons</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/calendar') }}">Calendar</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/card') }}">Card</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/carousel/bootstrap') }}">Bootstrap</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/carousel/swiper') }}">Swiper</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/collapse') }}">Collapse</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/dropdown') }}">Dropdown</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/dhtmlx-gantt') }}">Dhtmlx gantt</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/list-group') }}">List group</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/modal') }}">Modals</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/navs-and-tabs/navs') }}">Navs</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/navs-and-tabs/navbar') }}">Navbar</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/navs-and-tabs/tabs') }}">Tabs</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/offcanvas') }}">Offcanvas</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/progress-bar') }}">Progress bar</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/placeholder') }}">Placeholder</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/pagination') }}">Pagination</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/popovers') }}">Popovers</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/scrollspy') }}">Scrollspy</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/sortable') }}">Sortable</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/spinners') }}">Spinners</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/toast') }}">Toast</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/tooltips') }}">Tooltips</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/typed-text') }}">Typed text</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/components/chat-widget') }}">Chat widget</a>
                                </div>
                                <div class="col-12 col-sm-6 col-md-4">
                                    <div class="dropdown-item-group"><span class="me-2" data-feather="columns"
                                        ...
                                        href="{{ url('modules/tables/basic-tables') }}">Basic tables</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/tables/advance-tables') }}">Advance tables</a><a
                                        class="dropdown-link" href="{{ url('modules/tables/bulk-select') }}">Bulk
                                        Select</a>
                                    <div class="dropdown-item-group mt-5"><span class="me-2" data-feather="tool"
                                            style="stroke-width:2;"></span>
                                        <h6 class="dropdown-item-title">Utilities</h6>
                                    </div><a class="dropdown-link"
                                        href="{{ url('modules/utilities/background') }}">Background</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/borders') }}">Borders</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/colors') }}">Colors</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/display') }}">Display</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/flex') }}">Flex</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/stacks') }}">Stacks</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/float') }}">Float</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/grid') }}">Grid</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/interactions') }}">Interactions</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/opacity') }}">Opacity</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/overflow') }}">Overflow</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/position') }}">Position</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/shadows') }}">Shadows</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/sizing') }}">Sizing</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/spacing') }}">Spacing</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/typography') }}">Typography</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/vertical-align') }}">Vertical align</a><a
                                        class="dropdown-link"
                                        href="{{ url('modules/utilities/visibility') }}">Visibility</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button"
                ...
                <ul class="dropdown-menu navbar-dropdown-caret">
                    ...
                    <li class="dropdown dropdown-inside"><a class="dropdown-item dropdown-toggle"
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="{{ url('documentation/customization/configuration') }}">
                            ...
                            <li><a class="dropdown-item"
                                    href="{{ url('documentation/customization/dark-mode') }}">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Dark mode</div>
                                </a></li>
                    ...
                    <li class="dropdown dropdown-inside"><a class="dropdown-item dropdown-toggle" id="layouts-doc"
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="{{ url('documentation/layouts/vertical-navbar') }}">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Vertical navbar
                                    </div>
                                </a></li>
                            <li><a class="dropdown-item"
                                    href="{{ url('documentation/layouts/horizontal-navbar') }}">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end notification-dropdown-menu py-0 shadow border navbar-dropdown-caret"
                ...
                <div class="card position-relative border-0">
                        ...
                        <div class="scrollbar-overlay" style="height: 27rem;">
                            ...
                            <div class="px-2 px-sm-3 py-3 notification-card position-relative read ">
                                <div class="d-flex align-items-center justify-content-between position-relative">
                                    <div class="d-flex">
                                        <div class="avatar avatar-m status-online me-3"><img class="rounded-circle"
                                                src="{{ asset('assets/img/team/40x40/58.webp') }}" alt="">
                                        </div>
                                        <div class="flex-1 me-sm-3">
                                            <h4 class="fs-9 text-body-emphasis">Benjamin Button</h4>
                                            <p class="fs-9 text-body-highlight mb-2 mb-sm-3 fw-normal"><span
                    ...
                    <div class="card-footer p-0 border-top border-translucent border-0">
                        <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a
                                class="fw-bolder" href="{{ url('pages/notifications') }}">Notification history</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                        <div class="row text-center align-items-center gx-0 gy-0">
                            ...
                            <div class="col-4"><a
                                    class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!"><img
                                        src="{{ asset('assets/img/nav-icons/google-cloud.webp') }}" alt=""
                                        width="30">
                                    <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">Cloud</p>
                                </a></div>
                            <div class="col-4"><a
                            ...
                            <div class="col-4"><a
                                    class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                    href="#!"><img
                                        src="{{ asset('assets/img/nav-icons/google-drive.webp') }}" alt=""
                                        width="30">
                                    <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">Drive</p>
                                </a></div>
                            <div class="col-4"><a
                ...
                <a class="navbar-brand me-1 me-sm-3" href="{{ url('dashboard') }}">
                    <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center"><img
                                src="{{ asset('assets/img/icons/logo.png') }}" alt="phoenix" width="27">
                            <h5 class="logo-text ms-2 d-none d-sm-block">phoenix</h5>
                        </div>
                    </div>
                </a>
                            ...
                            <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                                <div class="row text-center align-items-center gx-0 gy-0">
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('assets/img/nav-icons/behance.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('assets/img/nav-icons/slack.webp') }}"
                                                alt="" width="30">
                                            <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">Slack</p>
                                        </a></div>
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('assets/img/nav-icons/gitlab.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('assets/img/nav-icons/bitbucket.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('assets/img/nav-icons/trello.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('assets/img/nav-icons/twitter.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('assets/img/nav-icons/pinterest.webp') }}"
                                                alt="" width="30">
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('assets/img/nav-icons/google-maps.webp') }}"
                                                alt="" width="30">
                                            <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">Maps</p>
                                        </a></div>
                                    <div class="col-4"><a
                                    ...
                                    <div class="col-4"><a
                                            class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                            href="#!"><img
                                                src="{{ asset('assets/img/nav-icons/spotify.webp') }}"
                                                alt="" width="30">
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!"
                    ...
                    <ul class="dropdown-menu navbar-dropdown-caret">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="admin"
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="{{ url('apps/e-commerce/admin/orders') }}">
                                                <div class="dropdown-item-wrapper"><span
                                        ...
                                        <li><a class="dropdown-item"
                                                href="{{ url('apps/e-commerce/admin/refund') }}">
                                                <div class="dropdown-item-wrapper"><span
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="customer"
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="{{ url('apps/e-commerce/landing/cart') }}">
                                                <div class="dropdown-item-wrapper"><span
                        ...
                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="project-management"
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item"
                                        href="{{ url('apps/project-management/create-new') }}">
                                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Create new
                                        </div>
                                    </a></li>
                                <li><a class="dropdown-item"
                                ...
                                <li><a class="dropdown-item"
                                        href="{{ url('apps/project-management/todo-list') }}">
                        ...
                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="travel-agency"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="hotel"
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="dropdown"><a class="dropdown-item dropdown-toggle"
                                                id="hotel-admin" href="#" data-bs-toggle="dropdown"
                                                data-bs-auto-close="outside">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="uil fs-8 uil-angle-right lh-1 dropdown-indicator-icon"></span><span><span
                                                            class="me-2 uil"></span>Admin</span></div>
                        ...
                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="stock"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{ url('apps/stock/portfolio') }}">
                                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Portfolio
                                        </div>
                                    </a></li>
                                <li><a class="dropdown-item" href="{{ url('apps/stock/watchlist') }}">
                                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Watchlist
                                        </div>
                                    </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="gallery"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{ url('apps/gallery/grid-with-title') }}">
                                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Grid with
                                            title</div>
                                    </a></li>
                                <li><a class="dropdown-item" href="{{ url('apps/gallery/gallery-masonry') }}">
                                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Gallery
                        ...
                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="file-manager"
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ url('apps/file-manager/grid-view') }}">
                                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Grid view
                                        </div>
                                    </a></li>
                                <li><a class="dropdown-item" href="{{ url('apps/file-manager/list-view') }}">
                                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>List view
                                        </div>
                                    </a></li>
                            </ul>
                        </li>
                                ...
                                <div class="row gx-4 gy-5">
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="dropdown-item-group"><span class="me-2"
                                            ...
                                            href="{{ url('modules/forms/advance/editor') }}">Editor</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/forms/advance/file-uploader') }}">File
                                            uploader</a><a class="dropdown-link"
                                            href="{{ url('modules/forms/advance/range') }}">Range</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/forms/advance/rating') }}">Rating</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/forms/advance/emoji-button') }}">Emoji
                                            button</a><a class="dropdown-link"
                                            href="{{ url('modules/forms/validation') }}">Validation</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/forms/wizard') }}">Wizard</a>
                                        <div class="dropdown-item-group mt-5"><span class="me-2"
                                            ...
                                            href="{{ url('modules/icons/feather') }}">Feather</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/icons/font-awesome') }}">Font awesome</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/icons/unicons') }}">Unicons</a>
                                        <div class="dropdown-item-group mt-5"><span class="me-2"
                                                data-feather="bar-chart-2" style="stroke-width:2;"></span>
                                            ...
                                            href="{{ url('modules/echarts/line-charts') }}">Line charts</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/echarts/bar-charts') }}">Bar charts</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/echarts/candlestick-charts') }}">Candlestick
                                            charts</a><a class="dropdown-link"
                                            href="{{ url('modules/echarts/geo-map') }}">Geo map</a><a
                                            ...
                                            href="{{ url('modules/echarts/scatter-charts') }}">Scatter charts</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/echarts/pie-charts') }}">Pie charts</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/echarts/gauge-chart') }}">Gauge chart</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/echarts/radar-charts') }}">Radar charts</a><a
                                            ...
                                            href="{{ url('modules/echarts/heatmap-charts') }}">Heatmap charts</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/echarts/how-to-use') }}">How to use</a>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="dropdown-item-group"><span class="me-2"
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="dropdown-item-group"><span class="me-2"
                                            ...
                                            href="{{ url('modules/tables/advance-tables') }}">Advance tables</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/tables/bulk-select') }}">Bulk Select</a>
                                        <div class="dropdown-item-group mt-5"><span class="me-2"
                                            ...
                                            href="{{ url('modules/utilities/typography') }}">Typography</a><a
                                            class="dropdown-link"
                                            href="{{ url('modules/utilities/vertical-align') }}">Vertical
                    ...
                    <ul class="dropdown-menu navbar-dropdown-caret">
                        ...
                        <li class="dropdown dropdown-inside"><a class="dropdown-item dropdown-toggle"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item"
                                        href="{{ url('documentation/customization/styling') }}">
                                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Styling
                                        </div>
                                    </a></li>
                                <li><a class="dropdown-item"
                                        href="{{ url('documentation/customization/color') }}">
                                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Color</div>
                                    </a></li>
                                <li><a class="dropdown-item"
                                        href="{{ url('documentation/customization/dark-mode') }}">
                                ...
                                <li><a class="dropdown-item"
                                        href="{{ url('documentation/customization/plugin') }}">
                        ...
                        <li class="dropdown dropdown-inside"><a class="dropdown-item dropdown-toggle"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item"
                                        href="{{ url('documentation/layouts/combo-navbar') }}">
