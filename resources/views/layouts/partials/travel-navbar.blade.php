<div class="sticky-top bg-body" data-navbar-shadow-on-scroll="data-navbar-shadow-on-scroll">
    <nav class="navbar navbar-top navbar-expand-lg container-medium border-0 bg-body px-3 py-2"><button
            ...
            class="navbar-brand flex-1 flex-lg-grow-0 me-lg-8 me-xl-13" href="{{ url('apps/travel-agency/landing') }}">
        ...
        <div class="d-flex align-items-center gap-2 gap-sm-3 gap-md-4 my-2 order-lg-1">
            <div class="theme-control-toggle feather-icon-wait"><input
                ...
                class="btn btn-link text-body-tertiary p-0" href="{{ url('pages/authentication/card/sign-in') }}"
        ...
        <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center pb-0"
            ...
            <ul class="navbar-nav travel-nav-top me-auto" data-dropdown-on-hover="data-dropdown-on-hover">
                <li class="nav-item dropdown"><a
                        class="nav-link fs-8 fw-bold dropdown-toggle {{ request()->is('apps/travel-agency/hotel*') ? 'text-primary' : '' }}"
                    ...
                    <ul class="dropdown-menu navbar-dropdown-caret">
                        <li><a class="dropdown-item" href="{{ url('apps/travel-agency/hotel/homepage') }}">Homepage</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ url('apps/travel-agency/hotel/hotel-details') }}">Hotel
                                Details</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ url('apps/travel-agency/hotel/hotel-compare') }}">Hotel
                                Compare</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ url('apps/travel-agency/hotel/checkout') }}">Check out</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ url('apps/travel-agency/hotel/payment') }}">Payment</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ url('apps/travel-agency/hotel/gallery') }}">Gallery</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item dropdown"><a
                        class="nav-link fs-8 fw-bold dropdown-toggle {{ request()->is('apps/travel-agency/flight*') ? 'text-primary' : '' }}"
                        href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                        aria-haspopup="true" aria-expanded="false">Flight</a>
                    <ul class="dropdown-menu navbar-dropdown-caret">
                        <li><a class="dropdown-item"
                                href="{{ url('apps/travel-agency/flight/homepage') }}">Homepage</a></li>
                        <li><a class="dropdown-item" href="{{ url('apps/travel-agency/flight/booking') }}">Booking</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ url('apps/travel-agency/flight/payment') }}">Payment</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item dropdown"><a
                        class="nav-link fs-8 fw-bold dropdown-toggle {{ request()->is('apps/travel-agency/trip*') ? 'text-primary' : '' }}"
                        href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                        aria-haspopup="true" aria-expanded="false">Trip</a>
                    <ul class="dropdown-menu navbar-dropdown-caret">
                        <li><a class="dropdown-item"
                                href="{{ url('apps/travel-agency/trip/homepage') }}">Homepage</a></li>
                        <li><a class="dropdown-item" href="{{ url('apps/travel-agency/trip/trip-details') }}">Trip
                                Details</a></li>
                        <li><a class="dropdown-item"
                ...
                <li class="nav-item dropdown"><a
                        class="nav-link fs-8 fw-bold {{ request()->is('apps/travel-agency/landing*') ? 'text-primary' : '' }}"
                        href="{{ url('apps/travel-agency/landing') }}">Landing</a></li>
            </ul>
        </div>
    </nav>
</div>
