        ...
        <div class="ecommerce-topbar">
            <nav class="navbar navbar-expand-lg navbar-light px-0">
                <div class="row gx-0 gy-2 w-100 flex-between-center">
                    <div class="col-auto"><a class="text-decoration-none" href="{{ url('apps/e-commerce/homepage') }}">
                    ...
                    <div class="col-auto order-md-1">
                        <ul class="navbar-nav navbar-nav-icons flex-row me-n2">
                            ...
                            <li class="nav-item feather-icon-wait" style="height: 40px;"><a
                                    class="nav-link px-2 icon-indicator icon-indicator-primary"
                                    href="{{ url('apps/e-commerce/cart') }}" role="button"><span
                            ...
                            <li class="nav-item dropdown feather-icon-wait" style="height: 40px;"><a
                                    ...
                                    aria-expanded="false"><span class="text-body-tertiary" data-feather="bell"
                                    ...
                                    <div class="card position-relative border-0">
                                        ...
                                        <div class="card-footer p-0 border-top border-translucent border-0">
                                            <div
                                                ...
                                                <a class="fw-bolder"
                                                    href="{{ url('pages/notifications') }}">Notification history</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="nav-item dropdown feather-icon-wait" style="height: 40px;"><a
                                    class="nav-link px-2" id="navbarDropdownUser" href="#" role="button"
                                    data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true"
                                        ...
                                        <div class="overflow-auto scrollbar" style="height: 10rem;">
                                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                                <li class="nav-item"><a class="nav-link px-3 d-block"
                                                        href="{{ url('apps/e-commerce/profile') }}"> <span
                                                            class="me-2 text-body align-bottom"
                                                            data-feather="user"></span><span>Profile</span></a></li>
                                                <li class="nav-item"><a class="nav-link px-3 d-block"
                                                        href="{{ url('apps/e-commerce/homepage') }}"><span
                                                            class="me-2 text-body align-bottom"
...
<nav class="navbar-responsive-navitems navbar-expand navbar-light bg-body-emphasis justify-content-between">
    <div class="container-small d-flex flex-between-center" data-navbar="data-navbar">
        <div class="dropdown feather-icon-wait"><button
                        ...
                        <div class="row gx-7 gy-5 mb-5">
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="d-flex align-items-center mb-3"><span class="text-primary me-2"
                                    ...
                                    <h6 class="text-body-highlight mb-0 text-nowrap">Musical Instruments &amp; Gear
                                    </h6>
                                </div>
                                <div class="ms-n2"><a
                                        class="text-body-emphasis d-block mb-1 text-decoration-none bg-body-highlight-hover px-2 py-1 rounded-2"
        ...
        <ul class="navbar-nav justify-content-end align-items-center">
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a
                    class="nav-link ps-0 {{ request()->is('apps/e-commerce/homepage*') ? 'active' : '' }}"
                    href="{{ url('apps/e-commerce/homepage') }}">Home</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a
                    class="nav-link {{ request()->is('apps/e-commerce/favourite-stores*') ? 'active' : '' }}"
                    href="{{ url('apps/e-commerce/favourite-stores') }}">My Favourite Stores</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a
                    class="nav-link {{ request()->is('apps/e-commerce/products-filter*') ? 'active' : '' }}"
                    href="{{ url('apps/e-commerce/products-filter') }}">Products</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a
                    class="nav-link {{ request()->is('apps/e-commerce/wishlist*') ? 'active' : '' }}"
                    href="{{ url('apps/e-commerce/wishlist') }}">Wishlist</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a
                    class="nav-link {{ request()->is('apps/e-commerce/shipping-info*') ? 'active' : '' }}"
                    href="{{ url('apps/e-commerce/shipping-info') }}">Shipping Info</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a
                    class="nav-link {{ request()->is('apps/e-commerce/invoice*') ? 'active' : '' }}"
                    href="{{ url('apps/e-commerce/invoice') }}">Invoice</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a
                    class="nav-link {{ request()->is('apps/e-commerce/order-tracking*') ? 'active' : '' }}"
                    href="{{ url('apps/e-commerce/order-tracking') }}">Track order</a></li>
            <li class="nav-item invisible" data-nav-item="data-nav-item"><a
                    class="nav-link pe-0 {{ request()->is('apps/e-commerce/checkout*') ? 'active' : '' }}"
                    href="{{ url('apps/e-commerce/checkout') }}">Checkout</a></li>
