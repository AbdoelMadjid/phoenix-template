<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="ltr" class="@yield('html_class')" data-navigation-type="@yield('navigation_type', 'dual')" data-navbar-horizontal-shape="@yield('navbar_horizontal_shape', 'default')" @yield('html_attributes')>
  <head>
    <meta charset="utf-8">
