                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    ...
                                    href="#!"><img
                                        ...
                                        width="53"></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                                    href="#!">Amazon Basics Mesh, Mid-Back,
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    ...
                                    href="#!"><img
                                        ...
                                        width="53"></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                                    href="#!">Echo Dot (4th Gen) _ Smart speaker
                                    with Alexa ...</a></td>
                            <td class="align-middle customer white-space-nowrap"><a
                                    class="d-flex align-items-center text-body"
                                    href="#!">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    ...
                                    href="#!"><img
                                        ...
                                        width="53"></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                                    href="#!">Nintendo Switch with Neon Blue and
                                    Neon Red Jo...</a></td>
                            <td class="align-middle customer white-space-nowrap"><a
                                    class="d-flex align-items-center text-body"
                                    href="#!">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    ...
                                    href="#!"><img
                                        ...
                                        width="53"></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                                    href="#!">Oculus Rift S PC-Powered VR Gaming
                                    Headset</a></td>
                            <td class="align-middle customer white-space-nowrap"><a
                                    class="d-flex align-items-center text-body"
                                    href="#!">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0"><a
                                    ...
                                    href="#!"><img
                                        ...
                                        width="53"></a></td>
                            <td class="align-middle product white-space-nowrap"><a class="fw-semibold"
                                    href="#!">Sony X85J 75 Inch Sony 4K Ultra HD
                                    LED Smart G...</a></td>
                            <td class="align-middle customer white-space-nowrap"><a
                                    class="d-flex align-items-center text-body"
                                    href="#!">
