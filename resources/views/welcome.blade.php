        ...
        <main class="main" id="top">
            <div class="bg-body-emphasis sticky-top" data-navbar-shadow-on-scroll="data-navbar-shadow-on-scroll">
                <nav class="navbar navbar-expand-lg container-small px-3 px-lg-7 px-xxl-3"><a
                        class="navbar-brand flex-1 flex-lg-grow-0" href="#top">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item border-bottom border-translucent border-bottom-lg-0"><a
                                    class="nav-link lh-1 py-0 fs-9 fw-bold py-3" aria-current="page"
                                    href="#top">Home</a></li>
                            <li class="nav-item border-bottom border-translucent border-bottom-lg-0"><a
                                    class="nav-link lh-1 py-0 fs-9 fw-bold py-3" href="#feature">Features</a></li>
                            <li class="nav-item border-bottom border-translucent border-bottom-lg-0"><a
                                    class="nav-link lh-1 py-0 fs-9 fw-bold py-3" href="#blog">Blog</a></li>
                            <li class="nav-item"><a class="nav-link lh-1 py-0 fs-9 fw-bold py-3"
                                    href="#team">Team</a></li>
                        </ul>
                        <div class="d-grid d-lg-flex align-items-center">
                            <div class="nav-item d-flex align-items-center d-none d-lg-block pe-2">
                                ...
                                class="text-body-quaternary text-body-tertiary-hover px-2 d-none d-lg-inline lh-sm"
                                href="#!" data-bs-toggle="modal" data-bs-target="#searchBoxModal"><span
                                    data-feather="search" style="height: 20px; width: 20px;"></span></a>
                            @auth
                                <a class="btn btn-phoenix-primary order-0" href="{{ route('dashboard') }}"><span
                                        ...
                                        <div class="list pb-3">
                                            ...
                                            <div class="py-2"><a
                                                    ...
                                                    <div class="file-thumbnail me-2"><img
                                                            ...
                                                            src="{{ asset('assets/img/products/60x60/3.png') }}"
                                                            alt=""></div>
                                                    <div class="flex-1">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-auto order-0 order-md-1 text-end order-1">
                            <div class="position-relative p-5 p-md-7 d-lg-none">
                                ...
                                <div class="position-relative"><img class="w-100 shadow-lg d-dark-none rounded-2"
                                        src="{{ asset('assets/img/bg/bg-31.png') }}" alt="hero-header"><img
                                        class="w-100 shadow-lg d-light-none rounded-2"
                                        src="{{ asset('assets/img/bg/bg-30.png') }}" alt="hero-header"></div>
                            </div>
                            <div class="hero-image-container position-absolute top-0 bottom-0 end-0 d-none d-lg-block">
                                <div class="position-relative h-100 w-100">
                                    ...
                                    <div class="position-absolute h-100 top-0 d-flex align-items-center end-0"><img
                                            ...
                                            src="{{ asset('assets/img/bg/bg-28.png') }}" alt="hero-header"><img
                                            class="pt-7 pt-md-0 w-100 shadow-lg d-light-none rounded-2"
                                            src="{{ asset('assets/img/bg/bg-29.png') }}" alt="hero-header"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6 text-lg-start text-center pt-8 pb-6 order-0 position-relative">
                            ...
                            <p class="mb-5">Standard, modern and Elegant solution for your next web app so you don’t
                                have to look further. Sign up or check the demo below.</p><a
                                class="btn btn-lg btn-primary rounded-pill me-3" href="#!" role="button">Sign
                                up</a><a class="btn btn-link me-2 fs-8 p-0" href="#!" role="button">Check
                                Demo<span class="fa-solid fa-angle-right ms-2 fs-9"></span></a>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row g-0">
                        <div class="col-6 col-md-3">
                            <div
                                ...
                                <img class="w-100" src="{{ asset('assets/img/brand2/netflix-n.png') }}"
                                    alt="">
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div
                                ...
                                <img class="w-100" src="{{ asset('assets/img/brand2/blender.png') }}"
                                    alt="">
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div
                                ...
                                <img class="w-100" src="{{ asset('assets/img/brand2/upwork.png') }}"
                                    alt="">
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div
                                ...
                                <img class="w-100" src="{{ asset('assets/img/brand2/facebook-f.png') }}"
                                    alt="">
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div
                                ...
                                <img class="w-100" src="{{ asset('assets/img/brand2/pocket.png') }}"
                                    alt="">
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div
                                ...
                                <img class="w-100" src="{{ asset('assets/img/brand2/mail-bluster-1.png') }}"
                                    alt="">
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div
                                ...
                                <img class="w-100" src="{{ asset('assets/img/brand2/discord.png') }}"
                                    alt="">
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div
                                ...
                                <img class="w-100" src="{{ asset('assets/img/brand2/google-g.png') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="position-relative z-2">
                        ...
                        <div
                            ...
                            <div class="col-lg-5"><img class="feature-image img-fluid mb-9 mb-lg-0 d-dark-none"
                                    src="{{ asset('assets/img/spot-illustrations/22_2.png') }}" alt=""><img
            ...
            <div class="position-relative">
                <div class="bg-holder z-2 d-none d-md-block"
                    style="background-image:url({{ asset('assets/img/bg/13.png') }});background-size:auto;background-position:right;">
                </div>
                <!--/.bg-holder-->
                <div class="bg-holder z-2 d-none d-md-block d-lg-none d-xl-block"
                    style="background-image:url({{ asset('assets/img/bg/bg-12.png') }});background-size:auto;background-position:left;">
                </div>
                <!--/.bg-holder-->
                <div class="bottom-0 start-0 end-0 bg-body-emphasis"><svg class="w-100" viewbox="0 0 1920 368"
                                            ...
                                            <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                                                <div class="col-lg-6 col-xl-5 text-center">
                                                    <div
                                                        ...
                                                        <div class="bg-holder"
                                                            style="background-image:url({{ asset('assets/img/bg/bg-2.png') }});background-size:contain;">
                                                        </div>
                                                        <!--/.bg-holder-->
                                            ...
                                            <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                                                <div class="col-lg-6 col-xl-5 text-center">
                                                    <div
                                                        ...
                                                        <!--/.bg-holder-->
                                                        <img class="rounded-3 mb-lg-0 opacity-100 position-relative"
                                                            src="{{ asset('assets/img/team/8.webp') }}"
                                                            width="154" alt="">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-xl-7 text-center text-lg-start">
            ...
            <div class="position-relative">
                <div class="bg-holder world-map-bg"
                    style="background-image:url({{ asset('assets/img/bg/bg-13.png') }});"></div>
                <!--/.bg-holder-->
                <div class="bg-holder z-2 opacity-25 "
                    style="background-image:url({{ asset('assets/img/bg/bg-right-21.png') }});background-size:auto;background-position:right;">
                </div>
                <!--/.bg-holder-->
                <div class="bg-holder z-2 mt-9 opacity-25"
                    style="background-image:url({{ asset('assets/img/bg/bg-left-21.png') }});background-size:auto;background-position:left;">
                </div>
                <!--/.bg-holder-->
                        ...
                        <div class="position-relative">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 text-center text-md-start"><img class="img-fluid"
                                        src="{{ asset('assets/img/generic/capterra.png') }}" alt=""></div>
                            </div>
                        </div>
                    </div>
                </section><svg class="w-100 position-relative" viewbox="0 0 1920 368"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            <section class="bg-body-emphasis pb-lg-6 pb-xl-8">
                <div class="bg-holder d-dark-none"
                    style="background-image:url({{ asset('assets/img/bg/bg-5.png') }});background-size:auto;"></div>
                <!--/.bg-holder-->
                <div class="bg-holder d-light-none"
                    style="background-image:url({{ asset('assets/img/bg/bg-dark-5.png') }});background-size:auto;">
                </div>
                <!--/.bg-holder-->
                <div class="bg-holder"
                    style="background-image:url({{ asset('assets/img/bg/bg-left-5.png') }});background-position:left;background-size:auto;">
                </div>
                <!--/.bg-holder-->
                <div class="bg-holder"
                    style="background-image:url({{ asset('assets/img/bg/bg-right-6.png') }});background-position:right;background-size:auto;">
                </div>
                <!--/.bg-holder-->
                    ...
                    <div class="row g-3" id="image_gallery" style="min-height: 948px"
                        ...
                        <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item fourth"><a href="#!"
                                data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/1.png"><img
                                    class="rounded img-fluid w-100" src="{{ asset('assets/img/gallery/1.png') }}"
                                    alt=""></a></div>
                        <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third"><a href="#!"
                                data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/2.png"><img
                                    class="rounded img-fluid w-100" src="{{ asset('assets/img/gallery/2.png') }}"
                                    alt=""></a></div>
                        <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!"
                                data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/3.png"><img
                                    class="rounded img-fluid w-100" src="{{ asset('assets/img/gallery/3.png') }}"
                                    alt=""></a></div>
                        <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third"><a href="#!"
                                data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/5.png"><img
                                    class="rounded img-fluid w-100" src="{{ asset('assets/img/gallery/5.png') }}"
                                    alt=""></a></div>
                        <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third second"><a href="#!"
                                data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/4.png"><img
                                    class="rounded img-fluid w-100" src="{{ asset('assets/img/gallery/4.png') }}"
                                    alt=""></a></div>
                        <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!"
                                data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/6.png"><img
                                    class="rounded img-fluid w-100" src="{{ asset('assets/img/gallery/6.png') }}"
                                    alt=""></a></div>
                        <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!"
                                data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/7.png"><img
                                    class="rounded img-fluid w-100" src="{{ asset('assets/img/gallery/7.png') }}"
                                    alt=""></a></div>
                        <div class="col-6 col-md-4 col-lg-6 px-2 isotope-item second"><a href="#!"
                                data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/9.png"><img
                                    class="rounded img-fluid w-100" src="{{ asset('assets/img/gallery/9.png') }}"
                                    alt=""></a></div>
                        <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item fourth"><a href="#!"
                                data-bigpicture='{"gallery":"#image_gallery"}' data-bp="assets/img/gallery/8.png"><img
                                    class="rounded img-fluid w-100" src="{{ asset('assets/img/gallery/8.png') }}"
                                    alt=""></a></div>
                        <div class="col-6 col-md-4 col-lg-6 px-2 isotope-item second"><a href="#!"
                                data-bigpicture='{"gallery":"#image_gallery"}'
                                data-bp="assets/img/gallery/10.png"><img class="rounded img-fluid w-100"
                                    src="{{ asset('assets/img/gallery/10.png') }}" alt=""></a></div>
                    </div>
                </div>
            </section>
            <section class="bg-body-emphasis pt-lg-0 pt-xl-8">
                <div class="bg-holder d-none d-md-block"
                    style="background-image:url({{ asset('assets/img/bg/bg-left-15.png') }});background-position:left;background-size:auto;">
                </div>
                <!--/.bg-holder-->
                <div class="bg-holder d-none d-md-block"
                    style="background-image:url({{ asset('assets/img/bg/bg-right-15.png') }});background-position:right;background-size:auto;">
                </div>
                <!--/.bg-holder-->
                <div class="container-small position-relative px-lg-7 px-xxl-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="fa-ul pricing-list">
                                                ...
                                                <li class="mb-4 d-flex align-items-center"><span class="fa-li"><span
                                                            class="fas fa-star text-primary"></span></span><span
                                                        class="text-body-secondary"
                                                        style="--phoenix-text-opacity:1;">Task dependencies</span></li>
                                                <li class="mb-4 d-flex align-items-center"><span class="fa-li"><span
                                                            class="fas fa-star text-primary"></span></span><span
                                                        class="text-body-secondary"
                    ...
                    <div class="row h-100 g-3 justify-content-center">
                        <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
                            <div class="card text-white dark__text-gray-1100 h-100"><img
                                    ...
                                    src="{{ asset('assets/img/blog/blog-1.png') }}" alt="...">
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
                            <div class="card text-white dark__text-gray-1100 h-100"><img
                                    class="rounded-top h-100 object-fit-cover"
                                    src="{{ asset('assets/img/blog/blog-2.png') }}" alt="...">
                                <div class="card-body rounded-top">
                                    <div class="d-flex align-items-cente mb-3">
                                        <div class="d-flex align-items-center me-3"><a
                                                class="btn-link text-decoration-none d-flex align-items-center"
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
                            <div class="card text-white dark__text-gray-1100 h-100"><img
                                    class="rounded-top h-100 object-fit-cover"
                                    src="{{ asset('assets/img/blog/blog-3.png') }}" alt="...">
                                <div class="card-body rounded-top">
                                    <div class="d-flex align-items-cente mb-3">
                                        <div class="d-flex align-items-center me-3"><a
                                                class="btn-link text-decoration-none d-flex align-items-center"
                        ...
                        <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
                            <div class="card text-white dark__text-gray-1100 h-100"><img
                                    class="rounded-top h-100 object-fit-cover"
                                    src="{{ asset('assets/img/blog/blog-4.png') }}" alt="...">
                                <div class="card-body rounded-top">
                                    <div class="d-flex align-items-cente mb-3">
                                        <div class="d-flex align-items-center me-3"><a
                                                class="btn-link text-decoration-none d-flex align-items-center"
                ...
                <div class="container-small px-lg-7 px-xxl-3">
                    ...
                    <div class="row g-5 g-lg-5">
                        <div class="col-md-6 mb-5 mb-md-0 text-center text-md-start">
                            ...
                            <div class="d-flex flex-column align-items-center align-items-md-start gap-3 gap-md-0">
                                <div class="d-md-flex align-items-center">
                                    ...
                                    <div class="flex-1 ms-3"><a class="link-900" href="#!">(871)
                                            406-7509</a></div>
                                </div>
                                <div class="d-md-flex align-items-center">
                                    <div class="icon-wrapper shadow-info"><span
                        ...
                        <div class="col-md-6 text-center text-md-start">
                            ...
                            <form class="row g-4">
                                <div class="col-12"><input class="form-control bg-body-emphasis" type="text"
                                        name="name" placeholder="Name" required="required"></div>
                                <div class="col-12"><input class="form-control bg-body-emphasis" type="email"
                                        name="email" placeholder="Email" required="required"></div>
                                <div class="col-12">
            ...
            <section id="team">
                <div class="bg-holder z-2"
                    style="background-image:url({{ asset('assets/img/bg/bg-left-17.png') }});background-size:auto;background-position:left center;">
                </div>
                <!--/.bg-holder-->
                <div class="bg-holder z-2"
                    style="background-image:url({{ asset('assets/img/bg/bg-right-17.png') }});background-size:auto;background-position:right center;">
                </div>
                <!--/.bg-holder-->
                <div class="position-absolute top-0 end-0 start-0"><svg class="w-100 text-white"
                        preserveaspectratio="none" viewbox="0 0 1920 368" xmlns="http://www.w3.org/2000/svg">
                        <path class="fill-emphasis-bg" d="M1920 0.44L0 367.74V0H1920V0.44Z"></path>
                    </svg></div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="text-center mt-5 position-relative">
                                <div class="team-avatar-container d-inline-block position-relative">
                                    <div class="bg-holder"
                                        style="background-image:url({{ asset('assets/img/bg/bg-21.png') }});background-size:contain;">
                                    </div>
                                    <!--/.bg-holder-->
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="text-center mt-5 position-relative">
                                <div class="team-avatar-container d-inline-block position-relative">
                                    ...
                                    <!--/.bg-holder-->
                                    <img class="img-fluid rounded mb-3 position-relative"
                                        src="{{ asset('assets/img/team/63.webp') }}" alt="...">
                                </div>
                                <h4>Marc Chiasson</h4>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="text-center mt-5 position-relative">
                                <div class="team-avatar-container d-inline-block position-relative">
                                    ...
                                    <!--/.bg-holder-->
                                    <img class="img-fluid rounded mb-3 position-relative"
                                        src="{{ asset('assets/img/team/64.webp') }}" alt="...">
                                </div>
                                <h4>Lilah Lola</h4>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="text-center mt-5 position-relative">
                                <div class="team-avatar-container d-inline-block position-relative">
                                    ...
                                    <!--/.bg-holder-->
                                    <img class="img-fluid rounded mb-3 position-relative"
                                        src="{{ asset('assets/img/team/66.webp') }}" alt="...">
                                </div>
                                <h4>Alan Casey</h4>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="text-center mt-5 position-relative">
                                <div class="team-avatar-container d-inline-block position-relative">
                                    ...
                                    <!--/.bg-holder-->
                                    <img class="img-fluid rounded mb-3 position-relative"
                                        src="{{ asset('assets/img/team/67.webp') }}" alt="...">
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="text-center mt-5 position-relative">
                                <div class="team-avatar-container d-inline-block position-relative">
                                    ...
                                    <!--/.bg-holder-->
                                    <img class="img-fluid rounded mb-3 position-relative"
                                        src="{{ asset('assets/img/team/68.webp') }}" alt="...">
                                </div>
                                <h4>Narokin Hijita</h4>
                                <h6 class="mb-3 fw-semibold">CEO, Global Cheat</h6><a href="#!"><span
                                        class="fa-brands fa-facebook text-primary me-3"></span></a><a
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="text-center mt-5 position-relative">
                                <div class="team-avatar-container d-inline-block position-relative">
                                    ...
                                    <!--/.bg-holder-->
                                    <img class="img-fluid rounded mb-3 position-relative"
                                        src="{{ asset('assets/img/team/69.webp') }}" alt="...">
                                </div>
                                <h4>Narokin Hijita</h4>
                                <h6 class="mb-3 fw-semibold">CEO, Global Cheat</h6><a href="#!"><span
                                        class="fa-brands fa-facebook text-primary me-3"></span></a><a
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 text-center">
                            <div class="card py-md-9 px-md-13 border-0 z-1 shadow-lg cta-card">
                                <div class="bg-holder"
                                    style="background-image:url({{ asset('assets/img/bg/bg-18.png') }});background-position:right;background-size:auto;">
                                </div>
                                <!--/.bg-holder-->
                                <div class="card-body position-relative"><img class="img-fluid mb-5 d-dark-none"
                                        ...
                                        src="{{ asset('assets/img/spot-illustrations/dark_27.png') }}"
                                        width="210" alt="...">
                                    ...
                                    <form class="d-flex justify-content-center mb-3 px-xxl-12">
                                        <div class="d-grid d-sm-block"></div><input class="form-control me-3"
                                            id="ctaEmail1" type="email" placeholder="Email"
                                            aria-describedby="ctaEmail1"><button class="btn btn-primary"
            ...
            <div class="position-relative">
                <div class="bg-holder footer-bg"
                    style="background-image:url({{ asset('assets/img/bg/bg-19.png') }});background-size:auto;">
                </div>
                <!--/.bg-holder-->
                <div class="bg-holder"
                    style="background-image:url({{ asset('assets/img/bg/bg-right-20.png') }});background-position:right;background-size:auto;">
                </div>
                <!--/.bg-holder-->
                <div class="bg-holder"
                    style="background-image:url({{ asset('assets/img/bg/bg-left-20.png') }});background-position:left;background-size:auto;">
                </div>
                <!--/.bg-holder-->
                <div class="position-relative"><svg class="w-100 text-white dark__text-gray-1100"
                        ...
                        <div class="container-small px-lg-7 px-xxl-3">
                            <div class="row position-relative">
                                <div class="col-12 col-sm-12 col-lg-5 mb-4 order-0 order-sm-0"><a
                                        href="#!"><img class="mb-3"
                                            src="{{ asset('assets/img/icons/logo-white.png') }}" height="48"
                                            alt=""></a>
